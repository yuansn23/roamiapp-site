...
# Sağ sütun: Popüler eSIM yapılandırması
sidebar_popular:
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "iPhone'umda kaç tane eSIM bulunabilir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bir iPhone'da 8 veya daha fazla eSIM profili saklayabilirsiniz. Ancak modelinize bağlı olarak aynı anda yalnızca iki eSIM aktif olarak çalışabilir (Çift eSIM)."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Evet. iPhone'lar Çift SIM işlevselliğini destekler; aramalar ve metinler için fiziksel ev SIM'inizi aktif tutarken veri için bir seyahat eSIM'i kullanabilirsiniz."
      }
    },
    {
      "@type": "Question",
      "name": "Seyahatimden sonra eSIM'imi silebilir miyim?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Evet. Seyahatiniz bittiğinde Ayarlar > Hücresel'e gidin, eSIM'e dokunun ve eSIM'i Sil'i seçin. Ancak hala seyahatteyken veya bağlantınız kesilirse ASLA silmeyin; çoğu eSIM QR kodu yalnızca bir kez taranabilir."
      }
    },
    {
      "@type": "Question",
      "name": "eSIM kullanmak iPhone pilimi daha hızlı tüketir mi?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "eSIM kullanmak fiziksel SIM ile aynı miktarda pil tüketir. Ancak zayıf sinyal alanında iki aktif hat çalıştırmak hafif pil tüketimine neden olabilir."
      }
    },
    {
      "@type": "Question",
      "name": "eSIM ile fiziksel SIM arasındaki fark nedir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "eSIM, fiziksel olarak çıkarılamayan dijital bir SIM'dir. Aynı işlevselliği sunar ancak daha fazla esneklik sağlar: operatörleri değiştirebilir, birden fazla profil depolayabilir ve anında planları etkinleştirebilirsiniz."
      }
    },
    {
      "@type": "Question",
      "name": "Telefonumun eSIM uyumlu olup olmadığını nasıl anlarım?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "*#06# tuşlayın; bir EID görünüyorsa telefonunuz eSIM'i destekliyordur. Veya Dijital SIM veya EID girişi için Ayarlar > Genel > Hakkında'yı kontrol edin."
      }
    },
    {
      "@type": "Question",
      "name": "eSIM'imi bir telefondan diğerine aktarabilir miyim?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Evet, iOS 19 Hızlı Aktarım (iPhone'dan iPhone'a) veya platformlar arası aktarım (iPhone ile Android arasında) kullanarak aktarabilirsiniz."
      }
    },
    {
      "@type": "Question",
      "name": "Seyahat eSIM'i nedir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Seyahat eSIM'i, uluslararası seyahatler için tasarlanmış yalnızca veri içeren bir eSIM'dir. Kalkıştan önce satın alır, evde kurar ve varışta etkinleştirirsiniz; dolaşım ücreti yoktur."
      }
    }
  ]
}
