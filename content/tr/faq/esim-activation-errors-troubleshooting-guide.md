...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "iPhone XR'm \"eSIM desteklenmiyor\" diyor ama çalışması gerekmiyor mu?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Çin anakara modeliniz varsa (model numarası CH/A ile biter), iPhone XR'nizde eSIM donanımı yoktur. Ayrıca operatör kilit durumunu da kontrol edin."
      }
    },
    {
      "@type": "Question",
      "name": "iPhone 7'de eSIM'i zorlayabilir miyim?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Hayır, iPhone 7'de eSIM donanımı yoktur, bu imkansızdır. Aynısı iPhone 6s, 8 ve iPhone X için de geçerlidir."
      }
    },
    {
      "@type": "Question",
      "name": "eSIM'imi yanlışlıkla sildim – nasıl geri alabilirim?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "eSIM sağlayıcınızla iletişime geçin. Seyahat eSIM'leri genellikle yeniden verilebilir; operatör eSIM'leri uygulamalarından yeniden indirilebilir."
      }
    },
    {
      "@type": "Question",
      "name": "eSIM'im saatlerce \"Etkinleştiriliyor\" da neden takılı kalıyor?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Uçak Modu'nu açıp kapatmayı, telefonunuzu yeniden başlatmayı veya Wi-Fi ağlarını değiştirmeyi deneyin. Hala takılıysa profili silin ve yeni bir QR kodu talep edin."
      }
    },
    {
      "@type": "Question",
      "name": "\"sim'iniz esim aktarımı için desteklenmiyor verizon\" ne anlama gelir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Verizon, yeni bir cihaza aktarmadan önce eSIM'i eski cihazdan kaldırmanızı gerektirir. Verizon'a özel adımları izleyin."
      }
    },
    {
      "@type": "Question",
      "name": "Telefonum eSIM'i desteklemiyor – yine de seyahat eSIM'i kullanabilir miyim?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Hayır, fiziksel bir SIM'e ihtiyacınız var. Birçok eSIM sağlayıcısı ayrıca fiziksel SIM kartları da satar."
      }
    },
    {
      "@type": "Question",
      "name": "eSIM uyumlu telefonların listesini nerede bulabilirim?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tam eSIM uyumlu telefonlar listesine (2026) bakın; iPhone'lar, Samsung, Pixel, OnePlus, Motorola, Xiaomi ve daha fazlasını kapsar."
      }
    },
    {
      "@type": "Question",
      "name": "\"esim ağı mevcut değil verizon\" görürsem ne yapmalıyım?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bu genellikle bir dolaşım ayarı sorunudur. eSIM hattınız için Veri Dolaşımı'nı açın ve manuel olarak farklı bir ağ seçmeyi deneyin."
      }
    },
    {
      "@type": "Question",
      "name": "iPhone'da \"esim qr kodu geçersiz\" nasıl düzeltilir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sağlayıcınızdan yeni bir QR kodu talep edin. QR kodlarının süresi 30-90 gün sonra dolar ve tarandıktan sonra yeniden kullanılamaz."
      }
    },
    {
      "@type": "Question",
      "name": "Etkinleştirmeden sonra \"esim kişisel sıcak nokta çalışmıyor\" neden olur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Planınızın sıcak nokta kullanımına izin verip vermediğini kontrol edin. Bazı seyahat eSIM'leri sıcak nokta paylaşımını kısıtlar. Ayrıca APN ayarlarını doğrulayın."
      }
    },
    {
      "@type": "Question",
      "name": "Samsung cihazlarda \"esim android'de çalışmıyor\" neye neden olur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yaygın nedenler arasında operatör kilitli cihazlar, bölgesel varyantlar veya güncel olmayan Android sürümleri bulunur. EID varlığını *#06# ile kontrol edin."
      }
    },
    {
      "@type": "Question",
      "name": "Etkinleştirmeden sonra \"esim iMessage çalışmıyor\" neden olur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "iMessage'ın yeniden etkinleştirilmesi gerekebilir. Ayarlar > Mesajlar > iMessage'ı kapatıp tekrar açın ve Gönder ve Al'da telefon numaranızın seçili olduğunu doğrulayın."
      }
    },
    {
      "@type": "Question",
      "name": "\"esim profili süresi doldu\" ne anlama gelir ve nasıl düzeltilir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "QR kodunuz geçerlilik süresini geçmiştir (genellikle 30-90 gün). Yeni bir QR kodu talep etmek için sağlayıcınızla iletişime geçin."
      }
    },
    {
      "@type": "Question",
      "name": "Hücresel bir iPad'de \"esim ipad'de çalışmıyorsa\" ne yapmalıyım?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Operatör kilit durumunu kontrol edin, iPad'inizi yeniden başlatın ve hücresel modelde olduğunuzdan emin olun. Wi-Fi yalnızca iPad'ler eSIM'i desteklemez."
      }
    },
    {
      "@type": "Question",
      "name": "iPhone'da \"esim veri dolaşımı çalışmıyor\" nasıl düzeltilir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Veri Dolaşımı'nın açık olduğundan, APN ayarlarının doğru olduğundan ve otomatik seçim başarısız olursa manuel olarak bir ağ seçtiğinizden emin olun."
      }
    }
  ]
}
