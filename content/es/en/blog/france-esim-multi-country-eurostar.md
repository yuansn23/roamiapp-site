...
h1title: "Best Multi-Country eSIM for Europe Rail: Eurostar, TGV & Eurail Guide 2026"
...
For travelers building a multi-country European itinerary around France, the connectivity strategy changes fundamentally: a single-country France eSIM will lose signal the moment your train enters Switzerland, Italy, or Spain. This guide covers **multi-country eSIM** options for Europe rail travel, with specific guidance for Eurostar, TGV cross-border routes, and the best regional eSIM plans for each itinerary type. Whether you are taking the Eurostar from London to Paris, the TGV from Paris to Milan, or a Eurail loop through five countries, this guide helps you choose the right connectivity solution for every border crossing.

For a complete overview of France-only connectivity, see our [France eSIM 101](/blog/france-esim-complete-guide/).

---

## France as Europe's Rail Hub: Why Connectivity Strategy Changes

> **Key takeaways:** A single-country France eSIM will lose signal the moment your train enters Switzerland, Italy, or Spain, so multi-country rail itineraries need a Europe-regional eSIM covering all countries on your route. The breakeven point versus individual country plans is approximately 3-4 countries, beyond which a regional plan saves 50-65%. For most multi-country rail itineraries, a Europe-regional eSIM plan between 10-20 GB provides the best balance of coverage and cost. The one unavoidable gap is the Eurostar Channel Tunnel, with approximately 35 minutes of complete connectivity loss.
...
The distinction matters for multi-country rail travelers. A France eSIM from a French carrier (like Orange Travel) would work across the EU under roaming rules, but these plans cost 20-40% more than international travel eSIMs. An international travel eSIM from a non-EU provider (like Airalo or Holafly) only works in France unless you specifically purchase a plan that includes other countries.

**The Fix:** A multi-country or Europe-regional eSIM that includes all countries on your itinerary. These plans typically cover 30-40 European countries under a single eSIM profile, automatically switching to local carriers as you cross borders. The eSIM profile is installed once before your trip and handles all network transitions without manual intervention.

Cross-border connectivity is relevant even for shorter trips — a week-long trip that includes Paris and Brussels requires at minimum a France + Belgium plan. For the most frequent multi-country itineraries, see our [France eSIM destination guide](/blog/france-esim-destination-guides/).

---

## Eurostar: London to Paris Connectivity
...
|---------|----------|---------------------|-------------------|
| London St Pancras to Folkestone | 45 minutes | Full 4G/5G throughout | UK carriers: EE, Vodafone, O2, Three |
| Channel Tunnel (UK approach) | 5 minutes | Signal weakens as train descends | UK carriers (fading) |
| Channel Tunnel (central section) | 35 minutes | **No signal of any kind** | Complete dead zone |
| Channel Tunnel (France approach) | 5 minutes | Signal returns gradually | French carriers (Orange, SFR, Bouygues, Free) |
...
2. **Separate eSIM profiles for UK and France** — you manually switch between them at the border crossing

Option 1 is significantly simpler. Most Europe-regional eSIMs from major providers include both the UK and France within a single profile, meaning the eSIM handles the transition automatically. After the 35-minute tunnel connectivity gap, your phone will reconnect to a French network within 2-5 minutes of emerging near Calais. If automatic carrier selection takes longer than 5 minutes, manually select "Orange F" or "SFR" from the network list to speed the process.

For specific provider recommendations, see our [France eSIM ranking comparison](/blog/france-esim-provider-ranking/).

---

## TGV High-Speed Rail: Cross-Border Routes
...
|-------|---------------|-------------------------------|----------------------|
| Paris to Geneva | 3 hours | Jura tunnel: 10 min | France + Switzerland |
| Paris to Milan | 4h 30min | Mont Blanc: 15 min, Alpine: 20 min | France + Italy |
| Paris to Barcelona | 5 hours | Pyrenees tunnels: 25 min intermittent | France + Spain |
| Paris to Brussels | 1h 30min | None significant | France + Belgium |
| Paris to Amsterdam | 3h 20min | None significant | France + Belgium + Netherlands |

For TGV routes crossing multiple borders (e.g., Paris to Amsterdam passing through Belgium and the Netherlands), a Europe-regional eSIM covering at least Western Europe is the most practical solution.

---

## Multi-Country eSIM Options: Comparison and Recommendations
...
|-----------|-------------------|---------------------|----------|
| Western Europe Regional | UK, France, Benelux, Germany, Switzerland, Italy, Spain, Portugal | $25-50 | Standard 3-5 country rail itinerary |
| Europe Regional | 30-40 European countries | $30-60 | Extended rail trip through multiple regions |
...
| Itinerary | Individual Plans (10GB each) | Regional Plan (10GB) | Savings with Regional |
|-----------|------------------------------|---------------------|----------------------|
| France + UK + Belgium | $18 + $16 + $17 = $51 | $18-25 | $26-33 (52-65%) |
| France + Spain + Italy | $18 + $17 + $18 = $53 | $18-25 | $28-35 (53-66%) |
...
Before purchasing a regional eSIM, request the full list of network partners for each country on your itinerary. If the provider lists only budget carriers in key destinations, the lower price may come with significantly reduced performance.

For a comprehensive comparison of providers and their carrier partnerships, see our [France eSIM price and purchase guide](/blog/france-esim-price-purchase-guide/).

---

## Price Comparison: Single-Country vs Multi-Country vs Regional Plans
...
|-------------------|-------------|---------|------------|------------|-----------------|---------------------|
| Budget provider | $12 | $11 | $13 | $12 | $48 | $25 |
| Mid-range provider | $15 | $14 | $15 | $14 | $58 | $30 |
...
|------------|-----------|----------------------|---------------|---------|
| Eurostar: London-Paris | UK + France | $16 + $12 = $28 | $12-18 | $10-16 (36-57%) |
| TGV: Paris-Brussels-Amsterdam | France + Belgium + Netherlands | $12 + $11 + $12 = $35 | $15-22 | $13-20 (37-57%) |
| TGV: Paris-Geneva | France + Switzerland | $12 + $14 = $26 | $12-18 | $8-14 (31-54%) |
| TGV: Paris-Barcelona | France + Spain | $12 + $12 = $24 | $12-18 | $6-12 (25-50%) |
| TGV: Paris-Milan | France + Italy | $12 + $13 = $25 | $12-18 | $7-13 (28-52%) |
...
3. At approximately 2-5 km from the border, Carrier A signal may fluctuate as the phone detects Carrier B from Country B
4. The train crosses the border — Carrier A signal drops below usable threshold
5. The phone scans for available networks and detects Carrier B
...
- Samsung Galaxy S20 and newer (including S20 FE)
- Most Android flagship and mid-range phones from 2021 onward

The key requirement is eSIM hardware support, not any regional-specific technology. The eSIM chip itself is identical regardless of how many country profiles it contains.

---

## Recommended Itineraries with Connectivity Plans

### Itinerary 1: Classic Eurostar Triangle — Best eSIM for UK-France-Benelux Rail

**Route:** London -> Paris -> Brussels -> Amsterdam -> London (return via Eurostar)
...
|-----|----------|------------|----------------|-------|
| 1-2 | London | UK (EE, Vodafone) | 50-150 Mbps | Full 4G/5G throughout city |
| 3 | Eurostar London-Paris | None for 35 min (tunnel) | N/A | Pre-load content before boarding |
| 4-5 | Paris | France (Orange, SFR) | 100-300 Mbps | Excellent 5G coverage |
| 6 | TGV Paris-Brussels | Continuous signal | 50-100 Mbps | Automatic border handover |
| 7-8 | Brussels | Belgium (Proximus) | 50-100 Mbps | Good coverage throughout |
| 9 | Thalys Brussels-Amsterdam | Continuous signal | 50-100 Mbps | NL border no tunnel |
| 10 | Amsterdam | Netherlands (KPN) | 50-150 Mbps | Strong 5G in city |

**Recommended eSIM:** Western Europe or Europe-regional plan (10-20 GB)
**Estimated cost:** $25-45
**Alternative:** Individual plans for each country ($50-70 total)
**Key consideration:** The Eurostar tunnel dead zone is unavoidable — plan content downloads before boarding

### Itinerary 2: Southern France to Italy — Best eSIM for France-Italy Rail

**Route:** Paris -> Nice -> Milan -> Florence -> Rome
...
**Recommended eSIM:** France + Italy dual-country plan (15-20 GB)
**Estimated cost:** $20-35
**Critical note:** The Nice-Milan train route through Ventimiglia has the longest tunnel dead zone on any standard rail route in this region — approximately 25 minutes of intermittent signal

### Itinerary 3: Central Europe Rail Loop — Best eSIM for Multi-Country Eurail

**Route:** Paris -> Brussels -> Amsterdam -> Berlin -> Munich -> Zurich -> Geneva -> Paris
...
| Segment | Train Type | Duration | Border Crossing Complexity |
|---------|-----------|----------|---------------------------|
| Paris to Brussels | TGV | 1h30m | Simple, no tunnels |
| Brussels to Amsterdam | Thalys | 1h50m | Simple, no tunnels |
| Amsterdam to Berlin | ICE | 6h+ | Moderate, some rural gaps |
| Berlin to Munich | ICE | 4h | Moderate, short tunnels |
| Munich to Zurich | ICE | 3h30m | Complex, Alpine tunnels |
| Zurich to Geneva | Swiss Rail | 2h45m | Moderate, some tunnel sections |

**Recommended eSIM:** Europe-regional plan with strong carrier partners (20-30 GB)
**Estimated cost:** $35-55
**Critical requirement:** Automatic carrier switching across 5 different countries is essential — manual profile switching for this many borders is impractical

### Itinerary 4: France-Spain-Portugal Rail — Best eSIM for Iberian Rail

**Route:** Paris -> Bordeaux -> San Sebastian -> Madrid -> Lisbon -> Porto
...
**Recommended eSIM:** Europe-regional plan (15-20 GB) with strong Iberian carrier partnerships
**Estimated cost:** $25-45
**Note:** Spanish (Movistar, Orange Spain) and Portuguese (MEO, NOS) carriers have strong 5G in cities but weaker coverage in rural areas between cities — plan offline maps for longer train segments
...
2. **Central Tunnel Section (5-45 km):** No signal of any kind. The tunnel is 75 meters below sea level in chalk marl bedrock. Signal repeaters exist only at emergency service stations within the tunnel, which are not accessible to passenger carriages
3. **France Approach Tunnel (45-50 km near Calais):** Signal returns gradually. French carriers become available within 2-3 km of the tunnel exit. Expect connectivity to resume within 1-2 minutes of seeing daylight
...
|----------|-------|----------------------|------------|
| Channel Tunnel | London-Paris (Eurostar) | 35 minutes | Eurostar |
| Mont Blanc Tunnel | Paris-Milan (TGV) | 8-10 minutes | TGV |
| Modane Alpine tunnels | Paris-Milan (TGV) | 15-20 minutes intermittent | TGV |
| Pyrenees tunnels | Paris-Barcelona (TGV) | 25 minutes intermittent | TGV |
| Jura Tunnel | Paris-Geneva (TGV) | 10 minutes | TGV |
| Marseille-Lyon tunnels | Paris-Marseille (TGV) | 5-8 minutes total (multiple short tunnels) | TGV |

---

## Train-Specific Data Usage: What You Actually Consume
...
|----------|----------------------|-------|
| Google Maps navigation (background) | 5-10 MB | Minimal — tile caching reduces continuous loading |
| Web browsing / news reading | 30-80 MB | Pages load slower in weak signal zones, consuming more data per page |
| Social media scrolling (Instagram, TikTok) | 150-400 MB | Auto-playing videos consume more in tunnel approach/exit zones |
| Music streaming (Spotify, Apple Music) | 50-100 MB | Dropped connections cause re-buffering, increasing data use |
| Video streaming (YouTube, Netflix) | 500MB - 1.5 GB | HD streaming consumes most; train WiFi may be better option |
| Video calls (Zoom, Teams, FaceTime) | 600MB - 1.2 GB | Connection instability causes quality fluctuations |
...
| Route Type | Additional Data Needed (vs stationary use) | Reason |
|------------|-----------------------------------------|--------|
| No tunnels (Paris-Brussels) | 0-10% more | Minimal reconnection spikes |
| Some tunnels (Paris-London via Eurostar) | 10-20% more | Channel Tunnel reconnection spike after 35 min gap |
| Many tunnels (Paris-Milan) | 20-30% more | Frequent reconnection spikes after Alpine tunnels |
| Very intermittent (Paris-Barcelona) | 25-35% more | Pyrenees tunnels cause multiple reconnection events |

---

## eSIM Provider Routing: Which Networks You Get by Country

Not all multi-country eSIMs connect to the same carrier in each country. The carrier partnership directly affects your speed and reliability. Below is how major eSIM providers route data in key Eurostar and TGV destination countries:

| Provider Type | France | UK | Italy | Spain | Switzerland | Belgium |
|--------------|--------|-----|-------|-------|-------------|---------|
| Premium (Orange-partnered) | Orange | EE or Vodafone | TIM | Movistar | Swisscom | Proximus |
| Mid-range (SFR/Bouygues) | SFR or Bouygues | Three or O2 | Vodafone IT | Orange Spain | Salt | Orange BE |
...
- In the Spanish Pyrenees (Paris-Barcelona route), Movistar has the best tunnel approach coverage

An eSIM that connects to premium carriers in each country will maintain connectivity for longer stretches of your rail journey. Budget eSIMs that connect to MVNOs may lose signal earlier in rural or mountainous sections.
...
2. **Enter APN settings for each country in advance:** Some multi-country eSIMs require different APN values depending on which country you are in. Research whether your provider uses a single APN for all countries or different APNs per country.

3. **Download offline maps for all countries on your route:** Google Maps offline maps for each country (50-200 MB each). Prioritize the countries where you will spend the most time and the countries with the weakest mobile coverage.

4. **Save carrier selection guide for manual override:** Note which network to manually select in each country in case automatic switching fails:
   - France: Orange F
   ...
   - Spain: Movistar or Orange Spain
   - Germany: Telekom DE

5. **Ensure data roaming is enabled for the eSIM line:** Data roaming must be ON for the eSIM to register on foreign networks. This is not a security risk — it is the standard configuration for international eSIM usage.
...
Unlike Airalo which locks you to Orange, Roami offers a [free eSIM service](/free-esim/) to test compatibility before committing to a full plan. Use code WEB20 at checkout for 20% off your first plan.
...
A: For itineraries that loop back to the UK (e.g., London-Paris-Brussels-London via Eurostar), a Europe-regional eSIM will handle the re-entry. The eSIM switches back to a UK carrier as the train crosses back through the Channel Tunnel and emerges at Folkestone.

### Q: What is the best eSIM for Eurostar travel?

A: The best eSIM for Eurostar travel is a multi-country plan that covers both the UK and France in a single profile. Europe-regional eSIMs from Roami, Airalo, or Ubigi handle the automatic carrier switch from UK carriers (EE/Vodafone) to French carriers (Orange/SFR) as the train emerges from the Channel Tunnel near Calais. A single-country France eSIM will not work on the UK side of the journey.

### Q: Does TGV cross-border eSIM work in tunnels?

A: Yes, a TGV cross-border eSIM works normally in tunnel sections where signal is available — but note that many Alpine and Pyrenees tunnels have no mobile infrastructure. The eSIM will reconnect automatically when the train exits the tunnel, typically within 30 seconds to 2 minutes. For tunnels like Mont Blanc (11.6km) with no signal, the eSIM cannot provide connectivity during the crossing itself.

---

## Eurail and Interrail Pass Holders: Connectivity Strategy
...
|-----------------|-----------------|---------------------|-----------------|
| Global Pass | 5-12 countries across Europe | 30+ countries | Europe Regional 20-50GB |
...
|-------------|---------------|-----------------|-----------------|
| Light user (maps, messaging, booking trains) | 300-500 MB | 9-15 GB | 10-20 GB regional |
...
- Downloading offline schedules — the app allows downloading country-specific timetables over WiFi for offline access

Best practice: download the Eurail Rail Planner app and pre-load timetables for each country over WiFi before departure. This reduces mobile data consumption by 40-50% on the app alone.

---

## Station WiFi and Connectivity Between Trains
...
|---------|------------------|-------|
| Paris Gare du Nord | Good (20-50 Mbps) | SNCF free WiFi, requires email or SNCF account login |
| Paris Gare de Lyon | Good (20-50 Mbps) | Same SNCF network, works across all Paris stations |
| London St Pancras | Excellent (50-100 Mbps) | Free WiFi throughout, no login required for basic use |
| Brussels Midi/Zuid | Moderate (10-30 Mbps) | SNCB free WiFi, 30-minute session limit |
| Amsterdam Centraal | Good (20-40 Mbps) | Free WiFi, requires Dutch mobile number or social login |
| Milano Centrale | Moderate (10-20 Mbps) | Free WiFi, 1-hour session limit |
| Barcelona Sants | Good (20-40 Mbps) | Free WiFi, requires email registration |
...
- **Omio** — Multi-modal booking (train, bus, flight) requires data for each search and purchase session

---

## Carrier Switching Behavior at Border Stations
...
|---------|--------|-------------------|-------------------|
| Lille Europe | France-Belgium | Orange F, SFR, Proximus | Stable on French or Belgian; may ping-pong |
| Calais Frethun | France-UK (Eurostar stop) | Orange F, EE (weak) | French carrier stable; UK carrier weak |
| Geneva | France-Switzerland | Orange F, Swisscom, Salt | High ping-pong risk; use manual selection |
| Basel SBB | France-Switzerland-Germany | Orange F, Swisscom, Telekom DE | Triple-carrier ping-pong expected |
| Ventimiglia | France-Italy | Orange F, TIM, Vodafone IT | Border station in Italy; manual select recommended |
...
4. Once you are 10-15 km past the border, re-enable automatic selection if your eSIM supports it

This manual approach prevents the "ping-pong" effect where the phone rapidly switches between carriers from two countries, draining battery and potentially causing missed messages during the transition window. Roami's eSIM includes advanced border handling logic that minimizes this ping-pong effect by maintaining connection priority for the departing country's carrier until the train is confirmed past the border zone.

---

## Summary: Choosing the Right Multi-Country eSIM

| Your Itinerary | Recommended Plan | Estimated Cost | Why |
|----------------|-----------------|----------------|-----|
| Paris + London (Eurostar) | Western Europe 5-10GB | $18-30 | Covers both UK and France, handles tunnel gap |
| Paris + Brussels + Amsterdam | Western Europe 10-15GB | $25-40 | 3 countries on one profile, continuous TGV connectivity |
| Paris + Geneva + Milan | France + Switzerland + Italy 10-20GB | $25-45 | Alpine tunnel dead zones require pre-planning |
| Paris + Barcelona + Madrid | France + Spain 10-20GB | $20-35 | Pyrenees tunnel gaps, strong Iberian carriers |
...
A [France eSIM for Europe rail](/france-esim/) with regional multi-country capabilities provides the foundation for any European rail itinerary starting in France. For additional guidance on specific destinations, see our [France eSIM coverage](/blog/france-esim-coverage-guide/) and [France eSIM installation](/blog/france-esim-setup-dual-sim-number/).

---

For official cross-border rail information, [Eurostar](https://www.eurostar.com/) and [SNCF](https://www.sncf.com/) provide route details. The [GSMA](https://www.gsma.com/esim/) defines eSIM technical standards. [Ookla Speedtest](https://www.speedtest.net/global-index/france) provides independent coverage benchmarks.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Will my France eSIM work in Switzerland if I am near the border?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Signal may spill across the border for 5-10 km, but this is unreliable. Once your phone registers on a Swiss carrier's tower — which can happen automatically even if you are still physically in France but close to the border — a France-only eSIM will lose data connectivity. Do not rely on border signal spillover."
      }
    },
    {
      "@type": "Question",
      "name": "How long does it take for a multi-country eSIM to switch carriers at a border?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Typically 30 seconds to 3 minutes after the previous country's signal drops below usable levels. The phone needs to detect the loss, scan available networks, select the strongest option, and complete registration. Toggling Airplane Mode forces a fresh scan and speeds up this process if the automatic switch is slow."
      }
    },
    {
      "@type": "Question",
      "name": "Can I use the same eSIM profile for multiple trips to different countries?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most travel eSIM profiles are single-use with a specific validity period (7, 15, or 30 days typically). After the plan expires, the profile remains on your phone but data stops working until you purchase a new plan. Some providers offer \"top-up\" options that add data to the existing profile — this is more convenient than reinstalling a new profile for each trip."
      }
    },
    {
      "@type": "Question",
      "name": "Do multi-country eSIMs work on high-speed trains like TGV and Eurostar?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Multi-country eSIMs work on any train, plane, or ferry. The eSIM connects to whichever carrier is available at the train's current location. On Eurostar, the eSIM connects to a UK carrier near London, goes silent in the Channel Tunnel, and connects to a French carrier near Calais. On TGV cross-border routes, the eSIM transitions from French to the neighboring country's network at the border."
      }
    },
    {
      "@type": "Question",
      "name": "Does my data allowance reset when I cross a border?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. The data allowance is shared across all countries in the plan. If you have a 10GB Europe-regional plan, you use the same 10GB pool whether you are in France, Italy, or Spain. There are no per-country data limits or resets."
      }
    },
    {
      "@type": "Question",
      "name": "Is a multi-country eSIM slower than a country-specific one?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not inherently. Speed depends on which local carrier the eSIM connects to in each country, not on the eSIM being multi-country. A well-designed regional eSIM with premium carrier partnerships in each country matches the performance of country-specific plans. A budget regional eSIM that uses discount MVNOs will be slower."
      }
    },
    {
      "@type": "Question",
      "name": "Can I use a multi-country eSIM for hotspot tethering while on trains?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, if the provider allows tethering. Most regional plans support hotspot tethering, but some have speed caps (limited to 3-5 Mbps on hotspot) or data limits (500MB-1GB per day on hotspot). Verify the provider's tethering policy before purchasing, especially if you need laptop connectivity during train travel."
      }
    },
    {
      "@type": "Question",
      "name": "What about the UK — does a Europe-regional eSIM cover the UK?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most Europe-regional eSIMs include the UK despite Brexit. However, some budget regional plans classify the UK as a separate zone. Verify UK coverage before purchasing if your itinerary includes London."
      }
    },
    {
      "@type": "Question",
      "name": "My eSIM says \"no service\" in the Channel Tunnel. Is this a problem with the eSIM?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. The Channel Tunnel has no mobile infrastructure. Every eSIM and physical SIM — regardless of provider, carrier, or country — will have no signal for the approximately 35 minutes the train is in the tunnel central section. This is a physical infrastructure limitation, not an eSIM issue."
      }
    },
    {
      "@type": "Question",
      "name": "Can I switch back to my home carrier's network when I return to the UK?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For itineraries that loop back to the UK (e.g., London-Paris-Brussels-London via Eurostar), a Europe-regional eSIM will handle the re-entry. The eSIM switches back to a UK carrier as the train crosses back through the Channel Tunnel and emerges at Folkestone."
      }
    },
    {
      "@type": "Question",
      "name": "What is the best eSIM for Eurostar travel?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The best eSIM for Eurostar travel is a multi-country plan that covers both the UK and France in a single profile. Europe-regional eSIMs from Roami, Airalo, or Ubigi handle the automatic carrier switch from UK carriers (EE/Vodafone) to French carriers (Orange/SFR) as the train emerges from the Channel Tunnel near Calais. A single-country France eSIM will not work on the UK side of the journey."
      }
    },
    {
      "@type": "Question",
      "name": "Does TGV cross-border eSIM work in tunnels?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, a TGV cross-border eSIM works normally in tunnel sections where signal is available — but note that many Alpine and Pyrenees tunnels have no mobile infrastructure. The eSIM will reconnect automatically when the train exits the tunnel, typically within 30 seconds to 2 minutes. For tunnels like Mont Blanc (11.6km) with no signal, the eSIM cannot provide connectivity during the crossing itself. ---"
      }
    }
  ]
}
