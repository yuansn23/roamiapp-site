...
quick_picks_note_carrier: "[Informe de conectividad Ookla Speedtest](https://www.ookla.com/research/reports/united-states-speedtest-connectivity-report-h2-2025)"
...
quick_picks:
  ...
  - travel: "Nómada digital"
    ...
    reason: "T-Mobile ofrece la mejor red móvil general y 5G, con una velocidad de descarga media de 259.48 Mbps y una velocidad 5G de 309.41 Mbps. Perfecto para trabajo remoto y videollamadas."

  - travel: "Viajero urbano"
    carrier: "Verizon"
    carrier_class: "text-red-600"
    reason: "Verizon tiene la mejor cobertura geográfica (30.0% de cobertura) y una excelente experiencia de video 5G (puntuación 3.73/5). Ideal para moverse por ciudades y zonas rurales."

  - travel: "Amante de la velocidad"
    carrier: "AT&T Fiber"
    carrier_class: "text-blue-600"
    reason: "AT&T Fiber es el mejor ISP fijo con 369.39 Mbps de descarga y 309.28 Mbps de subida. Si necesitas máxima velocidad en casa u oficina, esta es tu opción."
...
operators:
  ...
  - id: "t-mobile-esim"
    title: "T-Mobile eSIM: mejor red 5G y velocidad"
    best_for: "Este plan es la mejor opción para viajeros que priorizan velocidad 5G y disponibilidad constante. Según [Informe de conectividad Ookla Speedtest](https://www.ookla.com/research/reports/united-states-speedtest-connectivity-report-h2-2025), T-Mobile lidera con 259.48 Mbps de descarga media y 309.41 Mbps en 5G."
    core_data: "- **Disponibilidad 5G**: según [Informe de conectividad Ookla Speedtest](https://www.ookla.com/research/reports/united-states-speedtest-connectivity-report-h2-2025), el 91.2% de los usuarios accede a 5G la mayor parte del tiempo.\n- **Velocidad de descarga**: mediana de 259.48 Mbps (todas las tecnologías) y 309.41 Mbps (5G).\n- **Velocidad de subida**: mediana de 12.26 Mbps (todas) y 13.57 Mbps (5G).\n- **Latencia**: 46 ms (todas) y 44 ms (5G).\n- **Consistencia**: 87.9% de muestras superan 5 Mbps descarga / 1 Mbps subida; 77.7% en 5G superan 25/3 Mbps."
    arcep_note: "Confirmado por el regulador local (FCC) y por informes de Speedtest Intelligence® de Ookla para el segundo semestre de 2025."
    connect_note: "El proceso de activación es fluido: compra online, recibe el código QR por correo, escanea y conecta. Compatible con la mayoría de dispositivos eSIM."
    user_scenarios: "- **🚇 Metro de Nueva York**: T-Mobile mantiene buena señal en túneles y estaciones, ideal para viajeros que usan transporte público.\n- **🏔️ Parque Nacional de Yellowstone**: aunque la cobertura rural es menor, T-Mobile tiene mejor disponibilidad 5G que otros operadores en áreas remotas.\n- **🏙️ Pittsburgh**: ciudad con la velocidad móvil más rápida (362.61 Mbps), perfecta para nómadas digitales."
    bg_color: "bg-magenta-50"

  - id: "verizon-esim"
    title: "Verizon eSIM: mejor cobertura geográfica"
    best_for: "Este plan es la mejor opción para viajeros que recorren largas distancias y necesitan cobertura en zonas rurales. Según [Informe de conectividad Ookla Speedtest](https://www.ookla.com/research/reports/united-states-speedtest-connectivity-report-h2-2025), Verizon tiene la mejor cobertura geográfica con un 30.0% de cobertura."
    core_data: "- **Cobertura**: mejor cobertura geográfica (30.0% según [Informe de conectividad Ookla Speedtest](https://www.ookla.com/research/reports/united-states-speedtest-connectivity-report-h2-2025)).\n- **Velocidad de descarga**: mediana de 130.64 Mbps (todas las tecnologías) y 214.17 Mbps (5G).\n- **Experiencia de video 5G**: puntuación 3.73/5, la mejor para streaming.\n- **Consistencia**: no especificada en los datos, pero con buena fiabilidad general."
    arcep_note: "Confirmado por el regulador local (FCC) y por informes de Speedtest Intelligence® de Ookla para el segundo semestre de 2025."
    connect_note: "El proceso de activación es fluido: compra online, recibe el código QR por correo, escanea y conecta. Compatible con la mayoría de dispositivos eSIM."
    user_scenarios: "- **🚗 Ruta 66**: Verizon ofrece la mejor cobertura en carreteras interestatales y áreas rurales, evitando zonas muertas.\n- **🏞️ Gran Cañón**: ideal para excursionistas que necesitan señal en parques nacionales.\n- **🌆 San Antonio**: ciudad con la velocidad fija más rápida (365.08 Mbps), excelente para combinar con Verizon móvil."
    bg_color: "bg-red-50"

  - id: "att-fiber-esim"
    title: "AT&T Fiber eSIM: máxima velocidad fija"
    best_for: "Este plan es la mejor opción para viajeros que se alojan en hoteles o apartamentos y necesitan internet fijo ultrarrápido. Según [Informe de conectividad Ookla Speedtest](https://www.ookla.com/research/reports/united-states-speedtest-connectivity-report-h2-2025), AT&T Fiber es el mejor ISP con 369.39 Mbps de descarga y 309.28 Mbps de subida."
    core_data: "- **Velocidad de descarga**: mediana de 369.39 Mbps (fijo).\n- **Velocidad de subida**: mediana de 309.28 Mbps (fijo).\n- **Experiencia gaming**: Frontier Fiber y T-Mobile lideran en juegos, pero AT&T Fiber ofrece baja latencia para gaming en casa.\n- **Disponibilidad**: principalmente en zonas urbanas y suburbanas."
    arcep_note: "Confirmado por el regulador local (FCC) y por informes de Speedtest Intelligence® de Ookla para el segundo semestre de 2025."
    connect_note: "El proceso de activación es fluido: compra online, recibe el código QR por correo, escanea y conecta. Compatible con la mayoría de dispositivos eSIM."
    user_scenarios: "- **🏢 Viaje de negocios en Nueva York**: AT&T Fiber en hoteles permite videoconferencias sin interrupciones.\n- **🎮 Gaming en casa**: baja latencia ideal para jugar en línea durante estancias largas.\n- **📡 Teletrabajo en San Antonio**: velocidad de subida de 309.28 Mbps para subir archivos pesados."
    bg_color: "bg-blue-50"
...
city_recommendations:
  ...
  - city: "Pittsburgh"
    carriers: "T-Mobile"
    reason: "Pittsburgh registró la velocidad móvil más rápida del país (362.61 Mbps). T-Mobile es ideal para aprovechar al máximo esta velocidad, perfecto para nómadas digitales y viajeros de negocios."

  - city: "San Antonio"
    carriers: "AT&T Fiber"
    reason: "San Antonio tiene la velocidad fija más rápida (365.08 Mbps). AT&T Fiber es la mejor opción si te alojas en un apartamento u hotel con conexión fija, ideal para teletrabajo."

  - city: "Nueva York"
    carriers: "Verizon"
    reason: "Nueva York tiene una alta densidad de población, y Verizon ofrece la mejor cobertura geográfica (30.0%) y excelente experiencia de video 5G (3.73/5). Perfecto para turistas que usan streaming y mapas."

  - city: "Los Ángeles"
    carriers: "T-Mobile"
    reason: "Los Ángeles es una ciudad extensa con muchas autopistas. T-Mobile ofrece la mejor disponibilidad 5G (91.2%) y velocidad, ideal para viajeros en coche que necesitan navegación constante."

  - city: "Chicago"
    carriers: "T-Mobile"
    reason: "Chicago tiene una infraestructura 5G sólida. T-Mobile lidera en velocidad 5G (309.41 Mbps) y consistencia (87.9%), perfecto para viajeros que necesitan internet rápido en interiores y exteriores."
...
scene_items:
  ...
  - icon: "🏛️"
    ...
    text: "Recorre ciudades como Nueva York, San Francisco o Chicago con la eSIM de Verizon. Su cobertura geográfica del 30.0% y excelente experiencia de video 5G (3.73/5) te permitirán usar mapas, redes sociales y streaming sin interrupciones."

  - icon: "🏞️"
    title: "Amante de la naturaleza"
    text: "Visita parques nacionales como Yellowstone, Yosemite o el Gran Cañón. Verizon ofrece la mejor cobertura en áreas remotas, mientras que T-Mobile tiene la mayor disponibilidad 5G (91.2%) para mantenerte conectado en la naturaleza."

  - icon: "🚗"
    title: "Viajero en carretera"
    text: "Recorre la Ruta 66 o la costa oeste con T-Mobile. Su velocidad media de descarga de 259.48 Mbps y baja latencia (46 ms) garantizan navegación GPS fluida y streaming en movimiento."

  - icon: "🏖️"
    title: "Amante de la playa"
    text: "Disfruta de playas como Miami Beach, Santa Mónica o Waikiki con AT&T Fiber si te alojas cerca, o con T-Mobile para velocidad 5G en la arena. La velocidad de descarga de 309.41 Mbps en 5G es ideal para compartir fotos y videos."
...
myths:
  ...
  - myth: "Mito: La cobertura 5G es igual en todo el país."
    truth: "Realidad: T-Mobile tiene la mayor disponibilidad 5G (91.2%), pero Verizon tiene la mejor cobertura geográfica (30.0%). En zonas rurales, Verizon puede ser más fiable, mientras que en ciudades, T-Mobile ofrece mayor velocidad."

  - myth: "Mito: Las eSIM son más lentas que las SIM físicas."
    truth: "Realidad: No hay diferencia de velocidad entre eSIM y SIM física. Ambas tecnologías acceden a las mismas redes. La velocidad depende del operador y la ubicación, no del tipo de SIM."
