...
hero:
  ...
  primary_cta_text: Ver Planes para Europa
...
why_section:
  title: ¿Por qué elegir una eSIM Regional para Europa?
  subtitle: Un único plan regional te ahorra dinero, tiempo y la frustración de manejar múltiples tarjetas SIM.
  cards:
  - icon: globe
    color: blue
...
vs_roaming:
  ...
  subtitle: Si usas el roaming internacional de tu operador habitual en Europa, casi con seguridad estás pagando de más. Así se comparan.
  rows:
  - label: Costo diario
    roami: $0.33 - $2.00/día
    carrier: $10 - $15/día
  ...
  - label: Límite de datos
    ...
    carrier: A menudo tope de 0.5-2GB/día
    highlight: false
  - label: Múltiples países
    roami: 47 países, sin cargos extra
  ...
  - label: Tiempo de configuración
    ...
    highlight: false
  saving_callout: Un viaje de 14 días a 3 países europeos cuesta solo <strong>$15</strong> con Roami — frente a <strong>$140-$210</strong> con el roaming de tu operador. Eso es un <strong>90% de ahorro</strong>.
  promo_code: WEB20
  promo_discount: 20% DE DESCUENTO
  promo_text: Usa el código <strong>WEB20</strong> al finalizar la compra para obtener un 20% adicional de descuento en tu eSIM Europa. Este descuento aplica a todos los planes prepago.
faq_section:
...
- name: TIM
  ...
  rating: Muy Buena
  countries: Italia, San Marino, Ciudad del Vaticano
- name: Movistar
  hq: España
  speed: Excelente 5G/4G
  rating: Excelente
  countries: España, Alemania (O2), Reino Unido (O2)
- name: EE
  hq: Reino Unido
  speed: Excelente 5G/4G
  rating: Excelente
...
- name: Telenor
  ...
  speed: Muy buena 5G/4G
  rating: Muy Buena
  countries: Noruega, Suecia, Dinamarca, Finlandia, Serbia, Montenegro, Bulgaria
countries:
  western_europe:
  - name: Francia
    url: /france-esim/
