...
faq_section:
  ...
  - id: faq-general
    ...
    - q: |
        What happens if I use all my data in Australia before my plan expires?
      a: |
    ...
    - q: |
        I need internet access for just a couple of days in Australia. What's the minimum I can buy?
      a: |
        The cheapest plan is $1.99 for 7 days with 1GB — perfect for a short weekend trip with light usage. If you need more, top-up anytime from the app.
    - q: |
        What do I do if my Australia eSIM doesn't connect when I arrive?
      a: |
        Three quick checks taking about 30 seconds each: 1) Is Data Roaming turned on? 2) Can you manually select Telstra in network settings? 3) Try restarting your phone. About 90% of connection issues resolve with one of these steps. If not, Roami 24/7 support can help.
related_products:
