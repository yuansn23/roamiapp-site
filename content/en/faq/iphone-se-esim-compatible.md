...
1. **Check your generation:** If you have the small SE with a headphone jack (2016), you cannot use eSIM. If you have the larger SE with no headphone jack (2020 or 2022), you're good.
...
You cannot activate an eSIM without an internet connection. The profile must download from your carrier's secure SM‑DP+ server. Use a reliable Wi‑Fi network – avoid public hotspots that may time out during the download.

### 4. Have Your QR Code Ready

Your eSIM provider will send you a QR code via email. Make sure you can access it (open it on another device, or print it out).
