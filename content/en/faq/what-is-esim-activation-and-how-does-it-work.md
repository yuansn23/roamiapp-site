...
- To find the EID, go to **Settings > About Phone > Status Information** – look for **EID** (may be under “IMEI information” on some models).

#### On Google Pixel and Stock Android:
- Go to **Settings > Network & Internet > Mobile Network**.
- Look for **Add Carrier** or **Download a SIM instead?**.
- To find the EID: **Settings > About Phone > SIM Status** – the EID will appear if eSIM is present.
...
**How do I find my EID if I already have an eSIM installed?**
