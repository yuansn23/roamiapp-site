  ...
  - name: "General eSIM Basics"
    ...
    questions:
      ...
      - q: "Travel eSIM 2026: How to Avoid Roaming Fees & Stay Connected Abroad"
        snippet: "Traveling abroad? Use a travel eSIM. Compare roaming vs local eSIM vs global data plans. Step-by-step activation, unlock check. Save up to 90% on roaming."
      ...
      - q: "eSIM Troubleshooting: 16 Fixes for iPhone & iPad (iOS 18)"
      ...
      - q: "Dual eSIM Not Working? 12 Fixes for iPhone"
        snippet: "Second eSIM showing 'No Service'? Incoming calls go to voicemail? Covers call routing, VoLTE setup, battery drain and carrier lock checks. Works for iPhone 16 and iOS 18."
        url: "/faq/dual-esim-not-working-12-fixes-for-iphone/"
      - q: "2026 Ultimate Guide: iPhone 16 eSIM Activation Solutions"
        snippet: "The complete guide to iPhone 16 eSIM activation – global model distribution, carrier push, Quick Transfer, QR scanning, and troubleshooting."
        url: "/faq/2026-ultimate-guide-iphone-16-esim-activation-solutions/"
  - name: "Device-Specific Activation"
    ...
    questions:
      - q: "How to activate eSIM on iPhone (All Models)?"
        expanded: true
        snippet: "Go to Settings > Cellular > Add eSIM. Scan your QR code or transfer your physical SIM to eSIM seamlessly. Works on iPhone XS, XR, 11, 12, 13, 14, 15, 16 and SE."
