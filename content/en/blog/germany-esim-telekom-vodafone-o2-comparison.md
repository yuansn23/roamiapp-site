...
Telekom's [official coverage map](https://www.telekom.de/netz/abdeckung/) shows its coverage advantage is most pronounced in rural and suburban areas:
...
Aggregate statistics from regulators and industry reports are useful, but what matters most for a traveler is what happens on the ground. The [Bundesnetzagentur](https://www.bundesnetzagentur.de) publishes annual mobile network test results that provide the most authoritative picture of real-world performance across Germany. Here is a breakdown of what users of each network can expect in Germany's five largest cities, based on data from the Bundesnetzagentur's annual mobile network test and independent testing by Connect magazine and [heise.de](https://www.heise.de).
...
Testing published by [heise.de](https://www.heise.de) and supported by [Deutsche Bahn's ICE portal](https://www.bahn.de) shows a clear hierarchy on ICE routes:
...
### Tourists Visiting Popular City Destinations
