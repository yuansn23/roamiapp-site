...
For a complete overview of UK eSIM plans and coverage, see our [UK eSIM complete guide](/blog/uk-esim-complete-guide/).

## How do I check if my phone is eSIM compatible for use in the UK?

Most phones released since 2018 support eSIM, but compatibility varies by brand and model. Before buying a UK eSIM, verify your device against this UK eSIM compatible phones guide for iPhone, Samsung, Google Pixel, and other major brands.

**iPhones That Support eSIM**
Every iPhone model from the **iPhone XS, XS Max, and XR onwards** supports eSIM, according to [Apple's official support documentation (2026)](https://support.apple.com/en-us/118670). That covers everything from 2018 to the latest iPhone 17 range. The only exceptions are iPhones sold in mainland China, Hong Kong, and Macau, which use a physical dual-SIM setup instead.
...
If you're not sure, here are three quick ways to check phone eSIM compatibility with your specific device.
...
**Check the IMEI.** You can usually look up your phone's model number on the manufacturer's website or use the [GSMA's device database](https://www.gsma.com/esim/). If your phone was released in 2020 or later and isn't a budget model, there's a strong chance it supports eSIM.
...
**Step 8: Verify it's working.** Turn off WiFi (or disconnect from it). You should see your eSIM's signal bars appear at the top of the screen. The carrier name will show up as [EE](https://ee.co.uk), [Vodafone](https://www.vodafone.co.uk), [O2](https://www.o2.co.uk), [Three](https://www.three.co.uk), or something similar depending on which network your profile connects to.
...
Here are the APN settings for the four major UK networks, sourced from each carrier's official help pages (2026). Your provider will tell you which one to use. For multi-network plans that switch between carriers (like Roami), use the "global" APN if one is provided, or start with EE's settings as they're the most compatible.
...
You can verify these APN values on the official carrier websites: [EE](https://ee.co.uk), [Vodafone](https://www.vodafone.co.uk), [O2](https://www.o2.co.uk), and [Three](https://www.three.co.uk). Each carrier publishes its current APN settings on its help pages.
...
For a full walkthrough of dual SIM setup, check out our [UK eSIM dual SIM setup guide](/blog/uk-esim-dual-sim-setup/).
...
## Quick Decision: Which installation method should I use?
...
For more detailed troubleshooting, see our [UK eSIM troubleshooting guide](/blog/uk-esim-troubleshooting/) which covers 16 real-world cases and their solutions.
...
4. Manually select a different network from the list (try [EE](https://ee.co.uk) first, then [Vodafone](https://www.vodafone.co.uk), then [O2](https://www.o2.co.uk), then [Three](https://www.three.co.uk))
...
After setup, your UK eSIM connects to one of the four major UK networks, and your coverage depends on which network your plan uses. EE provides the best overall coverage across Great Britain, covering roughly 88% of the UK landmass, according to Ofcom's Connected Nations report (2025).
...
For a full look at how UK coverage compares across regions and networks, use Ofcom's [coverage checker](https://www.ofcom.org.uk/phones-telecoms-and-internet/advice-for-consumers/advice/mobile-coverage-checker). It's the most accurate source of coverage data available, broken down by postcode and network.
...
The UK has no restrictions on using eSIMs from foreign providers. You can buy a UK eSIM, England eSIM, or Great Britain eSIM from any provider in any country and use it as soon as you arrive. There's no registration requirement, no ID check, and no paperwork.
...
**Can I buy a UK eSIM at Heathrow airport?**
Yes, but you'll pay a significant premium. Airport kiosks at Heathrow, Gatwick, Manchester, and other UK airports sell eSIMs at 2-4 times the price of buying online in advance. A 5GB eSIM that costs roughly 6 GBP online can cost 20-35 GBP at the airport -- that's a markup of 200-400%.
...
Just make sure you set your UK eSIM as the default data line in your phone's settings. Otherwise, your phone might try to use your home carrier's roaming data, which would be much more expensive. For a full walkthrough, see the dual SIM section above or our [UK eSIM dual SIM setup guide](/blog/uk-esim-dual-sim-setup/).
...
With multi-network plans like Roami, the carrier name might change throughout the day as your phone switches between [EE](https://ee.co.uk), [Vodafone](https://www.vodafone.co.uk), [O2](https://www.o2.co.uk), and [Three](https://www.three.co.uk) for the best signal. This is normal behaviour -- it means the auto-switching is working as designed.
...
5G coverage in the UK is strong in cities and expanding rapidly in towns. EE leads the 5G rollout, according to Ofcom data, followed by Three, Vodafone, and O2. If 5G is important to you, check your provider's network partnership -- an eSIM that uses [EE](https://ee.co.uk) will generally give you the best 5G experience.

## What is the most important thing to remember about UK eSIM installation?

Installing a UK eSIM takes less than five minutes and doesn't require technical expertise. Buy the plan, scan the QR code, turn on data roaming, and you're connected anywhere in Great Britain -- England, Scotland, and Wales.

For 90% of users, the process is exactly that simple. The rest of this guide covers the edge cases -- the phones that need manual APN, the QR codes that won't scan, the plans that don't activate immediately.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can I install a UK eSIM while I'm still in my home country?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, absolutely. You can buy your plan and install the profile onto your phone over your home WiFi before you travel. The profile sits dormant on your phone until it detects a UK network. For most providers, the plan's validity period doesn't start until first activation on a supported network."
      }
    },
    {
      "@type": "Question",
      "name": "Can I buy a UK eSIM at Heathrow airport?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, but you'll pay a significant premium. Airport kiosks at Heathrow, Gatwick, Manchester, and other UK airports sell eSIMs at 2-4 times the price of buying online in advance. A 5GB eSIM that costs roughly 6 GBP online can cost 20-35 GBP at the airport."
      }
    },
    {
      "@type": "Question",
      "name": "What if I lose my QR code or delete the email?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Check your provider's app as most store your profile details in your account. Alternatively, log into your provider's website to re-download the QR code, or contact customer support to resend the QR code or provide a direct installation link."
      }
    },
    {
      "@type": "Question",
      "name": "Can I use a UK eSIM and my home SIM at the same time?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, modern phones with eSIM support are designed to run multiple lines simultaneously. Your physical home SIM can handle calls and texts while your UK eSIM provides data. Set your UK eSIM as the default data line in your phone's settings."
      }
    },
    {
      "@type": "Question",
      "name": "How do I know which network my eSIM profile is connected to?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "On iPhone, go to Settings > Cellular > your UK eSIM label to see the current network name. On Android, go to Settings > About Phone > Status > SIM Status and select your UK eSIM. With multi-network plans like Roami, the carrier name may change as your phone auto-switches between EE, Vodafone, O2, and Three."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need to remove my physical SIM to use a UK eSIM?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not at all. Your physical SIM stays in your phone and the eSIM plan works alongside it. This is one of the biggest advantages over traditional physical travel SIMs, which require you to swap out your home SIM and lose access to your regular number."
      }
    },
    {
      "@type": "Question",
      "name": "Why does my eSIM profile show SOS Only or Emergency Calls Only?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "This means your phone can see UK networks but can't connect to your provider's service. Common causes: the plan hasn't activated yet, you're in a coverage dead zone, the eSIM profile is corrupted and needs reinstalling, or your phone is carrier-locked to a non-UK network."
      }
    },
    {
      "@type": "Question",
      "name": "Can I hotspot or tether from my UK eSIM?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most travel eSIM plans allow tethering, but some restrict it. Check your provider's terms before relying on hotspot functionality. Roami's plans support tethering, so you can share your connection with other devices."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if I switch phones mid-trip?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "eSIM profiles are tied to the phone they were installed on. You cannot simply move an eSIM from one phone to another like a physical SIM card. You'll need to buy a new eSIM for the second phone or contact your provider to see if they support eSIM transfer."
      }
    },
    {
      "@type": "Question",
      "name": "How many eSIMs can I store on my phone?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "iPhone models typically support storing 8 or more eSIMs with two active simultaneously. Samsung Galaxy phones generally support 4-5 stored eSIMs with two active. Google Pixel phones support 2-4 stored eSIMs with two active."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need to configure anything differently for 5G?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. If your phone supports 5G and your provider offers 5G connectivity, the eSIM plan connects to 5G automatically when you're in a 5G coverage area. No additional configuration is needed."
      }
    }
  ]
}
