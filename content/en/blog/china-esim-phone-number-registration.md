...
description: "Most travel eSIMs have no Chinese number or SMS. Roami covers number providers, passport registration, and WeChat workarounds for your trip."
...
The most important distinction to understand before buying anything is that the China eSIM market is split into two entirely different product categories. Mixing them up leads to buying the wrong plan and discovering only after landing that you can't receive the SMS code you need to activate your bank card.

**International Travel eSIMs (Data-Only)**
These are the eSIMs you see advertised on travel blogs, YouTube sponsorships, and flight comparison sites. Brands like Airalo, Holafly, Saily, Yesim, Nomad, Jetpac, Roamify, and Ubigi all offer China eSIM plans. Every single one of them is data-only for China.

Here is what they give you:
- Mobile data (3G/4G/5G depending on your plan and location)
- Internet routing through Hong Kong or Singapore servers, which routes data outside mainland networks
- A private IP address

Here is what they don't give you:
- A Chinese phone number
- SMS capabilities
- Voice call capabilities

Some providers in other countries — particularly in Europe — offer eSIM plans that include a phone number with SMS and voice. For China, this doesn't exist from any major travel eSIM brand as of 2026. Every "unlimited data" China eSIM with built-in VPN you see is data-only.
...
There's a third category that doesn't fit neatly into either bucket. Hong Kong-based carriers like China Mobile Hong Kong (CMHK) and 3 Hong Kong offer roaming SIMs and eSIMs that include a Hong Kong phone number with data that works in mainland China. These are not Chinese domestic numbers, but they work for some registration purposes.

CMHK's "China & Hong Kong" plans include a Hong Kong number with SMS capability and mainland China roaming data. You can use them to receive SMS verification codes while in China. Some Chinese apps accept Hong Kong numbers for registration, though not all. WeChat works fine with a Hong Kong number. Alipay and Didi may or may not — it depends on which version of the app you're using and which service you're trying to register for.

For a full comparison of providers that offer number options alongside data, see the [China eSIM provider ranking and comparison guide](/blog/china-esim-provider-ranking-comparison/).

---

## Do You Need a Chinese Phone Number with a China eSIM?
...
If you already have WeChat Pay set up before your trip, you're set. If you need to set it up for the first time in China, a Chinese number simplifies the SMS verification significantly.

For a complete walkthrough of setting up WeChat with various number types, see the [China eSIM and essential apps guide](/blog/china-esim-apps-wechat-alipay-google-guide/).

**12306 Train Ticket Registration**
China's official railway booking platform, 12306, is infamous among travelers. Every foreign visitor who wants to book a high-speed train ticket independently must register for a 12306 account. Registration is free, and the account is verified against your passport rather than a Chinese phone number.

You can register with a non-Chinese mobile number, but the account still has to pass identity verification. Uploading a photo of your passport page is the usual route: online review takes a few working days, while taking the passport to a station ticket counter is usually done in minutes.

If you plan to book your own train tickets via the 12306 app or website, budget time for that verification step before your trip. Alternatives exist — third-party platforms like Trip.com (formerly Ctrip) handle the 12306 integration on your behalf and skip the verification wait — but they charge a service fee and may not offer all train options.

**Alipay**
Alipay is the other major payment platform in China alongside WeChat Pay. Like WeChat, you can register an Alipay account with a foreign phone number. Alipay's international version (the "Tour Pass" feature) has since been retired: Alipay now lets travellers link an international card directly in the app, with no Chinese number required.

Linking an international card turns Alipay into a working wallet for QR payments at shops, restaurants, and on public transport. You authorise the card in the app, and the wallet then works without a Chinese phone number.
...
Both apps require a Chinese phone number for registration. No exceptions. Foreign numbers are not accepted during the sign-up process. The apps send SMS verification codes to confirm your account, and their systems don't deliver SMS to international numbers.
...
Didi does offer an international version called "DiDi Chuxing" that can be used by travelers. The international version works with foreign phone numbers and foreign credit cards. However, it isn't as fully featured as the domestic app. Finding drivers in smaller cities through the international version can be difficult, and the English-language interface sometimes fails to load properly after app updates.

If you're staying in tier-1 cities (Beijing, Shanghai, Guangzhou, Shenzhen), the international version of Didi works reasonably well with a foreign phone number. If you plan to visit second- or third-tier cities, having a Chinese number to use the full Didi app is significantly more reliable.

**Bike Sharing: Hellobike, Meituan Bike, Didi Bike**
Dockless bike sharing is a popular way to get around Chinese cities. Hellobike, Meituan Bike, and Didi Bike all require app registration with a Chinese phone number. Their apps don't accept foreign numbers.

Unlike ride-hailing or food delivery, there's no international version of these bike-sharing apps. If you want to unlock a shared bike, you need a Chinese number. Some travelers have success using Alipay's built-in bike-sharing feature (Alipay integrates with Hellobike) — if your Alipay account is verified with a Chinese number, you can access bike sharing through Alipay without installing the individual bike apps.

**Banking and Payment Card Registration**
If you plan to open a Chinese bank account — during a long-term stay, for work, or for study — you need a Chinese phone number. Chinese banks require a local number for account registration, SMS transaction alerts, and online banking verification. This isn't optional.

To be clear: if your China trip involves Google Maps, WhatsApp, Instagram, and the occasional WeChat message, you're overthinking the phone number question. You don't need one. The friction of visiting a carrier store, handing over your passport, and managing a second SIM isn't worth it for what amounts to food delivery and bike-sharing access. The difference between having a Chinese number and not having one is smaller than most guides make it sound.

**Short Summary: Who Really Needs a Chinese Number**
| Scenario | Chinese Number Required? | Workaround Available? |
|---|---|---|
| Visiting family relatives | No — data eSIM is enough | Use WeChat (foreign number) for family communication |
| WeChat basic messaging | No | Use foreign number |
| WeChat Pay setup | Sometimes | Foreign card works in some regions |
| 12306 train booking | No | Passport verification required; Trip.com skips the wait |
| Alipay basic payments | No | Link an international card directly in the app |
...
## China eSIM Providers That Offer Chinese Phone Numbers
...
**Important limitation for eSIM users:** China Mobile does offer domestic eSIM, but as noted above, foreign passport holders are routinely denied eSIM activation at carrier stores. If you specifically want an eSIM form factor, you will likely be refused. The physical SIM is the reliable route. For travelers who want to preserve their eSIM slot for a data-only travel eSIM (for international routing), the dual-SIM configuration works well: China Mobile physical SIM in the SIM tray for your Chinese number, and a data-only travel eSIM providing internet with full Google/WhatsApp access. See the [China eSIM dual SIM setup guide](/blog/china-esim-setup-installation-dual-sim/) for the exact configuration steps.
...
CMHK offers eSIM profiles that include a Hong Kong phone number plus data that roams onto China Mobile's mainland network. This is the closest you can get to an eSIM with a Chinese number, though it's technically a Hong Kong number.
...
**Limitations:**
- CMHK requires pickup or verification that you're in Hong Kong during activation for some plans
- Not all Chinese apps accept Hong Kong numbers for registration. WeChat does; 12306 needs passport verification instead.
...
Nomad eSIM occasionally offers plans for China that include a virtual number for SMS reception. These are not Chinese numbers — they are typically UK or US virtual numbers that forward SMS. The feature isn't consistently available for China plans and has been removed and re-added multiple times over the past two years.

If you see a Nomad China plan advertising "SMS capability," read the fine print carefully. It may be a forwarding service rather than an actual Chinese number, and SMS delivery isn't guaranteed for all services.

---

## Real-Name Registration for a China eSIM: Passport Requirements

China's real-name registration system for mobile phone numbers is enforced by the Ministry of Industry and Information Technology (MIIT) under the 2013 telephone real-name registration regulation (MIIT Order No. 25). Every SIM a Chinese carrier issues — prepaid or postpaid, physical or eSIM — must be registered to a verified identity. For Chinese citizens, this means a national ID card. For foreigners, it means a passport.

**Why Real-Name Registration Exists**
The [2013 real-name registration regulation (MIIT Order No. 25)](https://www.miit.gov.cn/) requires carriers to link every mobile subscription to a verified identity. It also lists a foreign passport as a valid document for individual registration. The stated purpose is to reduce spam, fraud, and anonymous communication used for illegal activities. In practice, it means you can't buy a Chinese SIM anonymously the way you can in some other countries.
...
Airport kiosks and official carrier stores are the only places that can process foreign passport registration. Third-party resellers and convenience stores often can't handle foreign passports in their registration systems. Go to an official store.
...
A staff member takes a live photograph of your face using a tablet or dedicated camera. This photo is linked to your registration record. The system performs a basic liveness check to ensure the photo isn't a picture of a picture.
...
Your registered phone number remains linked to your expired passport in MIIT's database. When you return to China on a new passport, you can't update the registration to the new passport — the system doesn't support passport number changes for foreign nationals. You would need to cancel the old number and register a new one with the new passport.

Carrier staff may or may not know this. The rule varies by province. In Beijing, they typically tell you to cancel and re-register. In Shanghai, some stores have processed passport updates, but this isn't universal.
...
Since Chinese carriers don't issue eSIM with Chinese numbers to foreign passport holders at most stores, the real-name registration process is currently only relevant for physical SIM cards. If the rules change in the future and carriers begin offering eSIM to foreigners, the same passport-and-face-scan process would apply.

---

## Step by Step: Registering WeChat with a Foreign Number While Using a Data-Only eSIM

Since most travelers end up using a data-only international eSIM for internet access and don't get a Chinese number, the practical question becomes: how do I make WeChat and other essential apps work with what I have?
...
If you're new to dual SIM on iPhone, [Apple Support's guide to using dual SIM](https://support.apple.com/en-us/HT212780) covers the full setup with both physical SIM and eSIM combinations.
...
For a complete visual walkthrough, see the [China eSIM dual SIM configuration guide](/blog/china-esim-setup-installation-dual-sim/).
...
Important: Download WeChat before you leave for China if possible. The app is approximately 250 MB and downloading over a Chinese network, even with a international-routing eSIM, can be slow.

**Step 3: Register with Your Foreign Number**
1. Open WeChat and tap "Register"
2. Enter your country code and home phone number
3. Tap "Register" and wait for the SMS verification code — [WeChat's official help page for account registration](https://help.weixin.qq.com/) covers the supported number types and troubleshooting steps if the code doesn't arrive
...
- WeChat ID (your unique username — choose carefully, it's difficult to change)
...
For a more detailed guide covering specific card types and troubleshooting, see the [China eSIM and essential apps guide](/blog/china-esim-apps-wechat-alipay-google-guide/).
...
## Getting SMS in China Without a Chinese Number

If you have decided you don't want the hassle of a physical Chinese SIM but still need SMS capability for certain registrations, several workarounds exist.
...
- Services that detect you're roaming and block the SMS (rare, but possible)
...
If you have a US-based Google Voice number, it can receive SMS for some international services while you're in China. Google Voice works over your data connection (the China eSIM), so the SMS arrives via the Google Voice app without needing a cellular connection to your home carrier.

**Limitations:**
- Google Voice is US-only (requires a US phone number for initial setup)
- Many apps and services don't accept Google Voice numbers for verification
...
- Skype doesn't support SMS reception from all senders (some short codes are blocked)
...
Some travelers use two eSIMs: one data-only international China eSIM for internet (international routing), and their home carrier's roaming eSIM for their home number's SMS.
...
**Configuration:**
- Primary data: China eSIM (international routing, international routing)
...
**Limitations:**
- SMS forwarding isn't real-time (5-30 minute delays are common)
...
## Dual SIM Strategy: China eSIM Plus a Local Number
...
Bottom line: this dual-SIM setup is the sweet spot for 80% of travelers. Unless you're staying longer than three weeks or you genuinely need to book your own 12306 tickets, adding a Chinese physical SIM on top of this creates more complexity than it solves.
...
- eSIM slot: International data eSIM (for uninterrupted internet)
- Home SIM: Switched to eSIM if possible, or carry a second phone for SMS

Not all phones support this triple configuration. iPhone models from the iPhone 13 onward support dual eSIM plus one physical SIM via the eSIM + physical SIM tray. Android devices vary — Samsung Galaxy S23 Ultra and newer support dual eSIM plus physical SIM. Check your phone's specific SIM configuration before planning this — our [device compatibility guide](/compatibility/) lists the full eSIM and dual-SIM support matrix by model.

For travelers who want the flexibility of both a Chinese number and uninterrupted internet, this is the gold standard. See the [China eSIM vs physical SIM comparison](/blog/china-esim-vs-physical-sim-roaming/) for a detailed cost-benefit analysis.
...
If you're concerned about privacy but still need a Chinese number:
...
2. **Use a data-only eSIM for all internet traffic.** Never use the Chinese SIM's data connection for browsing. The data-only eSIM routes through Hong Kong and isn't subject to the same surveillance infrastructure. Keep the Chinese SIM only for SMS and occasional calls.

3. **Register apps with minimal permissions.** When Chinese apps ask for contacts, location, camera, and storage access, deny everything that isn't strictly necessary. WeChat will function without access to your contacts.
...
6. **Understand that data retention is permanent.** Deleting WeChat doesn't delete MIIT's registration record. Your phone number stays linked to your passport in the database indefinitely.

---

## Which Services Need a Chinese Number with a China eSIM?
...
These are the services you can't use without a Chinese (or in some cases, Hong Kong/Macau) phone number. No foreign number, Google Voice number, Skype number, or virtual number will work.

| Service | What It Does | Why Number Required |
|---|---|---|
| **12306** | China Railway official booking | Passport verification takes a few working days online, minutes at a station counter |
...
These services accept foreign phone numbers for basic registration or have international versions that routing the number requirement.
...
| **Alipay** | Yes | Link an international card in the app for basic QR payments. Full financial services still need a mainland account. |
...
| **Google Maps** | N/A | App works independent of phone number. Needs data connection from international-routing eSIM. |
| **WhatsApp** | N/A | Registration uses your home number. Needs data from international-routing eSIM. Voice calls are blocked on some networks. |
...
| **12306** | No | Register with a passport; a Hong Kong number is not required |
...
You can't complete real-name registration without your physical passport. Photocopies, digital scans, or photos of your passport are not accepted. The carrier store needs the physical document to scan the machine-readable zone. Keep your passport in your day bag on your first day in China.
...
If you need help recharging, Roami's [China travel eSIM](/china-esim/) support team (reachable even on the [free trial eSIM](/free-esim/)) provides setup guidance even though Roami plans are data-only.
...
## China eSIM Phone Number FAQ

**Do I need a Chinese phone number for eSIM?**
No. Travel eSIMs for China are data-only and don't include a phone number. You can use a data-only eSIM for internet access without a Chinese number. Whether you need a separate Chinese phone number depends on which apps and services you plan to use, not on the eSIM itself.

**Can I get a Chinese phone number with eSIM?**
Not from any international travel eSIM provider (Airalo, Holafly, Saily, Ubigi, etc.). Chinese carriers (China Mobile, China Unicom, China Telecom) offer domestic eSIM with Chinese numbers, but they don't issue these to foreign passport holders in practice. Your best option for a Chinese number is a physical SIM from one of the three carriers, purchased at an airport kiosk or carrier store with your passport.
...
## China eSIM and Phone Numbers: The Practical Path Forward

The answer to the question "can I get a Chinese phone number with eSIM" is no for travel eSIMs and theoretically yes for Chinese domestic eSIMs that are not practically available to foreign visitors. But that's not the end of the story.

For short-term travelers (1-2 weeks in major cities), the practical path is:
1. Buy a data-only China eSIM from any reputable provider for internet access with international routing
...
4. Accept that food delivery and bike sharing won't work without a Chinese number

For longer stays or travelers who want full access to Chinese services:
1. Buy a data-only travel eSIM for uninterrupted internet
...
A [China data eSIM](/china-esim/) from Roami covers the first part reliably — data-only with international routing, automatic carrier switching across China's three networks, and 24/7 support if you need help configuring the dual-SIM setup or understanding which type of connectivity you need. Use code WEB20 for a discount on your first plan, and try connectivity risk-free with the [free eSIM trial](/free-esim/).
...
- **Weekend trip (1-3 days, major cities):** Don't bother with a Chinese number. Grab a data-only eSIM like Saily (5GB/$15.99) or Roami (5GB from $5.99 with international routing). Your home SIM handles any SMS verification. You won't miss anything.
...
- **Month-long stay or work trip:** Get the Chinese physical SIM. You'll want food delivery, you'll probably book trains on 12306, and you'll appreciate having a local number for hotels and services. Pair it with a data-only eSIM for uninterrupted internet on Google and WhatsApp.

- **If you only care about one thing:** Get a data-only eSIM with built-in international routing. Without internet access to Google Maps and WhatsApp, the phone number question is irrelevant. Connectivity comes first. The Chinese number is a nice-to-have, not a must-have.

For official information on telecom regulations, visit [the official text of the regulation](https://www.gov.cn/zhengce/2022-08/23/content_5722716.htm).
