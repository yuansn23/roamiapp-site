...
h1title: "EU SIMs Now Charge Roaming in the UK — Here's the Cheaper eSIM"
...
## Three Key Changes in the UK eSIM Market in 2026
...
The UK market is unique because it combines "return of roaming charges" and "very cheap local cards." These three changes determine your choice:
...
## In-Depth Analysis of the UK's Four Major Operators

> The UK is a "Big Four" market, along with numerous budget MVNOs (giffgaff, VOXI, Tesco Mobile). Travel eSIMs usually connect automatically or manually to EE, O2, Vodafone, or Three.

### Core Data Comparison of UK's Four Major Operators

| Metric | EE | O2 | Vodafone | Three |
|------|-----|-----|---------|-------|
| Subscribers | ~25 million | ~34 million | ~18 million | ~10 million |
| 5G Population Coverage | **50%+** | 45%+ | 45%+ | 40%+ |
...
- **EE — "Speed King"**: UK's widest coverage and fastest 5G, best in cities and on main roads. **⚠️ Weakness**: Rural areas and parts of the Scottish Highlands have average coverage.
...
### Coverage Tests in Major UK Cities

| Destination | Coverage Quality | Speed | Best Network |
|--------|---------|------|---------|
| London (City Centre) | Excellent | 5G, 100-500 Mbps | EE |
| Edinburgh | Excellent | 5G, 80-300 Mbps | EE / Vodafone |
| London Underground (Deep Lines) | Poor (No Signal) | Only station WiFi | — |
| Lake District (Windermere) | Good-Average | 4G, 20-60 Mbps | O2 / Vodafone |
| Scottish Highlands | Average (with gaps) | 4G, 10-40 Mbps | **O2 / Vodafone** |
...
## Comprehensive Price Comparison of Three Major UK eSIM Brands
...
|------|--------|------|
| 3 days | 1GB / 3GB | $4.00 / $8.50 |
| 7 days | 3GB / 5GB / 10GB | $9.00 / $12.00 / $18.00 |
...
Holafly UK offers **only unlimited data**, priced per day:
...
Roami UK offers both fixed data and unlimited plans. Discounted price = listed price × 0.8 (code WEB20):

| Days | Data Tier | Listed Price | Discounted Price | Daily Cost |
|------|--------|---------|--------|---------|
| 3 days | 1GB / 3GB / 5GB / 10GB / Unlimited | $1.99 / $3.99 / $5.99 / $7.99 / $8.99 | **$1.59 / $3.19 / $4.79 / $6.39 / $7.19** | $0.53-2.40/day |
| 7 days | 1GB / 3GB / 5GB / 10GB / 20GB / Unlimited | $2.99 / $4.99 / $6.99 / $9.99 / $15.99 / $18.99 | **$2.39 / $3.99 / $5.59 / $7.99 / $12.79 / $15.19** | $0.34-2.17/day |
| 15 days | 3GB / 5GB / 10GB / 20GB / 30GB / Unlimited | $5.99 / $7.99 / $12.99 / $17.99 / $25.99 / $36.99 | **$4.79 / $6.39 / $10.39 / $14.39 / $20.79 / $29.59** | $0.32-1.97/day |
| 30 days | 3GB / 5GB / 10GB / 20GB / 30GB / 50GB / Unlimited | $6.99 / $9.99 / $14.99 / $18.99 / $29.99 / $37.99 / $41.99 | **$5.59 / $7.99 / $11.99 / $15.19 / $23.99 / $30.39 / $33.59** | $0.19-1.12/day |

> ⚠️ **Roami UK Risk Note**: The unlimited plan is slightly more expensive than the 20GB/50GB options (difference of $2.40-$3.20), only needed for heavy users. Otherwise, fixed tiers have the lowest unit price overall, making them more cost-effective for most trips.
...
| Plan | Price | Worth it? |
|------|------|--------|
| Roami 7-day 20GB discounted | $12.79 | Best if daily usage ≤2.86GB |
| Roami 7-day unlimited discounted | $15.19 | Only worth it if daily usage >2.86GB |
...
## Best UK eSIM for 3 Days: Which is Cheaper?

For a 3-day short trip (weekend getaway / layover / business), the starting price matters most.
...
## Best UK eSIM for 7 Days: Which to Choose?

7 days is the most common trip length (London + surroundings, or a short Edinburgh visit).
...
## Best UK eSIM for 15 Days: Half-Month Plan Comparison

15 days suits an in-depth "England + Scotland" tour.
...
## Best UK eSIM for 30 Days: One-Month Plan Comparison

30 days corresponds to long stays, short-term work, or student orientation.
...
## Choose Your UK eSIM by Travel Scenario

### London City Trip (3-5 days)

- **Daily usage**: 1-2GB (navigation + Tube route checking + social media)
- **Recommendation**: Roami 3-5GB
- **Reason**: EE 5G in central London is excellent; Roami's multi-network switching automatically picks between EE/O2 for the best signal. 3GB discounted from $3.19.
- **⚠️ Reminder**: No signal in deep Tube tunnels; load routes before entering or connect to station WiFi.

### Multi-City: London + Edinburgh (7-10 days)

- **Daily usage**: 1.5-2GB
- **Recommendation**: Roami 10-20GB
- **Reason**: Intercity rail routes have coverage gaps; multi-network switching is more reliable. 20GB discounted at $12.79.
- **⚠️ Reminder**: Signal fluctuations are normal when trains pass through rural areas.

### Scottish Highlands / Lake District Road Trip (7-10 days)

- **Daily usage**: 1.5-2GB
- **Recommendation**: Roami 10-20GB
- **Reason**: Coverage gaps are common in the Highlands and Lake District; multi-network switching to O2/Vodafone offers the best coverage. 20GB discounted at $12.79.
- **⚠️ Reminder**: Download offline maps in advance; deep Highlands may have no signal.

### Business Travel (3-7 days)

- **Daily usage**: 1-2GB (email + video conferencing)
- **Recommendation**: Roami 5-10GB
- **Reason**: Works on arrival without finding a store; stable network needed for video calls; multi-network switching is more reliable.
- **⚠️ Reminder**: Use hotel/office WiFi as a backup for important calls.

### Family Trip (5-10 days)

- **Daily usage**: 2-3GB (multiple users + tablets)
- **Recommendation**: Roami 10-20GB + unlimited hotspot
- **Reason**: Roami's hotspot has no restrictions—share one eSIM across the family, cheaper than buying separate cards.
- **⚠️ Reminder**: Avoid Holafly (1GB/day hotspot limit) if sharing with multiple users.

### Strictest Budget (3-5 days)

- **Daily usage**: <1GB (navigation + text)
...
The UK officially left the EU in 2020, and the EU's "Roam Like at Home" policy no longer automatically applies to the UK. From 2022 onwards:

- **UK operators** (EE, Vodafone, Three) have reinstated roaming charges for the EU (O2 partly retains free allowances).
- **EU operators** (Orange, Vodafone EU version, etc.) have mostly reinstated roaming charges for the UK.

This means: **If you buy a card in the EU or travel between the UK and the EU, your mobile card may charge you daily or per-MB roaming fees when in the UK.**

### How Travel eSIMs Avoid This

A [UK eSIM](/united-kingdom-esim/) connects directly to a UK local network (EE/O2/Vodafone/Three), **bypassing your EU operator entirely**, so "EU card roaming in the UK" doesn't apply. Install it before departure and switch to the eSIM upon arrival—avoiding these charges from the ground up.

### Roaming Cost Comparison of Three Options

| Option | Using EU Card in UK | Cost | Convenience |
|------|---------------|------|--------|
| EU card roaming | May charge €2-3/day | Medium-High | Use directly, but expensive |
...
| Aspect | Travel eSIM | UK Local SIM (giffgaff etc.) | International Roaming |
|------|----------|---------------------------|---------|
| Setup process | Install before departure | Buy at airport/store + activate | No setup needed |
| Works on arrival | ✅ | ❌ Requires insert/activate | ✅ |
| Multi-network switching | ✅ (Roami) | ❌ Single network | ❌ Single network |
| Price | Medium (lower discounted) | Low | High |
| UK phone number | ❌ | ✅ | ❌ |
| Best for | Short-term tourists, multi-country trips | Long stays, need UK number | Emergency |

**In short**: Short-term + works on arrival + multi-network → travel eSIM; long stay + need UK number → local SIM (giffgaff is very cheap); if you want zero hassle → don't choose roaming.

## UK eSIM Installation & Activation Guide

1. **Install before departure with WiFi**: After purchase, you'll receive a QR code. Scan it in Settings → Cellular/Mobile Network → Add eSIM before you leave.
2. **Turn on "Data Roaming" upon arrival**: This is the most common activation failure reason. Enable it after landing, and your phone will automatically connect to one of EE/O2/Vodafone/Three.
3. **Select data card**: Set the travel eSIM as the primary "Cellular Data" line.
4. **Turn off data roaming for your home card**: Avoid high roaming fees (especially for EU cards).
5. **Load maps before entering the Tube**: Deep-level London Underground tunnels have no signal; pre-load navigation and maps before you go down.
...
**Q1: Does a UK eSIM require a passport or registration?**

No. The UK doesn't mandate SIM registration, and travel eSIMs are issued overseas and work on arrival—no registration needed. You just need an eSIM-compatible phone and scan the QR code before departure.

**Q2: Will my EU card charge roaming in the UK post-Brexit?**

Very likely. From 2022, UK and EU operators gradually reinstated roaming charges (around €2-3/day or per MB). Using a UK eSIM that connects locally avoids these charges; see the Brexit roaming section above.

**Q3: Which UK operator has the best coverage?**
...
It's average. The Highlands and Lake District have many coverage gaps, with O2/Vodafone performing best. Choose a multi-network switching eSIM to automatically get the strongest signal, but still download offline maps for remote areas.
...
Usually not. UK eSIMs generally only cover the UK mainland; Northern Ireland is included, but the Republic of Ireland and other EU countries require a separate regional eSIM. Post-Brexit, the UK is no longer in the EU roaming zone—check coverage before you go.

**Q12: UK local SIM (giffgaff) vs eSIM—which is better?**

Depends on your needs. giffgaff is cheap (~£10 for 20GB) but requires buying/activating on site, single network, no multi-network switching. eSIM works on arrival, auto-switches networks, install before departure. Short-term tourists prefer eSIM for convenience; long stays prefer local SIM for savings.
...
About 20 hours of Google Maps navigation + extensive WhatsApp messaging, but only about 1 hour of short videos. Minimal users (navigation + text) can stretch 1GB for 3-5 days; video streamers should start with 10GB.

**Q15: What if my UK eSIM has no signal?**

First, check if "Data Roaming" is enabled; restart your phone; go to "Network Selection" and manually choose EE, O2, Vodafone, or Three. Deep Tube tunnels and remote Highlands may have no signal—download offline maps as backup.

**Q16: Can a UK eSIM make phone calls?**

Travel eSIMs are data-only, no UK phone number, so no traditional calls. Use WhatsApp, FaceTime, etc., for data-based calls. If you need a local number for callbacks, pair with a VoIP solution.
...
|------|---------|---------|-------------|---------|
| London 3-day weekend | Roami | 3GB/3 days | $3.19 | Works on arrival + multi-network, 62% cheaper than Airalo |
| London 5-day city trip | Roami | 5GB/7 days | $5.59 | City EE 5G stable, cheapest fixed tier |
| Edinburgh 4-day short trip | Roami | 5GB/7 days | $5.59 | Multi-network switching, more stable at attractions |
| Lake District 6-day road trip | Roami | 10GB/7 days | $7.99 | Switches to O2/Vodafone for better rural coverage |
| Highlands 8-day road trip | Roami | 20GB/7 days | $12.79 | Coverage gaps; multi-network is most reliable |
