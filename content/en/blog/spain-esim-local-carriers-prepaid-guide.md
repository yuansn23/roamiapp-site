...
h1title: "Spain Prepaid eSIM: Local vs International Guide 2026"
...
- **Movistar prepaid:** EUR 10 for 5GB
- **Orange prepaid:** EUR 10 for 15GB
- **Vodafone prepaid:** EUR 15 for 10GB
- **Yoigo prepaid:** EUR 7 for 10GB

Local carriers offer lower per-GB pricing (EUR 0.40-2.00/GB) but require Spanish ID registration. International providers (EUR 1.50-4.50/GB) offer instant activation without registration.

This guide compares both options so you can choose the right **Spain prepaid eSIM** for your trip length and budget. Whether you are looking for a **Spain eSIM for tourists** with quick setup or a **Spain local SIM vs eSIM** comparison to decide which offers better value for a long stay, this guide covers everything you need to know about Movistar, Orange, Vodafone, Yoigo, and international providers.

---

## Why Consider a Local Spanish Carrier?

For a general overview of using eSIMs in Spain, read our [complete travel guide](/blog/spain-esim-complete-travel-guide/).

Spanish telecom law requires prepaid SIM registration under Royal Decree 424/2005, which mandates identity verification for all prepaid mobile lines. This regulation, amended in 2022 to include eSIMs explicitly, applies equally to physical SIMs and eSIMs from local carriers, creating a registration process that international eSIM providers bypass entirely because they operate under their home country regulatory frameworks.

### Regulatory Background

The Spanish government enacted Royal Decree 424/2005 following EU Framework Directive 2002/21/EC, requiring telecom operators to verify the identity of all prepaid users. The current enforcement framework is managed by the [Comision Nacional de los Mercados y la Competencia (CNMC)](https://www.cnmc.es/), Spain's national markets and competition regulator. This law was strengthened in 2015 (Law 9/2014 amendment) and again in 2022 to explicitly include eSIMs as the technology gained adoption. Failure to register results in line suspension within 72 hours under current enforcement practices.
...
CNMC data shows prepaid lines accounted for 38% of Spanish mobile connections in 2025, down from 52% in 2019 as postpaid plans become more affordable. However, prepaid remains the practical choice for tourists, short-term residents, and anyone staying under 6 months. The Spanish mobile market includes approximately 58 million active connections as of Q1 2026, with the following distribution:

| Operator | Market Share | Prepaid % | Postpaid % | Network Type |
|---|---|---|---|---|
| Movistar (Telefonica) | 26.5% | 30% | 70% | Own infrastructure |
| Orange (including Jazztel) | 24.0% | 35% | 65% | Own infrastructure |
| Vodafone Spain | 20.5% | 38% | 62% | Own infrastructure |
| Yoigo (MasMovil) | 12.0% | 45% | 55% | Own + Movistar roaming |
| MVNOs (Lowi, DIGI, etc.) | 17.0% | 40% | 60% | Host network roaming |

### Advantages of Local Carrier Prepaid eSIMs

- **Lower per-GB pricing**: Local prepaid plans cost 40-70% less per GB than international eSIMs, with prices ranging from EUR 0.40/GB on larger Yoigo plans to EUR 2.00/GB on Movistar tourist plans
...
- **Top-up challenges**: International credit cards may be rejected by Spanish payment systems due to SEPA requirements and 3D Secure authentication protocols that favor Spanish-issued cards
- **eSIM compatibility**: Not all local carriers offer eSIM for prepaid lines (Movistar and Orange do, Vodafone offers limited eSIM prepaid, Yoigo supports eSIM via online registration)
- **Time investment**: In-store registration takes 15-30 minutes not including travel time; online video verification takes 5-10 minutes but requires a stable internet connection

### Why the Spanish Number Matters

The primary reason to choose a local carrier over an international eSIM is the Spanish phone number. Renfe (national train operator) requires a +34 number for account creation and two-factor authentication when booking AVE, Avlo, and Media Distancia tickets through the mobile app. Cabify and Uber use SMS verification to your +34 number for ride booking. Restaurant booking platforms like ElTenedor and OpenTable Spain require SMS verification. Even the Spanish government's Cl@ve digital identity system requires a Spanish mobile number for registration.

International eSIMs without voice capabilities cannot receive SMS verification codes from these services. While travelers can work around this limitation by using WhatsApp for restaurant reservations or purchasing train tickets at station kiosks, having a Spanish number eliminates these friction points entirely.

---

## Movistar Prepaid: Best Coverage, Higher Price

For a detailed comparison of major carriers, see our [Movistar vs Orange vs Vodafone guide](/blog/spain-esim-movistar-orange-vodafone-comparison/).

[Movistar](https://www.movistar.es/) (Telefonica) operates Spain's largest mobile network with the most extensive coverage footprint, reaching 99% of the population on 4G and 92% on 5G as of early 2026. Their prepaid eSIM offering targets long-stay visitors and residents rather than short-term tourists. Movistar has invested over EUR 3.2 billion in Spanish network infrastructure since 2020, including a standalone 5G (SA) core deployed across Madrid, Barcelona, Valencia, and Seville.
...
1. Visit a Movistar store (Tienda Movistar) with valid passport or NIE; stores are located in all cities and most towns with populations over 10,000
2. Request "alta de linea prepago con eSIM" -- staff may try to upsell postpaid contracts, so be specific about prepaid eSIM
3. Provide a Spanish address (hotel address accepted for tourist plans, Airbnb addresses also accepted in most cases)
4. Complete identity verification via document scan and photo; Movistar takes a photocopy of your passport and a live photo for their records
5. Receive eSIM QR code via email within 1-24 hours; some stores provide instant QR codes if they have eSIM provisioning terminals
6. Install and activate using iPhone or Android settings: Settings > Cellular > Add eSIM > Scan QR code
7. Top up via Movistar app (available in English and Spanish), website (movistar.es), or any Movistar store
8. First top-up must be done in-store at the time of activation for most tourist plans
...
Movistar's network advantage is most noticeable in rural areas, mountainous regions, and along AVE high-speed train routes. Travelers visiting the Pyrenees, Sierra Nevada, or interior villages of Castilla-La Mancha will maintain connectivity on Movistar when Orange and Vodafone users lose signal. In independent speed tests conducted by [nPerf](https://www.nperf.com/en/map/ES/-/Movistar/mobile-coverages/) in 2025, Movistar achieved the highest overall score at 89,890 nPoints, followed by Orange at 83,240 and Vodafone at 78,910.

### Movistar Weaknesses

- **Higher pricing:** 10GB prepaid at EUR 15 — 50% more than Orange
...
Check our [complete Spain eSIM travel guide](/blog/spain-esim-complete-travel-guide/) for more on network coverage and speeds.
...
| Orange Medio Prepago | 15GB | 10 | 0.67 | 30 days | 100 min, 100 SMS |
...
1. Purchase at any Orange store (Tienda Orange) with passport or NIE; over 800 stores nationwide
2. Register via Orange website (tienda.orange.es) with video ID verification requiring passport and a selfie photo
3. Receive eSIM QR code via email -- typically within 1 hour for online registrations, instant for in-store purchases
4. Install through iOS/Android eSIM settings: the QR code links to a profile that configures APN settings automatically
5. Activate by connecting to Orange network upon arrival in Spain; manual network selection may speed up activation
6. Top up via Orange app (Mi Orange), online portal, or any Orange store

Orange offers the smoothest online registration process among Spanish carriers. The video ID verification takes approximately 5 minutes and can be completed from a hotel room or apartment using a smartphone camera. Supported documents include EU national ID cards and passports from all countries. The eSIM QR code arrives via email within 1 hour during business hours (Monday to Saturday, 9:00-21:00), though weekend registrations may take 2-4 hours.

### Orange Holiday Europe Plan

The Orange Holiday Europe plan deserves special mention for travelers combining Spain with other EU destinations. At EUR 29.99 for 14 days, it includes 25GB data across 30 European countries with a Spanish number, voice minutes, and SMS. The plan includes:
...
For a side-by-side look at carrier coverage maps, visit our [Movistar, Orange, and Vodafone comparison](/blog/spain-esim-movistar-orange-vodafone-comparison/).
...
| Vodafone Prepago Medio | 10GB | 15 | 1.50 | 30 days | 100 min |
...
Vodafone has invested heavily in 5G infrastructure along Spain's Mediterranean and Atlantic coastlines. Their network consistently outperforms competitors in Malaga, Marbella, Alicante, Benidorm, Palma de Mallorca, and the Canary Islands. This investment is strategic: coastal tourist zones account for approximately 40% of Vodafone Spain's prepaid revenue during peak summer months.
...
1. Visit a Vodafone store with passport or NIE; tourist-area stores have English-speaking staff
2. For online registration, use Vodafone's website (vodafone.es) with video identification via the WebID process
3. Provide Spanish address (hotel accepted for tourist plans; Airbnb addresses also accepted)
4. Receive QR code via email or app notification (My Vodafone app)
5. Install through device eSIM settings
6. Activate upon connecting to Vodafone Spain network; may require restarting the device
7. Top up through Vodafone app, online portal, or any Vodafone store
...
Yoigo operates as Spain's fourth national mobile carrier with 12% market share. Yoigo is owned by MasMovil, which merged with Orange in 2024 to form MasOrange, though Yoigo continues operating as a separate brand with its own pricing and network strategy. They use a hybrid model combining their own network infrastructure in urban areas with Movistar roaming in rural zones.

### Yoigo Spain eSIM Prepaid Plans

| Plan Name | Data | Price (EUR) | Per GB | Validity | Network |
|---|---|---|---|---|---|
| Prepago 7 | 7GB | 7 | 1.00 | 30 days | Yoigo + Movistar |
...
Yoigo uses Movistar's rural network through a national roaming agreement. This means Yoigo prepaid users connect to Movistar's towers outside Yoigo's urban coverage zones, effectively matching Movistar's coverage footprint in rural and mountainous areas. In practice, Yoigo users experience:
...
For general travel tips and eSIM setup guidance, see our [complete Spain eSIM travel guide](/blog/spain-esim-complete-travel-guide/).
...
|---|---|---|
| Cost per GB | EUR 0.40-2.00 | EUR 1.50-4.50 |
...
|---|---|---|---|
| 5GB (7 days) | EUR 6-10 (Orange/Movistar) | USD 12-16 (Airalo, Nomad) | 37-50% |
| 10GB (7 days) | EUR 15 (Orange Medio 30-day) | USD 26 (Airalo 7-day) | ~42% |
| 15GB (14 days) | EUR 10-15 (Orange Medio 30-day) | USD 34 (Holafly unlimited 15-day) | 56-70% |
| 25GB (30 days) | EUR 15 (Orange or Yoigo) | USD 64 (Holafly unlimited 30-day) | ~77% |
| 50GB (30 days) | EUR 20 (Yoigo or Orange Super) | EUR 29-49 (international unlimited) | 31-59% |

Local carrier prepaid plans provide significantly better per-GB pricing for extended stays. The savings over a 30-day trip with 25GB data reach EUR 40-50 compared to international unlimited plans. These savings assume you complete the local registration process, which has an opportunity cost of 15-30 minutes plus travel time to a carrier store.
...
- International eSIM: approximately USD 12-16 (Airalo, Nomad, Holafly)
- Local prepaid (Orange Mini): EUR 6 for 5GB
- Convenience premium: EUR 4-8

The EUR 4-8 premium for skipping registration is justified for most short-stay travelers. The premium decreases on a per-day basis for longer stays, making local carriers increasingly attractive for trips over 14 days.
...
The speed difference is typically 20-40% during peak congestion, returning to normal during off-peak hours. For most travelers, this deprioritization is barely noticeable for messaging, navigation, and social media but may affect 4K video streaming and large file downloads.
...
|---|---|---|---|
| Online before travel | Instant delivery, best prices, widest selection | Requires pre-planning 1-3 days ahead | All travelers |
| Airport upon arrival | Immediate connectivity, no pre-planning | Higher prices (20-40% premium), limited options | Walk-in travelers |
| Local carrier store | Spanish number, local support, competitive pricing | Language barrier, paperwork, 15-30 min process | Long-stay visitors |
...
|---|---|---|---|---|
| Airalo | USD 4.50/1GB | 1GB-20GB | Orange, Movistar | Yes |
| Holafly | USD 27 unlimited | 5-90 days unlimited | Movistar | Yes |
| Nomad | USD 5/1GB | 1GB-50GB | Orange, Movistar | Yes |
| Saily | USD 3.99/1GB | 1GB-50GB | Vodafone | Yes |
...
- Activation: eSIM activates automatically upon connecting to Spanish network (no manual steps needed on most modern phones)
...
Major Spanish airports have carrier kiosks and electronics stores selling eSIMs. This option suits travelers who arrive without a plan or whose online purchase failed. Airport kiosk staff can assist with installation and troubleshooting.

| Airport | Carrier Kiosks | Location | Notes |
|---|---|---|---|
| Madrid-Barajas (MAD) | Vodafone, Orange, Movistar | T1, T3, T4 arrivals | All open 7:00-22:00 |
| Barcelona-El Prat (BCN) | Orange, Vodafone | T1 and T2 arrivals | Orange has dedicated eSIM desk |
| Malaga (AGP) | Orange, Vodafone, Movistar | Arrivals hall | Seasonal extended hours in summer |
| Palma de Mallorca (PMI) | Orange, Vodafone | Arrivals | Limited to summer season |
| Alicante (ALC) | Vodafone, Orange | Arrivals | Smaller kiosks |
| Valencia (VLC) | Orange, Vodafone | Arrivals | Moderate selection |
| Ibiza (IBZ) | Orange | Arrivals | Seasonal only (May-October) |

Airport eSIM prices are typically 20-40% higher than online rates. Orange's online 15GB plan at EUR 10 costs EUR 15-18 at airport kiosks. The convenience premium covers immediate activation and in-person support. Airport carriers offer physical SIMs and eSIMs, but eSIM compatibility depends on the staff member's knowledge. Ask specifically for "eSIM prepago" and confirm your phone supports eSIM before purchasing.

### Local Carrier Store During Your Stay

Spanish carrier stores are found in all cities and most towns with populations over 5,000. Store hours typically run 10:00-14:00 and 17:00-20:30 Monday through Saturday. Larger stores in shopping centers operate continuously 10:00-21:00. Sunday hours are limited to tourist areas and shopping centers in major cities.
...
| Carrier | Cash | International Card | Spanish Card | Bank Transfer |
|---|---|---|---|---|
| Movistar | Yes (in-store) | Sometimes rejected | Yes | Yes |
| Orange | Yes (in-store) | Accepted (Visa/MC) | Yes | Yes |
| Vodafone | Yes (in-store) | Sometimes rejected | Yes | Yes |
| Yoigo | Yes (in-store) | Sometimes rejected | Yes | Yes |

Carrying cash (EUR 20-50) is recommended as a backup payment method. Movistar and Vodafone stores reject international cards approximately 30-40% of the time according to traveler reports on Spain travel forums.
...
| Phase | Action | Connectivity |
|---|---|---|
| Before departure | Purchase international eSIM from any provider | Ready on arrival |
| Day 1 in Spain | Activate international eSIM | Immediate data |
| Day 1-3 | Visit local carrier store, register for prepaid eSIM | Backup connectivity via international eSIM |
| Day 3+ | Transfer primary data to local carrier prepaid | Cost savings start |
| Day 3+ onward | Keep international eSIM as secondary data line | Redundancy and auto-switching |

### How to Configure Dual eSIM for Hybrid Use

1. Install international eSIM QR code before departure (configure as primary data initially)
2. Upon arrival, international eSIM activates automatically without any manual intervention
3. Within first 3 days, visit local carrier store to register and receive Spanish prepaid eSIM
4. Install prepaid eSIM QR code alongside international eSIM (both remain active on the device)
5. Set prepaid eSIM as primary data line (lower per-GB cost for bulk usage)
6. Keep international eSIM as secondary data line (automatic fallback if prepaid coverage drops)
7. Configure home SIM for voice/SMS on your home number using WiFi calling over either data line
...
- Automatic fallback means no manual carrier switching if one network goes down
- Coverage diversity: if the local carrier has a dead zone, the international eSIM switches to a different network

### Cost Analysis: International Only vs Local Only vs Hybrid

| Approach | First 3 Days | Remaining 27 Days | Total Cost | Notes |
|---|---|---|---|---|
| International only (Airalo) | USD 26 (10GB 30-day) | USD 0 | USD 26 | No Spanish number |
| International only | EUR 29 (30-day fair use plan) | EUR 0 | EUR 29 | No Spanish number |
| Local only (Orange) | EUR 0 | EUR 15 (30-day, 15GB) | EUR 15 | Spanish number, 15-30 min registration |
| Local only (Yoigo) | EUR 0 | EUR 12 (30-day, 15GB) | EUR 12 | Spanish number, lowest cost |
| Hybrid (International + Orange) | EUR 29 (30-day fair use) | EUR 15 (Orange 30-day) | EUR 44 | Full redundancy |
| Hybrid (Airalo + Yoigo) | USD 10 (1GB for first 3 days) | EUR 12 (Yoigo) | Approx EUR 22 | Budget hybrid |

The hybrid approach costs more than local-only but provides redundancy and immediate connectivity. For travelers who value reliability over minimum cost, the dual-provider setup ensures continuous connectivity even if one carrier experiences technical issues. The EUR 29-44 total cost for a 30-day hybrid setup compares favorably to single international eSIM unlimited plans that cost EUR 49-80 for the same period.

### When Multi-Network Excels in a Hybrid Setup

A hybrid setup works particularly well with multi-network eSIMs because automatic carrier switching across Movistar, Orange, Vodafone, and Yoigo complements a local prepaid from any single carrier. If the local prepaid experiences congestion or coverage issues, the multi-network eSIM automatically switches to the strongest available network among the four major carriers. This means:
...
1. **iPhone user with physical home SIM**: Physical home SIM + international eSIM + Orange prepaid eSIM
   ...
   - Orange for long-term data with Spanish number at EUR 0.67/GB
...
- Label each eSIM clearly in your device settings (e.g., "International eSIM" and "Orange Prepaid")
- Set the local carrier as the default data line and enable "Allow Cellular Data Switching" (iOS) or "Automatically switch data SIM" (Android) for automatic fallback
- Turn off the international eSIM when not needed to prevent accidental data usage on the more expensive line
...
- First-time eSIM users can test device compatibility with a [free eSIM trial](/free-esim/) before committing to a paid plan
...
Choosing between local carrier prepaid and international eSIM ultimately turns on your trip duration, whether you need a Spanish number, and your tolerance for registration paperwork. Local carriers deliver better pricing and network priority but require documentation and time. International eSIMs provide instant activation and no registration but cost more per GB and typically lack voice capabilities. For most travelers staying under 2 weeks, the convenience of an international eSIM outweighs the cost savings of local registration. For extended stays exceeding 2 weeks, the savings from local carrier prepaid plans become substantial enough to justify the registration process. The ideal strategy depends on your itinerary and budget, but the hybrid approach delivers the best of both worlds for those who want both immediate connectivity and long-term savings with full redundancy.

---

## Frequently Asked Questions About Spain Prepaid eSIM

### What is the difference between a local prepaid eSIM and an international eSIM in Spain?

Local prepaid eSIMs from Movistar, Orange, Vodafone, and Yoigo include a Spanish phone number (+34), require passport registration, and offer lower per-GB pricing (EUR 0.40-2.00/GB). International eSIMs (Airalo, Holafly, Nomad) are data-only, require no registration, activate instantly, and cost more per GB (EUR 1.50-4.50/GB). For stays under 2 weeks, international eSIMs are more convenient. For stays over 2 weeks, local prepaid saves money.

### Which local carrier has the best prepaid eSIM for tourists?

Orange offers the best balance of price and coverage for tourists with their Medio Prepago plan: 15GB for EUR 10, valid 30 days, with a Spanish number. Yoigo offers the lowest per-GB pricing at EUR 7 for 7GB. Movistar provides the widest coverage but costs more. Vodafone is best along the Mediterranean coast. For a **Spain eSIM for tourists**, Orange is usually the best starting point.
...
You need a Spanish number if you plan to book AVE trains through Renfe (SMS verification required), use Cabify or Uber (SMS verification), make restaurant reservations through ElTenedor/OpenTable, or register with Spanish government services. If you plan to use WhatsApp for all communication and book trains at station kiosks, you can manage without a Spanish number. For a **Spain prepaid eSIM with phone number**, local carriers are the only option.

### How much does a Spain prepaid eSIM cost?

Prices vary by carrier and plan: Orange 5GB EUR 6, Orange 15GB EUR 10, Yoigo 7GB EUR 7, Yoigo 15GB EUR 12, Movistar 5GB EUR 10, Movistar 10GB EUR 15, Vodafone 5GB EUR 12, Vodafone 10GB EUR 15. Compared to international eSIMs at USD 12-16 for 5GB, local prepaid saves 37-50% on data costs. For a **Spain prepaid eSIM cost** comparison, Orange and Yoigo offer the best per-GB value.

### Can I get a local prepaid eSIM without a Spanish address?

Yes, most carriers accept hotel addresses for tourist prepaid plans. If the store asks for a Spanish address and you do not have one, provide your hotel name and address. Some stores also accept Airbnb addresses with booking confirmation. The address requirement is primarily for their internal records rather than validation. For a **Movistar prepaid eSIM**, hotel addresses are commonly accepted.
...
Yoigo offers the cheapest prepaid eSIM at EUR 7 for 7GB (EUR 1.00/GB) and EUR 12 for 15GB (EUR 0.80/GB). Orange's 15GB for EUR 10 is slightly more expensive at EUR 0.67/GB but has better coverage in some regions. For the absolute lowest cost, Yoigo is the cheapest among major carriers. For a **cheap Spain prepaid eSIM**, Yoigo and Orange are the top choices.
...
Yes, all major carriers offer online top-up through their apps or websites. The Orange app (Mi Orange) and Vodafone app (My Vodafone) support top-ups with international cards. Movistar top-up can be done online but sometimes rejects non-Spanish cards. Yoigo top-up accepts Spanish cards and bank transfers; international cards are less reliable. Cash top-up at carrier stores is the most reliable method for all carriers.
