...
There is a clear leader here, and it is EE. EE has invested heavily in rural coverage over recent years, as documented on their [coverage page](https://ee.co.uk/). The company operates a programme called "EE in the countryside" which has added hundreds of new masts in remote areas. EE is also the lead partner in the Shared Rural Network, receiving government funding to close gaps in places like the Lake District and Snowdonia.
