---
title: "Spain eSIM Setup : iPhone & Android Guide"
description: "Step-by-step Spain eSIM installation for iPhone & Android. Fix APN settings and activate your travel eSIM before departure with our 2026 guide"
keywords: ["Spain eSIM setup", "Spain eSIM installation", "Spain eSIM iPhone", "Spain eSIM APN settings", "Spain eSIM Android", "install Spain eSIM before travel", "Spain travel eSIM activation", "best Spain eSIM for iPhone", "Spain eSIM dual SIM setup"]
...
tags: ["Spain eSIM", "Travel eSIM", "eSIM Setup"]
readingTime: 20
draft: false
authorAvatar: "/img/logo.png"
authorPostsLink: "/blog/"
h1title: "Spain eSIM Setup Guide 2026: Install & Activate on iPhone and Android"
...
Installing a **Spain eSIM** takes 5-10 minutes. The most common setup mistake — leaving data roaming disabled — causes a "No Service" signal after landing. This comprehensive guide covers everything you need for a smooth Spain eSIM installation on both iPhone and Android, from compatibility checks to APN settings and dual-SIM configuration. Whether you're wondering how to get a Spain eSIM on your phone or need help with activation, this guide has you covered.

Setup overview:

- **Purchase online** before departure (QR code delivered by email)
- **Install at home** on WiFi (avoid airport activation issues)
- **Enable data roaming** on the eSIM line (required for all eSIMs)
- **Configure dual SIM** (home SIM for SMS, eSIM for data)

This guide covers compatibility checks, step-by-step Spain eSIM setup for iPhone and Android, APN settings, hotspot setup, and troubleshooting. Whether you are setting up an eSIM for a weekend trip or a long-term stay, following these steps ensures you stay connected from the moment you land in Spain.

For a complete Spain eSIM overview, see our [comprehensive Spain travel eSIM guide](/blog/spain-esim-complete-travel-guide/).

---

## Before You Start: Checking Phone Compatibility for Spain eSIM

Not all phones support eSIM, and some carriers impose additional restrictions on eSIM usage. Checking compatibility before purchasing saves significant time and prevents buying a plan that cannot be installed. Spain's mobile ecosystem works with both consumer and business eSIM profiles, so verifying your specific device variant is the first and most important step. If you're unsure, you can also try a [free eSIM trial](/free-esim/) to test compatibility before committing to a paid plan.

### iPhone models with eSIM support for Spain:

| Model | eSIM Support | Dual eSIM | Notes |
|---|---|---|---|
| iPhone XR, XS, XS Max | Yes | No | One eSIM + one physical SIM |
| iPhone 11 series | Yes | No | One eSIM + one physical SIM |
| iPhone 12 series | Yes | Yes (13+) | Dual eSIM on 13+ |
| iPhone 13 series | Yes | Yes | Dual active eSIM |
| iPhone 14 series (US) | Yes (no physical SIM) | Yes | eSIM only |
...
All iPhone models from the XR onward include eSIM support, but dual active eSIM — running two eSIMs simultaneously — is only available on iPhone 13 and newer. US iPhone 14, 15, and 16 models lack a physical SIM slot entirely, making eSIM the only option for cellular connectivity. For detailed instructions specific to Apple devices, see our [Spain eSIM iPhone setup guide](/blog/spain-esim-iphone-setup-guide/).

### Android models with eSIM support for Spain:

| Brand | Supported Models | eSIM Limit |
|---|---|---|
| Samsung Galaxy | S20, S21, S22, S23, S24, S25, S26 series; Note 20; Z Flip/Fold series | Dual active on S23+ |
| Google Pixel | Pixel 3, 3a, 4, 4a, 5, 6, 7, 8, 9, 10 series | Dual active on Pixel 7+ |
| Huawei | P40, P40 Pro, Mate 40 Pro (China models may lack eSIM) | Single eSIM |
| Xiaomi | 12T, 13, 13T, 14, 14T series | Single eSIM |
| Oppo | Find X3, X5, X8 series; Reno 10+ | Single eSIM |
| OnePlus | 11, 12, 13, Open series | Single eSIM |
| Sony | Xperia 1 IV, 1 V, 1 VI, 10 IV+ | Single eSIM |
| Motorola | Razr series, Edge 30+ | Single eSIM |
| Nothing | Phone (1), Phone (2), Phone (3) | Single eSIM |
| Fairphone | Fairphone 4, Fairphone 5 | Single eSIM |
| Honor | Magic 4 Pro+, Magic 5 Pro, Magic 6 Pro, Magic 7 Pro | Single eSIM |
| ASUS | Zenfone 9, Zenfone 10, Zenfone 11 | Single eSIM |

For Samsung and Pixel users, we have dedicated guides covering [Spain eSIM setup for Samsung Galaxy](/blog/spain-esim-samsung-galaxy-setup-guide/) and [Spain eSIM setup for Google Pixel](/blog/spain-esim-google-pixel-setup-guide/).
...
Carrier-locked phones from US carriers (T-Mobile, AT&T, Verizon) typically support eSIM only on that carrier's network. A Spain eSIM cannot be installed on a carrier-locked phone until it is unlocked by the original carrier. Contact your carrier before traveling to request an unlock. Most US carriers will unlock a phone once it is paid off and has been active on their network for at least 60 days. The unlocking process can take 24-72 hours, so initiate the request at least one week before departure.
...
## Installing Before Departure vs After Arrival in Spain
...
- The eSIM remains inactive until you arrive in Spain
- Configure data roaming and APN settings in advance
- Test that the eSIM profile installed correctly
- Only the QR code scan step requires internet access
...
- Allows time to troubleshoot installation issues with support
- Enables pre-configuring dual SIM settings
- Reduces setup time at destination to zero
...
3. Save QR code screenshot in phone gallery and email
4. Scan QR code in phone settings (no internet required)
5. Configure APN settings if needed (provider provides details)
6. Label the eSIM "Spain Data" for easy identification
7. Set cellular data line to the primary line (will activate later)
8. Enable data roaming for this line
9. Set home SIM as the default for voice and SMS
...
- Scan and configure in terminal or accommodation
...
- No ability to troubleshoot before trip
- May require configuring while managing luggage or transit
...
|---|---|---|
| Internet needed at landing | No | Yes (airport WiFi or cafe) |
| Troubleshooting time | Days before trip | Minutes during travel |
| Setup duration on arrival | 0 minutes | 10-15 minutes |
| QR code backup options | Full (print, email, gallery) | Limited to device |
| Best for | Planned trips, longer stays | Spontaneous travel, business |
...
- **Late-night arrivals:** Many airport shops and SIM kiosks close by 10 PM. Installing an eSIM in advance is essential for late-night or early-morning landings.
- **Ferry or cruise arrivals:** If arriving by sea, the eSIM activates when your phone connects to a Spanish coastal network. Install before departure to ensure connectivity the moment you dock.

Spain eSIM installation step by step: Once you have the QR code, the entire process takes under 5 minutes regardless of phone model.
...
3. Scan the QR code provided by your eSIM provider
   - Position QR code within the viewfinder rectangle
   - Hold steady until the code is recognized
   - If scanning fails, tap "Enter Details Manually" and input the SM-DP+ address and activation code
   - Ensure the QR code is not damaged, creased, or displayed at low brightness
4. iPhone displays "Cellular Plan Detected" — tap Continue
5. Label your plan (suggested: "Spain eSIM" or provider name with flag emoji such as "es")
6. Select "Use as Secondary Line" (for dual SIM setups)
7. Set default line for calls and messages to your home SIM
8. Set cellular data line to "Spain eSIM"
...
3. Tap "Network Selection" > Set to Automatic
...
4. Choose a preset or create custom label
...
- iMessage and FaceTime register with both numbers
- WhatsApp works with the number associated with each SIM
- Enable "Allow Cellular Data Switching" so the non-data line can forward calls over the data connection
...
|---|---|
| eSIM Quick Transfer | Transfer an existing eSIM profile from your old iPhone to a new one without contacting the provider |
| Multi-eSIM support | Store multiple Spain eSIM profiles and switch between them (iOS 16+) |
| eSIM carrier notifications | Receive provider updates directly through Settings |
...
- **eSIM shows "Activating..." for more than 10 minutes:** Ensure WiFi is connected, wait up to 30 minutes. If it persists, delete the eSIM profile and re-scan the QR code.
- **"Cellular Plan Not Found":** Contact provider to reissue QR code. Some eSIMs expire after a single failed installation attempt.
- **SIM card not supported:** Confirm iPhone is not carrier-locked. Settings > General > About — if "Carrier Lock" shows "SIM locked," contact your original carrier.
- **Data stops working after a few minutes:** Check APN settings. Some iPhone models require manual APN entry even when auto-configuration should work.
- **"No SIM Card Installed" error on the eSIM line:** Delete the eSIM profile (Settings > Cellular > select plan > Delete eSIM) and reinstall using the QR code backup.
- **Cellular Data Network menu is missing:** This happens when the eSIM is not set as the active data line. Go to Settings > Cellular > Cellular Data and select the Spain eSIM, then scroll down.
...
3. If prompted, select "Use your home number for iMessage"
4. Settings > FaceTime > Your home number should be selected
5. This ensures you continue receiving iMessages and FaceTime calls on your home number while using Spain data

---

## Android: Step-by-Step Spain eSIM Setup for Samsung, Pixel and Others
...
4. Scan the QR code provided by your eSIM provider
5. Tap "Add" to confirm installation
6. Name the eSIM (suggested: "Spain eSIM" or provider name)
7. Configure default SIM settings:
   - Primary SIM for calls: Home SIM
   - Primary SIM for messages: Home SIM
   - Mobile data: Spain eSIM
8. Enable data roaming for the Spain eSIM:
...
3. Tap "Yes" > "Next"
4. Scan QR code from provider
5. Tap "Download" to install
6. Configure SIM preferences:
   - Mobile data: Spain eSIM
   - Calls: Home SIM
   - SMS: Home SIM
...
- Pixel 8 and 9 series include "SIM manager" in the quick settings tiles for fast switching
...
|---|---|---|
| Xiaomi | Settings > SIM Cards & Mobile Networks > Add eSIM | May be under "Dual SIM settings" in MIUI/HyperOS |
| OnePlus | Settings > Wi-Fi & Internet > SIM & Network > Add eSIM | Carrier settings may override eSIM option |
| Oppo | Settings > Mobile Network > SIM Card Management > Add eSIM | Requires ColorOS 13+ |
| Sony | Settings > Network & Internet > SIMs > Add eSIM | Available on Xperia 1 IV+ |
| Nothing | Settings > Network & Internet > SIMs > Add eSIM | Nothing OS 2.0+ required |
...
1. Settings > Network & Internet > SIMs > Spain eSIM > Access Point Names
2. Tap "+" or "Add" to create new APN
3. Enter provider-specific APN settings from the table below
4. Save (three-dot menu > Save on Samsung; checkmark icon on stock Android)
...
2. Under "Preferred SIMs":
   - Voice calls: Home SIM
   - Video calls: Home SIM (or Ask first)
   - Messaging: Home SIM
   - Mobile data: Spain eSIM
...
| Issue | Resolution |
|---|---|
| "Cannot connect to network" after scanning | Go to Settings > Connections > Mobile Networks > Network Operators > Search networks and manually select Movistar, Orange, Vodafone, or Yoigo |
| eSIM download stuck at 0% | Switch from mobile data to WiFi and restart the download process |
| "SIM card not supported" on Samsung | Ensure your Samsung is not a Korean or US carrier model with region-locked eSIM firmware |
| Data works but calls fail | Set home SIM as default for calls — Spain eSIMs are typically data-only |
| APN changes not saving | Some Android skins hide the Save button behind the three-dot menu; do not use the Back button to exit |
| "No eSIM option" in Settings | Check for Android system updates — eSIM support was added in Android 10 and improved in Android 13+ |
...
|---|---|---|
| APN | The gateway address to the carrier's data network | This is the most critical field — an incorrect APN will not connect to data |
| Username | Carrier-specific authentication credential | Some Spanish carriers require this (Movistar, Orange); others leave it blank |
| Password | Carrier-specific authentication credential | Often identical to username; required when username is filled |
| Authentication | Security protocol (PAP, CHAP, or None) | PAP is most common; wrong type causes authentication failure |
| APN Type | Defines what the APN is used for (data, MMS, supl) | "default,supl" covers data and location services |
...
- MMS or visual voicemail not working on an eSIM that supports messaging
- Roaming indicator shows "E" or "G" instead of 4G/5G
...
3. Enter APN, Username, and Password from provider
4. Leave all other fields blank unless instructed otherwise
5. Tap "< Cellular" to save and return
...
3. Tap "+" icon to add new APN
4. Enter APN settings from provider
5. Tap three-dot menu > "Save"
6. Select the newly created APN by tapping the radio button next to it
...
- Restart phone after APN changes to apply settings
- Remove and re-add APN if first attempt fails
- Reset APN to default if changes break connectivity — on Android, tap three-dot menu > "Reset to default"
- On iPhone, delete the eSIM profile and re-add it to reset APN fields to blank
- Some MVNO APNs require you to also set the "MVNO Type" field to "GID" and provide a specific MVNO value
- If you have entered the correct APN but data still does not work, try changing APN Protocol from "IPv4/IPv6" to "IPv4" only

---

## Configuring Dual SIM: Home Line for Calls, eSIM for Data

The most common Spain eSIM configuration keeps your home SIM active for calls and SMS while the eSIM handles all mobile data. This setup requires specific configuration on both iPhone and Android to ensure you avoid roaming charges while maintaining access to your home number. For a deeper dive into this topic, see our [Spain eSIM dual SIM guide for iOS and Android](/blog/spain-esim-dual-sim-guide/).
...
- No roaming charges on home SIM (keep data roaming OFF on home line)
- Receive calls on home number without extra cost
...
| Reason | Explanation |
|---|---|
| Banking SMS | Banks send two-factor authentication codes to your home number |
| WhatsApp continuity | WhatsApp registration tied to your home number remains active |
| Emergency contact | Family and work can reach you on your usual number |
...
3. Tap "Cellular Data" > Select Spain eSIM
4. Tap each line > "Cellular Plan Label" > Assign appropriate names
5. Enable "Allow Cellular Data Switching"
   - This lets the home SIM access data when the eSIM has weak signal
   - May trigger home carrier roaming charges if active
   - Disable if you want strict data-only on eSIM
6. Tap "iMessage & FaceTime" > Set to home number
...
2. Under "Preferred SIMs":
   - Voice: Home SIM
   - Video: Home SIM (or Ask first)
   - Messaging: Home SIM
   - Mobile data: Spain eSIM
3. Enable "Call forwarding between SIMs" for missed calls on either line
4. Toggle "Auto data switching" ON (uses home SIM data when eSIM is weak) — but be aware this may incur home roaming data charges
...
3. Tap "SMS" > Select Home SIM
4. Tap "Mobile data" > Select Spain eSIM
5. Enable "Allow switching" for automatic data fallback
...
- When on a call from home SIM, eSIM data continues working uninterrupted
- When on a call from eSIM (if voice-enabled), data may pause depending on phone model
- Most Spain eSIMs are data-only, so no second call line concerns
...
Business travelers often need to be reachable on their work number while using a Spain eSIM for data. The recommended configuration:

1. Keep work SIM (home SIM) active for calls and SMS
2. Set up call forwarding from work number to a VoIP number (Skype, Google Voice) for data-based call routing
3. Configure the company's PBX to route calls through the mobile app over data
4. Use the Spain eSIM for all business apps, email, video conferencing, and hotspot sharing
5. Set a specific ringtone for the work SIM to differentiate business from personal calls
6. Disable cellular data on the work SIM entirely to eliminate any roaming data risk
...
|---|---|---|
| iPhone | Settings > Cellular > Spain eSIM | Data Roaming toggle |
| Samsung | Settings > Connections > SIM Card Manager > Spain eSIM | Data roaming ON |
| Google Pixel | Settings > Network & Internet > SIMs > Spain eSIM | Roaming ON |
| Xiaomi | Settings > SIM Cards > Spain eSIM | Enable Data Roaming |
| OnePlus | Settings > Wi-Fi & Internet > SIM > Spain eSIM | Roaming toggle |
...
- **"Roaming uses more battery"** — The effect is negligible with modern radios and strong signal. The battery impact is primarily from maintaining two SIM connections, not from the roaming flag itself.
- **"Roaming is less secure"** — Data is encrypted end-to-end regardless of roaming status. The eSIM connection uses the same encryption standards as a physical SIM.
...
- Data-dependent features (maps, messaging, calls) fail
- The home SIM may still function for voice and SMS
...
3. Set network selection to "Automatic" for the Spain eSIM
4. Verify 4G/5G is selected as preferred network type
5. Confirm the APN setting is correct for your provider
...
3. Go to Network Selection > turn OFF Automatic > manually select "Orange ES" or "Movistar ES" > wait for registration > turn Automatic back ON
4. Reset network settings (iPhone: Settings > General > Transfer or Reset iPhone > Reset > Reset Network Settings)
5. Contact your eSIM provider's support team for carrier-specific configuration

---

## Activation Timing: When Your Spain eSIM Starts Working
...
- Install the eSIM at home before departure
- The eSIM sits dormant until you land in Spain
- Activation occurs when your phone pings a Spanish carrier tower
- Plan validity counts from the actual first connection
- The eSIM profile remains on your phone but in an inactive state
...
- The validity clock starts even if you are still in your home country
- You must scan the QR code when you are ready to use the eSIM
...
- Choose the exact date you want the plan to activate
- The eSIM remains dormant until that date regardless of location or network connection
...
3. Do not manually select a Spanish network from home country
4. Upon landing (or arriving in Spanish waters/airspace), enable data roaming and data line
5. Phone automatically registers with Spanish network
6. eSIM activates within 30 seconds to 5 minutes
...
- Airplane mode on (disable upon landing)
- Weak signal at arrival terminal (walk to area with better reception, typically near windows or exit doors)
- Provider activation delay (some eSIMs take up to 30 minutes to fully activate)
...
- Avoid buying plans with fewer days than your trip
- Some providers allow early top-up that resets validity from the top-up date
...
- **Short layover in Spain:** eSIM may activate during brief network connection; contact provider about pausing or refunding if you are not staying
- **Ferry arrival:** eSIM activates when phone connects to Spanish coastal network, usually 30-60 minutes before docking
...
1. **Check status bar** for carrier name and signal strength
   ...
   - Signal bars should show 2+ bars in urban areas
2. **Confirm 4G or 5G icon** is visible
   - "E" or "G" indicates slow 2G/3G fallback — check APN settings if you see these
3. **Open Safari/Chrome** and load a webpage
   - Any webpage loading confirms basic connectivity
4. **Test speed** with fast.com or speedtest.net
   - Minimum expected: 5 Mbps down on 4G, 20 Mbps on 5G
5. **Send a WhatsApp message** or iMessage
   - Tests messaging over data connection
6. **Open Google Maps** and search for a location
   - Confirms real-time data and GPS integration
7. **Make a FaceTime or WhatsApp call**
   - Tests sustained data connection stability
8. **Send a photo via messaging app**
   - Tests upload speed and MMS capabilities
...
|---|---|---|
| No carrier name showing | Roaming off or airplane mode on | Enable roaming, disable airplane mode |
| "E" or "G" only | APN incorrect or network congestion | Check APN settings, move location |
| Connected but no data | APN not configured | Enter provider APN settings |
| Very slow speeds | Congestion or deprioritization | Move to different area, try off-peak hours |
| Data drops after 5 minutes | Carrier profile issue | Contact provider support |
| eSIM not in settings | Installation incomplete | Re-scan QR code or contact support |
...
1. Note the current carrier name in the status bar
2. Walk to a different area (indoor/outdoor, different district or building)
3. Check if carrier name changes within 5-10 minutes
4. Manually go to Network Selection, disable Automatic, and select a different carrier — if data continues working, your plan supports multi-network roaming
...
For a comprehensive coverage analysis comparing all four Spanish networks across cities, train routes, beaches, and islands, see our [Spain eSIM coverage guide](/blog/spain-esim-coverage-cities-ave-beaches-islands/).
...
2. Select "Phone Information" or "Device Information"
3. Look at "Mobile Network Type" — should show LTE, NR (5G), or similar
4. Check "Signal Strength" — values above -110 dBm are good; above -90 dBm are excellent
5. View "Registered Network" — confirms which Spanish carrier you are connected to
6. Tap "Run ping test" to check latency and packet loss
...
3. **Verify APN settings** are correct for your provider
4. **Re-enable data roaming** specifically for the eSIM line
5. **Check that the eSIM profile** shows "Connected" or "Active" status in Settings
6. **Delete and reinstall** the eSIM profile if all else fails — use the saved QR code backup
...
- [ ] Research Spain eSIM providers and compare pricing across at least 3 providers
- [ ] Read provider reviews specific to Spain, particularly for network performance in the regions you plan to visit
- [ ] Check if your home carrier offers better roaming rates for short trips (sometimes cheaper for 1-3 day trips)
- [ ] Verify that your phone's iOS or Android version supports eSIM (iOS 12.1+, Android 10+)
...
- [ ] Save backup copy of QR code in a secure cloud location (Google Drive, iCloud, Dropbox)
- [ ] Print QR code as paper backup (phone screen damage or loss contingency)
- [ ] Install eSIM profile in phone settings
- [ ] Configure data roaming to ON for eSIM line
- [ ] Set eSIM as default data line
- [ ] Set home SIM as default for voice and SMS
- [ ] Verify APN settings are correct (auto or manual)
- [ ] Disable data roaming on home SIM to prevent charges
- [ ] Test that iMessage/FaceTime/WhatsApp registration is complete on your home number
- [ ] Take a screenshot of your provider's support contact information
...
- [ ] Install airline apps for mobile boarding passes
- [ ] Save hotel address and reservation details offline
- [ ] Download Uber/Cabify/Freenow apps for ride-hailing
- [ ] Save provider customer support contact (app, website, WhatsApp)
- [ ] Share eSIM plan details and provider contact with travel companion
- [ ] Charge power bank fully
- [ ] Download offline translation pack for Spanish (Google Translate)
- [ ] Download TripAdvisor or similar travel apps with offline city guides
- [ ] Set up a digital wallet (Apple Pay/Google Pay) as backup payment — works wherever contactless is accepted in Spain
...
- [ ] Check carrier name and 4G/5G indicator in status bar
- [ ] Open browser and confirm data works
- [ ] Send a test WhatsApp message
- [ ] Open Google Maps to confirm navigation works
- [ ] If data does not work, toggle roaming OFF and ON again
- [ ] If still not working, restart phone
- [ ] If persistent issues, contact provider support immediately — WhatsApp is usually fastest
...
- Setting the eSIM as default voice line and accidentally making expensive calls home
- Purchasing a plan with insufficient validity days for the trip duration — always add 2-3 buffer days
- Using a US-locked phone that cannot accept foreign eSIMs — check carrier lock status before buying
- Accidentally deleting the eSIM profile when cleaning up old plans in Settings
...
1. **Download offline maps** for every city you plan to visit — Google Maps allows downloading large regional areas
2. **Save screenshots** of hotel addresses, reservation numbers, and emergency contacts
3. **Carry a backup eSIM code** — print a second QR code copy and store it separately from your phone
4. **Know airport WiFi SSIDs** — for example, Madrid-Barajas offers "Aena WiFi" with no SMS verification required
5. **Keep a small amount of cash** (EUR 50-100) for taxis or buses if maps/data fail at arrival
6. **Share your itinerary** with someone back home who can contact provider support on your behalf if needed
7. **Test data before leaving the airport** — most airport terminals have strong signal, but if it does not work there, it likely needs troubleshooting before you head into the city

---

## Frequently Asked Questions About Spain eSIM Setup

### Why is my Spain eSIM not working after I arrive?

The most common cause is Data Roaming being turned OFF. Go to Settings > Cellular/Mobile Data > select your Spain eSIM > toggle Data Roaming ON. Then toggle Airplane Mode ON and OFF to force re-registration on the network. If that does not work, try manual network selection — turn OFF Automatic and try Movistar, Orange, Vodafone, and Yoigo one at a time.

### How do I know if my phone supports Spain eSIM?
...
Set your home SIM as the default for voice and SMS, and set the Spain eSIM as the default for data. On iPhone: Settings > Cellular > Default Voice Line (home SIM) > Cellular Data (Spain eSIM). On Samsung: Settings > Connections > SIM Card Manager > Preferred SIMs. This keeps your home number active for calls and 2FA while using Spanish data. See our [Spain eSIM dual SIM setup guide](/blog/spain-esim-dual-sim-guide/) for complete instructions.

### How long does it take for a Spain eSIM to activate?

Most network-activated eSIMs activate within 30 seconds to 5 minutes of connecting to a Spanish network. If you installed the eSIM before departure, it activates automatically upon landing when your phone registers with Movistar, Orange, Vodafone, or Yoigo. QR-scan-activated eSIMs activate immediately upon scanning the QR code.

### What should I do if my Spain eSIM says "No Service"?

First, ensure Data Roaming is ON for the eSIM line. Then try manual network selection: Settings > Cellular/Mobile Data > Network Selection > turn OFF Automatic > select Movistar, Orange, Vodafone, or Yoigo manually. If still no service, restart your phone and wait 2-3 minutes. Contact your provider's support if the issue persists.

### Can I use a Spain eSIM on an Android phone?

Yes, Spain eSIMs work on Samsung Galaxy S20 and newer, Google Pixel 3 and newer, and many other Android devices from 2020 onward. For Spain eSIM Android setup, the process varies slightly by manufacturer but follows the same basic steps: Settings > Connections/SIM Manager > Add eSIM > scan QR code. Check your specific device model's compatibility before purchasing.
...
For troubleshooting issues after setup, see our [Spain eSIM troubleshooting guide](/blog/spain-esim-troubleshooting-fix-guide/).
