...
modal:
  ...
  text_android: Our eSIM service has been upgraded to <strong>PhoneSIM</strong>.<br>New
    customers enjoy a 20% discount, promo code:web20
seo:
  title: "Guam eSIM | Fast 5G Island-Wide"
  description: "Stay connected in Guam with Roami eSIM. Fast 5G across the island. Instant QR activation. Unlimited data for your stay."
...
hero:
  ...
  subtitle: Instant delivery | Hotspot supported | Travel with ease – The best prepaid
    eSIM for Guam travelers
features:
  title: Why Travelers Choose Roami for Guam eSIM
  items:
  - icon: zap
...
network_coverage:
  ...
  carriers:
    ...
    - name: GTA
      ...
      network: 5G/4G/LTE Network
reminders:
  title: Important reminders when using Guam eSIM
  items:
  - icon: 📱
