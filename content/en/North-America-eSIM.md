...
seo:
  ...
  description: "Cross North America with one Roami eSIM. 5G in USA, Canada & Mexico. No roaming at borders. Instant activation."
...
hero:
  ...
  subtitle: Travel with ease | Smooth video streaming | Travel essential – The best
    prepaid eSIM for North America travelers
features:
  title: Why Travelers Choose Roami for North America eSIM
  items:
  - icon: zap
...
plans_data:
  ...
  - spec: 10GB
    ...
    daily: '3.43'
discount_banner:
  title: Special Discount on North America eSIM Plans
  desc_html: Use promo code <span class="font-mono bg-white text-blue-600 px-2 py-0.5
    ...
    your order! Get the cheapest eSIM plan North America for your trip.
...
network_coverage:
  ...
  carriers:
    ...
    - name: Rogers
      ...
      network: 5G/4G/LTE Network
reminders:
  title: Important reminders when using North America eSIM
  items:
  - icon: 📱
  ...
  - id: faq-business
    ...
    - q: How to update travel itineraries online at any time to communicate with the
      ...
      a: You can access your corporate travel portals or email your HR department
        ...
        schedule changes.
related_products:
  title: Related North America eSIM Plans
  items:
