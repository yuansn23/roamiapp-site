...
modal:
  ...
  text_android: Our eSIM service has been upgraded to <strong>PhoneSIM</strong>.<br>New
    customers enjoy a 20% discount, promo code:web20
seo:
  title: "Dominican Republic eSIM | Fast 5G, Unlimited Data"
  description: "Escape to the DR with Roami eSIM. Fast 5G in Punta Cana, Santo Domingo & nationwide. Instant activation. Unlimited data."
...
hero:
  ...
  subtitle: Automatic network selection | Bestseller | 100% money-back guarantee –
    The best prepaid eSIM for Dominican Republic travelers
features:
  title: Why Travelers Choose Roami for Dominican Republic eSIM
  items:
  - icon: zap
...
network_coverage:
  ...
  carriers:
    ...
    - name: Viva
      ...
      network: 5G/4G/LTE Network
reminders:
  title: Important reminders when using Dominican Republic eSIM
  items:
  - icon: 📱
