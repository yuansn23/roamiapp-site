...
country_meta:
  ...
  scenario_keywords: Dublin sightseeing, Wild Atlantic Way road trip, Ring of Kerry drive, Cliffs of Moher visit, Galway city
    break
...
features:
  ...
  - icon: zap
    ...
    desc: Get your Ireland eSIM QR code via email in 5 minutes
  - icon: headset
    color: from-emerald-400 to-emerald-600
    title: 24/7 Support
    desc: 24/7 support for your Ireland trip - real humans, not bots
  - icon: shield-check
    color: from-amber-400 to-amber-600
    title: Not Available
    desc: 100% refund if your Ireland eSIM doesn't activate
  - icon: wifi
    color: from-purple-400 to-purple-600
    title: Hotspot Supported
    desc: Share your Ireland data with travel companions, no limits
  - icon: file-x
    color: from-rose-400 to-rose-600
    title: No Contracts
    desc: No contracts, cancel anytime - perfect for Ireland trips
  - icon: radio-tower
...
network_coverage:
  ...
  carriers:
    title: 'Vodafone, Three & Eir: Ireland eSIM Carrier Coverage'
...
activation_steps:
  ...
  - num: '3'
    ...
    desc: Upon arriving in Ireland, enable your Ireland eSIM in settings to start using data. We recommend connecting to WiFi
      during the initial activation.
    is_list: false
faq_section:
  title: "Getting Online in Ireland -- eSIM Network Quality and Speed Guide"
...
market_analysis:
  ...
  - icon: store
    ...
    prepaid_title: ''
    prepaid_desc: Three's eSIM ordering process requires an Irish mailing address; Vodafone stores require in-person activation
      and content filter removal.
    esim_title: Instant Digital Delivery
    esim_desc: Skip Vodafone store queues and Three's address requirement. Activate online within 1 minute after landing in
      Dublin.
  - icon: id-card
    title: KYC & Real-Name<br>Registration
    prepaid_title: ''
    prepaid_desc: Three requires sending a scanned copy of your passport to customer support to remove the content filter,
      which can take up to 5 days.
  ...
  - icon: globe
    ...
    prepaid_title: ''
    prepaid_desc: Vodafone X unlimited plan has an EU roaming cap of 40 GB; Three Super Surfer caps at 26 GB; eir's 50 GB
      plan drops to 27.1 GB in the EU.
    esim_title: Transparent Global Roaming
    esim_desc: Unlike eir's 50 GB plan that shrinks to 27.1 GB in the EU, Roami eSIM gives you the full data you pay for,
      no FUP caps.
  - icon: calendar-xmark
    title: Billing Cycle &<br>Sunk Cost
    prepaid_title: ''
    prepaid_desc: All major prepaid plans (Vodafone, Three, eir) have a 28-day cycle starting at €20; a 7-day tourist wastes
  ...
  - icon: wifi
    ...
    prepaid_title: ''
    prepaid_desc: 'Vodafone imposes strict tethering restrictions: using the wrong APN (hs.vodafone.com) incurs €0.19/MB charges;
      Lyca Mobile explicitly blocks hotspot sharing.'
    esim_title: Unrestricted Tethering
    esim_desc: Bypass Vodafone's APN trap (€0.19/MB) and Lyca Mobile's hotspot block. Roami allows full-speed tethering on
      all devices.
  - icon: credit-card
    title: Top-up Payments
    prepaid_title: ''
    prepaid_desc: Three's online top-up only accepts Irish and UK credit cards; international users must buy physical vouchers
      from retail stores.
  ...
  - icon: headset
    ...
    prepaid_title: ''
    prepaid_desc: Three's content filter removal requires emailing customer support with passport scan, processing time up
      to 5 days; no live chat mentioned.
  ...
  expert_verdict:
    ...
    - icon: wifi
      ...
      desc: Vodafone charges <b>€0.19/MB</b> if using the wrong APN; Lyca Mobile blocks hotspot entirely. Roami eSIM supports
        tethering with no restrictions.
    - icon: credit-card
      icon_bg: bg-emerald-100
      icon_color: text-emerald-600
      title: Pay with Any Global Card
      desc: Three's online top-up rejects non-Irish/UK cards. Roami accepts <b>Visa, Mastercard, AMEX, Apple Pay, Google Pay,
        and PayPal</b>.
    - icon: globe
