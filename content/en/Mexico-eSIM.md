...
features:
  ...
  - icon: zap
    ...
    desc: Get your Mexico eSIM QR code via email in 5 minutes
  - icon: headset
...
discount_banner:
  ...
  desc_html: Use promo code <span class="font-mono bg-white text-blue-600 px-2 py-0.5 rounded font-bold mx-1">web20</span>
    ...
    your order! Get the cheapest eSIM plan Mexico for your trip.
...
network_coverage:
  ...
  carriers:
    title: 'Telcel, AT&T & Movistar: Mexico eSIM Carrier Coverage'
