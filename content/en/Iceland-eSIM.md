...
hero:
  ...
  subtitle: Comfortable | Worry-free internet | Smooth video streaming – The best
    prepaid eSIM for Iceland travelers
features:
  title: Why Travelers Choose Roami for Iceland eSIM
  items:
  - icon: zap
...
network_coverage:
  ...
  carriers:
    ...
    - name: Telenor
      ...
      network: 5G/4G/LTE Network
reminders:
  title: Important reminders when using Iceland eSIM
  items:
  - icon: 📱
