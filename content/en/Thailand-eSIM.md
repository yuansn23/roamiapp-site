...
country_meta:
  ...
  scenario_keywords: Songkran water festival live streaming, Full Moon Party connectivity, Digital nomad remote work Bangkok, Island hopping in Krabi, Beach relaxation in Phuket, Temple sightseeing in Bangkok, Street food tour in Chiang Mai, Night market shopping
...
features:
  ...
  - icon: shield-check
    ...
    title: 100% Refund
    desc: Full refund if your Thailand eSIM doesn't activate
  - icon: wifi
  ...
  - icon: file-x
    ...
    desc: No face scan, no fingerprint, no ID — unlike Thai SIMs that require biometric KYC since 2017
  - icon: radio-tower
...
plans_data:
  ...
  - spec: 5GB
    data: High-Speed 5G/4G/LTE
    desc: Perfect for sharing street food & beach photos
    price: '4.99'
    oldPrice: '7.49'
    tag: Great Value
  ...
  - spec: 10GB
    data: High-Speed 5G/4G/LTE
    desc: Excellent for streaming & island hopping
    price: '7.99'
    oldPrice: '11.98'
    tag: Great Value
    tagColor: bg-emerald-500
...
discount_banner:
  ...
  desc_html: Use promo code <span class="font-mono bg-white text-blue-600 px-2 py-0.5 rounded font-bold mx-1">web20</span>
    ...
    your order! Get the cheapest Thailand travel eSIM with AIS & TrueMove coverage for your trip to Bangkok, Phuket or the islands.
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Coverage
      desc: Enjoy comprehensive network coverage across Thailand, including Bangkok (5G/4G), Chiang Mai (4G), Phuket (4G), Pattaya (4G), and Krabi (4G). Stay connected at the Grand Palace, Wat Arun, Phi Phi Islands, and along the Andaman coast. Your eSIM connects to AIS, TrueMove, and dtac networks — automatically switching for the best signal.
    - icon: zap
...
activation_steps:
  ...
  - num: '1'
    ...
    desc: After payment, your Thailand eSIM QR code and activation guide will be sent to your email within 5 minutes. Please check your spam folder if you don't see it.
    is_list: false
  - num: '2'
  ...
  - num: '3'
    ...
    desc: Upon arriving in Thailand, enable your Thailand eSIM in settings to start using data. We recommend connecting to WiFi during the initial activation.
    is_list: false
faq_section:
  title: "Thailand eSIM Guide: Speeds, Coverage, and Travel Tips for Thailand"
  ...
  - id: faq-general
    ...
    - q: |
      ...
      a: |
        Yes — and this is the biggest advantage over Thai local SIM cards. Since 2017, Thai law has required mandatory biometric KYC for all SIM purchases: facial scanning or fingerprint collection, with foreigner facial information matched against passport databases. AIS, TrueMove, and dtac counters at BKK airport take 30-45 minutes for this process. Roami eSIM is a data-only travel plan that bypasses this entirely. No face scan, no fingerprint, no passport copy. Just buy online, scan the QR code, and you're connected.
    - q: |
        I'm arriving in Bangkok late at night — can I still get a SIM card?
      a: |
        Usually not — and this is a huge frustration for travelers. Airport SIM counters at BKK close around 10pm-11pm. 7-Eleven and convenience stores sell SIM cards, but their registration systems close after hours — they can't activate your SIM until morning. With Roami, you buy online 24/7 and get your QR code instantly. Install before you land, enable Data Roaming, and you're online within 2 minutes of touchdown — even at 2am.
    - q: |
        Will my Thailand eSIM work in Phuket, Krabi, and the Phi Phi Islands?
      a: |
        Yes — Thailand's major tourist islands have excellent 4G coverage. In Phuket, you'll have strong signals across Patong, Kata, Karon, and the Old Town. In Krabi, coverage is reliable in Ao Nang, Railay Beach, and the town center. Phi Phi Islands have good signal around Tonsai Bay and the main village. AIS has the best island coverage, and Roami auto-connects to it. For long-tail boat trips between islands, signal may vary, but you'll reconnect upon arrival.
    - q: |
        I heard TrueMove bans hotspot sharing — does Roami have the same restriction?
      a: |
        No — and this is a major advantage of Roami. TrueMove H explicitly bans tethering on unlimited data plans through DNS detection — they can block your hotspot and even disconnect your device. dtac and AIS have similar restrictions on certain plans. Roami allows full-speed hotspot sharing on all plans, with no limits and no detection. Share with travel companions, laptops, or tablets without worry.
    - q: |
    ...
    - q: |
      ...
      a: |
        The plan validity starts when you connect to a local network in Thailand, not when you buy or install it. So you can purchase and install weeks before your trip without losing any plan days. A 7-day plan gives you 7 full days from first connection.
    - q: |
        Can I top up my Thailand eSIM if I run out of data?
      a: |
        Yes — you can top up through your Roami account at any time. Unlike Thai airport SIMs (which can't be recharged or extended), Roami gives you full flexibility to add data as needed. No need to buy a completely new SIM or visit a convenience store.
related_products:
...
market_analysis:
  ...
  - icon: headset
    ...
    prepaid_title: ''
    prepaid_desc: Customer support is primarily in Thai; English support is limited and available only during business hours.
