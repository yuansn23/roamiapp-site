...
country_meta:
  ...
  scenario_keywords: Kuwait City sightseeing, desert safari, island hopping, shopping
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Coverage
      desc: Enjoy comprehensive network coverage across Kuwait, including major cities
        like Kuwait City, Al Ahmadi, Hawalli, and Farwaniya. Our Kuwait eSIM seamlessly
        connects to the robust networks of Zain, Ooredoo, and stc, ensuring stable
...
activation_steps:
  ...
  - num: '3'
    ...
    desc: Upon arriving in Kuwait, enable your Kuwait eSIM in settings to start using
