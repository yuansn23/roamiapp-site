...
country_meta:
  ...
  scenario_keywords: visite touristique, voyage d'affaires, vacances à la plage, road
    trip, croisière
...
hero:
  ...
  title: Forfait eSIM pour Chypre
  subtitle: Streaming vidéo fluide | Accès 5G prioritaire | Activation en 1 minute
features:
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Couverture
      desc: Profitez d'une vaste couverture réseau dans tout Chypre, y compris des
        villes comme Nicosie, Limassol, Larnaca et Paphos. Notre eSIM pour Chypre
        se connecte de manière transparente aux réseaux MTN, PrimeTel et Epic.
    - icon: zap
...
activation_steps:
  title: Activez votre eSIM pour Chypre en quelques minutes
  steps:
  - num: '1'
    ...
    desc: Immédiatement après votre commande, vous recevrez un e-mail avec votre code
      ...
      donc la préparer tranquillement pour votre voyage à Chypre.
    is_list: false
  - num: '2'
    ...
    - Donnez un nom (par exemple « Roami Chypre ») et définissez-le comme **standard
  ...
  - num: '3'
    ...
    desc: Après l'installation, vous pouvez laisser l'eSIM désactivée dans les réglages.
      ...
      mobiles ne sont pas consommées). Dès que vous atterrissez à Chypre, il vous
      suffit d'activer l'eSIM – la validité commencera automatiquement lors de la
      première connexion au réseau MTN / PrimeTel. Aucun frais caché d'activation,
      aucun frais d'itinérance.
    is_list: false
  - num: '4'
    title: 'Arrivée à Chypre : connexion instantanée 5G/4G'
    desc: Dès que vous atterrissez à Chypre (par exemple dans Aéroport international
      de Larnaca, Aéroport international de Paphos, Aéroport d'Ercan), désactivez
      le mode avion (ou restez dedans et activez uniquement l'eSIM). Allez dans **Réglages
      → Réseau cellulaire** et activez votre eSIM Roami pour Chypre. En quelques secondes,
      votre appareil se connectera automatiquement au réseau 5G/4G le plus rapide
      disponible de MTN / PrimeTel. Vous pourrez immédiatement utiliser la navigation,
...
faq_section1:
  ...
  - id: faq-general
    ...
    - q: Quels réseaux 5G/4G utilise l'eSIM pour Chypre et quelle est la couverture
        ?
      a: L'eSIM pour Chypre fonctionne exclusivement avec MTN / PrimeTel. Vous obtenez
    ...
    - q: Puis-je installer l'eSIM pour Chypre avant mon voyage et l'activer plus tard
      ...
      a: Oui, vous pouvez installer l'eSIM dès maintenant (via Wi-Fi). L'activation
        se fera automatiquement lorsque votre téléphone, une fois dans Chypre, détectera
        pour la première fois le réseau MTN / PrimeTel. Ainsi, vous évitez le stress
        dès l'arrivée.
    - q: Proposez-vous une garantie de remboursement si l'eSIM pour Chypre ne fonctionne
        pas ?
    ...
    - q: Puis-je continuer à recevoir des appels sur ma carte SIM domestique tout
        en utilisant l'eSIM pour Chypre ?
    ...
    - q: Puis-je utiliser l'eSIM pour Chypre comme point d'accès pour d'autres appareils
        ?
      a: Oui, tous les forfaits Roami eSIM pour Chypre prennent en charge le partage
  ...
  - id: faq-airport
    ...
    - q: Comment obtenir un réseau fiable dès mon arrivée ?
      a: Installez l'eSIM pour Chypre avant votre départ. Dès que vous atterrissez
        dans des aéroports comme Aéroport international de Larnaca, Aéroport international
        de Paphos, Aéroport d'Ercan, désactivez simplement le mode avion et activez
    ...
    - q: Comment contacter ma prise en charge ou utiliser Uber/Grab ?
      a: Après activation à l'arrivée, vous pourrez immédiatement utiliser des applications
        comme Bolt, Uber, nTaxi pour commander un trajet, ou WhatsApp pour contacter
    ...
    - q: Comment utiliser Google/Apple Maps pour trouver les transports ?
      a: Avec les données de votre eSIM pour Chypre, vous pouvez, dès la sortie des
        bagages dans Aéroport international de Larnaca, Aéroport international de
        Paphos, Aéroport d'Ercan, consulter les horaires des trains et bus en temps
        réel ou trouver le chemin vers le parking des taxis.
    - q: Comment éviter les cartes SIM chères à l'aéroport ?
      a: En achetant notre eSIM pour Chypre à l'avance en ligne, vous contournez totalement
    ...
    - q: Comment recevoir les SMS de l'hôtel/location de voiture sans numéro local
        ?
      a: Notre eSIM pour Chypre est un forfait données uniquement. Pour recevoir des
    ...
    - q: Comment contacter immédiatement ma famille ?
      a: Dès que vous atterrissez, vous pouvez utiliser iMessage, WhatsApp ou FaceTime
        via les données rapides de notre eSIM pour Chypre pour dire à vos proches
  ...
  - id: faq-transport
    ...
    - q: Comment utiliser Google Maps pour planifier mon itinéraire ?
      a: Notre connexion eSIM stable pour Chypre garantit que Google Maps peut charger
        les données de trafic et les horaires en temps réel partout dans Chypre.
    - q: Comment les chauffeurs Uber/Grab peuvent-ils me contacter via l'application
        ?
      a: Les applications comme Bolt, Uber, nTaxi utilisent la VoIP. Comme vos données
        eSIM pour Chypre sont actives, les chauffeurs peuvent vous appeler via l'application
        ou envoyer des notifications sans numéro local.
    - q: Comment acheter des billets de train ou de métro en ligne ?
      a: Utilisez les données de votre eSIM pour Chypre pour acheter des billets QR
    ...
    - q: Comment utiliser Google Maps pour la navigation en temps réel dans une voiture
        de location ?
      a: Fixez votre téléphone et utilisez l'eSIM pour Chypre. Un forfait de 5 Go
    ...
    - q: Comment scanner et déverrouiller des trottinettes électriques (Lime/Bird)
      ...
      a: Le déverrouillage des trottinettes électriques nécessite une connexion Internet
        rapide. Notre eSIM pour Chypre assure la couverture fiable nécessaire.
    ...
    - q: Comment configurer un point d'accès stable pour la famille ?
      a: Activez simplement le « Point d'accès personnel » dans les réglages. Votre
        famille pourra se connecter à votre réseau eSIM pour Chypre dans le train
        ou la voiture.
  - id: faq-hotels
    icon: hotel
    tab_title: Hôtels
    ...
    - q: Comment faire un auto-arrivée (self-check-in) après réservation ?
      a: De nombreux hébergements modernes envoient les codes de serrures connectées
        par e-mail. Votre eSIM pour Chypre garantit que vous pouvez recevoir ces détails
    ...
    - q: Comment utiliser Google Maps pour naviguer vers l'hôtel ?
      a: Que vous séjourniez dans Four Seasons Hotel à Limassol, Annabelle à Paphos,
        Hilton Park à Nicosie, entrez l'adresse dans Google Maps et utilisez la navigation
        de votre eSIM pour Chypre.
    - q: Comment recevoir les codes SMS de confirmation ?
      a: Laissez votre carte SIM domestique active pour les SMS et utilisez les données
        de l'eSIM pour Chypre pour recevoir les codes par e-mail ou via l'application
        d'authentification.
    - q: Comment contacter rapidement le support client ?
      a: Utilisez des applications VoIP comme Skype ou la fonction de chat de l'application
        de réservation via les données haut débit de votre eSIM pour Chypre.
    - q: Comment commander de la nourriture via les applications locales de livraison
        ?
      a: Téléchargez Foody, Wolt, Bolt Food et utilisez les données de votre eSIM
        pour Chypre pour commander un repas chaud directement dans le hall de l'hôtel.
    - q: Comment rester en contact avec l'hôtel après le départ (checkout) ?
      a: Une fois que vous quittez le Wi-Fi de l'hôtel, votre eSIM pour Chypre prend
  ...
  - id: faq-attractions
    ...
    - q: Comment acheter des billets électroniques via GetYourGuide/Viator ?
      a: Si vous souhaitez visiter spontanément Plage de Nissi, Tombeaux des Rois,
        Grottes marines d'Ayia Napa, vous pouvez utiliser les données de votre eSIM
        pour Chypre pour acheter des billets en ligne et afficher le code-barres directement
        sur place.
    - q: Comment réserver des expériences sur Tripadvisor instantanément ?
      a: Avec le 4G/5G fiable de votre eSIM pour Chypre, vous pouvez lire les avis
    ...
    - q: Comment trouver le chemin vers la prochaine attraction ?
      a: Entrez la prochaine destination dans Google Maps ; la couverture puissante
        de votre eSIM pour Chypre vous guidera par l'itinéraire le plus rapide.
    - q: Comment vérifier les temps d'attente en temps réel dans les parcs d'attractions
      ...
      a: Les applications des parcs d'attractions ont besoin d'Internet pour afficher
        les temps d'attente. Votre eSIM pour Chypre vous maintient en ligne dans tout
        le parc.
    - q: Comment accéder à Ticketmaster pour les billets de spectacle ?
      a: Vous pouvez acheter des billets de dernière minute en toute sécurité via
        les applications de billetterie avec les données de votre eSIM pour Chypre.
    - q: Comment partager instantanément des photos/vidéos sur Instagram/TikTok ?
      a: La vitesse de téléchargement élevée de l'eSIM pour Chypre vous permet de
  ...
  - id: faq-dining
    ...
    - q: Comment trouver des restaurants via Google Maps/Tripadvisor ?
      a: Utilisez votre eSIM pour Chypre pour rechercher des « restaurants à proximité
    ...
    - q: Comment réserver une table en ligne ?
      a: Assurez votre réservation via les plateformes en ligne en utilisant votre
        eSIM pour Chypre pendant vos déplacements.
    - q: Comment scanner les codes QR pour les menus numériques ?
      a: De nombreux restaurants utilisent des menus numériques. Votre eSIM pour Chypre
    ...
    - q: Comment utiliser l'appareil photo Google Traduction pour les menus ?
      a: Ouvrez l'application et pointez l'appareil photo vers le menu. La traduction
        en direct nécessite une connexion Internet via votre eSIM pour Chypre.
    - q: Comment utiliser les services de livraison locaux ?
      a: Téléchargez les applications locales comme Foody, Wolt, Bolt Food et commandez
        confortablement en utilisant les données mobiles de votre eSIM pour Chypre.
    - q: Comment payer avec Apple Pay/Google Pay ?
      a: Les paiements sans contact ou les méthodes locales telles que Carte bancaire
        (Visa/Mastercard), Apple Pay, Google Pay, JCC nécessitent une brève validation
        Internet que votre eSIM pour Chypre exécute parfaitement.
    - q: Comment trouver les endroits secrets recommandés par les blogueurs culinaires
      ...
      a: Regardez des vlogs YouTube ou parcourez les avis sur Yelp avec les données
        de votre eSIM pour Chypre pour découvrir des pépites culinaires.
  - id: faq-social
    icon: smartphone
    ...
    - q: Comment utiliser WhatsApp/Telegram de manière stable à l'étranger ?
      a: Vos comptes sont liés à votre numéro domestique. Avec notre eSIM pour Chypre
    ...
    - q: Comment publier du contenu sur TikTok sans Wi-Fi public ?
      a: Le Wi-Fi public est souvent lent et peu sûr. Notre 4G/5G eSIM pour Chypre
    ...
    - q: Comment passer des appels vidéo avec ma famille ?
      a: Nos partenariats réseau garantissent que les appels vidéo via l'eSIM pour
        Chypre sont clairs et sans latence, où que vous soyez dans le pays.
    - q: Est-il sûr de se connecter aux réseaux sociaux via le Wi-Fi public ?
      a: Le Wi-Fi public est vulnérable aux pirates. Utiliser vos propres données
        eSIM pour Chypre est chiffré et bien plus sûr.
    - q: Comment partager la connexion en point d'accès avec des compagnons de voyage
      ...
      a: Activez la fonction point d'accès. Vos amis pourront se connecter et utiliser
        votre trafic eSIM pour Chypre pour leurs réseaux sociaux.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ai-je besoin d'une nouvelle carte SIM pour chaque pays ?
      a: L'eSIM pour un seul pays Chypre ne fonctionne que là-bas. Pour les voyages
    ...
    - q: Comment éviter les frais d'itinérance lors d'un voyage en train traversant
      ...
      a: Désactivez l'« Itinérance des données » sur votre carte SIM domestique. Assurez-vous
        que l'eSIM pour Chypre est définie comme principale pour les données.
  ...
  - id: faq-emergency
    ...
    - q: Comment composer les numéros d'urgence locaux ?
      a: 'Dans Chypre, vous pouvez composer des numéros d''urgence tels que Police
        : 112 / 199, Ambulance : 112, Pompiers : 112 directement si votre téléphone
        capte un signal cellulaire.'
    - q: Comment trouver l'hôpital le plus proche ?
      a: Les données de votre eSIM pour Chypre vous permettent de rechercher instantanément
    ...
    - q: Comment trouver les informations de l'ambassade en cas de perte de passeport
        ?
      a: Utilisez l'eSIM pour Chypre pour trouver rapidement l'adresse et le numéro
    ...
    - q: Comment contacter mon assurance en cas d'accident ?
      a: Utilisez des applications VoIP comme Skype via les données de l'eSIM pour
        Chypre pour appeler les lignes d'assistance de votre assurance.
    - q: Comment partager ma position en temps réel ?
      a: Utilisez « Partager ma position » dans WhatsApp ou Apple « Où suis-je ? »
        pour envoyer des coordonnées via les données de l'eSIM pour Chypre.
    - q: Comment télécharger des cartes hors ligne pour les zones reculées ?
      a: En utilisant la couverture urbaine de l'eSIM pour Chypre, téléchargez des
  ...
  - id: faq-business
    ...
    - q: Comment garantir des réunions stables sur Zoom/Teams ?
      a: Notre eSIM pour Chypre se connecte à des réseaux premium, fournissant la
    ...
    - q: Comment utiliser le point d'accès pour mon ordinateur portable dans un café
        ?
      a: Activez le point d'accès. Utiliser votre eSIM pour Chypre est nettement plus
...
market_analysis:
  ...
  table_rows:
    - icon: "store"
      ...
      prepaid_title: ""
      prepaid_desc: "Aucune donnée spécifique dans la source pour cette dimension. Toutefois, selon les connaissances du marché, les cartes SIM prépayées à Chypre peuvent être achetées dans les boutiques des opérateurs, les kiosques d'aéroport ou les magasins de détail, avec un processus d'activation pouvant prendre de 10 à 30 minutes."
      esim_title: "Activation instantanée en ligne"
      esim_desc: "Contrairement aux cartes SIM physiques qui nécessitent de se rendre en magasin et de passer par un processus d'enregistrement fastidieux (scanner le passeport, selfie), l'eSIM Roami s'active en ligne en moins d'une minute, dès l'atterrissage à Larnaca ou Paphos."
    - icon: "id-card"
      title: "KYC et enregistrement<br>par passeport"
      prepaid_title: ""
      prepaid_desc: "Selon la nouvelle loi de 2024, toutes les cartes SIM (y compris prépayées) doivent être enregistrées avant le 10 novembre 2025, sous peine d'annulation. Cyta exige la numérisation du passeport et une selfie pour la vérification faciale."
      esim_title: "Aucun enregistrement de passeport"
      esim_desc: "Fini les formalités obligatoires de KYC : avec Roami eSIM, pas besoin de fournir son passeport ni de se soumettre à une vérification faciale comme l'exige Cyta depuis 2024. Une liberté totale dès l'arrivée."
    - icon: "globe"
      title: "Itinérance<br>internationale"
      prepaid_title: ""
      prepaid_desc: "Cyta facture 0,20 €/MB (soit environ 200 €/GB) pour l'itinérance en Chypre du Nord, tandis que Telsim Vodafone facture 0,16 ₺/MB (environ 5 €/GB) pour l'itinérance en Chypre du Sud."
      esim_title: "Itinérance mondiale transparente"
      esim_desc: "Évitez les frais d'itinérance exorbitants de Cyta (0,20 €/MB en Chypre du Nord) ou de Telsim (0,16 ₺/MB en Chypre du Sud). Roami propose des forfaits couvrant l'ensemble de l'île et l'UE, sans surprise."
    - icon: "calendar-xmark"
      title: "Cycle de facturation et<br>coûts perdus"
      prepaid_title: ""
      prepaid_desc: "Les forfaits prépayés de Cyta (soeasy Plus) ont un cycle de 30 jours : 10 € pour 20 Go, 20 € pour 50 Go, 35 € pour 100 Go. Un touriste séjournant 3 jours perdrait plus de 90 % de la valeur du forfait."
      esim_title: "Forfaits flexibles sans perte"
      esim_desc: "Contrairement au cycle de 30 jours de Cyta (10 €/20 Go) qui gaspille plus de 90 % de la valeur pour un court séjour, Roami propose des forfaits de 7 jours à partir de 1,99 $/Go, adaptés à la durée réelle du voyage."
    - icon: "wifi"
      title: "Partage de connexion et<br>politique de vitesse"
      prepaid_title: ""
      prepaid_desc: "Primetel autorise le partage de connexion mais applique une politique d'utilisation équitable (FUP) qui limite la vitesse en cas de téléchargement P2P/BT."
      esim_title: "Partage de connexion illimité"
      esim_desc: "Contrairement à Primetel qui limite le partage via FUP, Roami autorise le partage de connexion sans restriction de vitesse, idéal pour connecter plusieurs appareils en voyage."
    - icon: "credit-card"
      title: "Recharge et paiement"
      prepaid_title: ""
      prepaid_desc: "Epic facture des frais de commission élevés pour les recharges par carte de crédit internationale ; Cyta nécessite l'envoi d'un e-mail pour obtenir un code d'autorisation, un processus fastidieux."
      esim_title: "Paiement global simplifié"
      esim_desc: "Fini les frais de commission élevés d'Epic pour les cartes internationales ou le processus d'autorisation par e-mail de Cyta. Roami accepte Visa, Mastercard, AMEX, Apple Pay, Google Pay et PayPal pour une recharge instantanée."
    - icon: "headset"
      title: "Support client"
      prepaid_title: ""
      prepaid_desc: "Aucune donnée spécifique dans la source pour cette dimension. Selon les connaissances générales, le support client des opérateurs chypriotes est généralement disponible en anglais et en grec, avec des horaires limités."
      esim_title: "Support client 24/7 multilingue"
      esim_desc: "Contrairement aux horaires limités du support local, Roami offre une assistance en ligne 24h/24 et 7j/7 en anglais et français, pour une tranquillité d'esprit totale."
  ...
  expert_verdict:
    ...
    cards:
      - icon: "hourglass-empty"
        ...
        desc: "Les forfaits Cyta soeasy Plus (10 €/20 Go) et Primetel Combo (10 €/60 Go) sont verrouillés sur 30 jours. Un séjour de 3 jours gaspille plus de <b>90 %</b> du forfait. Roami propose des forfaits de 7 jours à partir de <b>1,99 $/Go</b>."
      - icon: "credit-card"
        icon_bg: "bg-emerald-100"
        icon_color: "text-emerald-600"
        title: "Paiement sans frais cachés"
        desc: "Epic facture des <b>commissions élevées</b> sur les recharges par carte internationale ; Cyta nécessite un e-mail pour obtenir un code d'autorisation. Roami accepte Visa, Mastercard, AMEX, Apple Pay, Google Pay et PayPal sans frais."
      - icon: "wifi"
        icon_bg: "bg-purple-100"
        icon_color: "text-purple-600"
        title: "Partage de connexion sans restriction"
        desc: "Primetel applique une <b>FUP</b> limitant le partage de connexion (P2P/BT). Roami autorise le partage illimité à pleine vitesse, idéal pour les voyageurs en groupe."
      - icon: "clock"
        icon_bg: "bg-teal-100"
