...
country_meta:
  ...
  scenario_keywords: voyage d'affaires, safari, plage, visites culturelles, expédition
    nature
...
hero:
  ...
  title: Forfait eSIM pour Congo
  subtitle: Support 24h/24 | Partage de connexion autorisé | Aucune pièce d'identité
    requise
features:
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Couverture
      desc: Profitez d'une vaste couverture réseau dans tout Congo, y compris des
        villes comme Brazzaville, Pointe-Noire, Dolisie, Nkayi. Notre eSIM pour Congo
        se connecte de manière transparente aux réseaux Airtel Congo, MTN Congo, Congo
        Telecom.
    - icon: zap
...
activation_steps:
  title: Activez votre eSIM pour Congo en quelques minutes
  steps:
  - num: '1'
    ...
    desc: Immédiatement après votre commande, vous recevrez un e-mail avec votre code
      ...
      donc la préparer tranquillement pour votre voyage à Congo.
    is_list: false
  - num: '2'
    ...
    - Donnez un nom (par exemple « Roami Congo ») et définissez-le comme **standard
  ...
  - num: '3'
    ...
    desc: Après l'installation, vous pouvez laisser l'eSIM désactivée dans les réglages.
      ...
      mobiles ne sont pas consommées). Dès que vous atterrissez à Congo, il vous suffit
      d'activer l'eSIM – la validité commencera automatiquement lors de la première
      connexion au réseau Airtel Congo / MTN Congo. Aucun frais caché d'activation,
      aucun frais d'itinérance.
    is_list: false
  - num: '4'
    title: 'Arrivée à Congo : connexion instantanée 5G/4G'
    desc: Dès que vous atterrissez à Congo (par exemple dans Aéroport international
      Maya-Maya (Brazzaville), Aéroport international Agostinho-Neto (Pointe-Noire),
      Aéroport de Dolisie), désactivez le mode avion (ou restez dedans et activez
      uniquement l'eSIM). Allez dans **Réglages → Réseau cellulaire** et activez votre
      eSIM Roami pour Congo. En quelques secondes, votre appareil se connectera automatiquement
      au réseau 5G/4G le plus rapide disponible de Airtel Congo / MTN Congo. Vous
    ...
    is_list: false
faq_section:
  title: 'eSIM Congo : Foire aux questions et guide de voyage'
  desc: Tout ce que vous devez savoir sur l'utilisation de votre eSIM pour Congo dans
  ...
  - id: faq-general
    ...
    questions:
    - q: Proposez-vous une garantie de remboursement si l'eSIM pour Congo ne fonctionne
        pas ?
    ...
    - q: Mon smartphone prend-il en charge l'eSIM pour Congo et comment l'installer
      ...
      a: Oui, la plupart des smartphones modernes (iPhone XS/XR ou plus récent, Samsung
        ...
        l'eSIM pour Congo en scannant le code QR dans les réglages mobiles. Les réseaux
        Airtel Congo / MTN Congo offrent une excellente couverture 5G/4G dans Congo.
    - q: Puis-je continuer à recevoir des appels sur ma carte SIM domestique tout
        en utilisant l'eSIM pour Congo ?
    ...
    - q: L'eSIM pour Congo prend-elle en charge VoLTE et les appels vocaux HD ?
      a: Oui, l'eSIM pour Congo prend en charge VoLTE et la voix HD si votre appareil
        le permet. Profitez d'une qualité d'appel cristalline via le réseau 5G/4G
        de Airtel Congo / MTN Congo.
    - q: Roami propose-t-il des eSIM régionales pour les voyages hors de Congo ?
      a: Oui, en plus de l'eSIM pour Congo, nous proposons des eSIM régionales pour
        ...
        de carte SIM.
    - q: Comment fonctionne l'itinérance internationale avec l'eSIM pour Congo dans
        les pays voisins ?
      a: L'eSIM pour Congo est principalement optimisée pour Congo. Pour les voyages
    ...
    - q: Quels réseaux 5G/4G utilise l'eSIM pour Congo et quelle est la couverture
        ?
      a: L'eSIM pour Congo fonctionne exclusivement avec Airtel Congo / MTN Congo.
  ...
  - id: faq-airport
    ...
    - q: Comment obtenir un réseau fiable dès mon arrivée ?
      a: Installez l'eSIM pour Congo avant votre départ. Dès que vous atterrissez
        dans des aéroports comme Aéroport international Maya-Maya (Brazzaville), Aéroport
        international Agostinho-Neto (Pointe-Noire), Aéroport de Dolisie, désactivez
    ...
    - q: Comment contacter ma prise en charge ou utiliser Uber/Grab ?
      a: Après activation à l'arrivée, vous pourrez immédiatement utiliser des applications
        comme Yango, Gozem, VTC-Congo pour commander un trajet, ou WhatsApp pour contacter
    ...
    - q: Comment utiliser Google/Apple Maps pour trouver les transports ?
      a: Avec les données de votre eSIM pour Congo, vous pouvez, dès la sortie des
        bagages dans Aéroport international Maya-Maya (Brazzaville), Aéroport international
        Agostinho-Neto (Pointe-Noire), Aéroport de Dolisie, consulter les horaires
    ...
    - q: Comment éviter les cartes SIM chères à l'aéroport ?
      a: En achetant notre eSIM pour Congo à l'avance en ligne, vous contournez totalement
    ...
    - q: Comment recevoir les SMS de l'hôtel/location de voiture sans numéro local
        ?
      a: Notre eSIM pour Congo est un forfait données uniquement. Pour recevoir des
    ...
    - q: Comment contacter immédiatement ma famille ?
      a: Dès que vous atterrissez, vous pouvez utiliser iMessage, WhatsApp ou FaceTime
        via les données rapides de notre eSIM pour Congo pour dire à vos proches que
  ...
  - id: faq-transport
    ...
    - q: Comment utiliser Google Maps pour planifier mon itinéraire ?
      a: Notre connexion eSIM stable pour Congo garantit que Google Maps peut charger
        les données de trafic et les horaires en temps réel partout dans Congo.
    - q: Comment les chauffeurs Uber/Grab peuvent-ils me contacter via l'application
        ?
      a: Les applications comme Yango, Gozem, VTC-Congo utilisent la VoIP. Comme vos
        données eSIM pour Congo sont actives, les chauffeurs peuvent vous appeler
    ...
    - q: Comment acheter des billets de train ou de métro en ligne ?
      a: Utilisez les données de votre eSIM pour Congo pour acheter des billets QR
    ...
    - q: Comment utiliser Google Maps pour la navigation en temps réel dans une voiture
        de location ?
      a: Fixez votre téléphone et utilisez l'eSIM pour Congo. Un forfait de 5 Go ou
    ...
    - q: Comment scanner et déverrouiller des trottinettes électriques (Lime/Bird)
      ...
      a: Le déverrouillage des trottinettes électriques nécessite une connexion Internet
        rapide. Notre eSIM pour Congo assure la couverture fiable nécessaire.
    ...
    - q: Comment configurer un point d'accès stable pour la famille ?
      a: Activez simplement le « Point d'accès personnel » dans les réglages. Votre
        famille pourra se connecter à votre réseau eSIM pour Congo dans le train ou
        la voiture.
  - id: faq-hotels
    icon: hotel
    tab_title: Hôtels
    ...
    - q: Comment faire un auto-arrivée (self-check-in) après réservation ?
      a: De nombreux hébergements modernes envoient les codes de serrures connectées
        par e-mail. Votre eSIM pour Congo garantit que vous pouvez recevoir ces détails
    ...
    - q: Comment utiliser Google Maps pour naviguer vers l'hôtel ?
      a: Que vous séjourniez dans Radisson Blu M'Bamou Palace Hotel (Brazzaville),
        Les Jardins de l'Océan (Pointe-Noire), Hôtel Pefaco (Brazzaville), entrez
        l'adresse dans Google Maps et utilisez la navigation de votre eSIM pour Congo.
    - q: Comment recevoir les codes SMS de confirmation ?
      a: Laissez votre carte SIM domestique active pour les SMS et utilisez les données
        de l'eSIM pour Congo pour recevoir les codes par e-mail ou via l'application
        d'authentification.
    - q: Comment contacter rapidement le support client ?
      a: Utilisez des applications VoIP comme Skype ou la fonction de chat de l'application
        de réservation via les données haut débit de votre eSIM pour Congo.
    - q: Comment commander de la nourriture via les applications locales de livraison
      ...
      a: Téléchargez Yummy, Glovo, Jumia Food et utilisez les données de votre eSIM
        pour Congo pour commander un repas chaud directement dans le hall de l'hôtel.
    - q: Comment rester en contact avec l'hôtel après le départ (checkout) ?
      a: Une fois que vous quittez le Wi-Fi de l'hôtel, votre eSIM pour Congo prend
  ...
  - id: faq-attractions
    ...
    - q: Comment acheter des billets électroniques via GetYourGuide/Viator ?
      a: Si vous souhaitez visiter spontanément Fleuve Congo, Chutes de Livingstone,
        Parc national d'Odzala-Kokoua, vous pouvez utiliser les données de votre eSIM
        pour Congo pour acheter des billets en ligne et afficher le code-barres directement
        sur place.
    - q: Comment réserver des expériences sur Tripadvisor instantanément ?
      a: Avec le 4G/5G fiable de votre eSIM pour Congo, vous pouvez lire les avis
    ...
    - q: Comment trouver le chemin vers la prochaine attraction ?
      a: Entrez la prochaine destination dans Google Maps ; la couverture puissante
        de votre eSIM pour Congo vous guidera par l'itinéraire le plus rapide.
    - q: Comment vérifier les temps d'attente en temps réel dans les parcs d'attractions
      ...
      a: Les applications des parcs d'attractions ont besoin d'Internet pour afficher
        les temps d'attente. Votre eSIM pour Congo vous maintient en ligne dans tout
        le parc.
    - q: Comment accéder à Ticketmaster pour les billets de spectacle ?
      a: Vous pouvez acheter des billets de dernière minute en toute sécurité via
        les applications de billetterie avec les données de votre eSIM pour Congo.
    - q: Comment partager instantanément des photos/vidéos sur Instagram/TikTok ?
      a: La vitesse de téléchargement élevée de l'eSIM pour Congo vous permet de publier
  ...
  - id: faq-dining
    ...
    - q: Comment trouver des restaurants via Google Maps/Tripadvisor ?
      a: Utilisez votre eSIM pour Congo pour rechercher des « restaurants à proximité
    ...
    - q: Comment réserver une table en ligne ?
      a: Assurez votre réservation via les plateformes en ligne en utilisant votre
        eSIM pour Congo pendant vos déplacements.
    - q: Comment scanner les codes QR pour les menus numériques ?
      a: De nombreux restaurants utilisent des menus numériques. Votre eSIM pour Congo
    ...
    - q: Comment utiliser l'appareil photo Google Traduction pour les menus ?
      a: Ouvrez l'application et pointez l'appareil photo vers le menu. La traduction
        en direct nécessite une connexion Internet via votre eSIM pour Congo.
    - q: Comment utiliser les services de livraison locaux ?
      a: Téléchargez les applications locales comme Yummy, Glovo, Jumia Food et commandez
        confortablement en utilisant les données mobiles de votre eSIM pour Congo.
    - q: Comment payer avec Apple Pay/Google Pay ?
      a: Les paiements sans contact ou les méthodes locales telles que Mobile Money
        (Airtel Money, MTN Mobile Money), Visa, Mastercard nécessitent une brève validation
        Internet que votre eSIM pour Congo exécute parfaitement.
    - q: Comment trouver les endroits secrets recommandés par les blogueurs culinaires
      ...
      a: Regardez des vlogs YouTube ou parcourez les avis sur Yelp avec les données
        de votre eSIM pour Congo pour découvrir des pépites culinaires.
  - id: faq-social
    icon: smartphone
    ...
    - q: Comment utiliser WhatsApp/Telegram de manière stable à l'étranger ?
      a: Vos comptes sont liés à votre numéro domestique. Avec notre eSIM pour Congo
    ...
    - q: Comment publier du contenu sur TikTok sans Wi-Fi public ?
      a: Le Wi-Fi public est souvent lent et peu sûr. Notre 4G/5G eSIM pour Congo
    ...
    - q: Comment passer des appels vidéo avec ma famille ?
      a: Nos partenariats réseau garantissent que les appels vidéo via l'eSIM pour
        Congo sont clairs et sans latence, où que vous soyez dans le pays.
    - q: Est-il sûr de se connecter aux réseaux sociaux via le Wi-Fi public ?
      a: Le Wi-Fi public est vulnérable aux pirates. Utiliser vos propres données
        eSIM pour Congo est chiffré et bien plus sûr.
    - q: Comment partager la connexion en point d'accès avec des compagnons de voyage
      ...
      a: Activez la fonction point d'accès. Vos amis pourront se connecter et utiliser
        votre trafic eSIM pour Congo pour leurs réseaux sociaux.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ai-je besoin d'une nouvelle carte SIM pour chaque pays ?
      a: L'eSIM pour un seul pays Congo ne fonctionne que là-bas. Pour les voyages
    ...
    - q: Comment éviter les frais d'itinérance lors d'un voyage en train traversant
      ...
      a: Désactivez l'« Itinérance des données » sur votre carte SIM domestique. Assurez-vous
        que l'eSIM pour Congo est définie comme principale pour les données.
  ...
  - id: faq-emergency
    ...
    - q: Comment composer les numéros d'urgence locaux ?
      a: 'Dans Congo, vous pouvez composer des numéros d''urgence tels que Police
        : 117, Pompiers : 118, SAMU : 151 directement si votre téléphone capte un
        signal cellulaire.'
    - q: Comment trouver l'hôpital le plus proche ?
      a: Les données de votre eSIM pour Congo vous permettent de rechercher instantanément
    ...
    - q: Comment trouver les informations de l'ambassade en cas de perte de passeport
        ?
      a: Utilisez l'eSIM pour Congo pour trouver rapidement l'adresse et le numéro
    ...
    - q: Comment contacter mon assurance en cas d'accident ?
      a: Utilisez des applications VoIP comme Skype via les données de l'eSIM pour
        Congo pour appeler les lignes d'assistance de votre assurance.
    - q: Comment partager ma position en temps réel ?
      a: Utilisez « Partager ma position » dans WhatsApp ou Apple « Où suis-je ? »
        pour envoyer des coordonnées via les données de l'eSIM pour Congo.
    - q: Comment télécharger des cartes hors ligne pour les zones reculées ?
      a: En utilisant la couverture urbaine de l'eSIM pour Congo, téléchargez des
  ...
  - id: faq-business
    ...
    - q: Comment garantir des réunions stables sur Zoom/Teams ?
      a: Notre eSIM pour Congo se connecte à des réseaux premium, fournissant la bande
    ...
    - q: Comment utiliser le point d'accès pour mon ordinateur portable dans un café
        ?
      a: Activez le point d'accès. Utiliser votre eSIM pour Congo est nettement plus
