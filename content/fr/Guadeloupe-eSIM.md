...
country_meta:
  ...
  scenario_keywords: Vacances à la plage, randonnée en forêt tropicale, découverte
    culturelle, voyage d'affaires, croisière
...
hero:
  ...
  title: Forfait eSIM pour Guadeloupe
  subtitle: 20% de réduction durée limitée | Réseau haut débit 5G | Aucune pièce d'identité
    requise
features:
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Couverture
      desc: Profitez d'une vaste couverture réseau dans tout Guadeloupe, y compris
        des villes comme Basse-Terre, Pointe-à-Pitre, Les Abymes, Le Gosier. Notre
        eSIM pour Guadeloupe se connecte de manière transparente aux réseaux Orange
        Caraïbe, SFR Caraïbe, et Digicel.
    - icon: zap
...
activation_steps:
  title: Activez votre eSIM pour Guadeloupe en quelques minutes
  steps:
  - num: '1'
    ...
    desc: Immédiatement après votre commande, vous recevrez un e-mail avec votre code
      ...
      donc la préparer tranquillement pour votre voyage à Guadeloupe.
    is_list: false
  - num: '2'
    ...
    - Le profil eSIM pour Guadeloupe se téléchargera automatiquement – appuyez sur
      **"Suivant"**
    - Donnez un nom (par exemple « Roami Guadeloupe ») et définissez-le comme **standard
  ...
  - num: '3'
    ...
    desc: Après l'installation, vous pouvez laisser l'eSIM désactivée dans les réglages.
      ...
      mobiles ne sont pas consommées). Dès que vous atterrissez à Guadeloupe, il vous
      suffit d'activer l'eSIM – la validité commencera automatiquement lors de la
      première connexion au réseau Orange Caraïbe / SFR Caraïbe. Aucun frais caché
      d'activation, aucun frais d'itinérance.
    is_list: false
  - num: '4'
    title: 'Arrivée à Guadeloupe : connexion instantanée 5G/4G'
    desc: Dès que vous atterrissez à Guadeloupe (par exemple dans Aéroport Guadeloupe
      Pôle Caraïbes (PTP), Aéroport de Grand-Bourg (Marie-Galante), Aéroport de Saint-François),
      désactivez le mode avion (ou restez dedans et activez uniquement l'eSIM). Allez
      dans **Réglages → Réseau cellulaire** et activez votre eSIM Roami pour Guadeloupe.
      En quelques secondes, votre appareil se connectera automatiquement au réseau
      5G/4G le plus rapide disponible de Orange Caraïbe / SFR Caraïbe. Vous pourrez
    ...
    is_list: false
faq_section1:
  title: 'eSIM Guadeloupe : Foire aux questions et guide de voyage'
  desc: Tout ce que vous devez savoir sur l'utilisation de votre eSIM pour Guadeloupe
  ...
  - id: faq-general
    ...
    questions:
    - q: Puis-je utiliser l'eSIM pour Guadeloupe comme point d'accès pour d'autres
        appareils ?
      a: Oui, tous les forfaits Roami eSIM pour Guadeloupe prennent en charge le partage
    ...
    - q: Puis-je installer l'eSIM pour Guadeloupe avant mon voyage et l'activer plus
        tard ?
      a: Oui, vous pouvez installer l'eSIM dès maintenant (via Wi-Fi). L'activation
        se fera automatiquement lorsque votre téléphone, une fois dans Guadeloupe,
        détectera pour la première fois le réseau Orange Caraïbe / SFR Caraïbe. Ainsi,
        vous évitez le stress dès l'arrivée.
    - q: Comment fonctionne l'itinérance internationale avec l'eSIM pour Guadeloupe
        dans les pays voisins ?
      a: L'eSIM pour Guadeloupe est principalement optimisée pour Guadeloupe. Pour
    ...
    - q: Comment activer l'eSIM pour Guadeloupe et quand commence la période de validité
      ...
      a: Après l'achat, vous recevez immédiatement un code QR d'activation par e-mail.
        ...
        première fois à l'un de nos réseaux partenaires (Orange Caraïbe / SFR Caraïbe)
        dans Guadeloupe. Ainsi, vous ne payez que pour les jours où vous êtes réellement
        dans le pays.
    - q: Combien coûte l'eSIM pour Guadeloupe et y a-t-il des réductions ?
      a: Notre forfait eSIM pour Guadeloupe commence à 1,99 $/Go. Avec le code promo
    ...
    - q: Roami propose-t-il des eSIM régionales pour les voyages hors de Guadeloupe
        ?
      a: Oui, en plus de l'eSIM pour Guadeloupe, nous proposons des eSIM régionales
    ...
    - q: Roami propose-t-il des forfaits illimités pour Guadeloupe ? Y a-t-il une
        politique d'utilisation équitable (FUP) ?
      a: Roami propose des forfaits véritablement illimités pour Guadeloupe. La politique
  ...
  - id: faq-airport
    ...
    - q: Comment obtenir un réseau fiable dès mon arrivée ?
      a: Installez l'eSIM pour Guadeloupe avant votre départ. Dès que vous atterrissez
        dans des aéroports comme Aéroport Guadeloupe Pôle Caraïbes (PTP), Aéroport
        de Grand-Bourg (Marie-Galante), Aéroport de Saint-François, désactivez simplement
    ...
    - q: Comment contacter ma prise en charge ou utiliser Uber/Grab ?
      a: Après activation à l'arrivée, vous pourrez immédiatement utiliser des applications
        comme Uber, Karib Taxi, VTC Guadeloupe pour commander un trajet, ou WhatsApp
    ...
    - q: Comment utiliser Google/Apple Maps pour trouver les transports ?
      a: Avec les données de votre eSIM pour Guadeloupe, vous pouvez, dès la sortie
        des bagages dans Aéroport Guadeloupe Pôle Caraïbes (PTP), Aéroport de Grand-Bourg
        (Marie-Galante), Aéroport de Saint-François, consulter les horaires des trains
        et bus en temps réel ou trouver le chemin vers le parking des taxis.
    - q: Comment éviter les cartes SIM chères à l'aéroport ?
      a: En achetant notre eSIM pour Guadeloupe à l'avance en ligne, vous contournez
    ...
    - q: Comment recevoir les SMS de l'hôtel/location de voiture sans numéro local
        ?
      a: Notre eSIM pour Guadeloupe est un forfait données uniquement. Pour recevoir
    ...
    - q: Comment contacter immédiatement ma famille ?
      a: Dès que vous atterrissez, vous pouvez utiliser iMessage, WhatsApp ou FaceTime
        via les données rapides de notre eSIM pour Guadeloupe pour dire à vos proches
  ...
  - id: faq-transport
    ...
    - q: Comment utiliser Google Maps pour planifier mon itinéraire ?
      a: Notre connexion eSIM stable pour Guadeloupe garantit que Google Maps peut
        charger les données de trafic et les horaires en temps réel partout dans Guadeloupe.
    - q: Comment les chauffeurs Uber/Grab peuvent-ils me contacter via l'application
        ?
      a: Les applications comme Uber, Karib Taxi, VTC Guadeloupe utilisent la VoIP.
        Comme vos données eSIM pour Guadeloupe sont actives, les chauffeurs peuvent
    ...
    - q: Comment acheter des billets de train ou de métro en ligne ?
      a: Utilisez les données de votre eSIM pour Guadeloupe pour acheter des billets
    ...
    - q: Comment utiliser Google Maps pour la navigation en temps réel dans une voiture
        de location ?
      a: Fixez votre téléphone et utilisez l'eSIM pour Guadeloupe. Un forfait de 5
        Go ou 10 Go suffit pour une navigation GPS intensive lors de votre voyage
        à travers Guadeloupe.
    - q: Comment scanner et déverrouiller des trottinettes électriques (Lime/Bird)
      ...
      a: Le déverrouillage des trottinettes électriques nécessite une connexion Internet
        rapide. Notre eSIM pour Guadeloupe assure la couverture fiable nécessaire.
    ...
    - q: Comment configurer un point d'accès stable pour la famille ?
      a: Activez simplement le « Point d'accès personnel » dans les réglages. Votre
        famille pourra se connecter à votre réseau eSIM pour Guadeloupe dans le train
        ou la voiture.
  - id: faq-hotels
    icon: hotel
    tab_title: Hôtels
    ...
    - q: Comment faire un auto-arrivée (self-check-in) après réservation ?
      a: De nombreux hébergements modernes envoient les codes de serrures connectées
        par e-mail. Votre eSIM pour Guadeloupe garantit que vous pouvez recevoir ces
    ...
    - q: Comment utiliser Google Maps pour naviguer vers l'hôtel ?
      a: Que vous séjourniez dans La Creole Beach Hotel & Spa, Le Village de la Pointe
        des Châteaux, Hôtel Arawak Club, entrez l'adresse dans Google Maps et utilisez
        la navigation de votre eSIM pour Guadeloupe.
    - q: Comment recevoir les codes SMS de confirmation ?
      a: Laissez votre carte SIM domestique active pour les SMS et utilisez les données
        de l'eSIM pour Guadeloupe pour recevoir les codes par e-mail ou via l'application
        d'authentification.
    - q: Comment contacter rapidement le support client ?
      a: Utilisez des applications VoIP comme Skype ou la fonction de chat de l'application
        de réservation via les données haut débit de votre eSIM pour Guadeloupe.
    - q: Comment commander de la nourriture via les applications locales de livraison
        ?
      a: Téléchargez Uber Eats, Deliveroo, Allo Resto et utilisez les données de votre
        eSIM pour Guadeloupe pour commander un repas chaud directement dans le hall
        de l'hôtel.
    - q: Comment rester en contact avec l'hôtel après le départ (checkout) ?
      a: Une fois que vous quittez le Wi-Fi de l'hôtel, votre eSIM pour Guadeloupe
  ...
  - id: faq-attractions
    ...
    - q: Comment acheter des billets électroniques via GetYourGuide/Viator ?
      a: Si vous souhaitez visiter spontanément Parc national de la Guadeloupe, Les
        chutes du Carbet, La Soufrière, vous pouvez utiliser les données de votre
        eSIM pour Guadeloupe pour acheter des billets en ligne et afficher le code-barres
        directement sur place.
    - q: Comment réserver des expériences sur Tripadvisor instantanément ?
      a: Avec le 4G/5G fiable de votre eSIM pour Guadeloupe, vous pouvez lire les
    ...
    - q: Comment utiliser Wikipedia/Google pour obtenir des informations lors de la
      ...
      a: Améliorez votre expérience culturelle en recherchant des faits historiques
        ...
        données de l'eSIM pour Guadeloupe.
    - q: Comment trouver le chemin vers la prochaine attraction ?
      a: Entrez la prochaine destination dans Google Maps ; la couverture puissante
        de votre eSIM pour Guadeloupe vous guidera par l'itinéraire le plus rapide.
    - q: Comment vérifier les temps d'attente en temps réel dans les parcs d'attractions
      ...
      a: Les applications des parcs d'attractions ont besoin d'Internet pour afficher
        les temps d'attente. Votre eSIM pour Guadeloupe vous maintient en ligne dans
        tout le parc.
    - q: Comment accéder à Ticketmaster pour les billets de spectacle ?
      a: Vous pouvez acheter des billets de dernière minute en toute sécurité via
        les applications de billetterie avec les données de votre eSIM pour Guadeloupe.
    - q: Comment partager instantanément des photos/vidéos sur Instagram/TikTok ?
      a: La vitesse de téléchargement élevée de l'eSIM pour Guadeloupe vous permet
  ...
  - id: faq-dining
    ...
    - q: Comment trouver des restaurants via Google Maps/Tripadvisor ?
      a: Utilisez votre eSIM pour Guadeloupe pour rechercher des « restaurants à proximité
    ...
    - q: Comment réserver une table en ligne ?
      a: Assurez votre réservation via les plateformes en ligne en utilisant votre
        eSIM pour Guadeloupe pendant vos déplacements.
    - q: Comment scanner les codes QR pour les menus numériques ?
      a: De nombreux restaurants utilisent des menus numériques. Votre eSIM pour Guadeloupe
    ...
    - q: Comment utiliser l'appareil photo Google Traduction pour les menus ?
      a: Ouvrez l'application et pointez l'appareil photo vers le menu. La traduction
        en direct nécessite une connexion Internet via votre eSIM pour Guadeloupe.
    - q: Comment utiliser les services de livraison locaux ?
      a: Téléchargez les applications locales comme Uber Eats, Deliveroo, Allo Resto
    ...
    - q: Comment payer avec Apple Pay/Google Pay ?
      a: Les paiements sans contact ou les méthodes locales telles que Carte bancaire,
        espèces, PayPal nécessitent une brève validation Internet que votre eSIM pour
        Guadeloupe exécute parfaitement.
    - q: Comment trouver les endroits secrets recommandés par les blogueurs culinaires
      ...
      a: Regardez des vlogs YouTube ou parcourez les avis sur Yelp avec les données
        de votre eSIM pour Guadeloupe pour découvrir des pépites culinaires.
  - id: faq-social
    icon: smartphone
    ...
    - q: Comment utiliser WhatsApp/Telegram de manière stable à l'étranger ?
      a: Vos comptes sont liés à votre numéro domestique. Avec notre eSIM pour Guadeloupe
    ...
    - q: Comment publier du contenu sur TikTok sans Wi-Fi public ?
      a: Le Wi-Fi public est souvent lent et peu sûr. Notre 4G/5G eSIM pour Guadeloupe
    ...
    - q: Comment passer des appels vidéo avec ma famille ?
      a: Nos partenariats réseau garantissent que les appels vidéo via l'eSIM pour
        Guadeloupe sont clairs et sans latence, où que vous soyez dans le pays.
    - q: Est-il sûr de se connecter aux réseaux sociaux via le Wi-Fi public ?
      a: Le Wi-Fi public est vulnérable aux pirates. Utiliser vos propres données
        eSIM pour Guadeloupe est chiffré et bien plus sûr.
    - q: Comment partager la connexion en point d'accès avec des compagnons de voyage
      ...
      a: Activez la fonction point d'accès. Vos amis pourront se connecter et utiliser
        votre trafic eSIM pour Guadeloupe pour leurs réseaux sociaux.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ai-je besoin d'une nouvelle carte SIM pour chaque pays ?
      a: L'eSIM pour un seul pays Guadeloupe ne fonctionne que là-bas. Pour les voyages
    ...
    - q: Comment éviter les frais d'itinérance lors d'un voyage en train traversant
      ...
      a: Désactivez l'« Itinérance des données » sur votre carte SIM domestique. Assurez-vous
        que l'eSIM pour Guadeloupe est définie comme principale pour les données.
  ...
  - id: faq-emergency
    ...
    - q: Comment composer les numéros d'urgence locaux ?
      a: 'Dans Guadeloupe, vous pouvez composer des numéros d''urgence tels que Police
        : 17, Pompiers : 18, SAMU : 15 directement si votre téléphone capte un signal
        cellulaire.'
    - q: Comment trouver l'hôpital le plus proche ?
      a: Les données de votre eSIM pour Guadeloupe vous permettent de rechercher instantanément
    ...
    - q: Comment trouver les informations de l'ambassade en cas de perte de passeport
        ?
      a: Utilisez l'eSIM pour Guadeloupe pour trouver rapidement l'adresse et le numéro
    ...
    - q: Comment contacter mon assurance en cas d'accident ?
      a: Utilisez des applications VoIP comme Skype via les données de l'eSIM pour
        Guadeloupe pour appeler les lignes d'assistance de votre assurance.
    - q: Comment partager ma position en temps réel ?
      a: Utilisez « Partager ma position » dans WhatsApp ou Apple « Où suis-je ? »
        pour envoyer des coordonnées via les données de l'eSIM pour Guadeloupe.
    - q: Comment télécharger des cartes hors ligne pour les zones reculées ?
      a: En utilisant la couverture urbaine de l'eSIM pour Guadeloupe, téléchargez
  ...
  - id: faq-business
    ...
    - q: Comment garantir des réunions stables sur Zoom/Teams ?
      a: Notre eSIM pour Guadeloupe se connecte à des réseaux premium, fournissant
    ...
    - q: Comment utiliser le point d'accès pour mon ordinateur portable dans un café
        ?
      a: Activez le point d'accès. Utiliser votre eSIM pour Guadeloupe est nettement
    ...
    - q: Comment recevoir les codes 2FA pour ma messagerie professionnelle ?
      a: Laissez votre carte SIM domestique active pour les SMS et utilisez les données
        de l'eSIM pour Guadeloupe pour les codes reçus par e-mail.
    - q: Comment télécharger de gros fichiers lors de réunions avec des clients ?
      a: Les vitesses 5G/4G-LTE de votre eSIM pour Guadeloupe vous permettent de télécharger
        rapidement des présentations vers le cloud.
    - q: Comment utiliser Slack/Gmail sans interruption pour collaborer ?
      a: Votre eSIM pour Guadeloupe fournit une connexion constante, vous recevez
    ...
    - q: Comment mettre à jour les plans de voyage pour l'entreprise en ligne ?
      a: Accédez aux portails de l'entreprise via l'eSIM pour Guadeloupe en déplacement
