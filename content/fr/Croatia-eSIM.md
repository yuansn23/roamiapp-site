...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "Avis sur l eSIM Croatie : vitesse, débit et couverture réseau pour les touristes."
  desc: "Vous partez à Croatie? Découvrez tout sur l'eSIM Croatie : vitesses 4G/5G réelles, couverture du réseau Hrvatski Telekom en ville et à la campagne, et conseils pratiques pour rester connecté pendant votre voyage."
  categories:
  - id: faq-general
    icon: help-circle
    tab_title: Général
    ...
    - q: |
        L'eSIM Croatie est-elle vraiment moins chère que le roaming international?
      a: |
    ...
    - q: |
        Les cartes SIM vendues à l'aéroport de Croatie sont-elles moins chères?
      a: |
    ...
    - q: |
        Puis-je garder ma carte SIM française tout en utilisant eSIM à Croatie?
      a: |
