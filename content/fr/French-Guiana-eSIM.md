...
country_meta:
  ...
  scenario_keywords: tourisme spatial, voyage d'affaires, vacances en famille, exploration
    nature, évasion tropicale
...
hero:
  ...
  title: Forfait eSIM pour Guyane française
  subtitle: Réseau haut débit 5G | Aucune pièce d'identité requise | Partage de connexion
    autorisé
features:
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Couverture
      desc: Profitez d'une vaste couverture réseau dans toute la Guyane française,
        y compris des villes comme Cayenne, Kourou, Saint-Laurent-du-Maroni. Notre
        eSIM pour Guyane française se connecte de manière transparente aux réseaux
...
reminders:
  ...
  - icon: ✈️
    html: Nous recommandons d'activer l'eSIM uniquement après votre arrivée à Guyane
      française.
  - icon: ⏰
...
activation_steps:
  title: Activez votre eSIM pour Guyane française en quelques minutes
  steps:
  - num: '1'
    ...
    desc: Immédiatement après votre commande, vous recevrez un e-mail avec votre code
      ...
      donc la préparer tranquillement pour votre voyage à Guyane française.
    is_list: false
  - num: '2'
    ...
    - Le profil eSIM pour Guyane française se téléchargera automatiquement – appuyez
      sur **"Suivant"**
    - Donnez un nom (par exemple « Roami Guyane française ») et définissez-le comme
  ...
  - num: '3'
    ...
    desc: Après l'installation, vous pouvez laisser l'eSIM désactivée dans les réglages.
      ...
      mobiles ne sont pas consommées). Dès que vous atterrissez à Guyane française,
      il vous suffit d'activer l'eSIM – la validité commencera automatiquement lors
      de la première connexion au réseau Orange / SFR. Aucun frais caché d'activation,
      aucun frais d'itinérance.
    is_list: false
  - num: '4'
    title: 'Arrivée à Guyane française : connexion instantanée 5G/4G'
    desc: Dès que vous atterrissez à Guyane française (par exemple dans Aéroport international
      Félix-Éboué (CAY), Aéroport de Saint-Laurent-du-Maroni (LDX), Aéroport de Maripasoula
      (MPY)), désactivez le mode avion (ou restez dedans et activez uniquement l'eSIM).
      Allez dans **Réglages → Réseau cellulaire** et activez votre eSIM Roami pour
      Guyane française. En quelques secondes, votre appareil se connectera automatiquement
      au réseau 5G/4G le plus rapide disponible de Orange / SFR. Vous pourrez immédiatement
    ...
    is_list: false
faq_section:
  title: 'eSIM Guyane française : Foire aux questions et guide de voyage'
  desc: Tout ce que vous devez savoir sur l'utilisation de votre eSIM pour Guyane
    française dans divers scénarios de voyage.
  categories:
  - id: faq-general
    icon: help-circle
    tab_title: Général
    ...
    - q: Comment fonctionne l'itinérance internationale avec l'eSIM pour Guyane française
        dans les pays voisins ?
      a: L'eSIM pour Guyane française est principalement optimisée pour Guyane française.
    ...
    - q: Combien coûte l'eSIM pour Guyane française et y a-t-il des réductions ?
      a: Notre forfait eSIM pour Guyane française commence à 1,99 $/Go. Avec le code
    ...
    - q: Proposez-vous une garantie de remboursement si l'eSIM pour Guyane française
        ne fonctionne pas ?
    ...
    - q: Puis-je conserver mon numéro de téléphone tout en utilisant l'eSIM pour Guyane
        française ?
    ...
    - q: Roami propose-t-il des eSIM régionales pour les voyages hors de Guyane française
        ?
      a: Oui, en plus de l'eSIM pour Guyane française, nous proposons des eSIM régionales
    ...
    - q: Roami propose-t-il des forfaits illimités pour Guyane française ? Y a-t-il
        une politique d'utilisation équitable (FUP) ?
      a: Roami propose des forfaits véritablement illimités pour Guyane française.
        ...
        sont pas limités.
    - q: Mon smartphone prend-il en charge l'eSIM pour Guyane française et comment
        l'installer ?
      a: Oui, la plupart des smartphones modernes (iPhone XS/XR ou plus récent, Samsung
        ...
        l'eSIM pour Guyane française en scannant le code QR dans les réglages mobiles.
        Les réseaux Orange / SFR offrent une excellente couverture 5G/4G dans Guyane
        française.
  - id: faq-airport
    icon: plane
    tab_title: Aéroports
    ...
    - q: Comment obtenir un réseau fiable dès mon arrivée ?
      a: Installez l'eSIM pour Guyane française avant votre départ. Dès que vous atterrissez
        dans des aéroports comme Aéroport international Félix-Éboué (CAY), Aéroport
        de Saint-Laurent-du-Maroni (LDX), Aéroport de Maripasoula (MPY), désactivez
    ...
    - q: Comment utiliser Google/Apple Maps pour trouver les transports ?
      a: Avec les données de votre eSIM pour Guyane française, vous pouvez, dès la
        sortie des bagages dans Aéroport international Félix-Éboué (CAY), Aéroport
        de Saint-Laurent-du-Maroni (LDX), Aéroport de Maripasoula (MPY), consulter
    ...
    - q: Comment éviter les cartes SIM chères à l'aéroport ?
      a: En achetant notre eSIM pour Guyane française à l'avance en ligne, vous contournez
    ...
    - q: Comment recevoir les SMS de l'hôtel/location de voiture sans numéro local
        ?
      a: Notre eSIM pour Guyane française est un forfait données uniquement. Pour
    ...
    - q: Comment contacter immédiatement ma famille ?
      a: Dès que vous atterrissez, vous pouvez utiliser iMessage, WhatsApp ou FaceTime
        via les données rapides de notre eSIM pour Guyane française pour dire à vos
  ...
  - id: faq-transport
    ...
    - q: Comment utiliser Google Maps pour planifier mon itinéraire ?
      a: Notre connexion eSIM stable pour Guyane française garantit que Google Maps
    ...
    - q: Comment les chauffeurs Uber/Grab peuvent-ils me contacter via l'application
      ...
      a: Les applications comme Uber, Bolt, Heetch utilisent la VoIP. Comme vos données
        eSIM pour Guyane française sont actives, les chauffeurs peuvent vous appeler
    ...
    - q: Comment acheter des billets de train ou de métro en ligne ?
      a: Utilisez les données de votre eSIM pour Guyane française pour acheter des
    ...
    - q: Comment utiliser Google Maps pour la navigation en temps réel dans une voiture
        de location ?
      a: Fixez votre téléphone et utilisez l'eSIM pour Guyane française. Un forfait
        de 5 Go ou 10 Go suffit pour une navigation GPS intensive lors de votre voyage
        à travers Guyane française.
    - q: Comment scanner et déverrouiller des trottinettes électriques (Lime/Bird)
      ...
      a: Le déverrouillage des trottinettes électriques nécessite une connexion Internet
        rapide. Notre eSIM pour Guyane française assure la couverture fiable nécessaire.
    ...
    - q: Comment configurer un point d'accès stable pour la famille ?
      a: Activez simplement le « Point d'accès personnel » dans les réglages. Votre
        famille pourra se connecter à votre réseau eSIM pour Guyane française dans
  ...
  - id: faq-hotels
    ...
    - q: Comment faire un auto-arrivée (self-check-in) après réservation ?
      a: De nombreux hébergements modernes envoient les codes de serrures connectées
        par e-mail. Votre eSIM pour Guyane française garantit que vous pouvez recevoir
    ...
    - q: Comment utiliser Google Maps pour naviguer vers l'hôtel ?
      a: Que vous séjourniez dans Hôtel Royal Amazonia (Cayenne), Hôtel des Roches
        (Kourou), Hôtel Le Relais des Marronniers (Saint-Laurent-du-Maroni), entrez
        l'adresse dans Google Maps et utilisez la navigation de votre eSIM pour Guyane
        française.
    - q: Comment recevoir les codes SMS de confirmation ?
      a: Laissez votre carte SIM domestique active pour les SMS et utilisez les données
        de l'eSIM pour Guyane française pour recevoir les codes par e-mail ou via
    ...
    - q: Comment contacter rapidement le support client ?
      a: Utilisez des applications VoIP comme Skype ou la fonction de chat de l'application
        de réservation via les données haut débit de votre eSIM pour Guyane française.
    - q: Comment commander de la nourriture via les applications locales de livraison
        ?
      a: Téléchargez Uber Eats, Deliveroo, Foodora et utilisez les données de votre
        eSIM pour Guyane française pour commander un repas chaud directement dans
        le hall de l'hôtel.
    - q: Comment rester en contact avec l'hôtel après le départ (checkout) ?
      a: Une fois que vous quittez le Wi-Fi de l'hôtel, votre eSIM pour Guyane française
  ...
  - id: faq-attractions
    ...
    - q: Comment acheter des billets électroniques via GetYourGuide/Viator ?
      a: Si vous souhaitez visiter spontanément Centre spatial guyanais (Kourou),
        Îles du Salut, Marais de Kaw, vous pouvez utiliser les données de votre eSIM
        pour Guyane française pour acheter des billets en ligne et afficher le code-barres
        directement sur place.
    - q: Comment réserver des expériences sur Tripadvisor instantanément ?
      a: Avec le 4G/5G fiable de votre eSIM pour Guyane française, vous pouvez lire
    ...
    - q: Comment utiliser Wikipedia/Google pour obtenir des informations lors de la
      ...
      a: Améliorez votre expérience culturelle en recherchant des faits historiques
        ...
        données de l'eSIM pour Guyane française.
    - q: Comment trouver le chemin vers la prochaine attraction ?
      a: Entrez la prochaine destination dans Google Maps ; la couverture puissante
        de votre eSIM pour Guyane française vous guidera par l'itinéraire le plus
        rapide.
    - q: Comment vérifier les temps d'attente en temps réel dans les parcs d'attractions
      ...
      a: Les applications des parcs d'attractions ont besoin d'Internet pour afficher
        les temps d'attente. Votre eSIM pour Guyane française vous maintient en ligne
        dans tout le parc.
    - q: Comment accéder à Ticketmaster pour les billets de spectacle ?
      a: Vous pouvez acheter des billets de dernière minute en toute sécurité via
        les applications de billetterie avec les données de votre eSIM pour Guyane
        française.
    - q: Comment partager instantanément des photos/vidéos sur Instagram/TikTok ?
      a: La vitesse de téléchargement élevée de l'eSIM pour Guyane française vous
  ...
  - id: faq-dining
    ...
    - q: Comment trouver des restaurants via Google Maps/Tripadvisor ?
      a: Utilisez votre eSIM pour Guyane française pour rechercher des « restaurants
    ...
    - q: Comment réserver une table en ligne ?
      a: Assurez votre réservation via les plateformes en ligne en utilisant votre
        eSIM pour Guyane française pendant vos déplacements.
    - q: Comment scanner les codes QR pour les menus numériques ?
      a: De nombreux restaurants utilisent des menus numériques. Votre eSIM pour Guyane
        française garantit que le code sur la table se charge instantanément.
    - q: Comment utiliser l'appareil photo Google Traduction pour les menus ?
      a: Ouvrez l'application et pointez l'appareil photo vers le menu. La traduction
        en direct nécessite une connexion Internet via votre eSIM pour Guyane française.
    - q: Comment utiliser les services de livraison locaux ?
      a: Téléchargez les applications locales comme Uber Eats, Deliveroo, Foodora
    ...
    - q: Comment payer avec Apple Pay/Google Pay ?
      a: Les paiements sans contact ou les méthodes locales telles que Carte bancaire
        (Visa/Mastercard), Espèces (Euro), Paiement mobile (Apple Pay/Google Pay)
        nécessitent une brève validation Internet que votre eSIM pour Guyane française
    ...
    - q: Comment trouver les endroits secrets recommandés par les blogueurs culinaires
      ...
      a: Regardez des vlogs YouTube ou parcourez les avis sur Yelp avec les données
        de votre eSIM pour Guyane française pour découvrir des pépites culinaires.
  - id: faq-social
    icon: smartphone
    ...
    - q: Comment utiliser WhatsApp/Telegram de manière stable à l'étranger ?
      a: Vos comptes sont liés à votre numéro domestique. Avec notre eSIM pour Guyane
        française comme source de données, vous pourrez communiquer et passer des
        appels comme à la maison.
    - q: Comment publier du contenu sur TikTok sans Wi-Fi public ?
      a: Le Wi-Fi public est souvent lent et peu sûr. Notre 4G/5G eSIM pour Guyane
        française offre la bande passante nécessaire pour des téléchargements rapides.
    - q: Comment passer des appels vidéo avec ma famille ?
      a: Nos partenariats réseau garantissent que les appels vidéo via l'eSIM pour
        Guyane française sont clairs et sans latence, où que vous soyez dans le pays.
    - q: Est-il sûr de se connecter aux réseaux sociaux via le Wi-Fi public ?
      a: Le Wi-Fi public est vulnérable aux pirates. Utiliser vos propres données
        eSIM pour Guyane française est chiffré et bien plus sûr.
    - q: Comment partager la connexion en point d'accès avec des compagnons de voyage
      ...
      a: Activez la fonction point d'accès. Vos amis pourront se connecter et utiliser
        votre trafic eSIM pour Guyane française pour leurs réseaux sociaux.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ai-je besoin d'une nouvelle carte SIM pour chaque pays ?
      a: L'eSIM pour un seul pays Guyane française ne fonctionne que là-bas. Pour
    ...
    - q: Comment éviter les frais d'itinérance lors d'un voyage en train traversant
      ...
      a: Désactivez l'« Itinérance des données » sur votre carte SIM domestique. Assurez-vous
        que l'eSIM pour Guyane française est définie comme principale pour les données.
  ...
  - id: faq-emergency
    ...
    - q: Comment composer les numéros d'urgence locaux ?
      a: 'Dans Guyane française, vous pouvez composer des numéros d''urgence tels
        que Police : 17, Pompiers : 18, SAMU : 15, Numéro d''urgence européen : 112
        directement si votre téléphone capte un signal cellulaire.'
    - q: Comment trouver l'hôpital le plus proche ?
      a: Les données de votre eSIM pour Guyane française vous permettent de rechercher
    ...
    - q: Comment trouver les informations de l'ambassade en cas de perte de passeport
        ?
      a: Utilisez l'eSIM pour Guyane française pour trouver rapidement l'adresse et
    ...
    - q: Comment contacter mon assurance en cas d'accident ?
      a: Utilisez des applications VoIP comme Skype via les données de l'eSIM pour
        Guyane française pour appeler les lignes d'assistance de votre assurance.
    - q: Comment partager ma position en temps réel ?
      a: Utilisez « Partager ma position » dans WhatsApp ou Apple « Où suis-je ? »
        pour envoyer des coordonnées via les données de l'eSIM pour Guyane française.
    - q: Comment télécharger des cartes hors ligne pour les zones reculées ?
      a: En utilisant la couverture urbaine de l'eSIM pour Guyane française, téléchargez
  ...
  - id: faq-business
    ...
    - q: Comment garantir des réunions stables sur Zoom/Teams ?
      a: Notre eSIM pour Guyane française se connecte à des réseaux premium, fournissant
    ...
    - q: Comment utiliser le point d'accès pour mon ordinateur portable dans un café
        ?
      a: Activez le point d'accès. Utiliser votre eSIM pour Guyane française est nettement
    ...
    - q: Comment recevoir les codes 2FA pour ma messagerie professionnelle ?
      a: Laissez votre carte SIM domestique active pour les SMS et utilisez les données
        de l'eSIM pour Guyane française pour les codes reçus par e-mail.
    - q: Comment télécharger de gros fichiers lors de réunions avec des clients ?
      a: Les vitesses 5G/4G-LTE de votre eSIM pour Guyane française vous permettent
    ...
    - q: Comment utiliser Slack/Gmail sans interruption pour collaborer ?
      a: Votre eSIM pour Guyane française fournit une connexion constante, vous recevez
    ...
    - q: Comment mettre à jour les plans de voyage pour l'entreprise en ligne ?
      a: Accédez aux portails de l'entreprise via l'eSIM pour Guyane française en
