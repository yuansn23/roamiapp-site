...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "eSIM Albanie : test de la vitesse Internet, analyse de la couverture et conseils pour bien choisir."
  desc: "Vous partez à Albanie? Découvrez tout sur l'eSIM Albanie : vitesses 4G/5G réelles, couverture du réseau Vodafone en ville et à la campagne, et conseils pratiques pour rester connecté pendant votre voyage."
  categories:
  - id: faq-general
    icon: help-circle
    tab_title: Général
    ...
    - q: |
        Comment vérifier que mon eSIM Albanie fonctionne dès l'atterrissage?
      a: |
