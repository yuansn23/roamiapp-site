...
seo:
  title: eSIM ОАЭ | Высокоскоростной 5G для россиян | Roami
  description: >-
    Исследуйте ОАЭ с eSIM. 5G от ведущего оператора, автоматическое переключение сетей и безлимитные данные. Идеально для цифровых кочевников.
