...
| **eSIM показывает «Нет обслуживания» после переноса** | Телефон не зарегистрировался в сети нового оператора. | Включите **роуминг данных** в настройках eSIM. Вручную выберите сеть: `Настройки > Сотовая связь > Выбор сети`. |
