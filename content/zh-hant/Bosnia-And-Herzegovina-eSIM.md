...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: 波赫 eSIM 購買前必讀｜價格方案與電信指南
  desc: 整理了波赫 eSIM的波赫 BH Telecom HT 比較、波赫 BH Telecom 網路覆蓋、波赫 eSIM 護照認證等常見問題，包含方案價格、啟用教學、網速實測和電信商比較，一篇搞懂波赫上網。
  categories:
  - id: faq-general
    icon: help-circle
    tab_title: 常見問題
    title: 波赫 eSIM 購買前必讀｜價格方案與電信指南
    questions:
    - q: 波赫eSIM的價格從多少到多少？有便宜的短期方案嗎？
      a: Roami 波赫 eSIM從$1.99起（7天1GB）到$59.99（30天無限）。一般旅客買最多的是5GB/15天（$9.99），查地圖傳LINE剛好。常看短影片或開熱點給旅伴，選10GB以上比較夠。波赫以4G為主，查地圖傳LINE很穩，看影片建議用飯店WiFi。去波赫機場買SIM卡比eSIM貴30-50%，還要排隊填資料。如果不確定用量可以先買小的，到波赫後直接在App加購不換卡。方案到期自動失效，不會續約扣款。
    - q: 買好波赫eSIM之後要怎麼啟用？到了當地打開就可以用了嗎？
      a: 收到QR Code後，iOS進 設定 > 行動服務 > 加入行動方案，Android進 設定 > 網路與網際網路 > 加入eSIM，約2分鐘完成。強烈建議出發前在家用WiFi先裝好——安裝當下需要網路，到了波赫機場若WiFi要手機驗證才能連就麻煩了。裝好後抵達波赫開啟數據漫遊，約1-2分鐘自動連上BH Telecom。萬一沒訊號：先確認數據漫遊有開，再手動選BH Telecom試試。重開機通常能解決，Roami客服24小時在線可協助排除。
    - q: 去波赫玩辦eSIM，Roami會自動切換BH Telecom、HT、m:tel的網路嗎？
      a: 波赫主要有BH Telecom、HT、m:tel。BH Telecom市區下載快、基地台密集。HT郊區覆蓋廣，會去郊區的話選HT路線較有保障。m:tel價格親民，適合預算有限的旅客。波赫4G為主，5G逐步建置。不過Roami會自動切換到當前訊號最強的網路。市區用BH Telecom，移動到郊區若BH Telecom訊號變弱就自動跳HT或m:tel，完全不用手動選。
    - q: 有人說去波赫辦eSIM要上傳護照，是真的嗎？個資會不會外洩？
      a: 需要的。波赫預付卡需KYC認證，需提供護照。很多人不知道這規定，到了波赫機場才上傳護照，遇到假日審核延遲好幾小時，一入境就沒網路。建議出發前在Roami完成驗證——上傳護照約5-10分鐘核可。波赫4G為主，5G逐步建置。完成後到波赫開數據漫遊就能直接用。不支援eSIM可租WiFi機。
    - q: 離開波赫市區之後，eSIM的訊號會不會變得很差？
      a: 波赫的BH Telecom等電信主要城市覆蓋不錯，郊區或偏遠地區訊號可能較弱。波赫4G為主，5G逐步建置。Roami會自動切換到當前訊號最強的網路。建議前往偏遠地區前先下載離線地圖。
    - q: 波赫eSIM如果流量用完了可以隨時加購嗎？加購會不會很麻煩？
