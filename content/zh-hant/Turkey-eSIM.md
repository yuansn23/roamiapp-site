...
market_analysis:
  ...
  table_rows:
    ...
    - icon: "id-card"
      title: "KYC 與護照登記"
      prepaid_title: ""
      prepaid_desc: "購買時需出示有效期內護照；若護照文字為非拉丁字母（如阿拉伯語），必須提供公證翻譯件。"
      esim_title: "免護照免公證"
      esim_desc: "無需出示護照或公證翻譯，完全繞過 Vodafone 對非拉丁護照持有者的嚴苛身份驗證，保護個人隱私。"
    - icon: "globe"
      title: "國際漫遊"
      prepaid_title: ""
      prepaid_desc: "所有土耳其發行的預付卡均無國際漫遊功能，僅限土耳其本土及北塞浦路斯使用。"
      esim_title: "全球漫遊無國界"
      esim_desc: "與土耳其預付卡無國際漫遊不同，eSIM 可同時接入 Turkcell、Vodafone、Türk Telekom 三網，自動切換最佳訊號，且不受政府審查限制，暢通訪問所有國際網站。"
    - icon: "calendar-xmark"
      title: "計費週期與浪費成本"
      prepaid_title: ""
      prepaid_desc: "最低套餐週期 28 天，例如 Turkcell Fırsat 1GB 售價 ₺350 起，即使僅停留 3 天也無法按比例退款，大量剩餘流量和分鐘數直接作廢。"
      esim_title: "彈性週期零浪費"
      esim_desc: "與 Turkcell 的 28 天固定週期（₺350/1GB）不同，Roami 提供 7 天方案，最低 1.99 美元/GB，短途旅行可節省 75% 以上的浪費。"
    - icon: "wifi"
      title: "熱點分享與速度政策"
      prepaid_title: ""
      prepaid_desc: "Turkcell 明確允許 Tethering 和 VoIP。"
      esim_title: "無限熱點分享"
      esim_desc: "支援熱點分享，無每日降速限制，比 Turkcell 的允許政策更自由，多人共享更划算。"
    - icon: "credit-card"
      title: "儲值與付款"
      prepaid_title: ""
      prepaid_desc: "充值可通過門市或第三方網站充值，但存在匯率損失和手續費；國際信用卡經常被拒。"
      esim_title: "全球付款無障礙"
      esim_desc: "支援 Visa、Mastercard、AMEX、Apple Pay、Google Pay、PayPal，線上美元/歐元標價，無隱藏費用，避免門市砍價與國際信用卡被拒的困擾。"
    - icon: "headset"
      title: "客戶支援"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。"
      esim_title: "24/7 中文支援"
      esim_desc: "提供 24/7 全天候線上客服，無需擔心語言障礙，比當地電信商的有限服務更可靠。"

  # =============== 100% 完整復原：專家評語模組 ===============
  expert_verdict:
    title: "eSIM 給 土耳其 的啟用與設定比較：實體卡 vs 數位卡"
    cards:
      - icon: "shield"
        icon_bg: "bg-orange-100"
        icon_color: "text-orange-600"
        title: "避開 IMEI 封鎖風險"
        desc: "外國手機使用土耳其 SIM 卡 120 天後將被 IMEI 封鎖，需繳納 ₺45,614 進口稅。eSIM 為外國漫遊卡，不受此限制。"
      - icon: "globe"
        icon_bg: "bg-teal-100"
        icon_color: "text-teal-600"
        title: "無國際漫遊限制"
        desc: "土耳其預付卡完全無國際漫遊，跨出國境即斷網。eSIM 提供全球漫遊，不受地域限制。"
      - icon: "hourglass-empty"
        icon_bg: "bg-amber-100"
        icon_color: "text-amber-600"
        title: "28天週期造成巨額浪費"
        desc: "Turkcell 最低套餐 28 天/₺350，若停留 5 天，浪費超過 80% 的費用。eSIM 提供 1-30 天彈性方案，精準匹配行程。"
      - icon: "tower-observation"
        icon_bg: "bg-rose-100"
        icon_color: "text-rose-600"
        title: "三網自動切換無盲區"
        desc: "土耳其預付卡鎖定單一運營商（如 Turkcell），而 eSIM 可同時接入 Turkcell、Vodafone、Türk Telekom，根據訊號強度自動切換，避免鄉村覆蓋差的問題。"
---
