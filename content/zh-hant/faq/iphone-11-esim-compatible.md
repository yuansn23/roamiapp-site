...
description: "Moto G Power (2024) 與 Moto G Stylus (2024) 支援 eSIM。舊款型號 (2020-2023) 則不支援。了解如何檢查型號、用 *#06# 驗證，以及在 Airalo、Visible、Verizon、US Mobile、Holafly 上啟用。同時涵蓋 Motorola Edge、Razr 及其他支援 eSIM 的 Moto 手機。"
