...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: 剛果 eSIM 實名認證教學｜購買安裝完整指南
  desc: 整理了剛果 eSIM的剛果 Airtel Orange 比較、剛果 Airtel 網路覆蓋、剛果 Orange 速度等常見問題，包含方案價格、啟用教學、網速實測和電信商比較，一篇搞懂剛果上網。
  categories:
  - id: faq-general
    icon: help-circle
    tab_title: 常見問題
    ...
    - q: 去剛果旅遊的話，Airtel、Orange、MTN這三家電信分別有什麼優缺點？
