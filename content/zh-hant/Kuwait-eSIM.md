...
faq_section:
  ...
  - id: faq-airport
    icon: plane
    tab_title: 機場
    title: 科威特 機場：如何使用 科威特 eSIM
    questions:
    - q: 在科威特國際機場，哪裡可以找到免費Wi-Fi？連線步驟是什麼？
      a: 科威特國際機場提供名為「KWI Free WiFi」的公共無線網路，覆蓋整個航廈。連線時，請選擇該網路，瀏覽器會自動彈出登入頁面，輸入手機號碼或電子郵件接收驗證碼即可免費使用2小時。若無驗證需求，也可直接點擊「連接」按鈕。建議在大廳或登機門區域，訊號最強，下載速度約10
        Mbps。若需更長時間，可重新連線或使用eSIM數據。
  ...
  - id: faq-transport
    icon: car
    tab_title: 交通
    title: 科威特 eSIM 用於 科威特 的交通和導航
    questions:
    - q: 在科威特城，最推薦使用哪個叫車App？價格如何？
      a: 科威特城最推薦的叫車App是Careem和Uber，兩者均提供即時叫車服務。Careem起步價約1 KD（約3.3美元），每公里0.2 KD，而Uber價格相近。尖峰時段（如上下班）可能浮動約1.5倍。兩者都支援信用卡或KNET支付，且司機普遍友善。從機場到市中心約20分鐘車程，費用約5-8
        KD。
    - q: 科威特的公共交通是否發達？有地鐵嗎？
      a: 科威特的公共交通以公車為主，由科威特公共交通公司（KPTC）營運，路線包括城內及城際線，票價低廉（約0.2 KD）。但目前沒有地鐵系統，不過規劃中的地鐵計畫尚未完工。對於觀光客，公車班次較少且站牌多為阿拉伯文，較不便利。建議使用Careem或Uber作為主要交通工具。
  ...
  - id: faq-hotels
    ...
    - q: 在薩爾米亞海灘附近，有推薦的豪華飯店嗎？
      a: 薩爾米亞海灘旁的Jumeirah Messilah Beach Hotel是頂級選擇，提供海景房、水療中心和多家高檔餐廳。另外，Marina Hotel距離海灘僅步行5分鐘，設施現代。這些飯店均設有無邊際泳池，且鄰近Marina
        Mall，方便購物。每晚價格約100-250 KD，建議提前透過訂房網站比較。
    - q: 科威特城的飯店是否提供免費Wi-Fi？速度夠快嗎？
  ...
  - id: faq-attractions
    ...
    - q: 法拉卡島如何前往？島上有什麼值得一看的？
      a: 法拉卡島需從科威特城的碼頭搭乘渡輪，船程約30分鐘，船票來回約5 KD。島上有公元前青銅時代的遺址和亞歷山大大帝時期的堡壘，是歷史愛好者的天堂。建議參加導覽團，深入了解考古發現。島上無餐廳，需自備飲食，並注意防曬。
    - q: 科威特科學中心適合家庭嗎？有哪些展覽？
      a: 科威特科學中心非常適合家庭，內有水族館、IMAX影院和互動科學展區。水族館展示波斯灣海洋生物，包括鯊魚和海龜。門票成人約4 KD，兒童2.5 KD。建議預留半天，可同時參觀戶外運動區。週末人潮較多，平日更佳。
    - q: 在科威特城，可以免費參觀哪些景點？
      a: 科威特城有許多免費景點，例如科威特大清真寺（開放參觀）、科威特國家博物館（部分展區免費）、以及濱海大道（可散步欣賞海景）。另可造訪穆巴拉克市集，不需門票，適合拍照。建議規劃免費步行路線，從市集走到海邊，感受當地生活。
  - id: faq-social
    icon: smartphone
    tab_title: 社交媒體
    title: 透過 科威特 eSIM 在 科威特 使用通訊軟體和社群網站
    questions:
    - q: 科威特人常用的即時通訊軟體是什麼？
      a: 科威特人廣泛使用WhatsApp和Telegram進行日常溝通，Instagram也常用於分享生活。WhatsApp是最普遍的，無論是商業聯繫還是個人聊天。此外，部分年輕族群使用Snapchat和Twitter。建議遊客安裝WhatsApp以便聯繫飯店和餐廳。
    - q: 在科威特使用社交媒體要注意哪些文化禮儀？
      a: 科威特是一個保守的伊斯蘭國家，在社交媒體上發文時應避免批評政府、宗教或王室。此外，拍攝他人需徵得同意，尤其是女性。齋戒月期間，避免在公共場合發飲食照片。穿著得體，尊重本地習俗。違規可能引來法律問題。
    - q: 科威特有哪些當地熱門的Instagram打卡地點？
      a: 科威特的熱門打卡地點包括科威特塔、科威特大清真寺、The Avenues Mall的建築設計、以及薩爾米亞海灘的日落。另外，舒瓦克港（Shuwaikh）的街頭壁畫也很受歡迎。建議使用標籤#Kuwait並標註地點增加曝光。
    - q: 在科威特，可以用Tinder或Bumble交友嗎？
      a: Tinder在科威特可以使用，但由於社會保守，配對率較低，且部分用戶較低調。Bumble在年輕人間逐漸流行。建議在公共場合見面，展現尊重。注意，線上約會並非主流，許多人傾向透過朋友介紹。
    - q: 科威特人如何慶祝節日？社交媒體上常見什麼內容？
      a: 科威特主要節日包括開齋節和宰牲節，社交媒體上充滿家庭聚會、傳統美食（如Machboos）和煙火照片。在國慶日（2月25日），人們發布國旗和慶祝活動。齋戒月期間，人們分享開齋飯（Iftar）和慈善活動。建議節日期間留意時間，餐廳營業時間可能調整。
  - id: faq-emergency
    icon: alert-triangle
    tab_title: 緊急情況
    ...
    - q: 科威特的緊急疏散路線或避難所有哪些？
      a: 科威特的主要建築物和購物中心設有緊急出口和避難標示，市區有公共避難所如學校和體育館。在發生自然災害（少見）時，政府會透過電視和手機警報發布指示。建議隨時留意天氣，沙塵暴時待在室內。科威特風險較低，但仍需注意火災警報。
related_products:
