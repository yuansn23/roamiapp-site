...
market_analysis:
  ...
  table_rows:
    ...
    - icon: "id-card"
      title: "KYC 與護照登記"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。根據市場知識，列支敦士登的預付 SIM 卡通常需護照登記，但具體流程未提及。"
      esim_title: "免護照登記"
      esim_desc: "無需提供護照或進行實名認證，Roami eSIM 即買即用，保護個人隱私。"
    - icon: "globe"
      title: "國際漫遊"
      prepaid_title: ""
      prepaid_desc: "所有在列支敦士登發行的預付 SIM 卡都被視為瑞士（非 EEA）SIM 卡，所有 EEA 漫遊均需支付附加費，例如進入奧地利將產生高額國際漫遊帳單。"
      esim_title: "全球漫遊無憂"
      esim_desc: "與 Swisscom 實體卡被視為非 EEA 卡不同，Roami eSIM 提供區域方案，在 EEA 國家（如奧地利）順暢使用，無附加費。"
    - icon: "calendar-xmark"
      title: "計費週期與浪費成本"
      prepaid_title: ""
      prepaid_desc: "Swisscom 或 7acht 的實體卡遵循 30 天計費週期，對於僅停留 1-3 日的過境遊客，強制購買 30 天套餐造成嚴重的資金與流量沉沒成本。"
      esim_title: "彈性方案省錢"
      esim_desc: "與 Swisscom 的 30 天週期不同，Roami 提供 7 天數據方案，最低 1.99 美元/GB，避免 90% 的浪費。"
    - icon: "wifi"
      title: "熱點分享與速度政策"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。根據市場知識，Swisscom 和 Salt 的預付卡通常允許熱點分享，但速度可能受 FUP 限制。"
      esim_title: "無限熱點分享"
      esim_desc: "Roami eSIM 支援熱點分享，無速度限制，可與同行旅伴共享數據。"
    - icon: "credit-card"
      title: "儲值與付款"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。根據市場知識，列支敦士登的預付卡通常可在門市以現金或信用卡（Visa、Mastercard）購買。"
      esim_title: "全球付款方式"
      esim_desc: "支援 Visa、Mastercard、AMEX、Apple Pay、Google Pay、PayPal，無需現金或當地信用卡。"
    - icon: "headset"
      title: "客戶支援"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。根據市場知識，Swisscom 和 Salt 的客戶支援以德語為主，英語支援有限。"
      esim_title: "24/7 客服"
      esim_desc: "Roami 提供 24/7 多語言線上客服，無需等待門市營業時間。"

  # =============== 100% 完整復原：專家評語模組 ===============
  expert_verdict:
    title: "eSIM 給 列支敦斯登 更聰明省錢的選擇"
    cards:
      - icon: "passport"
        icon_bg: "bg-blue-100"
        icon_color: "text-blue-600"
        title: "繞過列支敦斯登嚴格的護照要求"
        desc: "列支敦斯登預付 SIM 卡需護照登記，而 Roami eSIM 無需任何身分驗證，即買即用，保護隱私。"
      - icon: "shield"
        icon_bg: "bg-teal-100"
        icon_color: "text-teal-600"
        title: "24/7 多語言支援"
        desc: "Swisscom 客服以德語為主，Roami 提供 24/7 英語及多語言支援，隨時解決問題。"
      - icon: "clock"
        icon_bg: "bg-indigo-100"
        icon_color: "text-indigo-600"
        title: "即時啟用免排隊"
        desc: "無需前往 Swisscom 門市排隊或跨境辦理，Roami eSIM 線上購買後 1 分鐘內啟用。"
      - icon: "hourglass-empty"
        icon_bg: "bg-amber-100"
        icon_color: "text-amber-600"
        title: "告別 30 天強制捆綁"
        desc: "Swisscom 實體卡強制 30 天週期，短途遊客浪費 90% 費用。Roami 提供 7 天方案，最低 1.99 美元/GB。"
---
