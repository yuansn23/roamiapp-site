...
seo:
  title: "印尼eSIM｜5G上網吃到飽，跨國旅行不斷網"
  description: "去印尼出國旅遊eSIM推薦選Roami，5G高速上網吃到飽隨時查詢景點導航。社群分享旅遊點滴不卡頓，出國旅遊上網卡方案旅客好評推薦首選，值得信賴。"
  keywords: 印尼 eSIM, 印尼 eSIM方案, 最佳印尼 eSIM, 印尼上網, Telkomsel 印尼, XL Axiata 印尼, Indosat Ooredoo 印尼, 雅加達 eSIM, 峇里島 eSIM, 泗水 eSIM,
    印尼行動網路, 5G 印尼
order_summary:
  title: 選擇 印尼 eSIM
  label_data: 數據量
...
hero:
  ...
  flag_alt: 印尼 國旗
  title: '印尼 eSIM: 每個目的地的高速5G'
  subtitle: 印尼最佳預付eSIM - 高速5G、即時啟用、24/7客服
features:
  title: 為什麼旅客選擇Roami的印尼 eSIM：速度、覆蓋與支援
  items:
  - icon: zap
    color: from-brand-400 to-brand-600
    title: 即時 QR 碼
    desc: 5分鐘內透過Email收到您的印尼 eSIM QR碼
  - icon: headset
    color: from-emerald-400 to-emerald-600
    title: 24/7 支援
    desc: 為您的印尼之旅提供24/7客服 - 真人服務，非機器人
  - icon: shield-check
    color: from-amber-400 to-amber-600
    title: 保證
    desc: 若印尼 eSIM無法啟用，100%全額退款
  - icon: wifi
    color: from-purple-400 to-purple-600
    title: 熱點分享
    desc: 與旅伴分享您的印尼數據，無限制
  - icon: file-x
    color: from-rose-400 to-rose-600
    title: 無合約
    desc: 無合約，隨時取消 - 印尼旅行完美選擇
  - icon: radio-tower
    color: from-blue-400 to-blue-600
    title: 自動選擇
    desc: 自動連線印尼最佳電信商，取得最強訊號
plans_title: 購買印尼 eSIM：適合各種旅程的方案
plans_data:
  15 天:
  - spec: Unlimited
    data: 無限高速數據
...
discount_banner:
  title: 印尼 eSIM 特別折扣！
  desc_html: 結帳時使用代碼 <span class="font-mono bg-white text-blue-600 px-2 py-0.5 rounded font-bold mx-1">web20</span> 即可享受 印尼
    eSIM <span class="font-bold underline decoration-wavy decoration-white underline-offset-4">20% 折扣</span>！
  btn_text: 儲存折扣
  validity: 有效期：3 天
network_coverage:
  title: 印尼 eSIM覆蓋範圍：當地網路完整指南
  ...
  service_details:
    ...
    - icon: map
      ...
      title: 覆蓋範圍
      desc: 享受覆蓋全印尼的全面網路，包括雅加達, 峇里島, 泗水, 日惹。您的eSIM會自動連線至Telkomsel, XL Axiata, Indosat Ooredoo的強大網路，在市區、旅遊熱點和主要交通路線提供穩定訊號。
    - icon: zap
    ...
    - icon: wifi
      ...
      desc: 熱點分享無限制。
  carriers:
    title: Telkomsel, XL Axiata & Indosat Ooredoo：印尼 eSIM電信商
    badge: 官方合作夥伴
    items:
    - name: Telkomsel
      coverage: 最佳整體覆蓋
...
activation_steps:
  title: 印尼 eSIM啟用：3個簡單步驟
  steps:
  - num: '1'
    title: 獲取並保存 QR 碼 – 為 印尼 做好準備
    desc: 下單後您會立即收到包含個人 QR 碼和說明的電子郵件。將 QR 碼儲存在手機中或列印出來 – 後續安裝不需要網路連線。eSIM 有效期為 30 天，您可以從容地為前往 印尼 的旅行做好準備。
    is_list: false
  - num: '2'
  ...
  - num: '3'
    title: 在家中準備 – 無風險測試
    desc: 安裝後，您可以在設定中保持 eSIM 關閉。但您可以透過家中的 Wi-Fi 進行測試（不會消耗行動數據）。當您抵達 印尼 時，只需開啟 eSIM – 有效期將在首次連接到 Telkomsel / XL Axiata 的網路時自動開始。無需隱藏的啟用費用，也無漫遊費。
    is_list: false
  - num: '4'
    title: 抵達 印尼：立即連上 5G/4G 網路
    desc: 當您降落在 印尼（例如 蘇加諾-哈達國際機場（雅加達）、伍拉·賴國際機場（峇里島）、朱安達國際機場（泗水））時，關閉飛航模式（或保持在飛航模式僅啟用 eSIM）。前往 **設定 → 行動服務** 並開啟您的 Roami eSIM
