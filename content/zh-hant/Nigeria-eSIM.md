...
faq_section:
  ...
  - id: faq-general
    ...
    - q: 出國去奈及利亞用eSIM，出發前要準備什麼？有沒有簡單的檢查步驟？
      a: 第一：撥號*#06#查EID確認手機支援。第二：購買方案。第三：出發前用WiFi裝好。到奈及利亞開數據漫遊就用。
related_products:
...
market_analysis:
  ...
  table_rows:
    ...
    - icon: "id-card"
      title: "KYC 與護照登記"
      prepaid_title: ""
      prepaid_desc: "尼日利亞自 2012 年起強制實行 SIM 卡購買實名制，每位遊客需在抵達後第一時間找到運營商官方門市，並出示護照完成登記。"
      esim_title: "免護照登記"
      esim_desc: "與 MTN 強制護照登記不同，Roami eSIM 無需 KYC，落地即可使用，省去 30 分鐘以上的登記流程。"
    - icon: "globe"
      title: "國際漫遊"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。基於市場知識：尼日利亞預付卡無區域漫遊優惠，跨國即高資費或無服務。"
      esim_title: "全球漫遊無縫"
      esim_desc: "不同於 Airtel 或 Glo 卡跨國即無服務，Roami eSIM 提供多國方案，在貝寧、喀麥隆等鄰國自動連接，無需換卡。"
    - icon: "calendar-xmark"
      title: "計費週期與浪費成本"
      prepaid_title: ""
      prepaid_desc: "主力套餐多為 30 天週期。例如 Glo 1.6GB 套餐 ₦1000（30天），遊客若僅停留 5-7 天，將導致超過 75% 的流量和資金沉沒。"
      esim_title: "彈性計費週期"
      esim_desc: "與 MTN 的 30 天週期（₦1000/1GB）不同，Roami 提供 7 天數據方案，最低 1.99 美元/GB，節省 75% 的浪費。"
    - icon: "wifi"
      title: "熱點分享與速度政策"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。基於市場知識：多數尼日利亞運營商允許熱點分享，但可能受速度限制。"
      esim_title: "無限熱點分享"
      esim_desc: "與部分運營商限制夜間流量不同，Roami eSIM 支援熱點分享，無速度限制，可同時連接多個設備。"
    - icon: "credit-card"
      title: "儲值與付款"
      prepaid_title: ""
      prepaid_desc: "使用國際信用卡通過其官方國際充值網站充值时需支付附加費。本地充值卡面額固定（如 ₦200 起）。"
      esim_title: "全球付款方式"
      esim_desc: "支援 Visa、Mastercard、AMEX、Apple Pay、Google Pay、PayPal，無需像 MTN 官網充值支付附加費。"
    - icon: "headset"
      title: "客戶支援"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。基於市場知識：客服通常為當地語言，外國遊客可能面臨語言障礙。"
      esim_title: "24/7 中文客服"
      esim_desc: "與當地運營商僅提供當地語言客服不同，Roami 提供 24/7 中文支援，解決語言障礙。"

  # =============== 100% 完整復原：專家評語模組 ===============
  expert_verdict:
    title: "eSIM 給 奈及利亞：更聰明的連線選擇勝過實體 SIM 卡"
    cards:
      - icon: "clock"
        icon_bg: "bg-yellow-100"
        icon_color: "text-yellow-600"
        title: "即時啟用免排隊"
        desc: "尼日利亞機場外門市稀少，排隊耗時。Roami eSIM 線上購買後掃碼即用，在等候行李時即可連網。"
      - icon: "shield"
        icon_bg: "bg-indigo-100"
        icon_color: "text-indigo-600"
        title: "保留原號安全驗證"
        desc: "使用實體 SIM 卡需拔插原卡，可能導致無法接收銀行驗證短信。Roami eSIM 與原 SIM 卡共存，保障金融通訊安全。"
      - icon: "hourglass-empty"
        icon_bg: "bg-amber-100"
        icon_color: "text-amber-600"
        title: "避免 30 天週期的浪費"
        desc: "MTN 和 Glo 的主力套餐均為 30 天週期，例如 Glo 1.6GB ₦1000，遊客停留 7 天將浪費超過 75% 的流量。Roami 提供 7 天方案，最低 1.99 美元/GB。"
      - icon: "wifi"
        icon_bg: "bg-green-100"
        icon_color: "text-green-600"
        title: "熱點分享無限制"
        desc: "部分尼日利亞套餐限制夜間流量（如 MTN 的 Bonus 流量僅限 1am-7am），且熱點分享可能被限制。Roami eSIM 支援無限熱點分享，無速度限制。"
---
