...
seo:
  ...
  keywords: 克羅埃西亞 eSIM, 克羅埃西亞 eSIM方案, 最佳克羅埃西亞 eSIM, 克羅埃西亞上網, Hrvatski Telekom 克羅埃西亞, A1 克羅埃西亞, Telemach 克羅埃西亞, 薩格勒布 eSIM,
    斯普利特 eSIM, 杜布羅夫尼克 eSIM, 克羅埃西亞行動網路, 5G 克羅埃西亞
order_summary:
  title: 選擇 克羅埃西亞 eSIM
  label_data: 數據量
  label_validity: 有效期
...
hero:
  ...
  flag_alt: 克羅埃西亞 國旗
  title: '克羅埃西亞 eSIM: 每個目的地的高速5G'
  subtitle: 克羅埃西亞最佳預付eSIM - 高速5G、即時啟用、24/7客服
features:
  title: 為什麼旅客選擇Roami的克羅埃西亞 eSIM：速度、覆蓋與支援
  items:
  - icon: zap
    color: from-brand-400 to-brand-600
    title: 即時 QR 碼
    desc: 5分鐘內透過Email收到您的克羅埃西亞 eSIM QR碼
  - icon: headset
    color: from-emerald-400 to-emerald-600
    title: 24/7 支援
    desc: 為您的克羅埃西亞之旅提供24/7客服 - 真人服務，非機器人
  - icon: shield-check
    color: from-amber-400 to-amber-600
    title: 保證
    desc: 若克羅埃西亞 eSIM無法啟用，100%全額退款
  - icon: wifi
    color: from-purple-400 to-purple-600
    title: 熱點分享
    desc: 與旅伴分享您的克羅埃西亞數據，無限制
  - icon: file-x
    color: from-rose-400 to-rose-600
    title: 無合約
    desc: 無合約，隨時取消 - 克羅埃西亞旅行完美選擇
  - icon: radio-tower
    color: from-blue-400 to-blue-600
    title: 自動選擇
    desc: 自動連線克羅埃西亞最佳電信商，取得最強訊號
plans_title: 購買克羅埃西亞 eSIM：適合各種旅程的方案
plans_data:
  30 天:
  - spec: 20GB
    data: 高速 5G/4G/LTE
...
discount_banner:
  ...
  desc_html: 結帳時使用代碼 <span class="font-mono bg-white text-blue-600 px-2 py-0.5 rounded font-bold mx-1">web20</span> 即可享受 克羅埃西亞
    eSIM <span class="font-bold underline decoration-wavy decoration-white underline-offset-4">20% 折扣</span>！
  btn_text: 儲存折扣
  validity: 有效期：3 天
network_coverage:
  title: 克羅埃西亞 eSIM覆蓋範圍：當地網路完整指南
  supports_text: 支援：
  service_details:
    title: 服務詳情
    items:
    - icon: map
      ...
      title: 覆蓋範圍
      desc: 享受覆蓋全克羅埃西亞的全面網路，包括薩格勒布, 斯普利特, 杜布羅夫尼克, 扎達爾。您的eSIM會自動連線至Hrvatski Telekom, A1, Telemach的強大網路，在市區、旅遊熱點和主要交通路線提供穩定訊號。
    - icon: zap
    ...
    - icon: wifi
      ...
      desc: 熱點分享無限制。
  carriers:
    title: Hrvatski Telekom, A1 & Telemach：克羅埃西亞 eSIM電信商
    badge: 官方合作夥伴
    items:
...
activation_steps:
  title: 克羅埃西亞 eSIM啟用：3個簡單步驟
  steps:
  - num: '1'
    title: 獲取並保存 QR 碼 – 為 克羅埃西亞 做好準備
    desc: 下單後您會立即收到包含個人 QR 碼和說明的電子郵件。將 QR 碼儲存在手機中或列印出來 – 後續安裝不需要網路連線。eSIM 有效期為 30 天，您可以從容地為前往 克羅埃西亞 的旅行做好準備。
    is_list: false
  - num: '2'
  ...
  - num: '3'
    title: 在家中準備 – 無風險測試
    desc: 安裝後，您可以在設定中保持 eSIM 關閉。但您可以透過家中的 Wi-Fi 進行測試（不會消耗行動數據）。當您抵達 克羅埃西亞 時，只需開啟 eSIM – 有效期將在首次連接到 Hrvatski Telekom / A1 的網路時自動開始。無需隱藏的啟用費用，也無漫遊費。
    is_list: false
  - num: '4'
    title: 抵達 克羅埃西亞：立即連上 5G/4G 網路
    desc: 當您降落在 克羅埃西亞（例如 薩格勒布弗拉尼奧·圖季曼機場 (ZAG), 斯普利特機場 (SPU), 杜布羅夫尼克機場 (DBV)）時，關閉飛航模式（或保持在飛航模式僅啟用 eSIM）。前往 **設定 → 行動服務** 並開啟您的
...
market_analysis:
  ...
  table_rows:
    ...
    - icon: "id-card"
      title: "KYC 與護照登記"
      prepaid_title: ""
      prepaid_desc: "若想獲得bonbon註冊獎勵的5 GB流量，必須完成提交護照照片等KYC步驟，在機場無法即買即用。"
      esim_title: "免護照登記"
      esim_desc: "無需像bonbon那樣提交護照照片以換取5 GB獎勵流量，Roami eSIM完全免KYC，保護個人隱私。"
    - icon: "globe"
      title: "國際漫遊"
      prepaid_title: ""
      prepaid_desc: "A1和Telemach的Tourist SIM完全不支援任何國際漫遊，一旦從克羅埃西亞進入斯洛維尼亞或匈牙利，立即斷網。"
      esim_title: "全球漫遊無憂"
      esim_desc: "與A1和Telemach的Tourist SIM完全不支援國際漫遊不同，Roami eSIM天然支援跨國使用，從克羅埃西亞到斯洛維尼亞或匈牙利不斷網。"
    - icon: "calendar-xmark"
      title: "計費週期與浪費成本"
      prepaid_title: ""
      prepaid_desc: "Hrvatski Telekom和A1的Tourist Offer多為10天或30天固定週期起步，價格在7.90歐元至29歐元不等。若行程為5天，購買7-10天套餐將造成高達50%的資金與流量浪費。"
      esim_title: "彈性計費週期"
      esim_desc: "與Hrvatski Telekom的10天/90天固定套餐（20歐元）不同，Roami提供7天數據方案，最低1.99美元/GB，避免50%的資金浪費。"
    - icon: "wifi"
      title: "熱點分享與速度政策"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。"
      esim_title: "無限熱點分享"
      esim_desc: "Roami eSIM支援熱點分享，無限制，而當地SIM卡如Telemach可能需手動設定APN，且部分方案限制分享。"
    - icon: "credit-card"
      title: "儲值與付款"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。"
      esim_title: "全球付款暢通"
      esim_desc: "支援Visa、Mastercard、AMEX、Apple Pay、Google Pay、PayPal，無需擔心當地SIM卡儲值時外國卡被拒的問題。"
    - icon: "headset"
      title: "客戶支援"
      prepaid_title: ""
      prepaid_desc: "此維度在來源中無具體數據。"
      esim_title: "24/7 客服支援"
      esim_desc: "Roami提供24/7多語言客服，而當地運營商如Hrvatski Telekom的客服可能僅限當地語言且非全天候。"

  # =============== 100% 完整復原：專家評語模組 ===============
  expert_verdict:
    title: "eSIM 給 克羅埃西亞：更聰明的連線選擇勝過實體 SIM 卡"
    cards:
      - icon: "shield"
        icon_bg: "bg-teal-100"
        icon_color: "text-teal-600"
        title: "保留國內門號安全"
        desc: "使用Telemach實體卡需取出國內SIM卡，可能錯過銀行驗證碼。Roami eSIM不佔卡槽，國內門號保持線上，安全無憂。"
      - icon: "credit-card"
        icon_bg: "bg-emerald-100"
        icon_color: "text-emerald-600"
        title: "全球付款無障礙"
        desc: "支援Visa、Mastercard、AMEX、Apple Pay、Google Pay、PayPal，無需擔心當地SIM卡儲值時外國卡被拒。"
      - icon: "wifi"
        icon_bg: "bg-green-100"
        icon_color: "text-green-600"
        title: "熱點分享無限制"
        desc: "當地SIM卡如Telemach的Data-only SIM需手動設定APN，且部分方案限制分享。Roami eSIM支援熱點分享，無限制。"
      - icon: "clock"
        icon_bg: "bg-purple-100"
        icon_color: "text-purple-600"
        title: "即時啟用免排隊"
        desc: "在薩格勒布機場尋找A1或Telemach實體店耗時30分鐘以上。Roami eSIM出發前購買，落地掃碼即用，節省寶貴時間。"
---
