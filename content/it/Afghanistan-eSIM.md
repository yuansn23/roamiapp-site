...
country_meta:
  ...
  scenario_keywords: turismo storico, viaggio d'affari, pellegrinaggio, trekking montano,
    visita città antiche
...
hero:
  ...
  title: eSIM Afghanistan – eSIM prepagata
  subtitle: Nessun documento d'identità richiesto | Viaggia con facilità | Supporto
    clienti 24/7
features:
  title: Perché i viaggiatori scelgono l'eSIM Roami per Afghanistan
  items:
  - icon: zap
...
network_coverage:
  title: Dettagli copertura di rete eSIM Afghanistan
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Copertura
      desc: Goditi una copertura di rete completa in tutta Afghanistan, comprese città
        come Kabul, Herat, Mazar-i-Sharif e Kandahar. La nostra eSIM Afghanistan si
        connette perfettamente alle reti di Afghan Wireless, Roshan e MTN.
    - icon: zap
  ...
  carriers:
    ...
    - name: MTN
      ...
      network: Rete 4G/LTE
reminders:
  title: Avvisi importanti per l'eSIM Afghanistan
  items:
  - icon: 📱
    html: |-
...
activation_steps:
  title: Attiva la tua eSIM Afghanistan in pochi minuti
  steps:
  - num: '1'
    ...
    desc: Subito dopo l'ordine riceverai un'email con il tuo codice QR di attivazione
      ...
      prima della partenza per Afghanistan.
    is_list: false
  - num: '2'
    ...
    - Assegna un nome (es. "Roami Afghanistan") e impostala come **predefinita per
      i dati mobili**
  ...
  - num: '3'
    ...
    desc: Dopo l'installazione puoi lasciare l'eSIM disattivata nelle impostazioni.
      ...
      mobili). Non appena atterri in Afghanistan, attiva l'eSIM – la validità inizierà
      automaticamente al primo collegamento con la rete di Afghan Wireless / Roshan.
      Nessuna tassa di attivazione nascosta, nessun costo di roaming.
    is_list: false
  - num: '4'
    title: 'Arrivo in Afghanistan: subito online con 5G/4G'
    desc: Non appena atterrato in Afghanistan (ad esempio in Aeroporto Internazionale
      di Kabul (KBL), Aeroporto di Herat (HEA), Aeroporto di Mazar-i-Sharif (MZR)),
      disattiva la modalità aereo (o rimani in modalità aereo e attiva solo l'eSIM).
      Vai su **Impostazioni → Cellulare** e attiva la tua eSIM Roami Afghanistan.
      Entro pochi secondi il tuo dispositivo si collegherà automaticamente alla rete
      5G/4G più veloce disponibile di Afghan Wireless / Roshan. Potrai subito navigare,
    ...
    is_list: false
faq_section:
  title: FAQ eSIM Afghanistan e Guida di Viaggio
  desc: Tutto ciò che devi sapere sull'uso della tua eSIM Afghanistan in diversi scenari
    di viaggio.
  categories:
  - id: faq-general
    icon: help-circle
    ...
    questions:
    - q: Come funziona il roaming internazionale con l'eSIM per Afghanistan nei paesi
        vicini?
      a: L'eSIM Afghanistan è ottimizzata principalmente per Afghanistan. Per viaggi
        ...
        nazionale non funziona in modo affidabile al di fuori di Afghanistan.
    - q: Durante l'utilizzo dell'eSIM Afghanistan, posso continuare a ricevere chiamate
    ...
    - q: Come attivo l'eSIM per Afghanistan e quando inizia la validità?
      a: Dopo l'acquisto riceverai immediatamente un codice QR di attivazione via
        ...
        volta a una delle reti partner (Afghan Wireless / Roshan) in Afghanistan.
    ...
    - q: Quanto costa l'eSIM per Afghanistan e ci sono offerte sconto?
      a: Il nostro piano eSIM Afghanistan parte da soli $1,99/GB. Con il codice promozionale
    ...
    - q: Roami offre piani dati illimitati per Afghanistan? Esiste una politica di
        fair use?
      a: Roami offre veri piani dati illimitati per Afghanistan. Una politica di fair
  ...
  - id: faq-airport
    ...
    - q: Come posso ottenere una rete affidabile subito dopo l'atterraggio?
      a: Installa l'eSIM Afghanistan prima del volo. Non appena atterri in aeroporti
        come Aeroporto Internazionale di Kabul (KBL), Aeroporto di Herat (HEA), Aeroporto
        di Mazar-i-Sharif (MZR), disattiva la modalità aereo e attiva la tua eSIM.
        Si collegherà in pochi secondi alla rete 4G/5G locale.
    - q: Come contatto la persona che viene a prendermi o uso Uber/Grab?
      a: Dopo l'attivazione all'atterraggio, puoi utilizzare app come Ride sharing
        non molto diffuso; si usano taxi locali, app come Uber non disponibili, preferito
        trasporto pubblico per prenotare una corsa o WhatsApp per contattare il tuo
    ...
    - q: Come uso Google Maps/Apple Maps per trovare i mezzi di trasporto?
      a: Con i tuoi dati eSIM Afghanistan, puoi controllare in tempo reale gli orari
    ...
    - q: Come evito SIM costose in aeroporto?
      a: Acquistando la nostra eSIM Afghanistan online in anticipo, eviti completamente
    ...
    - q: Come ricevo SMS da hotel/noleggio auto senza numero locale?
      a: La nostra eSIM Afghanistan è solo dati. Per ricevere SMS, lascia attiva la
    ...
    - q: Come contatto immediatamente la mia famiglia?
      a: Appena atterri, puoi usare iMessage, WhatsApp o FaceTime sui nostri rapidi
        dati eSIM Afghanistan per far sapere ai tuoi cari che sei arrivato sano e
        salvo.
  - id: faq-transport
    icon: car
    tab_title: Trasporti
    ...
    - q: Come uso Google Maps per pianificare il percorso?
      a: La nostra stabile connessione eSIM Afghanistan garantisce che Google Maps
        possa caricare i dati sul traffico in tempo reale e gli orari ovunque in Afghanistan.
    - q: Come possono i conducenti Uber/Grab contattarmi tramite l'app?
      a: App come Ride sharing non molto diffuso; si usano taxi locali, app come Uber
        non disponibili, preferito trasporto pubblico usano VoIP. Poiché hai dati
        eSIM Afghanistan attivi, gli autisti possono chiamarti o inviarti notifiche
    ...
    - q: Come acquisto biglietti del treno o della metropolitana online?
      a: Usa i tuoi dati eSIM Afghanistan per acquistare biglietti digitali con codice
    ...
    - q: Come uso Google Maps per la navigazione in tempo reale in auto a noleggio?
      a: Monta il telefono e usa la tua eSIM Afghanistan. Un piano da 5GB o 10GB è
        sufficiente per un'ampia navigazione GPS durante un viaggio su strada in Afghanistan.
    - q: Come scansiono e sblocco i monopattini elettrici (Lime/Bird)?
      a: Sbloccare i monopattini richiede una connessione Internet veloce. La nostra
        eSIM Afghanistan offre la copertura affidabile necessaria.
    ...
    - q: Come offro un hotspot stabile per la mia famiglia?
      a: Basta attivare 'Hotspot personale' nelle impostazioni. La tua famiglia può
        connettersi alla tua rete eSIM Afghanistan sul treno o in auto.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotel
    ...
    - q: Come faccio il self-check-in dopo la prenotazione?
      a: Molte strutture moderne inviano codici per serrature intelligenti via email.
        La tua eSIM Afghanistan ti garantisce di poter recuperare questi dettagli
    ...
    - q: Come contatto il mio host Airbnb al mio arrivo?
      a: Usa la funzione di messaggistica dell'app Airbnb o WhatsApp per coordinare
        l'orario di arrivo con il tuo host tramite i dati mobili eSIM Afghanistan.
    - q: Come uso Google Maps per navigare verso l'hotel?
      a: Che tu alloggi in Serena Hotel Kabul, Kabul International Hotel, Hotel Herat,
        inserisci l'indirizzo in Google Maps e usa la navigazione della tua eSIM Afghanistan.
    - q: Come ricevo i codici di verifica SMS?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i tuoi dati eSIM Afghanistan
    ...
    - q: Come contatto rapidamente l'assistenza clienti?
      a: Usa app VoIP come Skype o la funzione chat dell'app di prenotazione con i
        tuoi dati ad alta velocità eSIM Afghanistan.
    - q: Come ordino cibo con app di consegna locali?
      a: Scarica Talabate, Yummy, Kabul Online e usa i tuoi dati eSIM Afghanistan
        per ordinare un pasto caldo direttamente nella hall dell'hotel.
    - q: Come rimango in contatto con l'hotel dopo il check-out?
      a: Una volta uscito dal Wi-Fi dell'hotel, la tua eSIM Afghanistan subentra,
  ...
  - id: faq-attractions
    ...
    - q: Come acquisto biglietti elettronici su GetYourGuide/Viator?
      a: Se vuoi visitare Bamiyan Buddha, Giardini di Babur, Minareti di Jam all'ultimo
        minuto, puoi usare i tuoi dati eSIM Afghanistan per acquistare biglietti online
        e mostrare il codice a barre direttamente.
    - q: Come prenoto esperienze su Tripadvisor immediatamente?
      a: Con l'affidabile 4G/5G della tua eSIM Afghanistan, puoi leggere recensioni
    ...
    - q: Come uso Wikipedia/Google per informazioni durante la visita?
      a: Arricchisci la tua esperienza culturale cercando fatti storici su Google
        o traducendo i cartelli dei musei mentre esplori Afghanistan.
    - q: Come trovo la strada per l'attrazione successiva?
      a: Inserisci la tua prossima destinazione in Google Maps; la forte copertura
        della tua eSIM Afghanistan ti guiderà lungo il percorso più veloce.
    - q: Come controllo i tempi di attesa in tempo reale nei parchi divertimento?
      a: Le app dei parchi divertimento necessitano di Internet per i tempi di attesa
        in tempo reale. La tua eSIM Afghanistan ti mantiene online in tutto il parco.
    - q: Come accedo a Ticketmaster per i biglietti degli spettacoli?
      a: Puoi acquistare in sicurezza biglietti per spettacoli last minute tramite
        app di ticketing con i tuoi dati eSIM Afghanistan.
    - q: Come condivido subito foto/video su Instagram/TikTok?
      a: Le nostre veloci velocità di upload eSIM Afghanistan ti permettono di pubblicare
  ...
  - id: faq-social
    ...
    - q: Come utilizzo WhatsApp/Telegram in modo stabile all'estero?
      a: I tuoi account sono legati al tuo numero di casa. Con la nostra eSIM Afghanistan
    ...
    - q: Come carico contenuti su TikTok senza Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è spesso lento e insicuro. La nostra eSIM Afghanistan 4G/5G
    ...
    - q: Come faccio videochiamate con la mia famiglia?
      a: Le nostre partnership di rete garantiscono che le videochiamate tramite eSIM
        Afghanistan siano chiare e senza ritardi, ovunque ti trovi nel paese.
    - q: È sicuro accedere ai social network su Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è vulnerabile agli hacker. Utilizzare i tuoi dati eSIM
        Afghanistan personali è crittografato e molto più sicuro.
    - q: Come condivido la rete come hotspot con i compagni di viaggio?
      a: Attiva la funzione hotspot. I tuoi amici possono connettersi e utilizzare
        il tuo volume dati eSIM Afghanistan per i loro social media.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ho bisogno di una nuova SIM per ogni paese?
      a: L'eSIM singola per Afghanistan funziona solo lì. Per viaggiare attraverso
    ...
    - q: Come evito i costi di roaming durante i viaggi in treno oltre confine?
      a: Disattiva il 'Roaming dati' sulla tua SIM domestica. Assicurati che l'eSIM
        Afghanistan sia impostata come linea dati primaria.
  ...
  - id: faq-emergency
    ...
    - q: Come si compongono i numeri di emergenza locali?
      a: 'In Afghanistan puoi comporre direttamente numeri di emergenza come Polizia:
        119, Ambulanza: 112, Vigili del fuoco: 119, purché il telefono riceva un segnale
        cellulare.'
    - q: Come trovo l'ospedale più vicino?
      a: I tuoi dati eSIM Afghanistan consentono una ricerca immediata su Google Maps
    ...
    - q: Come trovo le informazioni dell'ambasciata in caso di smarrimento del passaporto?
      a: Usa la tua eSIM Afghanistan per trovare rapidamente l'indirizzo e il contatto
        di emergenza della tua ambasciata.
    - q: Come contatto l'assicurazione di viaggio in caso di incidente?
      a: Usa app VoIP come Skype tramite i tuoi dati eSIM Afghanistan per chiamare
    ...
    - q: Come condivido la mia posizione in tempo reale?
      a: Usa 'Condividi posizione live' su WhatsApp o 'Dov'è?' di Apple per inviare
        le tue coordinate tramite i dati eSIM Afghanistan.
    - q: Come scarico mappe offline per aree remote?
      a: Usa la copertura cittadina della tua eSIM Afghanistan per caricare mappe
  ...
  - id: faq-business
    ...
    - q: Come garantisco riunioni Zoom/Teams stabili?
      a: La nostra eSIM Afghanistan si connette a reti premium offrendo larghezza
