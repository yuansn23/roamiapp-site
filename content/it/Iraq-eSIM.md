...
country_meta:
  ...
  scenario_keywords: visite turistiche, viaggi d'affari, pellegrinaggio religioso, trekking in montagna, esplorazione storica
...
seo:
  ...
  keywords: eSIM Iraq, piano eSIM Iraq, migliore eSIM Iraq, Iraq dati, Zain Iraq Iraq, Asiacell Iraq, Korek Telecom Iraq,
    eSIM Baghdad, eSIM Erbil, eSIM Bassora, internet mobile Iraq, 5G Iraq
order_summary:
...
features:
  ...
  - icon: zap
    ...
    desc: Ricevi il tuo codice QR Iraq eSIM via email in 5 minuti
  - icon: headset
    color: from-emerald-400 to-emerald-600
    title: Supporto 24/7
    desc: Supporto 24/7 per il tuo viaggio in Iraq - persone reali, non bot
  - icon: shield-check
    color: from-amber-400 to-amber-600
    title: Garanzia
    desc: Rimborso 100% se la tua eSIM Iraq non si attiva
  - icon: wifi
    color: from-purple-400 to-purple-600
    title: Hotspot consentito
    desc: Condividi i tuoi dati Iraq con i compagni di viaggio, senza limiti
  - icon: file-x
    color: from-rose-400 to-rose-600
    title: Nessun contratto
    desc: Niente contratti, annullabile in qualsiasi momento - perfetto per viaggi in Iraq
  - icon: radio-tower
    color: from-blue-400 to-blue-600
    title: Selezione automatica
    desc: Connessione automatica ai migliori operatori Iraq per il segnale più forte
plans_title: 'Acquista eSIM Iraq: Piani per Ogni Viaggio'
plans_data:
  7 Giorni:
  - spec: 3GB
...
network_coverage:
  title: 'Copertura eSIM Iraq: Copertura & Confronto Operatori'
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Copertura
      desc: Goditi una copertura di rete completa in tutta Iraq, inclusi Baghdad, Erbil, Bassora, Mosul. La tua eSIM si collega
        alle reti robuste di Zain Iraq, Asiacell, Korek Telecom.
    - icon: zap
  ...
  carriers:
    title: 'Zain Iraq, Asiacell & Korek Telecom: Operatori eSIM Iraq'
    ...
    - name: Korek Telecom
      ...
      network: Rete 4G/LTE
reminders:
  title: 'Consigli eSIM Iraq: Cosa Sapere Prima di Partire'
  items:
  - icon: 📱
...
activation_steps:
  title: 'Attivazione eSIM Iraq: 3 Semplici Passi'
  steps:
  - num: '1'
    ...
    desc: Subito dopo l'ordine riceverai un'email con il tuo codice QR di attivazione personale e le istruzioni di configurazione.
      ...
      successiva. L'eSIM è valida per 30 giorni, quindi puoi prepararla con calma prima della partenza per Iraq.
    is_list: false
  - num: '2'
    ...
    - Assegna un nome (es. "Roami Iraq") e impostala come **predefinita per i dati mobili**
  ...
  - num: '3'
    ...
    desc: Dopo l'installazione puoi lasciare l'eSIM disattivata nelle impostazioni. Tuttavia, puoi già testarla con il Wi-Fi
      di casa (non verranno consumati dati mobili). Non appena atterri in Iraq, attiva l'eSIM – la validità inizierà automaticamente
      al primo collegamento con la rete di Zain Iraq / Asiacell. Nessuna tassa di attivazione nascosta, nessun costo di roaming.
    is_list: false
  - num: '4'
    title: 'Arrivo in Iraq: subito online con 5G/4G'
    desc: Non appena atterrato in Iraq (ad esempio in Aeroporto Internazionale di Baghdad, Aeroporto Internazionale di Erbil,
      Aeroporto Internazionale di Bassora), disattiva la modalità aereo (o rimani in modalità aereo e attiva solo l'eSIM).
      Vai su **Impostazioni → Cellulare** e attiva la tua eSIM Roami Iraq. Entro pochi secondi il tuo dispositivo si collegherà
