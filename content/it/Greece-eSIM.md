...
country_meta:
  ...
  scenario_keywords: vacanze al mare, crociera nelle isole, tour archeologico, viaggio
    d'affari, weekend romantico
...
seo:
  title: eSIM Grecia |Dati 5G illimitati per viaggi
  description: In viaggio in Grecia? Goditi 5G ad alta velocità e dati illimitati
    con Roami da operatori top locali. Perfetto per viaggi d'affari – nessuna SIM
    fisica e copertura nazionale.
...
hero:
  ...
  title: eSIM Grecia – eSIM prepagata
  subtitle: Attivazione in 1 minuto | Accesso 5G prioritario | Nessun documento d'identità
    richiesto
features:
  title: Perché i viaggiatori scelgono l'eSIM Roami per Grecia
  items:
  - icon: zap
...
network_coverage:
  title: Dettagli copertura di rete eSIM Grecia
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Copertura
      desc: Goditi una copertura di rete completa in tutta Grecia, comprese città
        come Atene, Salonicco, Candia e Patrasso. La nostra eSIM Grecia si connette
        perfettamente alle reti di Cosmote, Vodafone GR e Wind Tre.
    - icon: zap
  ...
  carriers:
    ...
    - name: Wind Tre
      ...
      network: Rete 5G/4G/LTE
reminders:
  title: Avvisi importanti per l'eSIM Grecia
  items:
  - icon: 📱
    html: |-
...
activation_steps:
  title: Attiva la tua eSIM Grecia in pochi minuti
  steps:
  - num: '1'
    ...
    desc: Subito dopo l'ordine riceverai un'email con il tuo codice QR di attivazione
      ...
      prima della partenza per Grecia.
    is_list: false
  - num: '2'
    ...
    - Assegna un nome (es. "Roami Grecia") e impostala come **predefinita per i dati
      mobili**
  ...
  - num: '3'
    ...
    desc: Dopo l'installazione puoi lasciare l'eSIM disattivata nelle impostazioni.
      ...
      mobili). Non appena atterri in Grecia, attiva l'eSIM – la validità inizierà
      automaticamente al primo collegamento con la rete di Cosmote / Vodafone GR.
      Nessuna tassa di attivazione nascosta, nessun costo di roaming.
    is_list: false
  - num: '4'
    title: 'Arrivo in Grecia: subito online con 5G/4G'
    desc: Non appena atterrato in Grecia (ad esempio in Aeroporto Internazionale di
      Atene, Aeroporto di Salonicco, Aeroporto di Candia), disattiva la modalità aereo
      (o rimani in modalità aereo e attiva solo l'eSIM). Vai su **Impostazioni → Cellulare**
      e attiva la tua eSIM Roami Grecia. Entro pochi secondi il tuo dispositivo si
      collegherà automaticamente alla rete 5G/4G più veloce disponibile di Cosmote
      / Vodafone GR. Potrai subito navigare, usare WhatsApp, controllare i social
...
faq_section:
  ...
  - id: faq-general
    ...
    - q: Il mio smartphone supporta l'eSIM per Grecia e come la installo?
      a: Sì, la maggior parte degli smartphone moderni (iPhone XS/XR o successivi,
        ...
        l'eSIM Grecia scansionando il codice QR nelle impostazioni cellulari. Le reti
        di Cosmote / Vodafone GR offrono un'eccellente copertura 5G/4G in Grecia.
    - q: Quali reti 5G/4G utilizza l'eSIM per Grecia e com'è la copertura?
      a: L'eSIM Grecia lavora esclusivamente con Cosmote / Vodafone GR. Riceverai
    ...
    - q: Posso installare l'eSIM Grecia prima della partenza e attivarla successivamente?
      a: Sì, puoi installare l'eSIM già a casa (tramite Wi-Fi). L'attivazione avviene
        ...
        rete di Cosmote / Vodafone GR in Grecia. Così eviti qualsiasi stress all'atterraggio.
    ...
    - q: Quanto costa l'eSIM per Grecia e ci sono offerte sconto?
      a: Il nostro piano eSIM Grecia parte da soli $1,99/GB. Con il codice promozionale
    ...
    - q: Come attivo l'eSIM per Grecia e quando inizia la validità?
      a: Dopo l'acquisto riceverai immediatamente un codice QR di attivazione via
        ...
        volta a una delle reti partner (Cosmote / Vodafone GR) in Grecia. Paghi solo
  ...
  - id: faq-airport
    ...
    - q: Come posso ottenere una rete affidabile subito dopo l'atterraggio?
      a: Installa l'eSIM Grecia prima del volo. Non appena atterri in aeroporti come
        Aeroporto Internazionale di Atene, Aeroporto di Salonicco, Aeroporto di Candia,
    ...
    - q: Come contatto la persona che viene a prendermi o uso Uber/Grab?
      a: Dopo l'attivazione all'atterraggio, puoi utilizzare app come Beat, Uber,
    ...
    - q: Come uso Google Maps/Apple Maps per trovare i mezzi di trasporto?
      a: Con i tuoi dati eSIM Grecia, puoi controllare in tempo reale gli orari di
        treni e autobus direttamente al ritiro bagagli in Aeroporto Internazionale
        di Atene, Aeroporto di Salonicco, Aeroporto di Candia o trovare la strada
        per il parcheggio dei taxi.
    - q: Come evito SIM costose in aeroporto?
      a: Acquistando la nostra eSIM Grecia online in anticipo, eviti completamente
    ...
    - q: Come ricevo SMS da hotel/noleggio auto senza numero locale?
      a: La nostra eSIM Grecia è solo dati. Per ricevere SMS, lascia attiva la tua
    ...
    - q: Come contatto immediatamente la mia famiglia?
      a: Appena atterri, puoi usare iMessage, WhatsApp o FaceTime sui nostri rapidi
        dati eSIM Grecia per far sapere ai tuoi cari che sei arrivato sano e salvo.
  - id: faq-transport
    icon: car
    tab_title: Trasporti
    ...
    - q: Come uso Google Maps per pianificare il percorso?
      a: La nostra stabile connessione eSIM Grecia garantisce che Google Maps possa
        caricare i dati sul traffico in tempo reale e gli orari ovunque in Grecia.
    - q: Come possono i conducenti Uber/Grab contattarmi tramite l'app?
      a: App come Beat, Uber, FreeNow usano VoIP. Poiché hai dati eSIM Grecia attivi,
    ...
    - q: Come acquisto biglietti del treno o della metropolitana online?
      a: Usa i tuoi dati eSIM Grecia per acquistare biglietti digitali con codice
    ...
    - q: Come uso Google Maps per la navigazione in tempo reale in auto a noleggio?
      a: Monta il telefono e usa la tua eSIM Grecia. Un piano da 5GB o 10GB è sufficiente
        per un'ampia navigazione GPS durante un viaggio su strada in Grecia.
    - q: Come scansiono e sblocco i monopattini elettrici (Lime/Bird)?
      a: Sbloccare i monopattini richiede una connessione Internet veloce. La nostra
        eSIM Grecia offre la copertura affidabile necessaria.
    ...
    - q: Come offro un hotspot stabile per la mia famiglia?
      a: Basta attivare 'Hotspot personale' nelle impostazioni. La tua famiglia può
        connettersi alla tua rete eSIM Grecia sul treno o in auto.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotel
    ...
    - q: Come faccio il self-check-in dopo la prenotazione?
      a: Molte strutture moderne inviano codici per serrature intelligenti via email.
        La tua eSIM Grecia ti garantisce di poter recuperare questi dettagli direttamente
        davanti alla porta.
    - q: Come contatto il mio host Airbnb al mio arrivo?
      a: Usa la funzione di messaggistica dell'app Airbnb o WhatsApp per coordinare
        l'orario di arrivo con il tuo host tramite i dati mobili eSIM Grecia.
    - q: Come uso Google Maps per navigare verso l'hotel?
      a: Che tu alloggi in Hotel Grande Bretagne, Aria Hotels, Blue Palace Resort,
        inserisci l'indirizzo in Google Maps e usa la navigazione della tua eSIM Grecia.
    - q: Come ricevo i codici di verifica SMS?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i tuoi dati eSIM Grecia
    ...
    - q: Come contatto rapidamente l'assistenza clienti?
      a: Usa app VoIP come Skype o la funzione chat dell'app di prenotazione con i
        tuoi dati ad alta velocità eSIM Grecia.
    - q: Come ordino cibo con app di consegna locali?
      a: Scarica eFood, Wolt, Box e usa i tuoi dati eSIM Grecia per ordinare un pasto
        caldo direttamente nella hall dell'hotel.
    - q: Come rimango in contatto con l'hotel dopo il check-out?
      a: Una volta uscito dal Wi-Fi dell'hotel, la tua eSIM Grecia subentra, permettendoti
  ...
  - id: faq-attractions
    ...
    - q: Come acquisto biglietti elettronici su GetYourGuide/Viator?
      a: Se vuoi visitare Acropoli di Atene, Santorini, Meteore all'ultimo minuto,
        puoi usare i tuoi dati eSIM Grecia per acquistare biglietti online e mostrare
        il codice a barre direttamente.
    - q: Come prenoto esperienze su Tripadvisor immediatamente?
      a: Con l'affidabile 4G/5G della tua eSIM Grecia, puoi leggere recensioni e prenotare
    ...
    - q: Come uso Wikipedia/Google per informazioni durante la visita?
      a: Arricchisci la tua esperienza culturale cercando fatti storici su Google
        o traducendo i cartelli dei musei mentre esplori Grecia.
    - q: Come trovo la strada per l'attrazione successiva?
      a: Inserisci la tua prossima destinazione in Google Maps; la forte copertura
        della tua eSIM Grecia ti guiderà lungo il percorso più veloce.
    - q: Come controllo i tempi di attesa in tempo reale nei parchi divertimento?
      a: Le app dei parchi divertimento necessitano di Internet per i tempi di attesa
        in tempo reale. La tua eSIM Grecia ti mantiene online in tutto il parco.
    - q: Come accedo a Ticketmaster per i biglietti degli spettacoli?
      a: Puoi acquistare in sicurezza biglietti per spettacoli last minute tramite
        app di ticketing con i tuoi dati eSIM Grecia.
    - q: Come condivido subito foto/video su Instagram/TikTok?
      a: Le nostre veloci velocità di upload eSIM Grecia ti permettono di pubblicare
  ...
  - id: faq-social
    ...
    - q: Come utilizzo WhatsApp/Telegram in modo stabile all'estero?
      a: I tuoi account sono legati al tuo numero di casa. Con la nostra eSIM Grecia
    ...
    - q: Come carico contenuti su TikTok senza Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è spesso lento e insicuro. La nostra eSIM Grecia 4G/5G
    ...
    - q: Come faccio videochiamate con la mia famiglia?
      a: Le nostre partnership di rete garantiscono che le videochiamate tramite eSIM
        Grecia siano chiare e senza ritardi, ovunque ti trovi nel paese.
    - q: È sicuro accedere ai social network su Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è vulnerabile agli hacker. Utilizzare i tuoi dati eSIM
        Grecia personali è crittografato e molto più sicuro.
    - q: Come condivido la rete come hotspot con i compagni di viaggio?
      a: Attiva la funzione hotspot. I tuoi amici possono connettersi e utilizzare
        il tuo volume dati eSIM Grecia per i loro social media.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ho bisogno di una nuova SIM per ogni paese?
      a: L'eSIM singola per Grecia funziona solo lì. Per viaggiare attraverso più
    ...
    - q: Come evito i costi di roaming durante i viaggi in treno oltre confine?
      a: Disattiva il 'Roaming dati' sulla tua SIM domestica. Assicurati che l'eSIM
        Grecia sia impostata come linea dati primaria.
  ...
  - id: faq-emergency
    ...
    - q: Come si compongono i numeri di emergenza locali?
      a: In Grecia puoi comporre direttamente numeri di emergenza come 112 (numero
        unico di emergenza), 100 (polizia), 166 (ambulanza), purché il telefono riceva
        un segnale cellulare.
    - q: Come trovo l'ospedale più vicino?
      a: I tuoi dati eSIM Grecia consentono una ricerca immediata su Google Maps di
    ...
    - q: Come trovo le informazioni dell'ambasciata in caso di smarrimento del passaporto?
      a: Usa la tua eSIM Grecia per trovare rapidamente l'indirizzo e il contatto
        di emergenza della tua ambasciata.
    - q: Come contatto l'assicurazione di viaggio in caso di incidente?
      a: Usa app VoIP come Skype tramite i tuoi dati eSIM Grecia per chiamare le linee
    ...
    - q: Come condivido la mia posizione in tempo reale?
      a: Usa 'Condividi posizione live' su WhatsApp o 'Dov'è?' di Apple per inviare
        le tue coordinate tramite i dati eSIM Grecia.
    - q: Come scarico mappe offline per aree remote?
      a: Usa la copertura cittadina della tua eSIM Grecia per caricare mappe offline
  ...
  - id: faq-business
    ...
    - q: Come garantisco riunioni Zoom/Teams stabili?
      a: La nostra eSIM Grecia si connette a reti premium offrendo larghezza di banda
    ...
    - q: Come mi connetto in modo sicuro alla VPN aziendale?
      a: I nostri dati non limitano alcun protocollo VPN. Puoi avviare la VPN aziendale
        in modo sicuro sulla rete eSIM Grecia.
    - q: Come uso l'hotspot per laptop nei bar?
      a: Attiva l'hotspot. Utilizzare la tua eSIM Grecia è molto più veloce e sicuro
        contro le minacce informatiche rispetto alle reti Wi-Fi aperte.
    - q: Come ricevo i codici 2FA per le email aziendali?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i dati eSIM Grecia per
        i codici basati su email.
    - q: Come carico file di grandi dimensioni durante le visite ai clienti?
      a: Con le velocità 5G/4G della tua eSIM Grecia puoi caricare rapidamente presentazioni
        sui servizi cloud.
    - q: Come utilizzo Slack/Gmail senza soluzione di continuità per la collaborazione?
      a: La tua eSIM Grecia offre una connessione costante, così ricevi immediatamente
        messaggi Slack ed email.
    - q: Come aggiorno online i piani di viaggio per l'azienda?
      a: Accedi ai portali aziendali con la tua eSIM Grecia in movimento per informare
