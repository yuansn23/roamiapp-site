...
country_meta:
  ...
  scenario_keywords: visite turistiche, viaggi d'affari, trekking, pellegrinaggi,
    viaggi in solitaria
...
seo:
  title: eSIM da viaggio India |5G sempre disponibile
  description: In viaggio in India? Ottieni 5G stabile Jio e dati ad alta velocità
    con Roami. Ideale per viaggi leggeri, nessun costo di roaming e migliore rete
    locale.
...
hero:
  ...
  title: eSIM India – eSIM prepagata
  subtitle: Comodo | Viaggia con facilità | Accesso 5G prioritario
features:
  title: Perché i viaggiatori scelgono l'eSIM Roami per India
  items:
  - icon: zap
...
network_coverage:
  title: Dettagli copertura di rete eSIM India
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Copertura
      desc: Goditi una copertura di rete completa in tutta India, comprese città come
        Nuova Delhi, Mumbai, Bangalore e Chennai. La nostra eSIM India si connette
        perfettamente alle reti di Airtel, Jio e Vi.
    - icon: zap
  ...
  carriers:
    ...
    - name: Vi (Vodafone Idea)
      ...
      network: Rete 5G/4G/LTE
reminders:
  title: Avvisi importanti per l'eSIM India
  items:
  - icon: 📱
    html: |-
...
activation_steps:
  title: Attiva la tua eSIM India in pochi minuti
  steps:
  - num: '1'
    ...
    desc: Subito dopo l'ordine riceverai un'email con il tuo codice QR di attivazione
      ...
      prima della partenza per India.
    is_list: false
  - num: '2'
    ...
    - Assegna un nome (es. "Roami India") e impostala come **predefinita per i dati
      mobili**
  ...
  - num: '3'
    ...
    desc: Dopo l'installazione puoi lasciare l'eSIM disattivata nelle impostazioni.
      ...
      mobili). Non appena atterri in India, attiva l'eSIM – la validità inizierà automaticamente
      al primo collegamento con la rete di Airtel / Jio. Nessuna tassa di attivazione
      nascosta, nessun costo di roaming.
    is_list: false
  - num: '4'
    title: 'Arrivo in India: subito online con 5G/4G'
    desc: Non appena atterrato in India (ad esempio in Indira Gandhi International
      Airport (Delhi), Chhatrapati Shivaji Maharaj International Airport (Mumbai),
      Kempegowda International Airport (Bangalore)), disattiva la modalità aereo (o
      rimani in modalità aereo e attiva solo l'eSIM). Vai su **Impostazioni → Cellulare**
      e attiva la tua eSIM Roami India. Entro pochi secondi il tuo dispositivo si
      collegherà automaticamente alla rete 5G/4G più veloce disponibile di Airtel
      / Jio. Potrai subito navigare, usare WhatsApp, controllare i social media o
      configurare un hotspot per altri dispositivi – senza attesa, senza documenti,
      senza contratto.
    is_list: false
faq_section:
  title: FAQ eSIM India e Guida di Viaggio
  desc: Tutto ciò che devi sapere sull'uso della tua eSIM India in diversi scenari
    di viaggio.
  categories:
  - id: faq-general
    icon: help-circle
    ...
    - q: Come attivo l'eSIM per India e quando inizia la validità?
      a: Dopo l'acquisto riceverai immediatamente un codice QR di attivazione via
        ...
        volta a una delle reti partner (Airtel / Jio) in India. Paghi solo per i giorni
    ...
    - q: Posso installare l'eSIM India prima della partenza e attivarla successivamente?
      a: Sì, puoi installare l'eSIM già a casa (tramite Wi-Fi). L'attivazione avviene
        ...
        rete di Airtel / Jio in India. Così eviti qualsiasi stress all'atterraggio.
    - q: Come funziona il roaming internazionale con l'eSIM per India nei paesi vicini?
      a: L'eSIM India è ottimizzata principalmente per India. Per viaggi nei paesi
        ...
        funziona in modo affidabile al di fuori di India.
    ...
    - q: Roami offre anche eSIM regionali per viaggiare al di fuori di India?
      a: Sì, oltre all'eSIM India, offriamo eSIM regionali per Europa, Asia, Nord
    ...
    - q: Posso usare l'eSIM per India come hotspot con altri dispositivi?
      a: Sì, tutti i piani Roami eSIM per India consentono tethering illimitato (hotspot).
  ...
  - id: faq-airport
    ...
    - q: Come posso ottenere una rete affidabile subito dopo l'atterraggio?
      a: Installa l'eSIM India prima del volo. Non appena atterri in aeroporti come
        Indira Gandhi International Airport (Delhi), Chhatrapati Shivaji Maharaj International
        Airport (Mumbai), Kempegowda International Airport (Bangalore), disattiva
    ...
    - q: Come contatto la persona che viene a prendermi o uso Uber/Grab?
      a: Dopo l'attivazione all'atterraggio, puoi utilizzare app come Uber, Ola, Rapido
    ...
    - q: Come uso Google Maps/Apple Maps per trovare i mezzi di trasporto?
      a: Con i tuoi dati eSIM India, puoi controllare in tempo reale gli orari di
        treni e autobus direttamente al ritiro bagagli in Indira Gandhi International
        Airport (Delhi), Chhatrapati Shivaji Maharaj International Airport (Mumbai),
        Kempegowda International Airport (Bangalore) o trovare la strada per il parcheggio
        dei taxi.
    - q: Come evito SIM costose in aeroporto?
      a: Acquistando la nostra eSIM India online in anticipo, eviti completamente
    ...
    - q: Come ricevo SMS da hotel/noleggio auto senza numero locale?
      a: La nostra eSIM India è solo dati. Per ricevere SMS, lascia attiva la tua
    ...
    - q: Come contatto immediatamente la mia famiglia?
      a: Appena atterri, puoi usare iMessage, WhatsApp o FaceTime sui nostri rapidi
        dati eSIM India per far sapere ai tuoi cari che sei arrivato sano e salvo.
  - id: faq-transport
    icon: car
    tab_title: Trasporti
    ...
    - q: Come uso Google Maps per pianificare il percorso?
      a: La nostra stabile connessione eSIM India garantisce che Google Maps possa
        caricare i dati sul traffico in tempo reale e gli orari ovunque in India.
    - q: Come possono i conducenti Uber/Grab contattarmi tramite l'app?
      a: App come Uber, Ola, Rapido usano VoIP. Poiché hai dati eSIM India attivi,
    ...
    - q: Come acquisto biglietti del treno o della metropolitana online?
      a: Usa i tuoi dati eSIM India per acquistare biglietti digitali con codice QR
    ...
    - q: Come uso Google Maps per la navigazione in tempo reale in auto a noleggio?
      a: Monta il telefono e usa la tua eSIM India. Un piano da 5GB o 10GB è sufficiente
        per un'ampia navigazione GPS durante un viaggio su strada in India.
    - q: Come scansiono e sblocco i monopattini elettrici (Lime/Bird)?
      a: Sbloccare i monopattini richiede una connessione Internet veloce. La nostra
        eSIM India offre la copertura affidabile necessaria.
    ...
    - q: Come offro un hotspot stabile per la mia famiglia?
      a: Basta attivare 'Hotspot personale' nelle impostazioni. La tua famiglia può
        connettersi alla tua rete eSIM India sul treno o in auto.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotel
    ...
    - q: Come faccio il self-check-in dopo la prenotazione?
      a: Molte strutture moderne inviano codici per serrature intelligenti via email.
        La tua eSIM India ti garantisce di poter recuperare questi dettagli direttamente
        davanti alla porta.
    - q: Come contatto il mio host Airbnb al mio arrivo?
      a: Usa la funzione di messaggistica dell'app Airbnb o WhatsApp per coordinare
        l'orario di arrivo con il tuo host tramite i dati mobili eSIM India.
    - q: Come uso Google Maps per navigare verso l'hotel?
      a: Che tu alloggi in Taj Mahal Palace (Mumbai), The Oberoi Amarvilas (Agra),
        The Leela Palace (New Delhi), inserisci l'indirizzo in Google Maps e usa la
        navigazione della tua eSIM India.
    - q: Come ricevo i codici di verifica SMS?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i tuoi dati eSIM India
    ...
    - q: Come contatto rapidamente l'assistenza clienti?
      a: Usa app VoIP come Skype o la funzione chat dell'app di prenotazione con i
        tuoi dati ad alta velocità eSIM India.
    - q: Come ordino cibo con app di consegna locali?
      a: Scarica Zomato, Swiggy, Uber Eats e usa i tuoi dati eSIM India per ordinare
        un pasto caldo direttamente nella hall dell'hotel.
    - q: Come rimango in contatto con l'hotel dopo il check-out?
      a: Una volta uscito dal Wi-Fi dell'hotel, la tua eSIM India subentra, permettendoti
  ...
  - id: faq-attractions
    ...
    - q: Come acquisto biglietti elettronici su GetYourGuide/Viator?
      a: Se vuoi visitare Taj Mahal, Red Fort, Gateway of India all'ultimo minuto,
        puoi usare i tuoi dati eSIM India per acquistare biglietti online e mostrare
        il codice a barre direttamente.
    - q: Come prenoto esperienze su Tripadvisor immediatamente?
      a: Con l'affidabile 4G/5G della tua eSIM India, puoi leggere recensioni e prenotare
    ...
    - q: Come uso Wikipedia/Google per informazioni durante la visita?
      a: Arricchisci la tua esperienza culturale cercando fatti storici su Google
        o traducendo i cartelli dei musei mentre esplori India.
    - q: Come trovo la strada per l'attrazione successiva?
      a: Inserisci la tua prossima destinazione in Google Maps; la forte copertura
        della tua eSIM India ti guiderà lungo il percorso più veloce.
    - q: Come controllo i tempi di attesa in tempo reale nei parchi divertimento?
      a: Le app dei parchi divertimento necessitano di Internet per i tempi di attesa
        in tempo reale. La tua eSIM India ti mantiene online in tutto il parco.
    - q: Come accedo a Ticketmaster per i biglietti degli spettacoli?
      a: Puoi acquistare in sicurezza biglietti per spettacoli last minute tramite
        app di ticketing con i tuoi dati eSIM India.
    - q: Come condivido subito foto/video su Instagram/TikTok?
      a: Le nostre veloci velocità di upload eSIM India ti permettono di pubblicare
  ...
  - id: faq-social
    ...
    - q: Come utilizzo WhatsApp/Telegram in modo stabile all'estero?
      a: I tuoi account sono legati al tuo numero di casa. Con la nostra eSIM India
    ...
    - q: Come carico contenuti su TikTok senza Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è spesso lento e insicuro. La nostra eSIM India 4G/5G offre
    ...
    - q: Come faccio videochiamate con la mia famiglia?
      a: Le nostre partnership di rete garantiscono che le videochiamate tramite eSIM
        India siano chiare e senza ritardi, ovunque ti trovi nel paese.
    - q: È sicuro accedere ai social network su Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è vulnerabile agli hacker. Utilizzare i tuoi dati eSIM
        India personali è crittografato e molto più sicuro.
    - q: Come condivido la rete come hotspot con i compagni di viaggio?
      a: Attiva la funzione hotspot. I tuoi amici possono connettersi e utilizzare
        il tuo volume dati eSIM India per i loro social media.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ho bisogno di una nuova SIM per ogni paese?
      a: L'eSIM singola per India funziona solo lì. Per viaggiare attraverso più paesi,
    ...
    - q: Come evito i costi di roaming durante i viaggi in treno oltre confine?
      a: Disattiva il 'Roaming dati' sulla tua SIM domestica. Assicurati che l'eSIM
        India sia impostata come linea dati primaria.
  ...
  - id: faq-emergency
    ...
    - q: Come si compongono i numeri di emergenza locali?
      a: 'In India puoi comporre direttamente numeri di emergenza come Polizia: 100,
        Ambulanza: 102, Vigili del fuoco: 101, purché il telefono riceva un segnale
        cellulare.'
    - q: Come trovo l'ospedale più vicino?
      a: I tuoi dati eSIM India consentono una ricerca immediata su Google Maps di
    ...
    - q: Come trovo le informazioni dell'ambasciata in caso di smarrimento del passaporto?
      a: Usa la tua eSIM India per trovare rapidamente l'indirizzo e il contatto di
        emergenza della tua ambasciata.
    - q: Come contatto l'assicurazione di viaggio in caso di incidente?
      a: Usa app VoIP come Skype tramite i tuoi dati eSIM India per chiamare le linee
    ...
    - q: Come condivido la mia posizione in tempo reale?
      a: Usa 'Condividi posizione live' su WhatsApp o 'Dov'è?' di Apple per inviare
        le tue coordinate tramite i dati eSIM India.
    - q: Come scarico mappe offline per aree remote?
      a: Usa la copertura cittadina della tua eSIM India per caricare mappe offline
  ...
  - id: faq-business
    ...
    - q: Come garantisco riunioni Zoom/Teams stabili?
      a: La nostra eSIM India si connette a reti premium offrendo larghezza di banda
    ...
    - q: Come mi connetto in modo sicuro alla VPN aziendale?
      a: I nostri dati non limitano alcun protocollo VPN. Puoi avviare la VPN aziendale
        in modo sicuro sulla rete eSIM India.
    - q: Come uso l'hotspot per laptop nei bar?
      a: Attiva l'hotspot. Utilizzare la tua eSIM India è molto più veloce e sicuro
        contro le minacce informatiche rispetto alle reti Wi-Fi aperte.
    - q: Come ricevo i codici 2FA per le email aziendali?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i dati eSIM India per
        i codici basati su email.
    - q: Come carico file di grandi dimensioni durante le visite ai clienti?
      a: Con le velocità 5G/4G della tua eSIM India puoi caricare rapidamente presentazioni
        sui servizi cloud.
    - q: Come utilizzo Slack/Gmail senza soluzione di continuità per la collaborazione?
      a: La tua eSIM India offre una connessione costante, così ricevi immediatamente
        messaggi Slack ed email.
    - q: Come aggiorno online i piani di viaggio per l'azienda?
      a: Accedi ai portali aziendali con la tua eSIM India in movimento per informare
