...
seo:
  title: Acquista eSIM Portogallo | Dati 5G illimitati per viaggi
  description: Hai bisogno di connessione in Portogallo? Resta connesso con operatori
    top locali, 5G a bassa latenza e dati ad alta velocità. Copertura nazionale e
    dati illimitati – ideale per viaggi leggeri.
...
hero:
  ...
  title: eSIM Portogallo – eSIM prepagata
  subtitle: Rete 5G ad alta velocità | Selezione automatica della rete | Essenziale
    per viaggiare
features:
  title: Perché i viaggiatori scelgono l'eSIM Roami per Portogallo
  items:
  - icon: zap
...
network_coverage:
  title: Dettagli copertura di rete eSIM Portogallo
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Copertura
      desc: Goditi una copertura di rete completa in tutta Portogallo, comprese città
        come Lisbona, Porto, Faro e Coimbra. La nostra eSIM Portogallo si connette
        perfettamente alle reti di Vodafone, NOS e MEO.
    - icon: zap
  ...
  carriers:
    ...
    - name: MEO
      ...
      network: Rete 5G/4G/LTE
reminders:
  title: Avvisi importanti per l'eSIM Portogallo
  items:
  - icon: 📱
    html: |-
...
activation_steps:
  title: Attiva la tua eSIM Portogallo in pochi minuti
  steps:
  - num: '1'
    ...
    desc: Subito dopo l'ordine riceverai un'email con il tuo codice QR di attivazione
      ...
      prima della partenza per Portogallo.
    is_list: false
  - num: '2'
    ...
    - Assegna un nome (es. "Roami Portogallo") e impostala come **predefinita per
      i dati mobili**
  ...
  - num: '3'
    ...
    desc: Dopo l'installazione puoi lasciare l'eSIM disattivata nelle impostazioni.
      ...
      mobili). Non appena atterri in Portogallo, attiva l'eSIM – la validità inizierà
      automaticamente al primo collegamento con la rete di Vodafone / NOS. Nessuna
      tassa di attivazione nascosta, nessun costo di roaming.
    is_list: false
  - num: '4'
    title: 'Arrivo in Portogallo: subito online con 5G/4G'
    desc: Non appena atterrato in Portogallo (ad esempio in Aeroporto di Lisbona (Humberto
      Delgado), Aeroporto di Porto (Francisco Sá Carneiro), Aeroporto di Faro (Algarve)),
      disattiva la modalità aereo (o rimani in modalità aereo e attiva solo l'eSIM).
      Vai su **Impostazioni → Cellulare** e attiva la tua eSIM Roami Portogallo. Entro
      pochi secondi il tuo dispositivo si collegherà automaticamente alla rete 5G/4G
      più veloce disponibile di Vodafone / NOS. Potrai subito navigare, usare WhatsApp,
...
faq_section:
  ...
  - id: faq-general
    ...
    - q: Come funziona il roaming internazionale con l'eSIM per Portogallo nei paesi
        vicini?
      a: L'eSIM Portogallo è ottimizzata principalmente per Portogallo. Per viaggi
        ...
        nazionale non funziona in modo affidabile al di fuori di Portogallo.
    ...
    - q: Posso usare l'eSIM per Portogallo come hotspot con altri dispositivi?
      a: Sì, tutti i piani Roami eSIM per Portogallo consentono tethering illimitato
    ...
    - q: Il mio smartphone supporta l'eSIM per Portogallo e come la installo?
      a: Sì, la maggior parte degli smartphone moderni (iPhone XS/XR o successivi,
        ...
        l'eSIM Portogallo scansionando il codice QR nelle impostazioni cellulari.
        Le reti di Vodafone / NOS offrono un'eccellente copertura 5G/4G in Portogallo.
    - q: Quali reti 5G/4G utilizza l'eSIM per Portogallo e com'è la copertura?
      a: L'eSIM Portogallo lavora esclusivamente con Vodafone / NOS. Riceverai automaticamente
  ...
  - id: faq-airport
    ...
    - q: Come posso ottenere una rete affidabile subito dopo l'atterraggio?
      a: Installa l'eSIM Portogallo prima del volo. Non appena atterri in aeroporti
        come Aeroporto di Lisbona (Humberto Delgado), Aeroporto di Porto (Francisco
        Sá Carneiro), Aeroporto di Faro (Algarve), disattiva la modalità aereo e attiva
    ...
    - q: Come uso Google Maps/Apple Maps per trovare i mezzi di trasporto?
      a: Con i tuoi dati eSIM Portogallo, puoi controllare in tempo reale gli orari
        di treni e autobus direttamente al ritiro bagagli in Aeroporto di Lisbona
        (Humberto Delgado), Aeroporto di Porto (Francisco Sá Carneiro), Aeroporto
        di Faro (Algarve) o trovare la strada per il parcheggio dei taxi.
    - q: Come evito SIM costose in aeroporto?
      a: Acquistando la nostra eSIM Portogallo online in anticipo, eviti completamente
    ...
    - q: Come ricevo SMS da hotel/noleggio auto senza numero locale?
      a: La nostra eSIM Portogallo è solo dati. Per ricevere SMS, lascia attiva la
    ...
    - q: Come contatto immediatamente la mia famiglia?
      a: Appena atterri, puoi usare iMessage, WhatsApp o FaceTime sui nostri rapidi
        dati eSIM Portogallo per far sapere ai tuoi cari che sei arrivato sano e salvo.
  - id: faq-transport
    icon: car
    tab_title: Trasporti
    ...
    - q: Come uso Google Maps per pianificare il percorso?
      a: La nostra stabile connessione eSIM Portogallo garantisce che Google Maps
        possa caricare i dati sul traffico in tempo reale e gli orari ovunque in Portogallo.
    - q: Come possono i conducenti Uber/Grab contattarmi tramite l'app?
      a: App come Uber, Bolt, Free Now usano VoIP. Poiché hai dati eSIM Portogallo
    ...
    - q: Come acquisto biglietti del treno o della metropolitana online?
      a: Usa i tuoi dati eSIM Portogallo per acquistare biglietti digitali con codice
    ...
    - q: Come uso Google Maps per la navigazione in tempo reale in auto a noleggio?
      a: Monta il telefono e usa la tua eSIM Portogallo. Un piano da 5GB o 10GB è
        sufficiente per un'ampia navigazione GPS durante un viaggio su strada in Portogallo.
    - q: Come scansiono e sblocco i monopattini elettrici (Lime/Bird)?
      a: Sbloccare i monopattini richiede una connessione Internet veloce. La nostra
        eSIM Portogallo offre la copertura affidabile necessaria.
    ...
    - q: Come offro un hotspot stabile per la mia famiglia?
      a: Basta attivare 'Hotspot personale' nelle impostazioni. La tua famiglia può
        connettersi alla tua rete eSIM Portogallo sul treno o in auto.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotel
    ...
    - q: Come faccio il self-check-in dopo la prenotazione?
      a: Molte strutture moderne inviano codici per serrature intelligenti via email.
        La tua eSIM Portogallo ti garantisce di poter recuperare questi dettagli direttamente
        davanti alla porta.
    - q: Come contatto il mio host Airbnb al mio arrivo?
      a: Usa la funzione di messaggistica dell'app Airbnb o WhatsApp per coordinare
        l'orario di arrivo con il tuo host tramite i dati mobili eSIM Portogallo.
    - q: Come uso Google Maps per navigare verso l'hotel?
      a: Che tu alloggi in Four Seasons Hotel Ritz Lisbon, Pestana Palace Lisboa,
        The Yeatman (Porto), inserisci l'indirizzo in Google Maps e usa la navigazione
        della tua eSIM Portogallo.
    - q: Come ricevo i codici di verifica SMS?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i tuoi dati eSIM Portogallo
    ...
    - q: Come contatto rapidamente l'assistenza clienti?
      a: Usa app VoIP come Skype o la funzione chat dell'app di prenotazione con i
        tuoi dati ad alta velocità eSIM Portogallo.
    - q: Come ordino cibo con app di consegna locali?
      a: Scarica Uber Eats, Glovo, Bolt Food e usa i tuoi dati eSIM Portogallo per
        ordinare un pasto caldo direttamente nella hall dell'hotel.
    - q: Come rimango in contatto con l'hotel dopo il check-out?
      a: Una volta uscito dal Wi-Fi dell'hotel, la tua eSIM Portogallo subentra, permettendoti
  ...
  - id: faq-attractions
    ...
    - q: Come acquisto biglietti elettronici su GetYourGuide/Viator?
      a: Se vuoi visitare Torre di Belém (Lisbona), Palácio da Pena (Sintra), Livraria
        Lello (Porto) all'ultimo minuto, puoi usare i tuoi dati eSIM Portogallo per
    ...
    - q: Come prenoto esperienze su Tripadvisor immediatamente?
      a: Con l'affidabile 4G/5G della tua eSIM Portogallo, puoi leggere recensioni
    ...
    - q: Come uso Wikipedia/Google per informazioni durante la visita?
      a: Arricchisci la tua esperienza culturale cercando fatti storici su Google
        o traducendo i cartelli dei musei mentre esplori Portogallo.
    - q: Come trovo la strada per l'attrazione successiva?
      a: Inserisci la tua prossima destinazione in Google Maps; la forte copertura
        della tua eSIM Portogallo ti guiderà lungo il percorso più veloce.
    - q: Come controllo i tempi di attesa in tempo reale nei parchi divertimento?
      a: Le app dei parchi divertimento necessitano di Internet per i tempi di attesa
        in tempo reale. La tua eSIM Portogallo ti mantiene online in tutto il parco.
    - q: Come accedo a Ticketmaster per i biglietti degli spettacoli?
      a: Puoi acquistare in sicurezza biglietti per spettacoli last minute tramite
        app di ticketing con i tuoi dati eSIM Portogallo.
    - q: Come condivido subito foto/video su Instagram/TikTok?
      a: Le nostre veloci velocità di upload eSIM Portogallo ti permettono di pubblicare
  ...
  - id: faq-social
    ...
    - q: Come utilizzo WhatsApp/Telegram in modo stabile all'estero?
      a: I tuoi account sono legati al tuo numero di casa. Con la nostra eSIM Portogallo
    ...
    - q: Come carico contenuti su TikTok senza Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è spesso lento e insicuro. La nostra eSIM Portogallo 4G/5G
    ...
    - q: Come faccio videochiamate con la mia famiglia?
      a: Le nostre partnership di rete garantiscono che le videochiamate tramite eSIM
        Portogallo siano chiare e senza ritardi, ovunque ti trovi nel paese.
    - q: È sicuro accedere ai social network su Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è vulnerabile agli hacker. Utilizzare i tuoi dati eSIM
        Portogallo personali è crittografato e molto più sicuro.
    - q: Come condivido la rete come hotspot con i compagni di viaggio?
      a: Attiva la funzione hotspot. I tuoi amici possono connettersi e utilizzare
        il tuo volume dati eSIM Portogallo per i loro social media.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ho bisogno di una nuova SIM per ogni paese?
      a: L'eSIM singola per Portogallo funziona solo lì. Per viaggiare attraverso
    ...
    - q: Come evito i costi di roaming durante i viaggi in treno oltre confine?
      a: Disattiva il 'Roaming dati' sulla tua SIM domestica. Assicurati che l'eSIM
        Portogallo sia impostata come linea dati primaria.
  ...
  - id: faq-emergency
    ...
    - q: Come si compongono i numeri di emergenza locali?
      a: In Portogallo puoi comporre direttamente numeri di emergenza come 112 (emergenze
        generali), 112 (Polizia), 112 (Ambulanza), purché il telefono riceva un segnale
        cellulare.
    - q: Come trovo l'ospedale più vicino?
      a: I tuoi dati eSIM Portogallo consentono una ricerca immediata su Google Maps
    ...
    - q: Come trovo le informazioni dell'ambasciata in caso di smarrimento del passaporto?
      a: Usa la tua eSIM Portogallo per trovare rapidamente l'indirizzo e il contatto
        di emergenza della tua ambasciata.
    - q: Come contatto l'assicurazione di viaggio in caso di incidente?
      a: Usa app VoIP come Skype tramite i tuoi dati eSIM Portogallo per chiamare
    ...
    - q: Come condivido la mia posizione in tempo reale?
      a: Usa 'Condividi posizione live' su WhatsApp o 'Dov'è?' di Apple per inviare
        le tue coordinate tramite i dati eSIM Portogallo.
    - q: Come scarico mappe offline per aree remote?
      a: Usa la copertura cittadina della tua eSIM Portogallo per caricare mappe offline
  ...
  - id: faq-business
    ...
    - q: Come garantisco riunioni Zoom/Teams stabili?
      a: La nostra eSIM Portogallo si connette a reti premium offrendo larghezza di
