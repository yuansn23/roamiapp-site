...
seo:
  ...
  - eSIM Sudafrica
  - viaggio Sudafrica
  - rete mobile Sudafrica
  - turismo Sudafrica
  - copertura 5G Sudafrica
order_summary:
...
hero:
  ...
  title: eSIM Sudafrica – eSIM prepagata
  subtitle: Supporto clienti 24/7 | Essenziale per viaggiare | Scelta intelligente
features:
  title: Perché i viaggiatori scelgono l'eSIM Roami per Sudafrica
  items:
  - icon: zap
...
network_coverage:
  title: Dettagli copertura di rete eSIM Sudafrica
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Copertura
      desc: Goditi una copertura di rete completa in tutta Sudafrica, comprese città
        come Johannesburg, Città del Capo, Durban e Pretoria. La nostra eSIM Sudafrica
        si connette perfettamente alle reti di Vodacom, MTN e Cell C.
    - icon: zap
  ...
  carriers:
    ...
    - name: Cell C
      ...
      network: Rete 5G/4G/LTE
reminders:
  title: Avvisi importanti per l'eSIM Sudafrica
  items:
  - icon: 📱
    html: |-
...
activation_steps:
  title: Attiva la tua eSIM Sudafrica in pochi minuti
  steps:
  - num: '1'
    ...
    desc: Subito dopo l'ordine riceverai un'email con il tuo codice QR di attivazione
      ...
      prima della partenza per Sudafrica.
    is_list: false
  - num: '2'
    ...
    - Assegna un nome (es. "Roami Sudafrica") e impostala come **predefinita per i
      dati mobili**
  ...
  - num: '3'
    ...
    desc: Dopo l'installazione puoi lasciare l'eSIM disattivata nelle impostazioni.
      ...
      mobili). Non appena atterri in Sudafrica, attiva l'eSIM – la validità inizierà
      automaticamente al primo collegamento con la rete di Vodacom / MTN. Nessuna
      tassa di attivazione nascosta, nessun costo di roaming.
    is_list: false
  - num: '4'
    title: 'Arrivo in Sudafrica: subito online con 5G/4G'
    desc: Non appena atterrato in Sudafrica (ad esempio in Aeroporto Internazionale
      O.R. Tambo (Johannesburg), Aeroporto Internazionale di Città del Capo, Aeroporto
      Internazionale King Shaka (Durban)), disattiva la modalità aereo (o rimani in
      modalità aereo e attiva solo l'eSIM). Vai su **Impostazioni → Cellulare** e
      attiva la tua eSIM Roami Sudafrica. Entro pochi secondi il tuo dispositivo si
      collegherà automaticamente alla rete 5G/4G più veloce disponibile di Vodacom
      / MTN. Potrai subito navigare, usare WhatsApp, controllare i social media o
      configurare un hotspot per altri dispositivi – senza attesa, senza documenti,
      senza contratto.
    is_list: false
faq_section1:
  title: FAQ eSIM Sudafrica e Guida di Viaggio
  desc: Tutto ciò che devi sapere sull'uso della tua eSIM Sudafrica in diversi scenari
    di viaggio.
  categories:
  - id: faq-general
    icon: help-circle
    ...
    - q: L'eSIM Sudafrica supporta VoLTE e chiamate HD?
      a: Sì, l'eSIM Sudafrica supporta VoLTE e voce HD, se il tuo dispositivo lo consente.
        Goditi una qualità audio nitida sulla rete 5G/4G di Vodacom / MTN.
    ...
    - q: Quali reti 5G/4G utilizza l'eSIM per Sudafrica e com'è la copertura?
      a: L'eSIM Sudafrica lavora esclusivamente con Vodacom / MTN. Riceverai automaticamente
    ...
    - q: Roami offre anche eSIM regionali per viaggiare al di fuori di Sudafrica?
      a: Sì, oltre all'eSIM Sudafrica, offriamo eSIM regionali per Europa, Asia, Nord
        America e globali. Ideali per gite di più giorni o tour attraverso più paesi
        – senza cambiare SIM.
    - q: Durante l'utilizzo dell'eSIM Sudafrica, posso continuare a ricevere chiamate
    ...
    - q: Roami offre piani dati illimitati per Sudafrica? Esiste una politica di fair
        use?
      a: Roami offre veri piani dati illimitati per Sudafrica. Una politica di fair
  ...
  - id: faq-airport
    ...
    - q: Come posso ottenere una rete affidabile subito dopo l'atterraggio?
      a: Installa l'eSIM Sudafrica prima del volo. Non appena atterri in aeroporti
        come Aeroporto Internazionale O.R. Tambo (Johannesburg), Aeroporto Internazionale
        di Città del Capo, Aeroporto Internazionale King Shaka (Durban), disattiva
    ...
    - q: Come uso Google Maps/Apple Maps per trovare i mezzi di trasporto?
      a: Con i tuoi dati eSIM Sudafrica, puoi controllare in tempo reale gli orari
        di treni e autobus direttamente al ritiro bagagli in Aeroporto Internazionale
        O.R. Tambo (Johannesburg), Aeroporto Internazionale di Città del Capo, Aeroporto
        Internazionale King Shaka (Durban) o trovare la strada per il parcheggio dei
        taxi.
    - q: Come evito SIM costose in aeroporto?
      a: Acquistando la nostra eSIM Sudafrica online in anticipo, eviti completamente
    ...
    - q: Come ricevo SMS da hotel/noleggio auto senza numero locale?
      a: La nostra eSIM Sudafrica è solo dati. Per ricevere SMS, lascia attiva la
    ...
    - q: Come contatto immediatamente la mia famiglia?
      a: Appena atterri, puoi usare iMessage, WhatsApp o FaceTime sui nostri rapidi
        dati eSIM Sudafrica per far sapere ai tuoi cari che sei arrivato sano e salvo.
  - id: faq-transport
    icon: car
    tab_title: Trasporti
    ...
    - q: Come uso Google Maps per pianificare il percorso?
      a: La nostra stabile connessione eSIM Sudafrica garantisce che Google Maps possa
        caricare i dati sul traffico in tempo reale e gli orari ovunque in Sudafrica.
    - q: Come possono i conducenti Uber/Grab contattarmi tramite l'app?
      a: App come Uber, Bolt, InDriver usano VoIP. Poiché hai dati eSIM Sudafrica
    ...
    - q: Come acquisto biglietti del treno o della metropolitana online?
      a: Usa i tuoi dati eSIM Sudafrica per acquistare biglietti digitali con codice
    ...
    - q: Come uso Google Maps per la navigazione in tempo reale in auto a noleggio?
      a: Monta il telefono e usa la tua eSIM Sudafrica. Un piano da 5GB o 10GB è sufficiente
        per un'ampia navigazione GPS durante un viaggio su strada in Sudafrica.
    - q: Come scansiono e sblocco i monopattini elettrici (Lime/Bird)?
      a: Sbloccare i monopattini richiede una connessione Internet veloce. La nostra
        eSIM Sudafrica offre la copertura affidabile necessaria.
    ...
    - q: Come offro un hotspot stabile per la mia famiglia?
      a: Basta attivare 'Hotspot personale' nelle impostazioni. La tua famiglia può
        connettersi alla tua rete eSIM Sudafrica sul treno o in auto.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotel
    ...
    - q: Come faccio il self-check-in dopo la prenotazione?
      a: Molte strutture moderne inviano codici per serrature intelligenti via email.
        La tua eSIM Sudafrica ti garantisce di poter recuperare questi dettagli direttamente
        davanti alla porta.
    - q: Come contatto il mio host Airbnb al mio arrivo?
      a: Usa la funzione di messaggistica dell'app Airbnb o WhatsApp per coordinare
        l'orario di arrivo con il tuo host tramite i dati mobili eSIM Sudafrica.
    - q: Come uso Google Maps per navigare verso l'hotel?
      a: Che tu alloggi in The Silo Hotel (Città del Capo), Saxon Hotel, Villas &
        Spa (Johannesburg), Oyster Box Hotel (Durban), inserisci l'indirizzo in Google
        Maps e usa la navigazione della tua eSIM Sudafrica.
    - q: Come ricevo i codici di verifica SMS?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i tuoi dati eSIM Sudafrica
    ...
    - q: Come contatto rapidamente l'assistenza clienti?
      a: Usa app VoIP come Skype o la funzione chat dell'app di prenotazione con i
        tuoi dati ad alta velocità eSIM Sudafrica.
    - q: Come ordino cibo con app di consegna locali?
      a: Scarica Uber Eats, Mr D Food, OrderIn e usa i tuoi dati eSIM Sudafrica per
        ordinare un pasto caldo direttamente nella hall dell'hotel.
    - q: Come rimango in contatto con l'hotel dopo il check-out?
      a: Una volta uscito dal Wi-Fi dell'hotel, la tua eSIM Sudafrica subentra, permettendoti
  ...
  - id: faq-attractions
    ...
    - q: Come acquisto biglietti elettronici su GetYourGuide/Viator?
      a: Se vuoi visitare Table Mountain, Kruger National Park, V&A Waterfront all'ultimo
        minuto, puoi usare i tuoi dati eSIM Sudafrica per acquistare biglietti online
        e mostrare il codice a barre direttamente.
    - q: Come prenoto esperienze su Tripadvisor immediatamente?
      a: Con l'affidabile 4G/5G della tua eSIM Sudafrica, puoi leggere recensioni
    ...
    - q: Come uso Wikipedia/Google per informazioni durante la visita?
      a: Arricchisci la tua esperienza culturale cercando fatti storici su Google
        o traducendo i cartelli dei musei mentre esplori Sudafrica.
    - q: Come trovo la strada per l'attrazione successiva?
      a: Inserisci la tua prossima destinazione in Google Maps; la forte copertura
        della tua eSIM Sudafrica ti guiderà lungo il percorso più veloce.
    - q: Come controllo i tempi di attesa in tempo reale nei parchi divertimento?
      a: Le app dei parchi divertimento necessitano di Internet per i tempi di attesa
        in tempo reale. La tua eSIM Sudafrica ti mantiene online in tutto il parco.
    - q: Come accedo a Ticketmaster per i biglietti degli spettacoli?
      a: Puoi acquistare in sicurezza biglietti per spettacoli last minute tramite
        app di ticketing con i tuoi dati eSIM Sudafrica.
    - q: Come condivido subito foto/video su Instagram/TikTok?
      a: Le nostre veloci velocità di upload eSIM Sudafrica ti permettono di pubblicare
  ...
  - id: faq-social
    ...
    - q: Come utilizzo WhatsApp/Telegram in modo stabile all'estero?
      a: I tuoi account sono legati al tuo numero di casa. Con la nostra eSIM Sudafrica
    ...
    - q: Come carico contenuti su TikTok senza Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è spesso lento e insicuro. La nostra eSIM Sudafrica 4G/5G
    ...
    - q: Come faccio videochiamate con la mia famiglia?
      a: Le nostre partnership di rete garantiscono che le videochiamate tramite eSIM
        Sudafrica siano chiare e senza ritardi, ovunque ti trovi nel paese.
    - q: È sicuro accedere ai social network su Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è vulnerabile agli hacker. Utilizzare i tuoi dati eSIM
        Sudafrica personali è crittografato e molto più sicuro.
    - q: Come condivido la rete come hotspot con i compagni di viaggio?
      a: Attiva la funzione hotspot. I tuoi amici possono connettersi e utilizzare
        il tuo volume dati eSIM Sudafrica per i loro social media.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ho bisogno di una nuova SIM per ogni paese?
      a: L'eSIM singola per Sudafrica funziona solo lì. Per viaggiare attraverso più
    ...
    - q: Come evito i costi di roaming durante i viaggi in treno oltre confine?
      a: Disattiva il 'Roaming dati' sulla tua SIM domestica. Assicurati che l'eSIM
        Sudafrica sia impostata come linea dati primaria.
  ...
  - id: faq-emergency
    ...
    - q: Come si compongono i numeri di emergenza locali?
      a: 'In Sudafrica puoi comporre direttamente numeri di emergenza come Polizia:
        10111, Ambulanza: 10177, Emergenze generali: 112, purché il telefono riceva
        un segnale cellulare.'
    - q: Come trovo l'ospedale più vicino?
      a: I tuoi dati eSIM Sudafrica consentono una ricerca immediata su Google Maps
    ...
    - q: Come trovo le informazioni dell'ambasciata in caso di smarrimento del passaporto?
      a: Usa la tua eSIM Sudafrica per trovare rapidamente l'indirizzo e il contatto
        di emergenza della tua ambasciata.
    - q: Come contatto l'assicurazione di viaggio in caso di incidente?
      a: Usa app VoIP come Skype tramite i tuoi dati eSIM Sudafrica per chiamare le
    ...
    - q: Come condivido la mia posizione in tempo reale?
      a: Usa 'Condividi posizione live' su WhatsApp o 'Dov'è?' di Apple per inviare
        le tue coordinate tramite i dati eSIM Sudafrica.
    - q: Come scarico mappe offline per aree remote?
      a: Usa la copertura cittadina della tua eSIM Sudafrica per caricare mappe offline
  ...
  - id: faq-business
    ...
    - q: Come garantisco riunioni Zoom/Teams stabili?
      a: La nostra eSIM Sudafrica si connette a reti premium offrendo larghezza di
