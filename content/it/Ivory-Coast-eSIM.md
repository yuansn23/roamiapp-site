...
country_meta:
  ...
  scenario_keywords: turismo culturale, viaggio d'affari, escursioni naturalistiche,
    visita alle spiagge, safari urbano
...
hero:
  ...
  title: eSIM Costa d'Avorio – eSIM prepagata
  subtitle: Selezione automatica della rete | Attivazione in 1 minuto | Essenziale
    per viaggiare
features:
  title: Perché i viaggiatori scelgono l'eSIM Roami per Costa d'Avorio
  items:
  - icon: zap
...
network_coverage:
  title: Dettagli copertura di rete eSIM Costa d'Avorio
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Copertura
      desc: Goditi una copertura di rete completa in tutta Costa d'Avorio, comprese
        città come Abidjan, Yamoussoukro, Bouaké, San-Pédro. La nostra eSIM Costa
        d'Avorio si connette perfettamente alle reti di Orange, MTN, Moov.
    - icon: zap
  ...
  carriers:
    ...
    - name: Moov
      ...
      network: Rete 5G/4G/LTE
reminders:
  title: Avvisi importanti per l'eSIM Costa d'Avorio
  items:
  - icon: 📱
    html: |-
...
activation_steps:
  title: Attiva la tua eSIM Costa d'Avorio in pochi minuti
  steps:
  - num: '1'
    ...
    desc: Subito dopo l'ordine riceverai un'email con il tuo codice QR di attivazione
      ...
      prima della partenza per Costa d'Avorio.
    is_list: false
  - num: '2'
    ...
    - Assegna un nome (es. "Roami Costa d'Avorio") e impostala come **predefinita
      per i dati mobili**
  ...
  - num: '3'
    ...
    desc: Dopo l'installazione puoi lasciare l'eSIM disattivata nelle impostazioni.
      ...
      mobili). Non appena atterri in Costa d'Avorio, attiva l'eSIM – la validità inizierà
      automaticamente al primo collegamento con la rete di Orange / MTN. Nessuna tassa
      di attivazione nascosta, nessun costo di roaming.
    is_list: false
  - num: '4'
    title: 'Arrivo in Costa d''Avorio: subito online con 5G/4G'
    desc: Non appena atterrato in Costa d'Avorio (ad esempio in Aeroporto Internazionale
      Félix-Houphouët-Boigny (Abidjan), Aeroporto di Yamoussoukro, Aeroporto di Bouaké),
      disattiva la modalità aereo (o rimani in modalità aereo e attiva solo l'eSIM).
      Vai su **Impostazioni → Cellulare** e attiva la tua eSIM Roami Costa d'Avorio.
      Entro pochi secondi il tuo dispositivo si collegherà automaticamente alla rete
      5G/4G più veloce disponibile di Orange / MTN. Potrai subito navigare, usare
    ...
    is_list: false
faq_section:
  title: FAQ eSIM Costa d'Avorio e Guida di Viaggio
  desc: Tutto ciò che devi sapere sull'uso della tua eSIM Costa d'Avorio in diversi
    scenari di viaggio.
  categories:
  - id: faq-general
    icon: help-circle
    ...
    - q: Posso installare l'eSIM Costa d'Avorio prima della partenza e attivarla successivamente?
      a: Sì, puoi installare l'eSIM già a casa (tramite Wi-Fi). L'attivazione avviene
        ...
        rete di Orange / MTN in Costa d'Avorio. Così eviti qualsiasi stress all'atterraggio.
    - q: Come attivo l'eSIM per Costa d'Avorio e quando inizia la validità?
      a: Dopo l'acquisto riceverai immediatamente un codice QR di attivazione via
        ...
        volta a una delle reti partner (Orange / MTN) in Costa d'Avorio. Paghi solo
    ...
    - q: Posso usare l'eSIM per Costa d'Avorio come hotspot con altri dispositivi?
      a: Sì, tutti i piani Roami eSIM per Costa d'Avorio consentono tethering illimitato
    ...
    - q: Posso mantenere il mio numero di telefono attuale mentre uso l'eSIM per Costa
        d'Avorio?
    ...
    - q: Roami offre anche eSIM regionali per viaggiare al di fuori di Costa d'Avorio?
      a: Sì, oltre all'eSIM Costa d'Avorio, offriamo eSIM regionali per Europa, Asia,
    ...
    - q: Quali reti 5G/4G utilizza l'eSIM per Costa d'Avorio e com'è la copertura?
      a: L'eSIM Costa d'Avorio lavora esclusivamente con Orange / MTN. Riceverai automaticamente
    ...
    - q: L'eSIM Costa d'Avorio supporta VoLTE e chiamate HD?
      a: Sì, l'eSIM Costa d'Avorio supporta VoLTE e voce HD, se il tuo dispositivo
        lo consente. Goditi una qualità audio nitida sulla rete 5G/4G di Orange /
        MTN.
    - q: Quali requisiti deve soddisfare il mio smartphone per utilizzare l'eSIM Costa
        d'Avorio?
    ...
    - q: Durante l'utilizzo dell'eSIM Costa d'Avorio, posso continuare a ricevere
  ...
  - id: faq-airport
    ...
    - q: Come posso ottenere una rete affidabile subito dopo l'atterraggio?
      a: Installa l'eSIM Costa d'Avorio prima del volo. Non appena atterri in aeroporti
        come Aeroporto Internazionale Félix-Houphouët-Boigny (Abidjan), Aeroporto
        di Yamoussoukro, Aeroporto di Bouaké, disattiva la modalità aereo e attiva
    ...
    - q: Come contatto la persona che viene a prendermi o uso Uber/Grab?
      a: Dopo l'attivazione all'atterraggio, puoi utilizzare app come Uber (Abidjan),
        Yango (locale), Moov Africa (servizi mobili) per prenotare una corsa o WhatsApp
    ...
    - q: Come uso Google Maps/Apple Maps per trovare i mezzi di trasporto?
      a: Con i tuoi dati eSIM Costa d'Avorio, puoi controllare in tempo reale gli
        orari di treni e autobus direttamente al ritiro bagagli in Aeroporto Internazionale
        Félix-Houphouët-Boigny (Abidjan), Aeroporto di Yamoussoukro, Aeroporto di
        Bouaké o trovare la strada per il parcheggio dei taxi.
    - q: Come evito SIM costose in aeroporto?
      a: Acquistando la nostra eSIM Costa d'Avorio online in anticipo, eviti completamente
    ...
    - q: Come ricevo SMS da hotel/noleggio auto senza numero locale?
      a: La nostra eSIM Costa d'Avorio è solo dati. Per ricevere SMS, lascia attiva
    ...
    - q: Come contatto immediatamente la mia famiglia?
      a: Appena atterri, puoi usare iMessage, WhatsApp o FaceTime sui nostri rapidi
        dati eSIM Costa d'Avorio per far sapere ai tuoi cari che sei arrivato sano
        e salvo.
  - id: faq-transport
    icon: car
    tab_title: Trasporti
    ...
    - q: Come uso Google Maps per pianificare il percorso?
      a: La nostra stabile connessione eSIM Costa d'Avorio garantisce che Google Maps
        possa caricare i dati sul traffico in tempo reale e gli orari ovunque in Costa
        d'Avorio.
    - q: Come possono i conducenti Uber/Grab contattarmi tramite l'app?
      a: App come Uber (Abidjan), Yango (locale), Moov Africa (servizi mobili) usano
        VoIP. Poiché hai dati eSIM Costa d'Avorio attivi, gli autisti possono chiamarti
    ...
    - q: Come acquisto biglietti del treno o della metropolitana online?
      a: Usa i tuoi dati eSIM Costa d'Avorio per acquistare biglietti digitali con
    ...
    - q: Come uso Google Maps per la navigazione in tempo reale in auto a noleggio?
      a: Monta il telefono e usa la tua eSIM Costa d'Avorio. Un piano da 5GB o 10GB
    ...
    - q: Come scansiono e sblocco i monopattini elettrici (Lime/Bird)?
      a: Sbloccare i monopattini richiede una connessione Internet veloce. La nostra
        eSIM Costa d'Avorio offre la copertura affidabile necessaria.
    ...
    - q: Come offro un hotspot stabile per la mia famiglia?
      a: Basta attivare 'Hotspot personale' nelle impostazioni. La tua famiglia può
        connettersi alla tua rete eSIM Costa d'Avorio sul treno o in auto.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotel
    ...
    - q: Come faccio il self-check-in dopo la prenotazione?
      a: Molte strutture moderne inviano codici per serrature intelligenti via email.
        La tua eSIM Costa d'Avorio ti garantisce di poter recuperare questi dettagli
    ...
    - q: Come contatto il mio host Airbnb al mio arrivo?
      a: Usa la funzione di messaggistica dell'app Airbnb o WhatsApp per coordinare
        l'orario di arrivo con il tuo host tramite i dati mobili eSIM Costa d'Avorio.
    - q: Come uso Google Maps per navigare verso l'hotel?
      a: Che tu alloggi in Hotel Ivoire (Abidjan), Radisson Blu (Abidjan), Noom Hotel
        Abidjan Plateau, inserisci l'indirizzo in Google Maps e usa la navigazione
        della tua eSIM Costa d'Avorio.
    - q: Come ricevo i codici di verifica SMS?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i tuoi dati eSIM Costa
        d'Avorio per ricevere codici via email o app di autenticazione.
    - q: Come contatto rapidamente l'assistenza clienti?
      a: Usa app VoIP come Skype o la funzione chat dell'app di prenotazione con i
        tuoi dati ad alta velocità eSIM Costa d'Avorio.
    - q: Come ordino cibo con app di consegna locali?
      a: Scarica Jumia Food, Uber Eats (presente ad Abidjan), Afrikrea (locale) e
        usa i tuoi dati eSIM Costa d'Avorio per ordinare un pasto caldo direttamente
        nella hall dell'hotel.
    - q: Come rimango in contatto con l'hotel dopo il check-out?
      a: Una volta uscito dal Wi-Fi dell'hotel, la tua eSIM Costa d'Avorio subentra,
  ...
  - id: faq-attractions
    ...
    - q: Come acquisto biglietti elettronici su GetYourGuide/Viator?
      a: Se vuoi visitare Basilica di Nostra Signora della Pace di Yamoussoukro, Parco
        Nazionale di Taï, Grand-Bassam (Patrimonio UNESCO) all'ultimo minuto, puoi
        usare i tuoi dati eSIM Costa d'Avorio per acquistare biglietti online e mostrare
        il codice a barre direttamente.
    - q: Come prenoto esperienze su Tripadvisor immediatamente?
      a: Con l'affidabile 4G/5G della tua eSIM Costa d'Avorio, puoi leggere recensioni
    ...
    - q: Come uso Wikipedia/Google per informazioni durante la visita?
      a: Arricchisci la tua esperienza culturale cercando fatti storici su Google
        o traducendo i cartelli dei musei mentre esplori Costa d'Avorio.
    - q: Come trovo la strada per l'attrazione successiva?
      a: Inserisci la tua prossima destinazione in Google Maps; la forte copertura
        della tua eSIM Costa d'Avorio ti guiderà lungo il percorso più veloce.
    - q: Come controllo i tempi di attesa in tempo reale nei parchi divertimento?
      a: Le app dei parchi divertimento necessitano di Internet per i tempi di attesa
        in tempo reale. La tua eSIM Costa d'Avorio ti mantiene online in tutto il
        parco.
    - q: Come accedo a Ticketmaster per i biglietti degli spettacoli?
      a: Puoi acquistare in sicurezza biglietti per spettacoli last minute tramite
        app di ticketing con i tuoi dati eSIM Costa d'Avorio.
    - q: Come condivido subito foto/video su Instagram/TikTok?
      a: Le nostre veloci velocità di upload eSIM Costa d'Avorio ti permettono di
  ...
  - id: faq-social
    ...
    - q: Come utilizzo WhatsApp/Telegram in modo stabile all'estero?
      a: I tuoi account sono legati al tuo numero di casa. Con la nostra eSIM Costa
        d'Avorio come fonte Internet, puoi chattare e chiamare esattamente come a
        casa.
    - q: Come carico contenuti su TikTok senza Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è spesso lento e insicuro. La nostra eSIM Costa d'Avorio
    ...
    - q: Come faccio videochiamate con la mia famiglia?
      a: Le nostre partnership di rete garantiscono che le videochiamate tramite eSIM
        Costa d'Avorio siano chiare e senza ritardi, ovunque ti trovi nel paese.
    - q: È sicuro accedere ai social network su Wi-Fi pubblico?
      a: Il Wi-Fi pubblico è vulnerabile agli hacker. Utilizzare i tuoi dati eSIM
        Costa d'Avorio personali è crittografato e molto più sicuro.
    - q: Come condivido la rete come hotspot con i compagni di viaggio?
      a: Attiva la funzione hotspot. I tuoi amici possono connettersi e utilizzare
        il tuo volume dati eSIM Costa d'Avorio per i loro social media.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Ho bisogno di una nuova SIM per ogni paese?
      a: L'eSIM singola per Costa d'Avorio funziona solo lì. Per viaggiare attraverso
    ...
    - q: Come evito i costi di roaming durante i viaggi in treno oltre confine?
      a: Disattiva il 'Roaming dati' sulla tua SIM domestica. Assicurati che l'eSIM
        Costa d'Avorio sia impostata come linea dati primaria.
  ...
  - id: faq-emergency
    ...
    - q: Come si compongono i numeri di emergenza locali?
      a: In Costa d'Avorio puoi comporre direttamente numeri di emergenza come 112
        (numero di emergenza unico), 185 (polizia), 180 (ambulanza), purché il telefono
        riceva un segnale cellulare.
    - q: Come trovo l'ospedale più vicino?
      a: I tuoi dati eSIM Costa d'Avorio consentono una ricerca immediata su Google
    ...
    - q: Come trovo le informazioni dell'ambasciata in caso di smarrimento del passaporto?
      a: Usa la tua eSIM Costa d'Avorio per trovare rapidamente l'indirizzo e il contatto
        di emergenza della tua ambasciata.
    - q: Come contatto l'assicurazione di viaggio in caso di incidente?
      a: Usa app VoIP come Skype tramite i tuoi dati eSIM Costa d'Avorio per chiamare
    ...
    - q: Come condivido la mia posizione in tempo reale?
      a: Usa 'Condividi posizione live' su WhatsApp o 'Dov'è?' di Apple per inviare
        le tue coordinate tramite i dati eSIM Costa d'Avorio.
    - q: Come scarico mappe offline per aree remote?
      a: Usa la copertura cittadina della tua eSIM Costa d'Avorio per caricare mappe
  ...
  - id: faq-business
    ...
    - q: Come garantisco riunioni Zoom/Teams stabili?
      a: La nostra eSIM Costa d'Avorio si connette a reti premium offrendo larghezza
    ...
    - q: Come mi connetto in modo sicuro alla VPN aziendale?
      a: I nostri dati non limitano alcun protocollo VPN. Puoi avviare la VPN aziendale
        in modo sicuro sulla rete eSIM Costa d'Avorio.
    - q: Come uso l'hotspot per laptop nei bar?
      a: Attiva l'hotspot. Utilizzare la tua eSIM Costa d'Avorio è molto più veloce
        e sicuro contro le minacce informatiche rispetto alle reti Wi-Fi aperte.
    - q: Come ricevo i codici 2FA per le email aziendali?
      a: Lascia attiva la tua SIM domestica per gli SMS e usa i dati eSIM Costa d'Avorio
        per i codici basati su email.
    - q: Come carico file di grandi dimensioni durante le visite ai clienti?
      a: Con le velocità 5G/4G della tua eSIM Costa d'Avorio puoi caricare rapidamente
        presentazioni sui servizi cloud.
    - q: Come utilizzo Slack/Gmail senza soluzione di continuità per la collaborazione?
      a: La tua eSIM Costa d'Avorio offre una connessione costante, così ricevi immediatamente
        messaggi Slack ed email.
    - q: Come aggiorno online i piani di viaggio per l'azienda?
      a: Accedi ai portali aziendali con la tua eSIM Costa d'Avorio in movimento per
