...
market_analysis:
  ...
  table_rows:
    - icon: "store"
      ...
      prepaid_title: ""
      prepaid_desc: "EE richiede l'attivazione in territorio britannico; l'attivazione tramite rete in roaming all'estero fallisce. Three impiega fino a 6 ore per attivare la SIM."
      esim_title: "Consegna digitale immediata"
      esim_desc: "Evita le lunghe attese nei negozi EE (fino a 30 minuti per lo sblocco dei contenuti per adulti) o l'attivazione di 6 ore di Three. Con Roami eSIM, attiva online in un minuto al tuo arrivo a Londra."
    - icon: "id-card"
    ...
    - icon: "calendar-xmark"
      ...
      prepaid_title: ""
      prepaid_desc: "I piani prepagati di EE, Vodafone e O2 hanno un ciclo di 30 giorni. Un turista che acquista il piano Vodafone da £10/8 GB per 7 giorni spreca oltre il 70% del valore del piano."
      esim_title: "Piani flessibili senza sprechi"
      esim_desc: "I piani locali hanno un ciclo fisso di 30 giorni (es. Vodafone £10/8 GB). Roami eSIM offre piani da 7 giorni a partire da 1,99 $/GB, eliminando lo spreco del 70% del valore del piano."
    - icon: "wifi"
      title: "Tethering e politiche di velocità"
      prepaid_title: ""
      prepaid_desc: "Lebara vieta esplicitamente il tethering. Three vieta il tethering al di fuori dell'UE (es. USA, Australia)."
      esim_title: "Tethering illimitato"
      esim_desc: "Lebara vieta il tethering e Three lo blocca fuori dall'UE. Con Roami eSIM, puoi condividere i dati con tutti i tuoi dispositivi senza restrizioni."
    - icon: "credit-card"
      title: "Ricarica e pagamento"
      prepaid_title: ""
      prepaid_desc: "Three e EE rifiutano carte di credito non britanniche per le ricariche online. Vodafone accetta PayPal ma con tassi di cambio sfavorevoli. I turisti spesso devono ricorrere a servizi di terze parti con sovrapprezzo del 10-15%."
      esim_title: "Pagamenti globali sicuri"
      esim_desc: "Evita le carte rifiutate da Three e EE. Roami eSIM accetta Visa, Mastercard, AMEX, Apple Pay, Google Pay e PayPal, senza sovrapprezzi nascosti."
    - icon: "headset"
      ...
      esim_desc: "A differenza del supporto locale spesso solo in inglese e con orari limitati, Roami eSIM offre assistenza clienti 24/7 in italiano e altre lingue."
  ...
  expert_verdict:
    ...
    cards:
      - icon: "wifi"
        ...
        desc: "Lebara vieta esplicitamente il tethering. Three lo blocca fuori dall'UE. Roami eSIM permette di condividere i dati con tutti i dispositivi senza restrizioni."
      - icon: "tower-observation"
        icon_bg: "bg-rose-100"
        icon_color: "text-rose-600"
        title: "Roaming UE senza costi nascosti"
        desc: "Three riduce i dati in roaming UE dell'85% (da 40 GB a 6 GB). Vodafone richiede un pacchetto aggiuntivo di £5/3 GB. Roami eSIM offre piani con roaming globale senza limiti di dati né costi extra."
      - icon: "clock"
        icon_bg: "bg-purple-100"
        icon_color: "text-purple-600"
        title: "Attivazione istantanea"
        desc: "EE richiede l'attivazione in negozio (fino a 30 minuti) e Three impiega fino a 6 ore. Roami eSIM si attiva online in meno di un minuto."
      - icon: "shield"
        icon_bg: "bg-red-100"
        icon_color: "text-red-600"
        title: "Sicurezza dei dati e privacy"
        desc: "Lyca Mobile ha noti rischi di furto di dati delle carte di credito. Roami eSIM non richiede dati sensibili e mantiene la tua SIM principale al sicuro."
---
