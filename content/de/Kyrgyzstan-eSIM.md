...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Kirgisistan eSIM FAQ
    questions:
    - q: |
        Ist eSIM günstiger als internationales Roaming für Kirgisistan?
      a: |
        Ja — Roami eSIM ist 80-90% günstiger als Roaming-Tarife der meisten heimischen Anbieter. Ein 5GB Tarif für Kirgisistan kostet $9.99, während Roaming $50+ kosten würde. Zudem erhalten Sie lokale Netzgeschwindigkeiten statt gedrosseltem Roaming. Tarife sind vorausbezahlt ohne versteckte Gebühren.
    - q: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. MegaComs Netz in Kirgisistan liefert stabile Verbindungen für Videoanrufe.
    - q: |
        Bekomme ich nach dem Kauf meiner Kirgisistan eSIM eine Bestätigung?
      a: |
    ...
    - q: |
      ...
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Kirgisistan Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
