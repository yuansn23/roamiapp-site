...
image: "/img/blog/usa/usa-esim-setup-guide.jpg"
...
h1title: "USA eSIM installieren und aktivieren: Schritt-für-Schritt für iPhone und Android"
...
recentPosts:
  ...
  - title: "Ultimativer Leitfaden: iPhone 17 eSIM-Aktivierungslösungen"
    ...
    date: "2026-05-20"
---
Diese Anleitung zur Einrichtung einer **eSIM Karte USA** deckt die Installation und Aktivierung ab. Die Installation einer **eSIM Karte USA** dauert auf den meisten modernen Smartphones etwa 2 Minuten, aber der häufigste Setup-Fehler – das Deaktivieren des Datenroamings – ist die Ursache für 80 % der „Kein Service“-Probleme nach der Landung.
...
Wenn Sie den gesamten Einrichtungsprozess vor Ihrer Reise risikofrei üben möchten, führt Sie [Roamis kostenlose eSIM-Testversion](/free-esim/) ohne Verpflichtung durch jeden Schritt. Der Code **WEB20** gewährt 20 % Rabatt auf jeden Tarif.

---

## Wie überprüfe ich, ob mein Telefon eSIM für die USA unterstützt?

Nicht alle Telefone funktionieren mit eSIM. Bevor Sie einen Tarif kaufen, vergewissern Sie sich, dass Ihres kompatibel ist. Dies ist der **erste und wichtigste Schritt** im Installationsprozess der USA eSIM.
...
|:-------|:------------|:----------------|
| Festlandchina | Bei den meisten Telefonen nicht verfügbar | iPhone (außer globale Modelle), Samsung, Xiaomi |
...
| Japan | Bei den meisten Telefonen verfügbar | iPhone (anbietergesperrte Modelle können abweichen) |
| Südkorea | Bei den meisten Telefonen verfügbar | Samsung, LG |

Wenn Sie Ihr Telefon in Festlandchina gekauft haben, bestätigen Sie die eSIM-Unterstützung beim Hersteller, bevor Sie einen USA eSIM-Tarif kaufen. Die meisten in China verkauften Telefone unterstützen kein eSIM, selbst wenn die globale Version desselben Modells es unterstützt.

---

## Wie wähle und kaufe ich den richtigen USA eSIM-Tarif?

Die meisten Anbieter bieten Tarife von 1 GB bis zu unbegrenztem Datenvolumen an. Hier ist eine kurze Übersicht basierend auf der Reisedauer.

| Anbieter | Startpreis | Am besten für | Netzwerk |
|:---------|:-------------:|:---------|:--------|
| Ubigi | $4 für 1 GB | Bestes Preis-Leistungs-Verhältnis | T-Mobile |
| Airalo | $4.50 für 1 GB | Kurze Reisen, einfache Einrichtung | T-Mobile + Verizon |
...
| 3 | Manueller Aktivierungscode (SM-DP+ Adresse) in der E-Mail | Gleiche E-Mail |
...
| Kurze Reise (5-7 Tage) | 3-10 GB | Plus Fotos, einige Videoanrufe |
| Zwei Wochen (10-14 Tage) | 10-20 GB | Mäßige Nutzung mit Streaming |
| Ein Monat (30 Tage) | 20-50 GB | Tägliche Nutzung, Hotspot, Streaming |

---

## Was gehört auf die USA eSIM-Installations-Checkliste vor der Abreise?

Befolgen Sie diese **USA eSIM-Installations-Checkliste vor der Abreise**, um Last-Minute-Probleme zu vermeiden:

| Schritt | Aufgabe | Status |
|:----:|:-----|:------:|
| 1 | **Telefonkompatibilität prüfen** — `*#06#` wählen und prüfen, ob eine EID-Nummer erscheint | |
| 2 | **Anbietersperre prüfen** — Kontaktieren Sie Ihren Anbieter, falls unsicher. Entsperrung mindestens 1 Woche vor Reise beantragen | |
| 3 | **eSIM-Tarif kaufen** — Anbieter wählen und online kaufen | |
| 4 | **QR-Code speichern** — Screenshot machen und auch den manuellen Aktivierungscode speichern | |
| 5 | **eSIM-Profil installieren** — QR-Code zu Hause im WLAN scannen | |
| 6 | **Linie benennen** — Nennen Sie sie z.B. „USA Daten“ zur leichteren Identifizierung | |
| 7 | **Dual-SIM konfigurieren** — Daten auf eSIM, Sprache auf heimische SIM einstellen | |
| 8 | **Offline-Karten herunterladen** — Google Maps offline für Ihre Zielstädte | |
| 9 | **Support-Info des Anbieters speichern** — Kontaktdaten für den Problemfall | |
| 10 | **Mit kostenloser Testversion testen** — Eine [kostenlose eSIM-Testversion](/free-esim/) ermöglicht es Ihnen, den gesamten Prozess zu üben | |
...
| 2 (Anbietersperre) | „SIM nicht unterstützt“-Fehler bei der Installation | Entsperrung 1+ Woche vor Reise beantragen |
| 3 (Tarif kaufen) | Keine Konnektivität bei Ankunft | Mindestens 2 Tage vor Abreise kaufen |
| 4 (QR-Code speichern) | QR-Code-E-Mail nicht finden | Screenshot + in der Cloud speichern |
| 5 (Profil installieren) | QR-Code am Flughafen nicht scannbar | Vor Abreise im heimischen WLAN installieren |
| 6 (Linie benennen) | eSIM mit heimischer SIM verwechseln | Deutlich „USA Daten“ nennen |
| 7 (Dual-SIM-Konfig.) | Falsche Linie für Daten verwendet | Vor Abreise konfigurieren |
| 8 (Offline-Karten) | Ohne Navigation verloren, wenn kein Signal | Vor Reise herunterladen |
| 9 (Support-Info) | Keine Hilfe, wenn eSIM versagt | In Kontakten oder Notizen speichern |
| 10 (Kostenlose Testversion) | Fehler bei der Ersteinrichtung | Mit [kostenloser Testversion](/free-esim/) üben |

---

## Wie installiere ich das USA eSIM-Profil auf meinem Telefon?
...
4. Benennen Sie die Linie eindeutig – z.B. „US-Daten“ oder „USA eSIM“
...
|:------------|:-------------------|:------|
| iOS 18 (aktuell) | Einstellungen -> Mobilfunk -> eSIM hinzufügen | QR-Code oder manuelle Eingabe |
...
|:-------|:-------------|:---------|
| **Mobiler Hotspot** | Verwenden Sie das Telefon eines Freundes als Hotspot für die 2 Minuten, die zum Scannen des QR-Codes benötigt werden | Reisen mit anderen |
| **Flughafen-WLAN** | Bei Ankunft mit dem kostenlosen Flughafen-WLAN verbinden und das Profil herunterladen | Spätentschlossene |
| **Manuelle Eingabe** | Der Anbieter sendet Ihnen die SM-DP+ Adresse und den Aktivierungscode per E-Mail zum manuellen Eintippen | Alle Reisenden |
| **Anbieter-App** | Einige Apps (Ubigi, Roami) bieten direkten Download ohne QR-Scanning | iPhone-Nutzer |
...
|:---------|:------------------|:--------------|
| Ubigi | Erste Verbindung zum US-Netzwerk | Vor Reise installieren, bei Ankunft aktivieren |
| Airalo | Erste Verbindung zum US-Netzwerk | Vor Reise installieren, bei Ankunft aktivieren |
...
| Nomad | Erste Datennutzung | Vor Reise installieren, bei Ankunft verbinden |
| **USA eSIM** | Erste Verbindung zum US-Netzwerk | Vor Reise installieren, bei Ankunft aktivieren |

**Wichtige Regel:** Bei den meisten Anbietern können Sie das eSIM-Profil zu Hause installieren, ohne die Tarifuhr zu starten. Der Tarif beginnt erst, wenn Sie sich erstmals mit einem US-Mobilfunknetz verbinden. Die Ausnahme ist Holafly, bei dem die Uhr ab dem Zeitpunkt des QR-Code-Scans beginnt.
...
|:---------|:---------|:-----------|:---------|:-----------------:|
| Städtereisender mit heimischer SIM | USA eSIM | Heimische SIM | Heimische SIM | Heimatnummer + E-Mail |
| Geschäftsreisender benötigt US-Nummer | USA eSIM | Tello-eSIM (US-Nummer) | Tello | Heimatnummer + E-Mail |
| Mehrländereise | USA eSIM | Heimische SIM | Heimische SIM | Heimatnummer |
...
2. Sprachanrufe: Stellen Sie Tello als Standard-Sprachleitung ein
3. SMS: Stellen Sie Tello als Standard-SMS-Leitung ein
4. Datenroaming für die USA eSIM EIN
5. Datenroaming für die heimische eSIM AUS
...
|:------|:-----------------|:-----------|
| iPhone | Einstellungen -> Mobilfunk -> Mobilfunkdaten | Zeigt an, welche Leitung für Daten verwendet wird |
| iPhone | Einstellungen -> Mobilfunk -> [Heimische SIM] -> Datenroaming | Muss AUS sein |
| Samsung | Einstellungen -> Verbindungen -> SIM-Karten-Manager -> Mobile Daten | Zeigt die Daten-SIM-Auswahl |
| Samsung | Einstellungen -> Verbindungen -> SIM-Karten-Manager -> [Heimische SIM] -> Datenroaming | Muss AUS sein |
| Google Pixel | Einstellungen -> Netzwerk & Internet -> SIMs -> [Heimische SIM] -> Datenroaming | Muss AUS sein |
...
2. **Schalten Sie den Flugmodus ein und aus** – erzwingt eine erneute Netzwerkregistrierung
3. **Setzen Sie die Netzwerkeinstellungen zurück** – Einstellungen -> Allgemein -> Übertragen oder Zurücksetzen -> Zurücksetzen -> Netzwerkeinstellungen zurücksetzen (iPhone) oder Einstellungen -> Allgemeine Verwaltung -> Zurücksetzen -> Netzwerkeinstellungen zurücksetzen (Samsung)
4. **Installieren Sie das eSIM-Profil neu** – löschen und neu installieren (nur wenn Sie eine Sicherung des QR-Codes haben)
5. **Kontaktieren Sie den Support des Anbieters** – sie können prüfen, ob das Profil auf deren Seite aktiv ist

---

## So stellen Sie den APN für die USA eSIM manuell ein

Die meisten Anbieter konfigurieren den APN automatisch. Wenn nicht, funktionieren Ihre Daten nicht, bis der APN korrekt eingestellt ist. Hier sind die **USA eSIM-APN-Einstellungen** und wie Sie sie manuell einrichten:
...
**So stellen Sie den APN auf dem iPhone ein:** Einstellungen -> Mobilfunk -> Tippen Sie auf die USA eSIM-Linie -> Mobilfunkdatennetz -> Geben Sie den APN-Wert ein.

**So stellen Sie den APN auf Android ein:** Einstellungen -> Verbindungen -> Mobile Netzwerke -> Zugangspunkte -> Neuen APN hinzufügen.
...
| Benutzerdefiniertes ROM oder gerootetes Telefon | Geänderte Firmware unterbricht die Autokonfiguration | APN manuell eingeben |
| eSIM über manuellen Code installiert | Autokonfiguration hängt von QR-Code-Metadaten ab | APN manuell eingeben |
| eSIM-Telefon der ersten Generation | Eingeschränkte Autokonfigurationsunterstützung | APN manuell eingeben |
...
3. Wenn Websites nicht geladen werden, das Telefon aber ein Signal anzeigt, ist der APN wahrscheinlich falsch
4. Überprüfen Sie die APN-Eingabe (bei einigen Anbietern wird zwischen Groß- und Kleinschreibung unterschieden)
5. Entfernen Sie nachgestellte Leerzeichen im APN-Feld

**Testen Sie mit einer zuverlässigen Seite:** Verwenden Sie google.com oder eine Speedtest-Seite. Einige Websites werden aufgrund von DNS-Problemen, die nichts mit dem APN zu tun haben, möglicherweise nicht geladen. Wenn eine Site fehlschlägt, aber eine andere geladen wird, funktioniert der APN und das Problem liegt am DNS.
...
2. Schalten Sie den Flugmodus ein und aus – dies erzwingt eine neue Netzwerkverbindung
...
|:-----|:---------------|:------------|
| Signalstärke prüfen | 3-5 Balken sichtbar | Zum Fenster oder in einen offenen Bereich gehen |
| Netzwerknamen prüfen | T-Mobile, AT&T, Verizon oder Partner | Flugmodus umschalten |
...
Wenn Ihnen während Ihrer Reise das Datenvolumen ausgeht, hängt **wie Sie USA eSIM-Daten aufladen** von Ihrem Anbieter ab:

| Anbieter | Auflademethode | Mindestaufladung | Kann aufladen? |
|:---------|:--------------|:--------------:|:-----------:|
| **Ubigi** | App -> Meine Tarife -> Daten hinzufügen | 1 GB | Ja |
| **Airalo** | App -> Meine eSIMs -> Daten hinzufügen | 1 GB | Ja |
| **Holafly** | App -> Tarif verlängern | 5 Tage | Ja (nur Verlängerung) |
| **Nomad** | App -> Aufladen | 1 GB | Ja |
...
|:-------|:-------------|:---------|
| Anbieter-App | Echtzeit-Nutzungs-Dashboard | Alle Nutzer |
...
| Anbieter-SMS | Text „USAGE“ an eine Kurzwahl | T-Mobile, AT&T, Verizon |
| Widget | Einige Anbieter-Apps bieten Startbildschirm-Widgets | Häufige Prüfer |

**Datenwarnung einstellen:** Auf dem iPhone gehen Sie zu Einstellungen -> Mobilfunk -> Mobilfunkdaten -> Datenwarnung bei 80 % Ihres Tarifs einstellen. Auf Android gehen Sie zu Einstellungen -> Netzwerk & Internet -> Datennutzung -> Datenwarnung & -grenze. Das gibt Ihnen Zeit, aufzuladen oder die Nutzung anzupassen, bevor das Volumen aufgebraucht ist.

---

## Kann ich meine USA eSIM neu installieren, wenn ich sie lösche?

**Kann ich meine USA eSIM neu installieren, wenn ich sie lösche?** Die kurze Antwort lautet: **Nein, Sie können ein gelöschtes USA eSIM-Profil nicht neu installieren.**

Sobald Sie ein eSIM-Profil von Ihrem Telefon löschen, ist der QR-Code nur einmal verwendbar und kann nicht erneut gescannt werden. Der gleiche QR-Code funktioniert kein zweites Mal. Hier ist, was zu tun ist:

| Anbieter | Kann neu installiert werden? | Was tun |
|:---------|:------------------:|:-----------|
...
| USA eSIM | Vielleicht | Support kontaktieren. Konto-verknüpfte Profile können möglicherweise erneut heruntergeladen werden |

**Die beste Praxis:** Löschen Sie Ihr eSIM-Profil niemals während der Fehlerbehebung. Löschen Sie es nur, wenn Sie sicher sind, dass Sie es nicht mehr benötigen. Bewahren Sie immer einen Screenshot Ihres QR-Codes und den manuellen Aktivierungscode aus Ihrer Bestätigungs-E-Mail auf – einige Anbieter können diese verwenden, um ein funktionierendes Profil neu auszustellen.
...
| „Heimat – [Anbieter]“ | Heimische SIM | Sprache und SMS |
...
## Behebung von Problemen bei der USA eSIM-Installation

**Behebung von Problemen bei der USA eSIM-Installation** – so lösen Sie die häufigsten Probleme:

| Problem | Wahrscheinliche Ursache | Kurzlösung |
|:--------|:-------------|:-----------|
| QR-Code wird nicht gescannt | Kamerafokus oder Beleuchtung | Screenshot des QR-Codes und Scannen vom Screenshot |
| „Keine Mobilfunkdaten“ nach Installation | Datenroaming aus | Datenroaming für die eSIM-Linie einschalten |
| 5G wird angezeigt, aber kein Internet | APN nicht eingestellt | APN manuell aus der obigen Tabelle eingeben |
| Telefon akzeptiert die eSIM nicht | Anbietergesperrt | Kontaktieren Sie den Anbieter, um das Telefon zu entsperren |
| Fehler „eSIM kann nicht hinzugefügt werden“ | Inkompatibles Gerät | EID-Nummer über `*#06#` prüfen |
| eSIM installiert, aber kein Signal | Keine Netzwerkauswahl | Manuell T-Mobile, AT&T oder Verizon auswählen |
| Daten haben mitten auf der Reise aufgehört | Tarif abgelaufen oder Daten aufgebraucht | Tarifgültigkeit und Restdaten prüfen; bei Bedarf aufladen |
...
4. Wählen Sie zuerst „T-Mobile“ – wenn dies fehlschlägt, versuchen Sie „AT&T“ oder „Verizon“
...
4. Wenn die Registrierung fehlschlägt, versuchen Sie ein anderes Netzwerk
...
| iPhone 13 (chinesisches Modell) | eSIM in Firmware deaktiviert | Kann eSIM nicht verwenden – physische SIM verwenden |
...
| Derzeit konfigurierte APN-Einstellungen | Einstellungen -> Mobilfunkdatennetz |
| Datenroaming-Status (EIN/AUS) | Einstellungen -> Mobilfunk -> [eSIM-Linie] |
| Bereits durchgeführte Schritte | Auflisten, was Sie versucht haben |

Wenn Sie diese Informationen bereithalten, verkürzt sich die Support-Lösungszeit von über 30 Minuten auf unter 10 Minuten für die meisten Probleme.

---

## Welche häufigen Fehler sollten Sie bei der USA eSIM-Installation vermeiden?

**Datenroaming nicht einschalten.** Dies ist der häufigste Grund, warum eSIMs nach der Landung nicht funktionieren. Reise-eSIMs benötigen Datenroaming, um zu funktionieren. Ohne es leitet Ihr Telefon keine Daten über die eSIM.

**Die eSIM vor der Ankunft einschalten.** Einige Tarife beginnen mit der Zählung ab der Aktivierung und nicht ab der ersten Netzwerkverbindung. Wenn Sie die eSIM-Linie zu Hause aktivieren, könnten Sie einen Tag Dienst verlieren. Lassen Sie sie ausgeschaltet, bis Sie landen.

**Das Profil während der Fehlerbehebung löschen.** QR-Codes sind nur einmal verwendbar. Wenn Sie das eSIM-Profil löschen, können Sie es nicht mit demselben QR-Code neu installieren. Sie müssen den Support für einen Ersatz kontaktieren.

**Die Anbietersperre nicht prüfen.** Wenn Ihr Telefon für einen Anbieter gesperrt ist, funktionieren USA eSIMs nicht. Überprüfen Sie dies vor dem Kauf bei Ihrem Anbieter.
...
| Kauf von zu wenig Daten und Nachladen erforderlich | $5-15 zusätzliche Gebühren | 20 % mehr als geschätzt kaufen |
| Aktivierung zur falschen Zeit | 1-2 Tage verlorene Gültigkeit | Bei Ankunft aktivieren, nicht vorher |
| Nutzung von Hotspot ohne Prüfung der Obergrenze | Dienstunterbrechung | Hotspot-Richtlinie vor dem Kauf prüfen – bei den meisten Anbietern ist **eSIM USA Tethering Hotspot erlaubt** |
| Ignorieren von Aktionscodes | 10-20 % Ersparnis verpasst | Vor dem Kauf nach Codes suchen |
...
**Auf Android (Samsung):** Einstellungen -> Verbindungen -> SIM-Karten-Manager -> Tippen Sie auf die eSIM-Linie. Der Netzwerkname wird unterhalb des Signalindikators angezeigt.

**Auf Android (Google Pixel):** Einstellungen -> Netzwerk & Internet -> SIMs -> Tippen Sie auf die eSIM-Linie. Das aktuelle Netzwerk wird oben angezeigt.
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "USA eSIM installieren und aktivieren: Schritt-für-Schritt für iPhone und Android",
  "description": "USA eSIM auf iPhone & Android einrichten per QR-Code oder manuell. In 2 Min. aktiviert mit Roami. Jetzt einrichten!",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "USA eSIM Installation", "item": "/blog/usa-esim-setup-guide/" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Wie installiere ich eine USA eSIM auf dem iPhone?", "acceptedAnswer": { "@type": "Answer", "text": "Öffnen Sie Einstellungen -> Mobilfunk -> eSIM hinzufügen -> QR-Code scannen -> Linie benennen -> Daten auf eSIM, Sprache auf heimische SIM einstellen. Vollständige Installation vor der Abreise im WLAN durchführen." } },
    { "@type": "Question", "name": "Wie aktiviere ich eine USA eSIM auf Android?", "acceptedAnswer": { "@type": "Answer", "text": "Für Samsung: Einstellungen -> Verbindungen -> SIM-Karten-Manager -> eSIM hinzufügen -> QR-Code scannen. Für Google Pixel: Einstellungen -> Netzwerk & Internet -> SIMs -> eSIM hinzufügen -> QR-Code scannen." } },
    { "@type": "Question", "name": "Kann ich USA eSIM vor meiner Reise installieren?", "acceptedAnswer": { "@type": "Answer", "text": "Ja – und Sie sollten es tun. Installieren Sie das Profil vor der Abreise zu Hause im WLAN. Der Tarif beginnt erst mit der Zählung, wenn Sie sich mit einem US-Netzwerk verbinden." } },
    { "@type": "Question", "name": "Muss ich für die USA eSIM das Datenroaming aktivieren?", "acceptedAnswer": { "@type": "Answer", "text": "Ja. Reise-eSIMs benötigen Datenroaming, um zu funktionieren. Schalten Sie das Datenroaming für die eSIM-Linie EIN und für Ihre heimische SIM AUS, um internationale Gebühren zu vermeiden." } },
    { "@type": "Question", "name": "Kann ich meine USA eSIM neu installieren, wenn ich sie lösche?", "acceptedAnswer": { "@type": "Answer", "text": "Nein. Der QR-Code ist nur einmal verwendbar. Wenn Sie das Profil löschen, können Sie es nicht mit demselben QR-Code neu installieren. Kontaktieren Sie den Support – dieser kann möglicherweise ein neues Profil generieren." } }
  ]
}
</script>

*Die Preise können sich ändern – überprüfen Sie die aktuellen Tarife auf der offiziellen Website jedes Anbieters, bevor Sie kaufen. Zuletzt aktualisiert: Juli.*

Eine vollständige Übersicht über die USA eSIM finden Sie in unserem [USA eSIM-Komplettleitfaden](/blog/usa-esim-complete-guide/).