...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Brasilien eSIM FAQ
    questions:
    - q: |
        Gibt es große Unterschiede zwischen Vivo, Claro und TIM für eSIM in Brasilien?
      a: |
        Ja — Vivo ist am schnellsten in Städten (5G bis zu 1 Gbit/s). Claro deckt etwa 85% des Landes ab, auch ländliche Gebiete. TIM ist die günstigste Option mit niedrigeren Preisen pro GB. Brasilien nutzt 5G auf n78-Band mit Abdeckung in São Pa Roami wählt automatisch das beste Netz für Sie aus.
    - q: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Vivos Netz in Brasilien liefert stabile Verbindungen für Videoanrufe.
    - q: |
        Bekomme ich nach dem Kauf meiner Brasilien eSIM eine Bestätigung?
      a: |
