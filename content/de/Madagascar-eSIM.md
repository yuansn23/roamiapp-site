...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Madagaskar eSIM FAQ
    questions:
    - q: |
        Was tun, wenn meine Madagaskar eSIM bei der Ankunft nicht funktioniert?
      a: |
    ...
    - q: |
      ...
      a: |
        Vor der Abreise — die Installation benötigt Internet und dauert etwa 2 Minuten. Der QR-Code kommt innerhalb von 5 Minuten per Email. In Madagaskar einfach Daten-Roaming aktivieren, und Sie sind in unter 60 Sekunden online. Ohne vorherige Installation müssten Sie am Flughafen auf WiFi angewiesen sein, das oft eine SMS-Verifizierung verlangt — ein klassisches Henne-Ei-Problem.
    - q: |
    ...
    - q: |
        Kann ich WhatsApp und FaceTime mit eSIM in Madagaskar nutzen?
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Oranges Netz in Madagaskar liefert stabile Verbindungen für Videoanrufe.
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Madagaskar nutze?
      a: |
