...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "eSIM in Panama -- Welche Geschwindigkeit ist realistisch? Ein Reisebericht"
  ...
  - id: faq-general
    ...
    questions:
    - q: |
        Gibt es große Unterschiede zwischen Claro, +Móvil und Tigo für eSIM in Panama?
      a: |
        Ja — Claro ist am schnellsten in Städten (5G bis zu 1 Gbit/s). +Móvil deckt etwa 85% des Landes ab, auch ländliche Gebiete. Tigo ist die günstigste Option mit niedrigeren Preisen pro GB. Panama hat 4G/5G mit guter Abdeckung in Panama-Stadt. Roami wählt automatisch das beste Netz für Sie aus.
    - q: |
        Woran erkenne ich, ob mein Handy eSIM in Panama unterstützt?
      a: |
    ...
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Panama nutze?
      a: |
    ...
    - q: |
        Bekomme ich nach dem Kauf meiner Panama eSIM eine Bestätigung?
      a: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Claros Netz in Panama liefert stabile Verbindungen für Videoanrufe.
    - q: |
