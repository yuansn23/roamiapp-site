...
features:
  ...
  - icon: zap
    ...
    desc: Erhalten Sie Ihren Färöer eSIM QR-Code per E-Mail in 5 Minuten
  - icon: headset
    color: from-emerald-400 to-emerald-600
    title: 24/7 Support
    desc: 24/7 Support für Ihre Färöer-Reise - echte Menschen, keine Bots
  - icon: shield-check
    color: from-amber-400 to-amber-600
    title: Garantie
    desc: 100% Geld-zurück, falls Ihre Färöer eSIM nicht aktiviert wird
  - icon: wifi
    color: from-purple-400 to-purple-600
    title: Hotspot erlaubt
    desc: Teilen Sie Ihre Färöer-Daten mit Reisebegleitern, keine Limits
  - icon: file-x
    color: from-rose-400 to-rose-600
    title: Keine Verträge
    desc: Keine Verträge, jederzeit kündbar - perfekt für Färöer-Reisen
  - icon: radio-tower
...
network_coverage:
  title: 'Färöer eSIM Netzabdeckung: Komplette Anleitung zu lokalen Netzen'
  ...
  carriers:
    title: 'Faroese Telecom, Vodafone Føroyar & Telenor Føroyar: Färöer eSIM Anbieter'
    ...
    - name: Vodafone
      ...
      network: 5G/4G/LTE Netzwerk
reminders:
  title: 'Färöer eSIM Tipps: Was Sie vor Ihrer Reise wissen sollten'
  items:
  - icon: 📱
...
activation_steps:
  title: 'Färöer eSIM Aktivierung: In 3 Schritten verbunden'
  steps:
  - num: '1'
    ...
    desc: Direkt nach Ihrer Bestellung erhalten Sie eine E‑Mail mit Ihrem persönlichen Aktivierungs‑QR‑Code und den Einrichtungsanweisungen.
      ...
      für die spätere Installation. Die eSIM ist 30 Tage gültig, Sie können sie also vor Ihrer Abreise nach Färöer in aller
      Ruhe vorbereiten.
    is_list: false
  - num: '2'
    ...
    - Vergeben Sie einen Namen (z.B. „Roami Färöer“) und wählen Sie ihn als **Standard für mobile Daten**
  ...
  - num: '3'
    ...
    desc: Nach der Installation können Sie die eSIM in den Einstellungen deaktiviert lassen. Sie können sie jedoch bereits
      mit Ihrem heimischen WLAN testen (es werden keine mobilen Daten verbraucht). Sobald Sie in Färöer landen, schalten Sie
      die eSIM einfach ein – die Gültigkeit startet dann automatisch bei der ersten Verbindung mit dem Netz von Faroese Telecom
      / Vodafone Føroyar. Keine versteckten Aktivierungsgebühren, keine Roamingkosten.
    is_list: false
  - num: '4'
    title: 'Ankunft in Färöer: sofort online mit 5G/4G'
    desc: Sobald Sie in Färöer gelandet sind (z.B. in Flughafen Vágar (FAE) – der einzige internationale Flughafen, daneben
      Hubschrauberlandeplätze in Tórshavn), schalten Sie den Flugmodus aus (oder bleiben Sie im Flugmodus und aktivieren Sie
      nur die eSIM). Gehen Sie zu **Einstellungen → Mobilfunk** und aktivieren Sie Ihre Roami Färöer eSIM. Innerhalb weniger
      Sekunden verbindet sich Ihr Gerät automatisch mit dem schnellsten verfügbaren 5G/4G-Netz von Faroese Telecom / Vodafone
