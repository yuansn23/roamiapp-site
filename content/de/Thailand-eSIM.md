...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Thailand eSIM FAQ
    questions:
    - q: |
        Welcher Netzbetreiber in Thailand ist am besten für Reisende — AIS, TrueMove oder dtac?
      a: |
        Thailand hat drei Hauptanbieter: AIS, TrueMove und dtac. AIS erreicht etwa 95% der Bevölkerung mit 4G/5G. TrueMove hat eine stärkere ländliche Abdeckung. dtac bietet oft günstigere Tarife, etwa 15-20% günstiger als AIS. Thailand nutzt 5G auf n78-Band mit guter Abdeckung in S Roami verbindet Sie automatisch mit dem stärksten Netz an Ihrem Standort.
    - q: |
        Soll ich meine Thailand eSIM vor der Abreise oder erst am Flughafen installieren?
      a: |
        Vor der Abreise — die Installation benötigt Internet und dauert etwa 2 Minuten. Der QR-Code kommt innerhalb von 5 Minuten per Email. In Thailand einfach Daten-Roaming aktivieren, und Sie sind in unter 60 Sekunden online. Ohne vorherige Installation müssten Sie am Flughafen auf WiFi angewiesen sein, das oft eine SMS-Verifizierung verlangt — ein klassisches Henne-Ei-Problem.
    - q: |
        Bekomme ich nach dem Kauf meiner Thailand eSIM eine Bestätigung?
      a: |
    ...
    - q: |
        Was tun, wenn meine Thailand eSIM bei der Ankunft nicht funktioniert?
      a: |
        Drei schnelle Checks (je ca. 30 Sekunden): 1) Ist Daten-Roaming aktiviert? 2) Können Sie AIS manuell auswählen? 3) Haben Sie das Telefon neu gestartet? Etwa 90% der Verbindungsprobleme lassen sich mit einem dieser Schritte lösen. Falls nicht: Roami 24/7 Support hilft innerhalb weniger Minuten weiter.
    - q: |
        Kann ich WhatsApp und FaceTime mit eSIM in Thailand nutzen?
      a: |
