...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "Wie gut kommt man mit eSIM in Japan online? Alle wichtigen Infos"
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Japan eSIM FAQ
    questions:
    - q: |
        Gibt es große Unterschiede zwischen Docomo, SoftBank und AU für eSIM in Japan?
      a: |
        Ja — Docomo ist am schnellsten in Städten (5G bis zu 1 Gbit/s). SoftBank deckt etwa 85% des Landes ab, auch ländliche Gebiete. AU ist die günstigste Option mit niedrigeren Preisen pro GB. Japan nutzt 5G auf n77/n78/n257-Bändern. Die meisten Ha Roami wählt automatisch das beste Netz für Sie aus.
    - q: |
    ...
    - q: |
      ...
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Japan Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Japan nutze?
      a: |
    ...
    - q: |
      ...
      a: |
        Die meisten Handys speichern 5-10 eSIM-Profile. Sie können Ihre Japan eSIM neben Ihrer heimischen SIM und bis zu 8 anderen Ländernprofilen speichern. Das Umschalten dauert etwa 10 Sekunden in den Telefoneinstellungen. iPhone ab XS (2018+) und Samsung ab S20 (2020+) unterstützen mehrere Profile gleichzeitig.
    - q: |
