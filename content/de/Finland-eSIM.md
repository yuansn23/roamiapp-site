...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Finnland eSIM FAQ
    questions:
    - q: |
        Woran erkenne ich, ob mein Handy eSIM in Finnland unterstützt?
      a: |
    ...
    - q: |
        Was tun, wenn meine Finnland eSIM bei der Ankunft nicht funktioniert?
      a: |
        Drei schnelle Checks (je ca. 30 Sekunden): 1) Ist Daten-Roaming aktiviert? 2) Können Sie Elisa manuell auswählen? 3) Haben Sie das Telefon neu gestartet? Etwa 90% der Verbindungsprobleme lassen sich mit einem dieser Schritte lösen. Falls nicht: Roami 24/7 Support hilft innerhalb weniger Minuten weiter.
    - q: |
        Kann ich meine Finnland eSIM noch in letzter Minute vor dem Flug kaufen?
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Finnland Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
    ...
    - q: |
      ...
      a: |
        Die meisten Handys speichern 5-10 eSIM-Profile. Sie können Ihre Finnland eSIM neben Ihrer heimischen SIM und bis zu 8 anderen Ländernprofilen speichern. Das Umschalten dauert etwa 10 Sekunden in den Telefoneinstellungen. iPhone ab XS (2018+) und Samsung ab S20 (2020+) unterstützen mehrere Profile gleichzeitig.
    - q: |
        Kann ich WhatsApp und FaceTime mit eSIM in Finnland nutzen?
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Elisas Netz in Finnland liefert stabile Verbindungen für Videoanrufe.
    - q: |
