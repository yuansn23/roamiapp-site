...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Israel eSIM FAQ
    questions:
    - q: |
        Gibt es große Unterschiede zwischen Cellcom, Partner und HOT für eSIM in Israel?
      a: |
        Ja — Cellcom ist am schnellsten in Städten (5G bis zu 1 Gbit/s). Partner deckt etwa 85% des Landes ab, auch ländliche Gebiete. HOT ist die günstigste Option mit niedrigeren Preisen pro GB. Israel nutzt 5G auf n78-Band mit dichter landesweiter A Roami wählt automatisch das beste Netz für Sie aus.
    - q: |
        Was tun, wenn meine Israel eSIM bei der Ankunft nicht funktioniert?
      a: |
        Drei schnelle Checks (je ca. 30 Sekunden): 1) Ist Daten-Roaming aktiviert? 2) Können Sie Cellcom manuell auswählen? 3) Haben Sie das Telefon neu gestartet? Etwa 90% der Verbindungsprobleme lassen sich mit einem dieser Schritte lösen. Falls nicht: Roami 24/7 Support hilft innerhalb weniger Minuten weiter.
    - q: |
        Kann ich meine Israel eSIM noch in letzter Minute vor dem Flug kaufen?
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Israel Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
