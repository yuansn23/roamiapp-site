...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "Wie gut kommt man mit eSIM in Croatia online? Alle wichtigen Infos"
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Kroatien eSIM FAQ
    questions:
    - q: |
        Woran erkenne ich, ob mein Handy eSIM in Kroatien unterstützt?
      a: |
    ...
    - q: |
      ...
      a: |
        Drei schnelle Checks (je ca. 30 Sekunden): 1) Ist Daten-Roaming aktiviert? 2) Können Sie Hrvatski Telekom manuell auswählen? 3) Haben Sie das Telefon neu gestartet? Etwa 90% der Verbindungsprobleme lassen sich mit einem dieser Schritte lösen. Falls nicht: Roami 24/7 Support hilft innerhalb weniger Minuten weiter.
    - q: |
        Kann ich meine Kroatien eSIM noch in letzter Minute vor dem Flug kaufen?
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Kroatien Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Hrvatski Telekoms Netz in Kroatien liefert stabile Verbindungen für Videoanrufe.
    - q: |
