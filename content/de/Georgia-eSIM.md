...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "eSIM Internetgeschwindigkeit in Georgia -- Was Reisende wissen sollten"
  desc: "Complete guide to eSIM internet speeds, network coverage, and connection quality for travelers in Georgia. Find out what speeds to expect and where eSIM works best."
  categories:
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Georgien eSIM FAQ
    questions:
    - q: |
        Was tun, wenn meine Georgien eSIM bei der Ankunft nicht funktioniert?
      a: |
        Drei schnelle Checks (je ca. 30 Sekunden): 1) Ist Daten-Roaming aktiviert? 2) Können Sie MagtiCom manuell auswählen? 3) Haben Sie das Telefon neu gestartet? Etwa 90% der Verbindungsprobleme lassen sich mit einem dieser Schritte lösen. Falls nicht: Roami 24/7 Support hilft innerhalb weniger Minuten weiter.
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Georgien nutze?
      a: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. MagtiComs Netz in Georgien liefert stabile Verbindungen für Videoanrufe.
    - q: |
