...
faq_section:
  ...
  - id: faq-general
    ...
    - q: |
      ...
      a: |
        Ja, nach 30GB pro Tag wird die Geschwindigkeit auf 512 kbps reduziert — bis Mitternacht. Die meisten Reisenden verbrauchen 500MB bis 3GB pro Tag. 30GB zu erreichen bedeutet 10 Stunden 4K-Streaming — für normale Nutzer unrealistisch. Türkei nutzt 5G auf n78-Band mit Abdeckung in Großstädt Ein 5GB oder 10GB Tarif ist für die meisten Reisenden völlig ausreichend.
    - q: |
    ...
    - q: |
      ...
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Türkei Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
    ...
    - q: |
        Was tun, wenn meine Türkei eSIM bei der Ankunft nicht funktioniert?
      a: |
        Drei schnelle Checks (je ca. 30 Sekunden): 1) Ist Daten-Roaming aktiviert? 2) Können Sie Turkcell manuell auswählen? 3) Haben Sie das Telefon neu gestartet? Etwa 90% der Verbindungsprobleme lassen sich mit einem dieser Schritte lösen. Falls nicht: Roami 24/7 Support hilft innerhalb weniger Minuten weiter.
---
