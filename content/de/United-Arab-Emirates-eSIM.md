...
modal:
  ...
  btn_text: Fortsetzen
  text_default: |-
    Unser eSIM-Dienst wurde auf <strong>PhoneSIMGo</strong> aktualisiert.<br>Neukunden erhalten 20% Rabatt, Promocode: web20
  text_android: |-
...
features:
  ...
  - icon: headset
    ...
    desc: Support, der Etisalat, du und Virgin Mobile UAE kennt
  - icon: radio-tower
  ...
  - icon: file-x
    ...
    desc: Keine Verträge, jederzeit kündbar
  - icon: shield-check
...
discount_banner:
  title: Spezialrabatt!
  desc_html: |-
    Verwenden Sie den Promocode <span class="font-mono bg-white text-blue-600 px-2 py-0.5 rounded font-bold mx-1">web20</span> an der Kasse und erhalten Sie <span class="font-bold underline decoration-wavy decoration-white underline-offset-4">20% RABATT</span> auf Ihre Bestellung!
...
network_coverage:
  ...
  carriers:
    ...
    items:
    - name: Etisalat
      coverage: Niedrige Latenz
      network: 5G/4G/LTE Netzwerk
    - name: du
      coverage: Zuverlässigkeit
      network: 5G/4G/LTE Netzwerk
reminders:
  title: Kurztipps für Reisende
  items:
  - icon: 📱
    html: |-
  ...
  compatibility_check:
    ...
    code: '*#06#'
    result_html: |-
      Wenn eine <span class="bg-slate-100 px-2 py-0.5 rounded text-slate-900 border border-slate-200 font-bold">EID</span> erscheint, ist Ihr Telefon bereit für eine eSIM.
activation_steps:
  title: Aktivierungsschritte
  steps:
  - num: '1'
    title: 'Schritt 1: QR-Code erhalten'
    desc: Nach der Zahlung werden ein QR-Code und eine Aktivierungsanleitung innerhalb von 5 Minuten an Ihre E-Mail-Adresse gesendet.
    is_list: false
  - num: '2'
...
faq_section:
  ...
  - id: faq-airport
    ...
    - q: Ist es sicher, Flughafen-WLAN anstelle dieser Touristen-eSIM zu verwenden?
      a: Öffentliches WLAN am Dubai International Airport (DXB), Abu Dhabi International Airport (AUH), Sharjah International Airport (SHJ) ist oft ungesichert und anfällig für Hacking. Die Nutzung Ihres eigenen privaten Mobilfunkdatentarifs ist viel sicherer für den Zugriff auf Banking-Apps oder persönliche E-Mails.
  - id: faq-transport
    icon: car
    tab_title: Transport
  ...
  - id: faq-dining
    ...
    - q: Kann ich einen Kaffee im Voraus über eine lokale Café-App bestellen?
      a: Ja, Sie können Ihre mobilen Daten nutzen, um im Voraus zu bestellen und zu bezahlen, sodass Sie bei Ihrer Ankunft im Café die Schlange überspringen können.
    - q: Kann ich in lokalen Cafés mit Bargeld, Kredit-/Debitkarte, Apple Pay/Google Pay oder Apple Pay bezahlen?
      a: Ja, kontaktlose Zahlungen via Apple Pay, Google Pay oder Bargeld, Kredit-/Debitkarte, Apple Pay/Google Pay erfordern einen kurzen Internet-Handshake, den Ihr aktiver Datentarif sofort verarbeitet.
    - q: Kann ich überprüfen, ob ein Restaurant auf Ernährungseinschränkungen eingeht?
      a: Mit sofortigem Internetzugang können Sie schnell die Website eines Restaurants durchstöbern oder ihm in sozialen Medien schreiben, um die Menüoptionen zu bestätigen.
  ...
  - id: faq-social
    ...
    title: 7. Soziale Medien & Chat
    questions:
    - q: Muss ich meine Telegram- oder iMessage-Einstellungen ändern?
      a: Keine Änderungen nötig. Solange Sie über unsere Touristen-eSIM Internet haben, funktionieren alle Ihre Messaging-Apps normal.
    - q: Verbraucht die Nutzung von TikTok oder Instagram mein Datenvolumen schnell?
      a: Video-Apps verbrauchen schnell Datenvolumen. Wenn Sie sie intensiv nutzen möchten, empfehlen wir den Kauf eines größeren Datenpakets oder einer unbegrenzten Touristen-eSIM.
  ...
  - id: faq-emergency
    ...
    - q: Kann ich diese Touristen-eSIM nutzen, um schnell eine Apotheke oder ein Krankenhaus zu finden?
      a: Ja, in einem Notfall ermöglicht Ihnen Ihre zuverlässige Datenverbindung, sofort Google Maps nach den nächstgelegenen medizinischen Einrichtungen zu durchsuchen und die schnellste Route zu erhalten.
    - q: Ist es möglich, medizinische Symptome mit einem lokalen Arzt zu übersetzen?
      a: Ja, Sie können den Konversationsmodus von Google Translate über Ihre mobilen Daten nutzen, um Ihre Symptome klar an medizinisches Fachpersonal zu kommunizieren.
  - id: faq-business
    icon: briefcase
    tab_title: Geschäft
