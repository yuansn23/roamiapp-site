...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Schweden eSIM FAQ
    questions:
    - q: |
        Gibt es große Unterschiede zwischen Telia, Tele2 und Telenor für eSIM in Schweden?
      a: |
        Ja — Telia ist am schnellsten in Städten (5G bis zu 1 Gbit/s). Tele2 deckt etwa 85% des Landes ab, auch ländliche Gebiete. Telenor ist die günstigste Option mit niedrigeren Preisen pro GB. Schweden nutzt 5G auf n78-Band mit Abdeckung in Großstä Roami wählt automatisch das beste Netz für Sie aus.
    - q: |
        Woran erkenne ich, ob mein Handy eSIM in Schweden unterstützt?
      a: |
    ...
    - q: |
        Soll ich meine Schweden eSIM vor der Abreise oder erst am Flughafen installieren?
      a: |
        Vor der Abreise — die Installation benötigt Internet und dauert etwa 2 Minuten. Der QR-Code kommt innerhalb von 5 Minuten per Email. In Schweden einfach Daten-Roaming aktivieren, und Sie sind in unter 60 Sekunden online. Ohne vorherige Installation müssten Sie am Flughafen auf WiFi angewiesen sein, das oft eine SMS-Verifizierung verlangt — ein klassisches Henne-Ei-Problem.
    - q: |
        Kann ich meine Schweden eSIM noch in letzter Minute vor dem Flug kaufen?
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Schweden Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
