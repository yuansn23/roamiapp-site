...
hero:
  ...
  title: Andorra eSIM Datentarif
  subtitle: Automatische Netzwerkauswahl | 1-Minuten-Aktivierung | Intelligente Wahl
features:
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Abdeckung
      desc: Genießen Sie umfassende Netzabdeckung in ganz Andorra, einschließlich
        Städten wie Andorra la Vella, Escaldes-Engordany und Encamp.  Unsere Andorra
        eSIM verbindet sich nahtlos mit den Netzen von Andorra Telecom, Mobilis und
        Som.
    - icon: zap
...
activation_steps:
  title: Aktivierung Ihrer Andorra eSIM in wenigen Minuten
  steps:
  - num: '1'
    ...
    desc: Direkt nach Ihrer Bestellung erhalten Sie eine E‑Mail mit Ihrem persönlichen
      ...
      vor Ihrer Abreise nach Andorra in aller Ruhe vorbereiten.
    is_list: false
  - num: '2'
    ...
    - Vergeben Sie einen Namen (z.B. „Roami Andorra“) und wählen Sie ihn als **Standard
      für mobile Daten**
  ...
  - num: '3'
    ...
    desc: Nach der Installation können Sie die eSIM in den Einstellungen deaktiviert
      ...
      keine mobilen Daten verbraucht). Sobald Sie in Andorra landen, schalten Sie
      die eSIM einfach ein – die Gültigkeit startet dann automatisch bei der ersten
      Verbindung mit dem Netz von Andorra Telecom / Mobilis. Keine versteckten Aktivierungsgebühren,
      keine Roamingkosten.
    is_list: false
  - num: '4'
    title: 'Ankunft in Andorra: sofort online mit 5G/4G'
    desc: Sobald Sie in Andorra gelandet sind (z.B. in Flughafen Barcelona-El Prat,
      Flughafen Toulouse-Blagnac, Flughafen Girona), schalten Sie den Flugmodus aus
      (oder bleiben Sie im Flugmodus und aktivieren Sie nur die eSIM). Gehen Sie zu
      **Einstellungen → Mobilfunk** und aktivieren Sie Ihre Roami Andorra eSIM. Innerhalb
      weniger Sekunden verbindet sich Ihr Gerät automatisch mit dem schnellsten verfügbaren
      5G/4G-Netz von Andorra Telecom / Mobilis. Sie können sofort navigieren, WhatsApp
      nutzen, soziale Medien checken oder einen Hotspot für andere Geräte einrichten
      – ohne Wartezeit, ohne Ausweis, ohne Vertrag.
    is_list: false
faq_section:
  title: Andorra eSIM FAQ & Reiseführer
  desc: Alles, was Sie über die Verwendung Ihrer Andorra eSIM in verschiedenen Reiseszenarien
    wissen müssen.
  categories:
  - id: faq-general
    icon: help-circle
    ...
    - q: Was kostet die Andorra eSIM und gibt es Rabattaktionen?
      a: Unser Andorra eSIM Tarif startet bei nur $1.99/GB. Mit dem Promo-Code 'web20'
    ...
    - q: Bietet Roami auch regionale eSIMs für Reisen über Andorra hinaus an?
      a: Ja, zusätzlich zur Andorra eSIM bieten wir Regional‑eSIM für Europa, Asien,
    ...
    - q: Wie aktiviere ich die Andorra eSIM und wann beginnt die Gültigkeit?
      a: Nach dem Kauf erhalten Sie sofort einen Aktivierungs‑QR‑Code per E‑Mail.
        Die Gültigkeit startet erst, wenn Ihr Telefon in Andorra erstmals eine Verbindung
        zu einem der Partner-Netze (Andorra Telecom / Mobilis) herstellt. So zahlen
    ...
    - q: Welche 5G/4G-Netzwerke nutzt die Andorra eSIM und wie ist die Abdeckung?
      a: Die Andorra eSIM arbeitet exklusiv mit Andorra Telecom / Mobilis zusammen.
    ...
    - q: Wie funktioniert das internationale Roaming mit der Andorra eSIM in Nachbarländern?
      a: Die Andorra eSIM ist primär für Andorra optimiert. Für Reisen in EU‑Nachbarländer
        empfehlen wir unsere Europa‑eSIM, die nahtloses Roaming ohne zusätzliche Kosten
        bietet. Die reine Land‑eSIM funktioniert nicht zuverlässig außerhalb von Andorra.
    ...
    - q: Kann ich meine bestehende Telefonnummer behalten, wenn ich die Andorra eSIM
        nutze?
    ...
    - q: Welche Voraussetzungen muss mein Smartphone erfüllen, um die Andorra eSIM
        nutzen zu können?
  ...
  - id: faq-airport
    ...
    - q: Wie erhalte ich sofort nach der Landung ein zuverlässiges Netz?
      a: Installieren Sie die Andorra eSIM vor Ihrem Flug. Sobald Sie an Flughäfen
        wie Flughafen Barcelona-El Prat, Flughafen Toulouse-Blagnac, Flughafen Girona
    ...
    - q: Wie kontaktiere ich meinen Abholer oder nutze Uber/Grab?
      a: Nach der Aktivierung bei der Landung können Sie sofort Apps wie Moovit, Free
        Now, Taxi Andorra App nutzen, um eine Fahrt zu buchen, oder WhatsApp verwenden,
    ...
    - q: Wie nutze ich Google Maps/Apple Maps, um Transportmittel zu finden?
      a: Mit Ihren Andorra eSIM-Daten können Sie direkt an der Gepäckausgabe in Flughafen
        Barcelona-El Prat, Flughafen Toulouse-Blagnac, Flughafen Girona Echtzeit-Fahrpläne
        für Züge und Busse prüfen oder den Weg zum Taxistand finden.
    - q: Wie vermeide ich teure SIM-Karten am Flughafen?
      a: Indem Sie unsere Andorra eSIM vorab online kaufen, umgehen Sie die teuren
    ...
    - q: Wie empfange ich SMS von Hotel/Autovermietung ohne lokale Nummer?
      a: Unsere Andorra eSIM ist ein reiner Datentarif. Um SMS zu empfangen, lassen
    ...
    - q: Wie kontaktiere ich sofort meine Familie?
      a: Sobald Sie landen, können Sie iMessage, WhatsApp oder FaceTime über unsere
        schnellen Andorra eSIM-Daten nutzen, um Ihren Lieben mitzuteilen, dass Sie
  ...
  - id: faq-transport
    ...
    - q: Wie nutze ich Google Maps zur Routenplanung?
      a: Unsere stabile Andorra eSIM-Verbindung stellt sicher, dass Google Maps überall
        in Andorra Echtzeit-Verkehrsdaten und Fahrpläne laden kann.
    - q: Wie können mich Uber/Grab-Fahrer über die App kontaktieren?
      a: Apps wie Moovit, Free Now, Taxi Andorra App nutzen VoIP. Da Sie aktive Andorra
    ...
    - q: Wie kaufe ich Zug- oder U-Bahn-Tickets online?
      a: Nutzen Sie Ihre Andorra eSIM-Daten, um in lokalen Apps digitale QR-Code-Tickets
        zu kaufen und lange Schlangen an Automaten zu vermeiden.
    - q: Wie nutze ich Google Maps für Echtzeit-Navigation im Mietwagen?
      a: Befestigen Sie Ihr Telefon und nutzen Sie Ihre Andorra eSIM. Ein 5GB- oder
    ...
    - q: Wie scanne und entsperre ich E-Scooter (Lime/Bird)?
      a: Das Entsperren von E-Scootern erfordert eine schnelle Internetverbindung.
        Unsere Andorra eSIM bietet die dafür nötige zuverlässige Abdeckung.
    ...
    - q: Wie biete ich einen stabilen Hotspot für meine Familie?
      a: Aktivieren Sie einfach den 'Persönlichen Hotspot' in Ihren Einstellungen.
        Ihre Familie kann sich mit Ihrem Andorra eSIM-Netzwerk im Zug oder Auto verbinden.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotels
    ...
    - q: Wie mache ich einen Self-Check-in nach Buchung?
      a: Viele moderne Unterkünfte senden Smart-Lock-Codes per E-Mail. Ihre Andorra
    ...
    - q: Wie kontaktiere ich meinen Airbnb-Gastgeber bei Ankunft?
      a: Nutzen Sie die Messaging-Funktion der Airbnb-App oder WhatsApp, um Ihre Ankunftszeit
        mit Ihrem Gastgeber über mobile Andorra eSIM-Daten abzustimmen.
    - q: Wie nutze ich Google Maps, um zum Hotel zu navigieren?
      a: Egal ob Sie in Sport Hotel Hermitage & Spa, Nobu Hotel Andorra, Park Piolets
        Mountain Hotel & Spa übernachten, geben Sie die Adresse in Google Maps ein
        und nutzen Sie die Navigation Ihrer Andorra eSIM.
    - q: Wie empfange ich SMS-Verifizierungscodes?
      a: Lassen Sie Ihre heimische SIM für SMS aktiv und nutzen Sie Ihre Andorra eSIM-Daten,
    ...
    - q: Wie kontaktiere ich schnell den Kundenservice?
      a: Nutzen Sie VoIP-Apps wie Skype oder die Chat-Funktion der Buchungs-App über
        Ihre Hochgeschwindigkeits-Andorra eSIM-Daten.
    - q: Wie bestelle ich Essen mit lokalen Liefer-Apps?
      a: Laden Sie Just Eat, Glovo, Uber Eats herunter und nutzen Sie Ihre Andorra
    ...
    - q: Wie bleibe ich nach dem Checkout mit dem Hotel in Kontakt?
      a: Sobald Sie das Hotel-WLAN verlassen, übernimmt Ihre Andorra eSIM, sodass
  ...
  - id: faq-attractions
    ...
    - q: Wie kaufe ich E-Tickets über GetYourGuide/Viator?
      a: Wenn Sie Caldea Thermal Spa, Grandvalira Skigebiet, Casa de la Vall spontan
        besuchen möchten, können Sie Ihre Andorra eSIM-Daten nutzen, um Online-Tickets
        zu kaufen und den Barcode direkt vorzuzeigen.
    - q: Wie buche ich Erlebnisse bei Tripadvisor sofort?
      a: Mit dem zuverlässigen 4G/5G Ihrer Andorra eSIM können Sie Bewertungen lesen
    ...
    - q: Wie nutze ich Wikipedia/Google für Informationen während des Besuchs?
      a: Erweitern Sie Ihr kulturelles Erlebnis, indem Sie historische Fakten googeln
        oder Museumstafeln übersetzen, während Sie Andorra erkunden.
    - q: Wie finde ich den Weg zur nächsten Sehenswürdigkeit?
      a: Geben Sie Ihr nächstes Ziel in Google Maps ein; die starke Abdeckung Ihrer
        Andorra eSIM führt Sie über die schnellste Route.
    - q: Wie prüfe ich Echtzeit-Wartezeiten in Freizeitparks?
      a: Freizeitpark-Apps benötigen Internet für Live-Wartezeiten. Ihre Andorra eSIM
    ...
    - q: Wie greife ich auf Ticketmaster für Show-Tickets zu?
      a: Sie können sicher Last-Minute-Theaterkarten über Ticketing-Apps mit Ihren
        Andorra eSIM-Daten kaufen.
    - q: Wie teile ich Fotos/Videos sofort auf Instagram/TikTok?
      a: Unsere schnellen Andorra eSIM-Upload-Geschwindigkeiten ermöglichen es Ihnen,
  ...
  - id: faq-dining
    ...
    - q: Wie finde ich Restaurants mit Google Maps/Tripadvisor?
      a: Suchen Sie mit Ihrer Andorra eSIM nach 'Restaurants in der Nähe', um Bewertungen,
        Öffnungszeiten und Menüfotos zu prüfen.
    - q: Wie reserviere ich Tische online?
      a: Sichern Sie sich eine Reservierung über Online-Plattformen mit Ihrer Andorra
        eSIM, während Sie unterwegs sind.
    - q: Wie scanne ich QR-Codes für digitale Menüs?
      a: Viele Restaurants nutzen digitale Menüs. Ihre Andorra eSIM stellt sicher,
    ...
    - q: Wie nutze ich die Google Translate Kamera für Speisekarten?
      a: Öffnen Sie die App und richten Sie die Kamera auf das Menü. Die Live-Übersetzung
        benötigt eine Internetverbindung über Ihre Andorra eSIM.
    - q: Wie nutze ich lokale Lieferdienste?
      a: Laden Sie lokale Apps wie Just Eat, Glovo, Uber Eats herunter und bestellen
        Sie bequem über Ihre Andorra eSIM-Mobildaten.
    - q: Wie bezahle ich mit Apple Pay/Google Pay?
      a: Kontaktlose Zahlungen oder lokale Methoden wie Visa, Mastercard, Bizum erfordern
        einen kurzen Internet-Handshake, den Ihre Andorra eSIM perfekt meistert.
    - q: Wie finde ich Geheimtipps von Food-Bloggern?
      a: Streamen Sie YouTube-Vlogs oder stöbern Sie in Yelp-Bewertungen mit Ihrer
        Andorra eSIM, um kulinarische Highlights zu entdecken.
  - id: faq-social
    icon: smartphone
    ...
    - q: Wie nutze ich WhatsApp/Telegram stabil im Ausland?
      a: Ihre Accounts sind an Ihre Heimnummer gebunden. Mit unserer Andorra eSIM
    ...
    - q: Wie lade ich Inhalte auf TikTok hoch, ohne öffentliches WLAN?
      a: Öffentliches WLAN ist oft langsam und unsicher. Unsere 4G/5G Andorra eSIM
        bietet die Bandbreite für schnelle Uploads.
    - q: Wie mache ich Videoanrufe mit meiner Familie?
      a: Unsere Netzwerkpartnerschaften garantieren, dass Videoanrufe über die Andorra
    ...
    - q: Ist es sicher, sich in öffentlichen WLANs in soziale Accounts einzuloggen?
      a: Öffentliches WLAN ist anfällig für Hacker. Die Nutzung Ihrer persönlichen
        Andorra eSIM-Daten ist verschlüsselt und wesentlich sicherer.
    - q: Wie teile ich das Netzwerk als Hotspot mit Reisebegleitern?
      a: Aktivieren Sie die Hotspot-Funktion. Ihre Freunde können sich verbinden und
        Ihr Andorra eSIM-Datenvolumen für ihre sozialen Medien nutzen.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Brauche ich für jedes Land eine neue SIM-Karte?
      a: Die Einzelland-Andorra eSIM funktioniert nur dort. Für Reisen durch mehrere
    ...
    - q: Wie vermeide ich Roaminggebühren bei Zugfahrten über Grenzen?
      a: Deaktivieren Sie 'Daten-Roaming' auf Ihrer Heim-SIM. Stellen Sie sicher,
        dass die Andorra eSIM als primäre Datenleitung eingestellt ist.
  ...
  - id: faq-emergency
    ...
    - q: Wie wähle ich lokale Notrufnummern?
      a: In Andorra können Sie Notrufnummern wie 112 (Notruf), 110 (Polizei), 116
        (Krankenwagen) direkt wählen, solange Ihr Telefon ein Mobilfunksignal empfängt.
    - q: Wie finde ich das nächste Krankenhaus?
      a: Ihre Andorra eSIM-Daten ermöglichen eine sofortige Suche auf Google Maps
        nach 'Apotheke' oder 'Krankenhaus' mit der schnellsten Route.
    - q: Wie finde ich Botschaftsinformationen bei Passverlust?
      a: Nutzen Sie Ihre Andorra eSIM, um schnell Adresse und Notfallkontakt Ihrer
        Botschaft zu finden.
    - q: Wie kontaktiere ich die Reiseversicherung bei einem Unfall?
      a: Nutzen Sie VoIP-Apps wie Skype über Ihre Andorra eSIM-Daten, um die Hotlines
    ...
    - q: Wie teile ich meinen Standort in Echtzeit?
      a: Nutzen Sie 'Live-Standort teilen' in WhatsApp oder Apples 'Wo ist?', um Ihre
        Koordinaten über Andorra eSIM-Daten zu senden.
    - q: Wie lade ich Offline-Karten für abgelegene Gebiete?
      a: Nutzen Sie Ihre Stadt-Abdeckung der Andorra eSIM, um Offline-Karten in Google
  ...
  - id: faq-business
    ...
    - q: Wie garantiere ich stabile Zoom/Teams-Meetings?
      a: Unsere Andorra eSIM verbindet sich mit Premium-Netzen und bietet die Bandbreite
    ...
    - q: Wie verbinde ich mich sicher mit dem Firmen-VPN?
      a: Unsere Daten beschränken keine VPN-Protokolle. Sie können Ihr Firmen-VPN
        sicher über das Andorra eSIM-Netzwerk starten.
    - q: Wie nutze ich den Hotspot für Laptops in Cafés?
      a: Aktivieren Sie den Hotspot. Die Nutzung Ihrer Andorra eSIM ist deutlich schneller
        und sicherer vor Cyber-Bedrohungen als offene WLANs.
    - q: Wie empfange ich 2FA-Codes für Firmen-E-Mails?
      a: Lassen Sie Ihre heimische SIM für SMS aktiv und nutzen Sie die Andorra eSIM-Daten
        für E-Mail-basierte Codes.
    - q: Wie lade ich große Dateien bei Kundenbesuchen hoch?
      a: Mit 5G/4G-LTE-Geschwindigkeiten Ihrer Andorra eSIM können Sie Präsentationen
        schnell in Cloud-Dienste hochladen.
    - q: Wie nutze ich Slack/Gmail nahtlos für die Zusammenarbeit?
      a: Ihre Andorra eSIM bietet konstante Verbindung, sodass Sie Slack-Nachrichten
        und E-Mails sofort erhalten.
    - q: Wie aktualisiere ich Reisepläne für die Firma online?
      a: Greifen Sie über Ihre Andorra eSIM von unterwegs auf Firmenportale zu, um
...
market_analysis:
  ...
  table_rows:
    - icon: "store"
      ...
      prepaid_title: ""
      prepaid_desc: "Der Erwerb einer Prepaid-SIM von Andorra Telecom erfordert den persönlichen Besuch einer Filiale oder die Online-Registrierung mit Hochladen von Passfoto und Selfie, gefolgt von einer manuellen Prüfung, die mehrere Stunden dauern kann."
      esim_title: "Sofortige digitale Lieferung"
      esim_desc: "Umgehen Sie die manuelle Prüfung von Andorra Telecom. Aktivieren Sie Ihre eSIM online innerhalb von 1 Minute nach der Landung in Andorra la Vella."
    - icon: "id-card"
      title: "KYC & Realnamen-<br>Registrierung"
      prepaid_title: ""
      prepaid_desc: "Andorra Telecom verlangt bei Kauf oder eSIM-Aktivierung zwingend die Vorlage eines Reisepasses oder nationalen Ausweises sowie ein Selfie zur Identitätsprüfung."
      esim_title: "Kein Pass oder Selfie nötig"
      esim_desc: "Andorra Telecom verlangt Passfoto und Selfie für die Aktivierung. Mit Roami eSIM entfällt dieser Schritt – sofortige Konnektivität ohne Datenschutzbedenken."
    - icon: "globe"
      title: "Internationales<br>Roaming"
      prepaid_title: ""
      prepaid_desc: "Internationales Roaming außerhalb Andorras kostet €3 für 1 GB pro Tag, gültig nur bis Mitternacht; ohne Roaming-Paket ist keine Datenverbindung möglich."
      esim_title: "Weltweites Roaming inklusive"
      esim_desc: "Vermeiden Sie die €3/1GB-Tagespakete von Andorra Telecom. Roami eSIM bietet nahtloses Roaming in Spanien und Frankreich zum gleichen Tarif, ohne Zusatzkosten."
    - icon: "calendar-xmark"
      title: "Abrechnungszyklus &<br>verschwendete Kosten"
      prepaid_title: ""
      prepaid_desc: "Der Abrechnungszeitraum beträgt strikt 30 Tage; der günstigste Tarif Tarifa S kostet €10 für 3 GB, bei einem 2-tägigen Aufenthalt werden 90% des Tarifwerts verschwendet."
      esim_title: "Flexible Tarife ab 7 Tagen"
      esim_desc: "Andorra Telecom zwingt Sie zu 30-Tage-Zyklen (€10/3GB). Roami bietet 7-Tage-Datentarife ab $1.99/GB – zahlen Sie nur für das, was Sie nutzen."
    - icon: "wifi"
      title: "Hotspot &<br>Geschwindigkeitsrichtlinien"
      prepaid_title: ""
      prepaid_desc: "Keine spezifischen Daten in der Quelle für diese Dimension. Typischerweise erlaubt Andorra Telecom Tethering, aber nach Verbrauch des Datenvolumens wird die Verbindung komplett unterbrochen."
      esim_title: "Uneingeschränktes Tethering"
      esim_desc: "Andorra Telecom unterbricht die Datenverbindung nach Verbrauch des Volumens. Roami eSIM erlaubt unbegrenztes Tethering ohne Drosselung."
    - icon: "credit-card"
      title: "Aufladung & Zahlung"
      prepaid_title: ""
      prepaid_desc: "Aufladungen sind online mit Kreditkarte (Visa, Mastercard) oder über physische Gutscheine in Werten von €15, €30 oder €60 möglich."
      esim_title: "Weltweite Zahlungsmethoden"
      esim_desc: "Andorra Telecom akzeptiert nur Visa/Mastercard oder lokale Gutscheine. Roami unterstützt Visa, Mastercard, AMEX, Apple Pay, Google Pay und PayPal."
    - icon: "headset"
      title: "Kundensupport"
      prepaid_title: ""
      prepaid_desc: "Kundensupport ist nur auf Katalanisch und Spanisch verfügbar, per Telefon von 9-17 Uhr an Werktagen; kein Live-Chat für Prepaid-Kunden."
      esim_title: "24/7 Kundensupport auf Deutsch"
      esim_desc: "Andorra Telecom bietet nur katalanischen/spanischen Support zu Bürozeiten. Roami hat rund um die Uhr deutschsprachigen Support per Chat und E-Mail."
  ...
  expert_verdict:
    ...
    cards:
      - icon: "globe"
        ...
        desc: "Andorra Telecoms Roaming kostet <b>€3/1GB/Tag</b> in Europa. Roami eSIM deckt Andorra, Spanien und Frankreich in einem Tarif ab – ideal für Grenzpendler."
      - icon: "hourglass-empty"
        icon_bg: "bg-amber-100"
        icon_color: "text-amber-600"
        title: "Flexible Tarife statt 30-Tage-Zwang"
        desc: "Andorra Telecoms günstigster Tarif <b>Tarifa S (€10/3GB)</b> läuft 30 Tage – für einen 2-tägigen Aufenthalt verschwenden Sie <b>90%</b> des Werts. Roami bietet 7-Tage-Tarife ab <b>$1.99/GB</b>."
      - icon: "tower-observation"
        icon_bg: "bg-rose-100"
        icon_color: "text-rose-600"
        title: "Vermeiden Sie teure Roaming-Tagespakete"
        desc: "Andorra Telecom berechnet <b>€3 für 1 GB</b> Roaming pro Tag, gültig nur bis Mitternacht. Roami eSIM bietet nahtloses Roaming in Spanien und Frankreich ohne Zusatzkosten."
      - icon: "shield"
        icon_bg: "bg-teal-100"
        icon_color: "text-teal-600"
        title: "Datenschutz ohne Selfie-Zwang"
        desc: "Andorra Telecom verlangt ein Selfie zur Identitätsprüfung – ein Risiko für Ihre Privatsphäre. Roami eSIM kommt ohne biometrische Daten aus."
---
