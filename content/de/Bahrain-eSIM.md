...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "Wie schnell ist das eSIM Internet in Bahrain? Geschwindigkeit und Abdeckung"
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Bahrain eSIM FAQ
    questions:
    - q: |
        Wie viele eSIM-Profile kann ich auf meinem Handy für Bahrain speichern?
      a: |
        Die meisten Handys speichern 5-10 eSIM-Profile. Sie können Ihre Bahrain eSIM neben Ihrer heimischen SIM und bis zu 8 anderen Ländernprofilen speichern. Das Umschalten dauert etwa 10 Sekunden in den Telefoneinstellungen. iPhone ab XS (2018+) und Samsung ab S20 (2020+) unterstützen mehrere Profile gleichzeitig.
    - q: |
    ...
    - q: |
      ...
      a: |
        Drei schnelle Checks (je ca. 30 Sekunden): 1) Ist Daten-Roaming aktiviert? 2) Können Sie Batelco manuell auswählen? 3) Haben Sie das Telefon neu gestartet? Etwa 90% der Verbindungsprobleme lassen sich mit einem dieser Schritte lösen. Falls nicht: Roami 24/7 Support hilft innerhalb weniger Minuten weiter.
    - q: |
        Soll ich meine Bahrain eSIM vor der Abreise oder erst am Flughafen installieren?
      a: |
        Vor der Abreise — die Installation benötigt Internet und dauert etwa 2 Minuten. Der QR-Code kommt innerhalb von 5 Minuten per Email. In Bahrain einfach Daten-Roaming aktivieren, und Sie sind in unter 60 Sekunden online. Ohne vorherige Installation müssten Sie am Flughafen auf WiFi angewiesen sein, das oft eine SMS-Verifizierung verlangt — ein klassisches Henne-Ei-Problem.
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Bahrain nutze?
      a: |
    ...
    - q: |
        Bekomme ich nach dem Kauf meiner Bahrain eSIM eine Bestätigung?
      a: |
    ...
    - q: |
        Funktioniert eSIM in Bahrain auch in ländlichen Gebieten?
      a: |
    ...
    - q: |
        Kann ich meine Bahrain eSIM noch in letzter Minute vor dem Flug kaufen?
      a: |
