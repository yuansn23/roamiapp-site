...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Kenia eSIM FAQ
    questions:
    - q: |
        Welcher Netzbetreiber in Kenia ist am besten für Reisende — Safaricom, Airtel oder Telkom?
      a: |
        Kenia hat drei Hauptanbieter: Safaricom, Airtel und Telkom. Safaricom erreicht etwa 95% der Bevölkerung mit 4G/5G. Airtel hat eine stärkere ländliche Abdeckung. Telkom bietet oft günstigere Tarife, etwa 15-20% günstiger als Safaricom. Kenia ist hauptsächlich 4G mit 5G in Nairobi. Roami verbindet Sie automatisch mit dem stärksten Netz an Ihrem Standort.
    - q: |
        Was tun, wenn meine Kenia eSIM bei der Ankunft nicht funktioniert?
      a: |
        Drei schnelle Checks (je ca. 30 Sekunden): 1) Ist Daten-Roaming aktiviert? 2) Können Sie Safaricom manuell auswählen? 3) Haben Sie das Telefon neu gestartet? Etwa 90% der Verbindungsprobleme lassen sich mit einem dieser Schritte lösen. Falls nicht: Roami 24/7 Support hilft innerhalb weniger Minuten weiter.
    - q: |
        Funktioniert eSIM in Kenia auch in ländlichen Gebieten?
      a: |
    ...
    - q: |
      ...
      a: |
        Die meisten Handys speichern 5-10 eSIM-Profile. Sie können Ihre Kenia eSIM neben Ihrer heimischen SIM und bis zu 8 anderen Ländernprofilen speichern. Das Umschalten dauert etwa 10 Sekunden in den Telefoneinstellungen. iPhone ab XS (2018+) und Samsung ab S20 (2020+) unterstützen mehrere Profile gleichzeitig.
    - q: |
