...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Singapur eSIM FAQ
    questions:
    - q: |
        Woran erkenne ich, ob mein Handy eSIM in Singapur unterstützt?
      a: |
    ...
    - q: |
        Bekomme ich nach dem Kauf meiner Singapur eSIM eine Bestätigung?
      a: |
    ...
    - q: |
        Soll ich meine Singapur eSIM vor der Abreise oder erst am Flughafen installieren?
      a: |
        Vor der Abreise — die Installation benötigt Internet und dauert etwa 2 Minuten. Der QR-Code kommt innerhalb von 5 Minuten per Email. In Singapur einfach Daten-Roaming aktivieren, und Sie sind in unter 60 Sekunden online. Ohne vorherige Installation müssten Sie am Flughafen auf WiFi angewiesen sein, das oft eine SMS-Verifizierung verlangt — ein klassisches Henne-Ei-Problem.
    - q: |
        Funktioniert eSIM in Singapur auch in ländlichen Gebieten?
      a: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Singtels Netz in Singapur liefert stabile Verbindungen für Videoanrufe.
related_products:
