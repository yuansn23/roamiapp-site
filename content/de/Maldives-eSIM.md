...
hero:
  ...
  title: Malediven eSIM Datentarif
  subtitle: 24/7 Kundensupport | Hotspot unterstützt | Flüssiges Videostreaming
features:
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Abdeckung
      desc: Genießen Sie umfassende Netzabdeckung in ganz Malediven, einschließlich
        Städten wie Malé, Addu City, Fuvahmulah und Kulhudhuffushi. Unsere Malediven
        eSIM verbindet sich nahtlos mit den Netzen von Dhiraagu, Ooredoo und Wataniya.
    - icon: zap
...
activation_steps:
  title: Aktivierung Ihrer Malediven eSIM in wenigen Minuten
  steps:
  - num: '1'
    ...
    desc: Direkt nach Ihrer Bestellung erhalten Sie eine E‑Mail mit Ihrem persönlichen
      ...
      vor Ihrer Abreise nach Malediven in aller Ruhe vorbereiten.
    is_list: false
  - num: '2'
    ...
    - Vergeben Sie einen Namen (z.B. „Roami Malediven“) und wählen Sie ihn als **Standard
      für mobile Daten**
  ...
  - num: '3'
    ...
    desc: Nach der Installation können Sie die eSIM in den Einstellungen deaktiviert
      ...
      keine mobilen Daten verbraucht). Sobald Sie in Malediven landen, schalten Sie
      die eSIM einfach ein – die Gültigkeit startet dann automatisch bei der ersten
      Verbindung mit dem Netz von Dhiraagu / Ooredoo. Keine versteckten Aktivierungsgebühren,
      keine Roamingkosten.
    is_list: false
  - num: '4'
    title: 'Ankunft in Malediven: sofort online mit 5G/4G'
    desc: Sobald Sie in Malediven gelandet sind (z.B. in Velana International Airport
      (MLE), Gan International Airport (GAN), Hanimaadhoo International Airport (HAQ)),
      ...
      Sie Ihre Roami Malediven eSIM. Innerhalb weniger Sekunden verbindet sich Ihr
      Gerät automatisch mit dem schnellsten verfügbaren 5G/4G-Netz von Dhiraagu /
      Ooredoo. Sie können sofort navigieren, WhatsApp nutzen, soziale Medien checken
      oder einen Hotspot für andere Geräte einrichten – ohne Wartezeit, ohne Ausweis,
      ohne Vertrag.
    is_list: false
faq_section:
  title: Malediven eSIM FAQ & Reiseführer
  desc: Alles, was Sie über die Verwendung Ihrer Malediven eSIM in verschiedenen Reiseszenarien
    wissen müssen.
  categories:
  - id: faq-general
    icon: help-circle
    ...
    - q: Kann ich meine bestehende Telefonnummer behalten, wenn ich die Malediven
        eSIM nutze?
    ...
    - q: Was kostet die Malediven eSIM und gibt es Rabattaktionen?
      a: Unser Malediven eSIM Tarif startet bei nur $1.99/GB. Mit dem Promo-Code 'web20'
    ...
    - q: Welche 5G/4G-Netzwerke nutzt die Malediven eSIM und wie ist die Abdeckung?
      a: Die Malediven eSIM arbeitet exklusiv mit Dhiraagu / Ooredoo zusammen. Sie
    ...
    - q: Bietet Roami unbegrenzte Datentarife für Malediven an? Gibt es eine Fair‑Use‑Policy?
      a: Roami bietet echte unbegrenzte Datentarife für Malediven. Eine Fair‑Use‑Policy
    ...
    - q: Kann ich die Malediven eSIM als Hotspot mit anderen Geräten teilen?
      a: Ja, alle Roami eSIM-Tarife für Malediven erlauben unbegrenztes Tethering
    ...
    - q: Kann ich während der Nutzung der Malediven eSIM weiterhin Anrufe auf meiner
    ...
    - q: Wie funktioniert das internationale Roaming mit der Malediven eSIM in Nachbarländern?
      a: Die Malediven eSIM ist primär für Malediven optimiert. Für Reisen in EU‑Nachbarländer
        empfehlen wir unsere Europa‑eSIM, die nahtloses Roaming ohne zusätzliche Kosten
        bietet. Die reine Land‑eSIM funktioniert nicht zuverlässig außerhalb von Malediven.
    - q: Bietet Roami auch regionale eSIMs für Reisen über Malediven hinaus an?
      a: Ja, zusätzlich zur Malediven eSIM bieten wir Regional‑eSIM für Europa, Asien,
    ...
    - q: Wie aktiviere ich die Malediven eSIM und wann beginnt die Gültigkeit?
      a: Nach dem Kauf erhalten Sie sofort einen Aktivierungs‑QR‑Code per E‑Mail.
        Die Gültigkeit startet erst, wenn Ihr Telefon in Malediven erstmals eine Verbindung
        zu einem der Partner-Netze (Dhiraagu / Ooredoo) herstellt. So zahlen Sie nur
  ...
  - id: faq-airport
    ...
    - q: Wie erhalte ich sofort nach der Landung ein zuverlässiges Netz?
      a: Installieren Sie die Malediven eSIM vor Ihrem Flug. Sobald Sie an Flughäfen
        wie Velana International Airport (MLE), Gan International Airport (GAN), Hanimaadhoo
        International Airport (HAQ) landen, schalten Sie einfach den Flugmodus aus
    ...
    - q: Wie kontaktiere ich meinen Abholer oder nutze Uber/Grab?
      a: Nach der Aktivierung bei der Landung können Sie sofort Apps wie Maldives
        Transport, Speedboat Transfer Maldives, Maldives Taxi nutzen, um eine Fahrt
        zu buchen, oder WhatsApp verwenden, um Ihren Fahrer zu kontaktieren, ohne
        auf unsicheres Flughafen-WLAN angewiesen zu sein.
    - q: Wie nutze ich Google Maps/Apple Maps, um Transportmittel zu finden?
      a: Mit Ihren Malediven eSIM-Daten können Sie direkt an der Gepäckausgabe in
        Velana International Airport (MLE), Gan International Airport (GAN), Hanimaadhoo
        International Airport (HAQ) Echtzeit-Fahrpläne für Züge und Busse prüfen oder
        den Weg zum Taxistand finden.
    - q: Wie vermeide ich teure SIM-Karten am Flughafen?
      a: Indem Sie unsere Malediven eSIM vorab online kaufen, umgehen Sie die teuren
    ...
    - q: Wie empfange ich SMS von Hotel/Autovermietung ohne lokale Nummer?
      a: Unsere Malediven eSIM ist ein reiner Datentarif. Um SMS zu empfangen, lassen
    ...
    - q: Wie kontaktiere ich sofort meine Familie?
      a: Sobald Sie landen, können Sie iMessage, WhatsApp oder FaceTime über unsere
        schnellen Malediven eSIM-Daten nutzen, um Ihren Lieben mitzuteilen, dass Sie
  ...
  - id: faq-transport
    ...
    - q: Wie nutze ich Google Maps zur Routenplanung?
      a: Unsere stabile Malediven eSIM-Verbindung stellt sicher, dass Google Maps
        überall in Malediven Echtzeit-Verkehrsdaten und Fahrpläne laden kann.
    - q: Wie können mich Uber/Grab-Fahrer über die App kontaktieren?
      a: Apps wie Maldives Transport, Speedboat Transfer Maldives, Maldives Taxi nutzen
        VoIP. Da Sie aktive Malediven eSIM-Daten haben, können Fahrer Sie direkt über
        die App anrufen oder benachrichtigen, ohne eine lokale Nummer.
    - q: Wie kaufe ich Zug- oder U-Bahn-Tickets online?
      a: Nutzen Sie Ihre Malediven eSIM-Daten, um in lokalen Apps digitale QR-Code-Tickets
        zu kaufen und lange Schlangen an Automaten zu vermeiden.
    - q: Wie nutze ich Google Maps für Echtzeit-Navigation im Mietwagen?
      a: Befestigen Sie Ihr Telefon und nutzen Sie Ihre Malediven eSIM. Ein 5GB- oder
    ...
    - q: Wie scanne und entsperre ich E-Scooter (Lime/Bird)?
      a: Das Entsperren von E-Scootern erfordert eine schnelle Internetverbindung.
        Unsere Malediven eSIM bietet die dafür nötige zuverlässige Abdeckung.
    ...
    - q: Wie biete ich einen stabilen Hotspot für meine Familie?
      a: Aktivieren Sie einfach den 'Persönlichen Hotspot' in Ihren Einstellungen.
        Ihre Familie kann sich mit Ihrem Malediven eSIM-Netzwerk im Zug oder Auto
        verbinden.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotels
    ...
    - q: Wie mache ich einen Self-Check-in nach Buchung?
      a: Viele moderne Unterkünfte senden Smart-Lock-Codes per E-Mail. Ihre Malediven
    ...
    - q: Wie kontaktiere ich meinen Airbnb-Gastgeber bei Ankunft?
      a: Nutzen Sie die Messaging-Funktion der Airbnb-App oder WhatsApp, um Ihre Ankunftszeit
        mit Ihrem Gastgeber über mobile Malediven eSIM-Daten abzustimmen.
    - q: Wie nutze ich Google Maps, um zum Hotel zu navigieren?
      a: Egal ob Sie in Soneva Fushi, The Maledives, Anantara Kihavah Maldives Villas
        übernachten, geben Sie die Adresse in Google Maps ein und nutzen Sie die Navigation
        Ihrer Malediven eSIM.
    - q: Wie empfange ich SMS-Verifizierungscodes?
      a: Lassen Sie Ihre heimische SIM für SMS aktiv und nutzen Sie Ihre Malediven
    ...
    - q: Wie kontaktiere ich schnell den Kundenservice?
      a: Nutzen Sie VoIP-Apps wie Skype oder die Chat-Funktion der Buchungs-App über
        Ihre Hochgeschwindigkeits-Malediven eSIM-Daten.
    - q: Wie bestelle ich Essen mit lokalen Liefer-Apps?
      a: Laden Sie Ooredoo Mall, Dhiraagu, Yummy herunter und nutzen Sie Ihre Malediven
    ...
    - q: Wie bleibe ich nach dem Checkout mit dem Hotel in Kontakt?
      a: Sobald Sie das Hotel-WLAN verlassen, übernimmt Ihre Malediven eSIM, sodass
  ...
  - id: faq-attractions
    ...
    - q: Wie kaufe ich E-Tickets über GetYourGuide/Viator?
      a: Wenn Sie Male Atoll Unterwasserrestaurant, Banana Reef, Unterwasserwelt von
        Ari-Atoll spontan besuchen möchten, können Sie Ihre Malediven eSIM-Daten nutzen,
        um Online-Tickets zu kaufen und den Barcode direkt vorzuzeigen.
    - q: Wie buche ich Erlebnisse bei Tripadvisor sofort?
      a: Mit dem zuverlässigen 4G/5G Ihrer Malediven eSIM können Sie Bewertungen lesen
    ...
    - q: Wie nutze ich Wikipedia/Google für Informationen während des Besuchs?
      a: Erweitern Sie Ihr kulturelles Erlebnis, indem Sie historische Fakten googeln
        oder Museumstafeln übersetzen, während Sie Malediven erkunden.
    - q: Wie finde ich den Weg zur nächsten Sehenswürdigkeit?
      a: Geben Sie Ihr nächstes Ziel in Google Maps ein; die starke Abdeckung Ihrer
        Malediven eSIM führt Sie über die schnellste Route.
    - q: Wie prüfe ich Echtzeit-Wartezeiten in Freizeitparks?
      a: Freizeitpark-Apps benötigen Internet für Live-Wartezeiten. Ihre Malediven
    ...
    - q: Wie greife ich auf Ticketmaster für Show-Tickets zu?
      a: Sie können sicher Last-Minute-Theaterkarten über Ticketing-Apps mit Ihren
        Malediven eSIM-Daten kaufen.
    - q: Wie teile ich Fotos/Videos sofort auf Instagram/TikTok?
      a: Unsere schnellen Malediven eSIM-Upload-Geschwindigkeiten ermöglichen es Ihnen,
  ...
  - id: faq-dining
    ...
    - q: Wie finde ich Restaurants mit Google Maps/Tripadvisor?
      a: Suchen Sie mit Ihrer Malediven eSIM nach 'Restaurants in der Nähe', um Bewertungen,
        Öffnungszeiten und Menüfotos zu prüfen.
    - q: Wie reserviere ich Tische online?
      a: Sichern Sie sich eine Reservierung über Online-Plattformen mit Ihrer Malediven
        eSIM, während Sie unterwegs sind.
    - q: Wie scanne ich QR-Codes für digitale Menüs?
      a: Viele Restaurants nutzen digitale Menüs. Ihre Malediven eSIM stellt sicher,
    ...
    - q: Wie nutze ich die Google Translate Kamera für Speisekarten?
      a: Öffnen Sie die App und richten Sie die Kamera auf das Menü. Die Live-Übersetzung
        benötigt eine Internetverbindung über Ihre Malediven eSIM.
    - q: Wie nutze ich lokale Lieferdienste?
      a: Laden Sie lokale Apps wie Ooredoo Mall, Dhiraagu, Yummy herunter und bestellen
        Sie bequem über Ihre Malediven eSIM-Mobildaten.
    - q: Wie bezahle ich mit Apple Pay/Google Pay?
      a: Kontaktlose Zahlungen oder lokale Methoden wie Kreditkarte (Visa/Mastercard),
        Ooredoo Pay, Dhiraagu Mobile Money erfordern einen kurzen Internet-Handshake,
        den Ihre Malediven eSIM perfekt meistert.
    - q: Wie finde ich Geheimtipps von Food-Bloggern?
      a: Streamen Sie YouTube-Vlogs oder stöbern Sie in Yelp-Bewertungen mit Ihrer
        Malediven eSIM, um kulinarische Highlights zu entdecken.
  - id: faq-social
    icon: smartphone
    ...
    - q: Wie nutze ich WhatsApp/Telegram stabil im Ausland?
      a: Ihre Accounts sind an Ihre Heimnummer gebunden. Mit unserer Malediven eSIM
    ...
    - q: Wie lade ich Inhalte auf TikTok hoch, ohne öffentliches WLAN?
      a: Öffentliches WLAN ist oft langsam und unsicher. Unsere 4G/5G Malediven eSIM
        bietet die Bandbreite für schnelle Uploads.
    - q: Wie mache ich Videoanrufe mit meiner Familie?
      a: Unsere Netzwerkpartnerschaften garantieren, dass Videoanrufe über die Malediven
    ...
    - q: Ist es sicher, sich in öffentlichen WLANs in soziale Accounts einzuloggen?
      a: Öffentliches WLAN ist anfällig für Hacker. Die Nutzung Ihrer persönlichen
        Malediven eSIM-Daten ist verschlüsselt und wesentlich sicherer.
    - q: Wie teile ich das Netzwerk als Hotspot mit Reisebegleitern?
      a: Aktivieren Sie die Hotspot-Funktion. Ihre Freunde können sich verbinden und
        Ihr Malediven eSIM-Datenvolumen für ihre sozialen Medien nutzen.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Brauche ich für jedes Land eine neue SIM-Karte?
      a: Die Einzelland-Malediven eSIM funktioniert nur dort. Für Reisen durch mehrere
    ...
    - q: Wie vermeide ich Roaminggebühren bei Zugfahrten über Grenzen?
      a: Deaktivieren Sie 'Daten-Roaming' auf Ihrer Heim-SIM. Stellen Sie sicher,
        dass die Malediven eSIM als primäre Datenleitung eingestellt ist.
  ...
  - id: faq-emergency
    ...
    - q: Wie wähle ich lokale Notrufnummern?
      a: 'In Malediven können Sie Notrufnummern wie Polizei: 119, Rettungsdienst:
        102, Feuerwehr: 118 direkt wählen, solange Ihr Telefon ein Mobilfunksignal
        empfängt.'
    - q: Wie finde ich das nächste Krankenhaus?
      a: Ihre Malediven eSIM-Daten ermöglichen eine sofortige Suche auf Google Maps
        nach 'Apotheke' oder 'Krankenhaus' mit der schnellsten Route.
    - q: Wie finde ich Botschaftsinformationen bei Passverlust?
      a: Nutzen Sie Ihre Malediven eSIM, um schnell Adresse und Notfallkontakt Ihrer
        Botschaft zu finden.
    - q: Wie kontaktiere ich die Reiseversicherung bei einem Unfall?
      a: Nutzen Sie VoIP-Apps wie Skype über Ihre Malediven eSIM-Daten, um die Hotlines
    ...
    - q: Wie teile ich meinen Standort in Echtzeit?
      a: Nutzen Sie 'Live-Standort teilen' in WhatsApp oder Apples 'Wo ist?', um Ihre
        Koordinaten über Malediven eSIM-Daten zu senden.
    - q: Wie lade ich Offline-Karten für abgelegene Gebiete?
      a: Nutzen Sie Ihre Stadt-Abdeckung der Malediven eSIM, um Offline-Karten in
  ...
  - id: faq-business
    ...
    - q: Wie garantiere ich stabile Zoom/Teams-Meetings?
      a: Unsere Malediven eSIM verbindet sich mit Premium-Netzen und bietet die Bandbreite
    ...
    - q: Wie verbinde ich mich sicher mit dem Firmen-VPN?
      a: Unsere Daten beschränken keine VPN-Protokolle. Sie können Ihr Firmen-VPN
        sicher über das Malediven eSIM-Netzwerk starten.
    - q: Wie nutze ich den Hotspot für Laptops in Cafés?
      a: Aktivieren Sie den Hotspot. Die Nutzung Ihrer Malediven eSIM ist deutlich
        schneller und sicherer vor Cyber-Bedrohungen als offene WLANs.
    - q: Wie empfange ich 2FA-Codes für Firmen-E-Mails?
      a: Lassen Sie Ihre heimische SIM für SMS aktiv und nutzen Sie die Malediven
        eSIM-Daten für E-Mail-basierte Codes.
    - q: Wie lade ich große Dateien bei Kundenbesuchen hoch?
      a: Mit 5G/4G-LTE-Geschwindigkeiten Ihrer Malediven eSIM können Sie Präsentationen
        schnell in Cloud-Dienste hochladen.
    - q: Wie nutze ich Slack/Gmail nahtlos für die Zusammenarbeit?
      a: Ihre Malediven eSIM bietet konstante Verbindung, sodass Sie Slack-Nachrichten
        und E-Mails sofort erhalten.
    - q: Wie aktualisiere ich Reisepläne für die Firma online?
      a: Greifen Sie über Ihre Malediven eSIM von unterwegs auf Firmenportale zu,
...
market_analysis:
  ...
  table_rows:
    - icon: "store"
      ...
      prepaid_title: ""
      prepaid_desc: "SIM-Karten sind an Flughafen-Kiosken erhältlich, jedoch zwischen 23:00 und 07:00 Uhr sowie freitags von 11:00 bis 14:00 Uhr geschlossen; der Kauf erfordert das Ausfüllen eines Formulars und die Vorlage des Reisepasses."
      esim_title: "Sofortige digitale Lieferung"
      esim_desc: "Umgehen Sie die eingeschränkten Öffnungszeiten der Dhiraagu-Filialen (23:00–07:00 Uhr geschlossen, freitags 11:00–14:00 Uhr). Aktivieren Sie Ihre eSIM online in 1 Minute vor Reiseantritt – kein Anstehen, kein Formular."
    - icon: "id-card"
      title: "KYC & Realnamen-<br>Registrierung"
      prepaid_title: ""
      prepaid_desc: "Beim Kauf einer SIM-Karte muss ein Formular ausgefüllt und der Reisepass vorgelegt werden; dies ist bei allen Anbietern Pflicht."
      esim_title: "Kein Pass erforderlich"
      esim_desc: "Während lokale SIMs zwingend die Vorlage des Reisepasses und das Ausfüllen eines Formulars verlangen, benötigt Roami eSIM keine persönliche Identifikation. Datenschutz und Bequemlichkeit in einem."
    - icon: "globe"
      title: "Internationales<br>Roaming"
      prepaid_title: ""
      prepaid_desc: "Keine spezifischen Daten in der Quelle für diese Dimension. (Ergänzung: Lokale SIM-Karten bieten in der Regel kein internationales Roaming; bei Nutzung im Ausland fallen hohe Gebühren an.)"
      esim_title: "Weltweites Roaming inklusive"
      esim_desc: "Lokale SIMs wie Dhiraagu oder Ooredoo funktionieren nur auf den Malediven. Roami eSIM bietet nahtloses Roaming in über 190 Ländern – ideal für Zwischenstopps in Dubai oder Sri Lanka, ohne Kartenwechsel."
    - icon: "calendar-xmark"
      title: "Abrechnungszyklus &<br>verschwendete Kosten"
      prepaid_title: ""
      prepaid_desc: "Dhiraagu-Tarife haben eine Laufzeit von 30 Tagen (z. B. 20 GB für 40 $), Ooredoo bietet 7-Tage-Pakete ab 3 GB für MVR 198; alle Preise verstehen sich zzgl. mindestens 6 % GST."
      esim_title: "Flexible Tarife ohne Verschwendung"
      esim_desc: "Dhiraagu zwingt Touristen in 30-Tage-Pakete ab 40 $ (20 GB) – bei einem 7-tägigen Aufenthalt verschwenden Sie über 75 % des Tarifwerts. Roami bietet 7-Tage-Tarife ab 1,99 $/GB, passgenau für Ihre Reisedauer."
    - icon: "wifi"
      title: "Hotspot &<br>Geschwindigkeitsrichtlinien"
      prepaid_title: ""
      prepaid_desc: "Keine spezifischen Daten in der Quelle für diese Dimension. (Ergänzung: Die meisten lokalen Anbieter erlauben Tethering, jedoch kann die Geschwindigkeit nach Verbrauch des Datenvolumens gedrosselt werden.)"
      esim_title: "Uneingeschränktes Tethering"
      esim_desc: "Während lokale Anbieter wie Ooredoo Tethering teilweise einschränken oder nach Datenverbrauch drosseln, erlaubt Roami eSIM uneingeschränktes Hotspot-Sharing – teilen Sie Ihr Datenvolumen mit Laptop und Tablet."
    - icon: "credit-card"
      title: "Aufladung & Zahlung"
      prepaid_title: ""
      prepaid_desc: "Online-Zahlungen akzeptieren keine internationalen Kreditkarten; Aufladungen sind nur mit lokalen Gutscheinen möglich, die in Touristengebieten höher besteuert werden."
      esim_title: "Weltweite Zahlungsmethoden"
      esim_desc: "Lokale SIMs akzeptieren keine internationalen Kreditkarten für Aufladungen – nur Bargeld oder lokale Gutscheine. Roami eSIM akzeptiert Visa, Mastercard, AMEX, Apple Pay, Google Pay und PayPal – bequem und sicher."
    - icon: "headset"
      title: "Kundensupport"
      prepaid_title: ""
      prepaid_desc: "Keine spezifischen Daten in der Quelle für diese Dimension. (Ergänzung: Kundensupport ist in der Regel nur auf lokaler Sprache verfügbar und nicht rund um die Uhr erreichbar.)"
      esim_title: "24/7 Kundensupport"
      esim_desc: "Lokale Anbieter bieten oft nur Support in Landessprache und zu Bürozeiten. Roami eSIM bietet rund um die Uhr deutschsprachigen Support per Chat und E-Mail – immer erreichbar, wenn Sie uns brauchen."
  ...
  expert_verdict:
    ...
    cards:
      - icon: "shield"
        ...
        desc: "Lokale Anbieter bieten Support oft nur auf Dhivehi und zu Bürozeiten. Roami eSIM bietet rund um die Uhr deutschsprachigen Support per Chat und E-Mail – immer erreichbar, wenn Sie uns brauchen."
      - icon: "hourglass-empty"
        icon_bg: "bg-amber-100"
        icon_color: "text-amber-600"
        title: "Flexible Tarife vermeiden versunkene Kosten"
        desc: "Dhiraagu zwingt Touristen in 30-Tage-Pakete ab 40 $ (20 GB) – bei einem 7-tägigen Aufenthalt verschwenden Sie über 75 % des Tarifwerts. Roami bietet 7-Tage-Tarife ab 1,99 $/GB, passgenau für Ihre Reisedauer."
      - icon: "wifi"
        icon_bg: "bg-green-100"
        icon_color: "text-green-600"
        title: "Uneingeschränktes Tethering ohne Drossel"
        desc: "Ooredoo erhebt bei Datenverbrauch über das Paket hinaus bis zu MVR 90/MB. Roami eSIM erlaubt uneingeschränktes Hotspot-Sharing – teilen Sie Ihr Datenvolumen mit Laptop und Tablet, ohne versteckte Kosten."
      - icon: "globe"
        icon_bg: "bg-purple-100"
        icon_color: "text-purple-600"
        title: "Keine versteckten Steuern oder Gebühren"
        desc: "Lokale Tarife von Dhiraagu und Ooredoo sind mit mindestens 6 % GST besteuert, in Touristengebieten bis zu 12 %. Roami eSIM zeigt alle Preise inklusive Steuern an – keine Überraschungen."
---
