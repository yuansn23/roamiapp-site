...
hero:
  ...
  title: Dominica eSIM Datentarif
  subtitle: Flüssiges Videostreaming | Sorgenfreies Internet | Intelligente Wahl
features:
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Abdeckung
      desc: Genießen Sie umfassende Netzabdeckung in ganz Dominica, einschließlich
        Städten wie Roseau, Portsmouth, Marigot. Unsere Dominica eSIM verbindet sich
        nahtlos mit den Netzen von Digicel, Flow und Cable & Wireless.
    - icon: zap
...
activation_steps:
  title: Aktivierung Ihrer Dominica eSIM in wenigen Minuten
  steps:
  - num: '1'
    ...
    desc: Direkt nach Ihrer Bestellung erhalten Sie eine E‑Mail mit Ihrem persönlichen
      ...
      vor Ihrer Abreise nach Dominica in aller Ruhe vorbereiten.
    is_list: false
  - num: '2'
    ...
    - Vergeben Sie einen Namen (z.B. „Roami Dominica“) und wählen Sie ihn als **Standard
      für mobile Daten**
  ...
  - num: '3'
    ...
    desc: Nach der Installation können Sie die eSIM in den Einstellungen deaktiviert
      ...
      keine mobilen Daten verbraucht). Sobald Sie in Dominica landen, schalten Sie
  ...
  - num: '4'
    ...
    desc: Sobald Sie in Dominica gelandet sind (z.B. in Douglas-Charles Airport (DOM),
      Canefield Airport (DCF), Melville Hall Airport (DOM)), schalten Sie den Flugmodus
      aus (oder bleiben Sie im Flugmodus und aktivieren Sie nur die eSIM). Gehen Sie
      zu **Einstellungen → Mobilfunk** und aktivieren Sie Ihre Roami Dominica eSIM.
      Innerhalb weniger Sekunden verbindet sich Ihr Gerät automatisch mit dem schnellsten
      verfügbaren 5G/4G-Netz von Digicel / Flow. Sie können sofort navigieren, WhatsApp
      nutzen, soziale Medien checken oder einen Hotspot für andere Geräte einrichten
      – ohne Wartezeit, ohne Ausweis, ohne Vertrag.
    is_list: false
faq_section:
  title: Dominica eSIM FAQ & Reiseführer
  desc: Alles, was Sie über die Verwendung Ihrer Dominica eSIM in verschiedenen Reiseszenarien
    wissen müssen.
  categories:
  - id: faq-general
    icon: help-circle
    ...
    questions:
    - q: Welche Voraussetzungen muss mein Smartphone erfüllen, um die Dominica eSIM
        nutzen zu können?
    ...
    - q: Wie aktiviere ich die Dominica eSIM und wann beginnt die Gültigkeit?
      a: Nach dem Kauf erhalten Sie sofort einen Aktivierungs‑QR‑Code per E‑Mail.
        Die Gültigkeit startet erst, wenn Ihr Telefon in Dominica erstmals eine Verbindung
        zu einem der Partner-Netze (Digicel / Flow) herstellt. So zahlen Sie nur für
    ...
    - q: Bietet Roami unbegrenzte Datentarife für Dominica an? Gibt es eine Fair‑Use‑Policy?
      a: Roami bietet echte unbegrenzte Datentarife für Dominica. Eine Fair‑Use‑Policy
    ...
    - q: Kann ich während der Nutzung der Dominica eSIM weiterhin Anrufe auf meiner
    ...
    - q: Kann ich die Dominica eSIM als Hotspot mit anderen Geräten teilen?
      a: Ja, alle Roami eSIM-Tarife für Dominica erlauben unbegrenztes Tethering (Hotspot).
    ...
    - q: Wie funktioniert das internationale Roaming mit der Dominica eSIM in Nachbarländern?
      a: Die Dominica eSIM ist primär für Dominica optimiert. Für Reisen in EU‑Nachbarländer
        empfehlen wir unsere Europa‑eSIM, die nahtloses Roaming ohne zusätzliche Kosten
        bietet. Die reine Land‑eSIM funktioniert nicht zuverlässig außerhalb von Dominica.
    - q: Kann ich die Dominica eSIM vor meiner Abreise installieren und später aktivieren?
      a: Ja, Sie können die eSIM bereits zu Hause (per WLAN) installieren. Die Aktivierung
        erfolgt dann automatisch, sobald Ihr Telefon in Dominica das erste Mal das
    ...
    - q: Was kostet die Dominica eSIM und gibt es Rabattaktionen?
      a: Unser Dominica eSIM Tarif startet bei nur $1.99/GB. Mit dem Promo-Code 'web20'
  ...
  - id: faq-airport
    ...
    - q: Wie erhalte ich sofort nach der Landung ein zuverlässiges Netz?
      a: Installieren Sie die Dominica eSIM vor Ihrem Flug. Sobald Sie an Flughäfen
        wie Douglas-Charles Airport (DOM), Canefield Airport (DCF), Melville Hall
        Airport (DOM) landen, schalten Sie einfach den Flugmodus aus und aktivieren
    ...
    - q: Wie kontaktiere ich meinen Abholer oder nutze Uber/Grab?
      a: Nach der Aktivierung bei der Landung können Sie sofort Apps wie keine großen
        Fahrdienst-Apps; lokale Taxi-Apps oder WhatsApp-Buchung, private Shuttles
        nutzen, um eine Fahrt zu buchen, oder WhatsApp verwenden, um Ihren Fahrer
    ...
    - q: Wie nutze ich Google Maps/Apple Maps, um Transportmittel zu finden?
      a: Mit Ihren Dominica eSIM-Daten können Sie direkt an der Gepäckausgabe in Douglas-Charles
        Airport (DOM), Canefield Airport (DCF), Melville Hall Airport (DOM) Echtzeit-Fahrpläne
        für Züge und Busse prüfen oder den Weg zum Taxistand finden.
    - q: Wie vermeide ich teure SIM-Karten am Flughafen?
      a: Indem Sie unsere Dominica eSIM vorab online kaufen, umgehen Sie die teuren
    ...
    - q: Wie empfange ich SMS von Hotel/Autovermietung ohne lokale Nummer?
      a: Unsere Dominica eSIM ist ein reiner Datentarif. Um SMS zu empfangen, lassen
    ...
    - q: Wie kontaktiere ich sofort meine Familie?
      a: Sobald Sie landen, können Sie iMessage, WhatsApp oder FaceTime über unsere
        schnellen Dominica eSIM-Daten nutzen, um Ihren Lieben mitzuteilen, dass Sie
  ...
  - id: faq-transport
    ...
    - q: Wie nutze ich Google Maps zur Routenplanung?
      a: Unsere stabile Dominica eSIM-Verbindung stellt sicher, dass Google Maps überall
        in Dominica Echtzeit-Verkehrsdaten und Fahrpläne laden kann.
    - q: Wie können mich Uber/Grab-Fahrer über die App kontaktieren?
      a: Apps wie keine großen Fahrdienst-Apps; lokale Taxi-Apps oder WhatsApp-Buchung,
        private Shuttles nutzen VoIP. Da Sie aktive Dominica eSIM-Daten haben, können
        Fahrer Sie direkt über die App anrufen oder benachrichtigen, ohne eine lokale
        Nummer.
    - q: Wie kaufe ich Zug- oder U-Bahn-Tickets online?
      a: Nutzen Sie Ihre Dominica eSIM-Daten, um in lokalen Apps digitale QR-Code-Tickets
        zu kaufen und lange Schlangen an Automaten zu vermeiden.
    - q: Wie nutze ich Google Maps für Echtzeit-Navigation im Mietwagen?
      a: Befestigen Sie Ihr Telefon und nutzen Sie Ihre Dominica eSIM. Ein 5GB- oder
    ...
    - q: Wie scanne und entsperre ich E-Scooter (Lime/Bird)?
      a: Das Entsperren von E-Scootern erfordert eine schnelle Internetverbindung.
        Unsere Dominica eSIM bietet die dafür nötige zuverlässige Abdeckung.
    ...
    - q: Wie biete ich einen stabilen Hotspot für meine Familie?
      a: Aktivieren Sie einfach den 'Persönlichen Hotspot' in Ihren Einstellungen.
        Ihre Familie kann sich mit Ihrem Dominica eSIM-Netzwerk im Zug oder Auto verbinden.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotels
    ...
    - q: Wie mache ich einen Self-Check-in nach Buchung?
      a: Viele moderne Unterkünfte senden Smart-Lock-Codes per E-Mail. Ihre Dominica
    ...
    - q: Wie kontaktiere ich meinen Airbnb-Gastgeber bei Ankunft?
      a: Nutzen Sie die Messaging-Funktion der Airbnb-App oder WhatsApp, um Ihre Ankunftszeit
        mit Ihrem Gastgeber über mobile Dominica eSIM-Daten abzustimmen.
    - q: Wie nutze ich Google Maps, um zum Hotel zu navigieren?
      a: Egal ob Sie in Secret Bay, Jungle Bay Resort & Spa, InterContinental Dominica
        Cabrits Resort & Spa übernachten, geben Sie die Adresse in Google Maps ein
        und nutzen Sie die Navigation Ihrer Dominica eSIM.
    - q: Wie empfange ich SMS-Verifizierungscodes?
      a: Lassen Sie Ihre heimische SIM für SMS aktiv und nutzen Sie Ihre Dominica
    ...
    - q: Wie kontaktiere ich schnell den Kundenservice?
      a: Nutzen Sie VoIP-Apps wie Skype oder die Chat-Funktion der Buchungs-App über
        Ihre Hochgeschwindigkeits-Dominica eSIM-Daten.
    - q: Wie bestelle ich Essen mit lokalen Liefer-Apps?
      a: Laden Sie SkipTheDishes, Uber Eats (eingeschränkt), lokale Lieferdienste
        über WhatsApp herunter und nutzen Sie Ihre Dominica eSIM-Daten, um eine warme
        Mahlzeit direkt in die Hotellobby zu bestellen.
    - q: Wie bleibe ich nach dem Checkout mit dem Hotel in Kontakt?
      a: Sobald Sie das Hotel-WLAN verlassen, übernimmt Ihre Dominica eSIM, sodass
  ...
  - id: faq-attractions
    ...
    - q: Wie kaufe ich E-Tickets über GetYourGuide/Viator?
      a: Wenn Sie Trafalgar Falls, Morne Trois Pitons National Park, Boiling Lake
        spontan besuchen möchten, können Sie Ihre Dominica eSIM-Daten nutzen, um Online-Tickets
        zu kaufen und den Barcode direkt vorzuzeigen.
    - q: Wie buche ich Erlebnisse bei Tripadvisor sofort?
      a: Mit dem zuverlässigen 4G/5G Ihrer Dominica eSIM können Sie Bewertungen lesen
    ...
    - q: Wie nutze ich Wikipedia/Google für Informationen während des Besuchs?
      a: Erweitern Sie Ihr kulturelles Erlebnis, indem Sie historische Fakten googeln
        oder Museumstafeln übersetzen, während Sie Dominica erkunden.
    - q: Wie finde ich den Weg zur nächsten Sehenswürdigkeit?
      a: Geben Sie Ihr nächstes Ziel in Google Maps ein; die starke Abdeckung Ihrer
        Dominica eSIM führt Sie über die schnellste Route.
    - q: Wie prüfe ich Echtzeit-Wartezeiten in Freizeitparks?
      a: Freizeitpark-Apps benötigen Internet für Live-Wartezeiten. Ihre Dominica
    ...
    - q: Wie greife ich auf Ticketmaster für Show-Tickets zu?
      a: Sie können sicher Last-Minute-Theaterkarten über Ticketing-Apps mit Ihren
        Dominica eSIM-Daten kaufen.
    - q: Wie teile ich Fotos/Videos sofort auf Instagram/TikTok?
      a: Unsere schnellen Dominica eSIM-Upload-Geschwindigkeiten ermöglichen es Ihnen,
  ...
  - id: faq-dining
    ...
    - q: Wie finde ich Restaurants mit Google Maps/Tripadvisor?
      a: Suchen Sie mit Ihrer Dominica eSIM nach 'Restaurants in der Nähe', um Bewertungen,
        Öffnungszeiten und Menüfotos zu prüfen.
    - q: Wie reserviere ich Tische online?
      a: Sichern Sie sich eine Reservierung über Online-Plattformen mit Ihrer Dominica
        eSIM, während Sie unterwegs sind.
    - q: Wie scanne ich QR-Codes für digitale Menüs?
      a: Viele Restaurants nutzen digitale Menüs. Ihre Dominica eSIM stellt sicher,
    ...
    - q: Wie nutze ich die Google Translate Kamera für Speisekarten?
      a: Öffnen Sie die App und richten Sie die Kamera auf das Menü. Die Live-Übersetzung
        benötigt eine Internetverbindung über Ihre Dominica eSIM.
    - q: Wie nutze ich lokale Lieferdienste?
      a: Laden Sie lokale Apps wie SkipTheDishes, Uber Eats (eingeschränkt), lokale
        Lieferdienste über WhatsApp herunter und bestellen Sie bequem über Ihre Dominica
        eSIM-Mobildaten.
    - q: Wie bezahle ich mit Apple Pay/Google Pay?
      a: Kontaktlose Zahlungen oder lokale Methoden wie Bargeld (EC-Dollar), Kreditkarten
        (Visa/Mastercard), mobile Zahlungen (Digicel Mobile Money) erfordern einen
        kurzen Internet-Handshake, den Ihre Dominica eSIM perfekt meistert.
    - q: Wie finde ich Geheimtipps von Food-Bloggern?
      a: Streamen Sie YouTube-Vlogs oder stöbern Sie in Yelp-Bewertungen mit Ihrer
        Dominica eSIM, um kulinarische Highlights zu entdecken.
  - id: faq-social
    icon: smartphone
    ...
    - q: Wie nutze ich WhatsApp/Telegram stabil im Ausland?
      a: Ihre Accounts sind an Ihre Heimnummer gebunden. Mit unserer Dominica eSIM
    ...
    - q: Wie lade ich Inhalte auf TikTok hoch, ohne öffentliches WLAN?
      a: Öffentliches WLAN ist oft langsam und unsicher. Unsere 4G/5G Dominica eSIM
        bietet die Bandbreite für schnelle Uploads.
    - q: Wie mache ich Videoanrufe mit meiner Familie?
      a: Unsere Netzwerkpartnerschaften garantieren, dass Videoanrufe über die Dominica
    ...
    - q: Ist es sicher, sich in öffentlichen WLANs in soziale Accounts einzuloggen?
      a: Öffentliches WLAN ist anfällig für Hacker. Die Nutzung Ihrer persönlichen
        Dominica eSIM-Daten ist verschlüsselt und wesentlich sicherer.
    - q: Wie teile ich das Netzwerk als Hotspot mit Reisebegleitern?
      a: Aktivieren Sie die Hotspot-Funktion. Ihre Freunde können sich verbinden und
        Ihr Dominica eSIM-Datenvolumen für ihre sozialen Medien nutzen.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Brauche ich für jedes Land eine neue SIM-Karte?
      a: Die Einzelland-Dominica eSIM funktioniert nur dort. Für Reisen durch mehrere
    ...
    - q: Wie vermeide ich Roaminggebühren bei Zugfahrten über Grenzen?
      a: Deaktivieren Sie 'Daten-Roaming' auf Ihrer Heim-SIM. Stellen Sie sicher,
        dass die Dominica eSIM als primäre Datenleitung eingestellt ist.
  ...
  - id: faq-emergency
    ...
    - q: Wie wähle ich lokale Notrufnummern?
      a: 'In Dominica können Sie Notrufnummern wie Polizei: 999, Krankenwagen: 911,
        Feuerwehr: 999 direkt wählen, solange Ihr Telefon ein Mobilfunksignal empfängt.'
    - q: Wie finde ich das nächste Krankenhaus?
      a: Ihre Dominica eSIM-Daten ermöglichen eine sofortige Suche auf Google Maps
        nach 'Apotheke' oder 'Krankenhaus' mit der schnellsten Route.
    - q: Wie finde ich Botschaftsinformationen bei Passverlust?
      a: Nutzen Sie Ihre Dominica eSIM, um schnell Adresse und Notfallkontakt Ihrer
        Botschaft zu finden.
    - q: Wie kontaktiere ich die Reiseversicherung bei einem Unfall?
      a: Nutzen Sie VoIP-Apps wie Skype über Ihre Dominica eSIM-Daten, um die Hotlines
    ...
    - q: Wie teile ich meinen Standort in Echtzeit?
      a: Nutzen Sie 'Live-Standort teilen' in WhatsApp oder Apples 'Wo ist?', um Ihre
        Koordinaten über Dominica eSIM-Daten zu senden.
    - q: Wie lade ich Offline-Karten für abgelegene Gebiete?
      a: Nutzen Sie Ihre Stadt-Abdeckung der Dominica eSIM, um Offline-Karten in Google
  ...
  - id: faq-business
    ...
    - q: Wie garantiere ich stabile Zoom/Teams-Meetings?
      a: Unsere Dominica eSIM verbindet sich mit Premium-Netzen und bietet die Bandbreite
    ...
    - q: Wie verbinde ich mich sicher mit dem Firmen-VPN?
      a: Unsere Daten beschränken keine VPN-Protokolle. Sie können Ihr Firmen-VPN
        sicher über das Dominica eSIM-Netzwerk starten.
    - q: Wie nutze ich den Hotspot für Laptops in Cafés?
      a: Aktivieren Sie den Hotspot. Die Nutzung Ihrer Dominica eSIM ist deutlich
        schneller und sicherer vor Cyber-Bedrohungen als offene WLANs.
    - q: Wie empfange ich 2FA-Codes für Firmen-E-Mails?
      a: Lassen Sie Ihre heimische SIM für SMS aktiv und nutzen Sie die Dominica eSIM-Daten
        für E-Mail-basierte Codes.
    - q: Wie lade ich große Dateien bei Kundenbesuchen hoch?
      a: Mit 5G/4G-LTE-Geschwindigkeiten Ihrer Dominica eSIM können Sie Präsentationen
        schnell in Cloud-Dienste hochladen.
    - q: Wie nutze ich Slack/Gmail nahtlos für die Zusammenarbeit?
      a: Ihre Dominica eSIM bietet konstante Verbindung, sodass Sie Slack-Nachrichten
        und E-Mails sofort erhalten.
    - q: Wie aktualisiere ich Reisepläne für die Firma online?
      a: Greifen Sie über Ihre Dominica eSIM von unterwegs auf Firmenportale zu, um
...
market_analysis:
  ...
  table_rows:
    - icon: "store"
      ...
      prepaid_title: ""
      prepaid_desc: "SIM-Karten von Flow und Digicel kosten EC$ 25 und erfordern den Kauf in physischen Geschäften, z. B. in Roseau."
      esim_title: "Sofortige digitale Lieferung"
      esim_desc: "Umgehen Sie die EC$ 25 SIM-Kartenkosten und Schlangen in Flow- oder Digicel-Shops. Aktivieren Sie online innerhalb von 1 Minute nach der Landung in Roseau."
    - icon: "id-card"
      ...
      esim_desc: "Im Gegensatz zu Flow und Digicel, die einen Reisepass verlangen, benötigt Roami eSIM keine KYC. Kein Warten, keine Ausweiskopien."
    - icon: "globe"
      title: "Internationales<br>Roaming"
      prepaid_title: ""
      prepaid_desc: "Digicels 'Roam Like You're Home' kostet EC$ 13,79/7 Tage, aber lokale Datenpakete gelten nicht; stattdessen werden EC$ 1/MB berechnet."
      esim_title: "Weltweites Roaming ohne Fallen"
      esim_desc: "Vermeiden Sie Digicels 'Roam Like You're Home'-Falle: EC$ 1/MB nach Nutzung. Roami eSIM bietet nahtloses Roaming in über 190 Ländern zu festen Preisen ab $1.99/GB."
    - icon: "calendar-xmark"
      ...
      esim_desc: "Flow zwingt zu 30-Tage-Paketen (3 GB für EC$ 69,99) mit automatischer Verlängerung. Roami eSIM bietet 7-Tage-Tarife ab $1.99/GB, ideal für Kurzreisen."
    - icon: "wifi"
      title: "Hotspot &<br>Geschwindigkeitsrichtlinien"
      prepaid_title: ""
      prepaid_desc: "Keine spezifischen Daten in der Quelle für diese Dimension. Typischerweise erlauben beide Anbieter Tethering, aber Geschwindigkeitsdrosselung ist möglich."
      esim_title: "Uneingeschränktes Tethering"
      esim_desc: "Während lokale SIMs Tethering einschränken können, erlaubt Roami eSIM uneingeschränktes Hotspot-Teilen auf all Ihren Geräten."
    - icon: "credit-card"
      title: "Aufladung & Zahlung"
      prepaid_title: ""
      prepaid_desc: "Aufladung erfolgt über physische Gutscheine in Geschäften; Online-Zahlungen mit ausländischen Karten werden oft abgelehnt."
      esim_title: "Weltweite Zahlung akzeptiert"
      esim_desc: "Zahlen Sie einfach mit Visa, Mastercard, AMEX, Apple Pay, Google Pay oder PayPal. Keine Suche nach Aufladestationen für Flow/Digicel-Gutscheine."
    - icon: "headset"
      title: "Kundensupport"
      prepaid_title: ""
      ...
      esim_desc: "Roami eSIM bietet mehrsprachigen 24/7-Support per Chat und E-Mail, im Gegensatz zu den lokalen Öffnungszeiten von Flow und Digicel."
  ...
  expert_verdict:
    ...
    cards:
      - icon: "clock"
        ...
        desc: "Flow- und Digicel-SIMs müssen in Geschäften gekauft und aktiviert werden (EC$ 25 Kartenpreis). Roami eSIM wird vor Reiseantritt installiert und aktiviert sich automatisch bei Ankunft."
      - icon: "credit-card"
        icon_bg: "bg-emerald-100"
        icon_color: "text-emerald-600"
        title: "Bequeme Zahlung mit Karte oder PayPal"
        desc: "Lokale SIMs erfordern Bargeld oder Gutscheine. Roami eSIM akzeptiert Visa, Mastercard, AMEX, Apple Pay, Google Pay und PayPal – keine Suche nach Aufladestationen."
      - icon: "globe"
        icon_bg: "bg-purple-100"
        icon_color: "text-purple-600"
        title: "Nahtloses Roaming in der Karibik"
        desc: "Flow und Digicel haben in Dominica lückenhafte Abdeckung im Inland. Roami eSIM nutzt mehrere Netze und bietet stabile Verbindung in Roseau, Portsmouth und sogar auf abgelegenen Inseln."
      - icon: "shield"
        icon_bg: "bg-teal-100"
        icon_color: "text-teal-600"
        title: "Sicherheit durch Dual-SIM-Betrieb"
        desc: "Mit Roami eSIM behalten Sie Ihre heimische SIM-Karte im Slot für Anrufe und SMS. Kein Risiko des SIM-Kartenverlusts wie beim Wechsel zu Flow oder Digicel."
---
