...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "eSIM Internet in United States -- Wie schnell surft man wirklich?"
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Vereinigte Staaten eSIM FAQ
    questions:
    - q: |
        Funktioniert mein Handy mit eSIM in Vereinigte Staaten? Wie kann ich das überprüfen?
      a: |
        Schnelltest: Wählen Sie *#06#. Wenn eine EID-Nummer (ca. 30-40 Ziffern) erscheint, unterstützt Ihr Handy eSIM. iPhone XS/XR und neuer (2018+), Samsung Galaxy S20 und neuer, Google Pixel 4 und neuer — alle unterstützen eSIM. Etwa 80% der seit 2021 verkauften Handys haben eSIM. USA nutzen 5G auf n71/n77/n260/n261-Bändern. Internatio Prüfen Sie Ihr Modell auf unserer [eSIM-Kompatibilität](/compatibility/) Seite.
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Vereinigte Staaten nutze?
      a: |
    ...
    - q: |
        Kann ich WhatsApp und FaceTime mit eSIM in Vereinigte Staaten nutzen?
      a: |
