...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "Wie schnell ist das eSIM Internet in Belarus? Geschwindigkeit und Abdeckung"
  ...
  - id: faq-general
    ...
    - q: |
      ...
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Weißrussland Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
    ...
    - q: |
        Bekomme ich nach dem Kauf meiner Weißrussland eSIM eine Bestätigung?
      a: |
    ...
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Weißrussland nutze?
      a: |
