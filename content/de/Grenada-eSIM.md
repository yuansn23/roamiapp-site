...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "Wie gut kommt man mit eSIM in Grenada online? Alle wichtigen Infos"
  ...
  - id: faq-general
    ...
    - q: |
      ...
      a: |
        Die meisten Handys speichern 5-10 eSIM-Profile. Sie können Ihre Grenada eSIM neben Ihrer heimischen SIM und bis zu 8 anderen Ländernprofilen speichern. Das Umschalten dauert etwa 10 Sekunden in den Telefoneinstellungen. iPhone ab XS (2018+) und Samsung ab S20 (2020+) unterstützen mehrere Profile gleichzeitig.
    - q: |
        Funktioniert eSIM in Grenada auch in ländlichen Gebieten?
      a: |
    ...
    - q: |
        Bekomme ich nach dem Kauf meiner Grenada eSIM eine Bestätigung?
      a: |
    ...
    - q: |
        Kann ich WhatsApp und FaceTime mit eSIM in Grenada nutzen?
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Flows Netz in Grenada liefert stabile Verbindungen für Videoanrufe.
    - q: |
