...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Frankreich eSIM FAQ
    questions:
    - q: |
        Gibt es große Unterschiede zwischen Orange, SFR und Free für eSIM in Frankreich?
      a: |
        Ja — Orange ist am schnellsten in Städten (5G bis zu 1 Gbit/s). SFR deckt etwa 85% des Landes ab, auch ländliche Gebiete. Free ist die günstigste Option mit niedrigeren Preisen pro GB. Frankreich nutzt 5G auf n78-Band. 4G hauptsächlich auf  Roami wählt automatisch das beste Netz für Sie aus.
    - q: |
        Woran erkenne ich, ob mein Handy eSIM in Frankreich unterstützt?
      a: |
    ...
    - q: |
        Funktioniert eSIM in Frankreich auch in ländlichen Gebieten?
      a: |
    ...
    - q: |
        Kann ich WhatsApp und FaceTime mit eSIM in Frankreich nutzen?
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Oranges Netz in Frankreich liefert stabile Verbindungen für Videoanrufe.
    - q: |
        Bekomme ich nach dem Kauf meiner Frankreich eSIM eine Bestätigung?
      a: |
