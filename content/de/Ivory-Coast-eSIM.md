...
modal:
  ...
  text_android: 'Unser eSIM-Service wurde auf <strong>PhoneSIM</strong> aktualisiert.<br>Neukunden erhalten 20% Rabatt mit
    Code: web20'
seo:
  title: 'Elfenbeinküste eSIM 2026: 5G mit unbegrenztem Datenvolumen'
  description: Vergleichen Sie Elfenbeinküste eSIM Tarife mit 5G in Abidjan, Bouaké, Yamoussoukro. Orange & MTN & Moov Abdeckungsguide.
    Sofortige QR-Aktivierung ab $1.99.
  keywords: Elfenbeinküste eSIM, Elfenbeinküste Reise eSIM, beste eSIM Elfenbeinküste, Elfenbeinküste Datentarif, Orange Elfenbeinküste,
    MTN Elfenbeinküste, Moov Elfenbeinküste, Abidjan eSIM, Bouaké eSIM, Yamoussoukro eSIM, Elfenbeinküste mobiles Internet,
    5G Elfenbeinküste
order_summary:
...
features:
  ...
  - icon: zap
    ...
    desc: Erhalten Sie Ihren Elfenbeinküste eSIM QR-Code per E-Mail in 5 Minuten
  - icon: headset
    color: from-emerald-400 to-emerald-600
    title: 24/7 Support
    desc: 24/7 Support für Ihre Elfenbeinküste-Reise - echte Menschen, keine Bots
  - icon: shield-check
    color: from-amber-400 to-amber-600
    title: Garantie
    desc: 100% Geld-zurück, falls Ihre Elfenbeinküste eSIM nicht aktiviert wird
  - icon: wifi
    color: from-purple-400 to-purple-600
    title: Hotspot erlaubt
    desc: Teilen Sie Ihre Elfenbeinküste-Daten mit Reisebegleitern, keine Limits
  - icon: file-x
    color: from-rose-400 to-rose-600
    title: Keine Verträge
    desc: Keine Verträge, jederzeit kündbar - perfekt für Elfenbeinküste-Reisen
  - icon: radio-tower
    color: from-blue-400 to-blue-600
    title: Auto-Auswahl
    desc: Auto-Verbindung zu den besten Elfenbeinküste-Anbietern für das stärkste Signal
plans_title: 'Elfenbeinküste eSIM kaufen: Tarife fuer jeden Reisezeitraum'
plans_data:
  7 Tage:
  - spec: 1GB
...
network_coverage:
  title: 'Elfenbeinküste eSIM Netzabdeckung: Netzabdeckung & Anbietervergleich'
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Abdeckung
      desc: Geniessen Sie umfassende Netzabdeckung in ganz Elfenbeinküste, einschliesslich Abidjan, Bouaké, Yamoussoukro,
        Korhogo. Ihre eSIM verbindet sich nahtlos mit den robusten Netzen von Orange, MTN, Moov.
    - icon: zap
  ...
  carriers:
    title: 'Orange, MTN & Moov: Elfenbeinküste eSIM Anbieter'
    ...
    - name: MTN
      ...
      network: 5G/4G/LTE Netzwerk
reminders:
  title: 'Elfenbeinküste eSIM Tipps: Was Sie vor Ihrer Reise wissen sollten'
  items:
  - icon: 📱
...
activation_steps:
  title: 'Elfenbeinküste eSIM Aktivierung: In 3 Schritten verbunden'
  steps:
  - num: '1'
    ...
    desc: Direkt nach Ihrer Bestellung erhalten Sie eine E‑Mail mit Ihrem persönlichen Aktivierungs‑QR‑Code und den Einrichtungsanweisungen.
      ...
      für die spätere Installation. Die eSIM ist 30 Tage gültig, Sie können sie also vor Ihrer Abreise nach Elfenbeinküste
  ...
  - num: '2'
    ...
    - Vergeben Sie einen Namen (z.B. „Roami Elfenbeinküste“) und wählen Sie ihn als **Standard für mobile Daten**
  ...
  - num: '3'
    ...
    desc: Nach der Installation können Sie die eSIM in den Einstellungen deaktiviert lassen. Sie können sie jedoch bereits
      mit Ihrem heimischen WLAN testen (es werden keine mobilen Daten verbraucht). Sobald Sie in Elfenbeinküste landen, schalten
  ...
  - num: '4'
    ...
    desc: Sobald Sie in Elfenbeinküste gelandet sind (z.B. in Flughafen Abidjan (Félix-Houphouët-Boigny), Flughafen Bouaké,
      Flughafen Yamoussoukro), schalten Sie den Flugmodus aus (oder bleiben Sie im Flugmodus und aktivieren Sie nur die eSIM).
      Gehen Sie zu **Einstellungen → Mobilfunk** und aktivieren Sie Ihre Roami Elfenbeinküste eSIM. Innerhalb weniger Sekunden
      verbindet sich Ihr Gerät automatisch mit dem schnellsten verfügbaren 5G/4G-Netz von Orange / MTN. Sie können sofort
