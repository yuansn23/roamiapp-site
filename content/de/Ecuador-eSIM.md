...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "eSIM Internetgeschwindigkeit in Ecuador -- Was Reisende wissen sollten"
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Ecuador eSIM FAQ
    questions:
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Ecuador nutze?
      a: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Claros Netz in Ecuador liefert stabile Verbindungen für Videoanrufe.
    - q: |
        Bekomme ich nach dem Kauf meiner Ecuador eSIM eine Bestätigung?
      a: |
    ...
    - q: |
        Soll ich meine Ecuador eSIM vor der Abreise oder erst am Flughafen installieren?
      a: |
        Vor der Abreise — die Installation benötigt Internet und dauert etwa 2 Minuten. Der QR-Code kommt innerhalb von 5 Minuten per Email. In Ecuador einfach Daten-Roaming aktivieren, und Sie sind in unter 60 Sekunden online. Ohne vorherige Installation müssten Sie am Flughafen auf WiFi angewiesen sein, das oft eine SMS-Verifizierung verlangt — ein klassisches Henne-Ei-Problem.
    - q: |
        Was tun, wenn meine Ecuador eSIM bei der Ankunft nicht funktioniert?
      a: |
