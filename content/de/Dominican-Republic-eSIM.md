...
country_meta:
  ...
  main_cities: Santo Domingo, Punta Cana, Santiago de los Caballeros, Puerto Plata,
    La Romana
...
hero:
  ...
  title: Dominikanische Republik eSIM Datentarif
  subtitle: Sofortige Lieferung | Automatische Netzwerkauswahl | Reise mit Leichtigkeit
features:
...
network_coverage:
  ...
  service_details:
    ...
    - icon: map
      ...
      title: Abdeckung
      desc: Genießen Sie umfassende Netzabdeckung in ganz Dominikanische Republik,
        einschließlich Städten wie Santo Domingo, Punta Cana, Santiago de los Caballeros.
        Unsere Dominikanische Republik eSIM verbindet sich nahtlos mit den Netzen
        von Claro, Altice Dominicana und Viva.
    - icon: zap
...
reminders:
  ...
  - icon: ✈️
    html: Wir empfehlen, die eSIM erst nach der Ankunft in Dominikanische Republik
      zu aktivieren.
  - icon: ⏰
...
activation_steps:
  title: Aktivierung Ihrer Dominikanische Republik eSIM in wenigen Minuten
  steps:
  - num: '1'
    ...
    desc: Direkt nach Ihrer Bestellung erhalten Sie eine E‑Mail mit Ihrem persönlichen
      ...
      vor Ihrer Abreise nach Dominikanische Republik in aller Ruhe vorbereiten.
    is_list: false
  - num: '2'
    ...
    - Das Dominikanische Republik eSIM-Profil wird automatisch geladen – tippen Sie
      auf **"Weiter"**
    - Vergeben Sie einen Namen (z.B. „Roami Dominikanische Republik“) und wählen Sie
  ...
  - num: '3'
    ...
    desc: Nach der Installation können Sie die eSIM in den Einstellungen deaktiviert
      ...
      keine mobilen Daten verbraucht). Sobald Sie in Dominikanische Republik landen,
      schalten Sie die eSIM einfach ein – die Gültigkeit startet dann automatisch
      bei der ersten Verbindung mit dem Netz von Claro / Altice Dominicana. Keine
      versteckten Aktivierungsgebühren, keine Roamingkosten.
    is_list: false
  - num: '4'
    title: 'Ankunft in Dominikanische Republik: sofort online mit 5G/4G'
    desc: Sobald Sie in Dominikanische Republik gelandet sind (z.B. in Flughafen Punta
      Cana (PUJ), Flughafen Santo Domingo (SDQ), Flughafen Santiago (STI)), schalten
      ...
      Roami Dominikanische Republik eSIM. Innerhalb weniger Sekunden verbindet sich
      Ihr Gerät automatisch mit dem schnellsten verfügbaren 5G/4G-Netz von Claro /
      Altice Dominicana. Sie können sofort navigieren, WhatsApp nutzen, soziale Medien
      checken oder einen Hotspot für andere Geräte einrichten – ohne Wartezeit, ohne
      Ausweis, ohne Vertrag.
    is_list: false
faq_section:
  title: Dominikanische Republik eSIM FAQ & Reiseführer
  desc: Alles, was Sie über die Verwendung Ihrer Dominikanische Republik eSIM in verschiedenen
  ...
  - id: faq-general
    ...
    questions:
    - q: Unterstützt mein Smartphone die Dominikanische Republik eSIM und wie installiere
        ich sie?
      a: Ja, die meisten modernen Smartphones (iPhone XS/XR oder neuer, Samsung Galaxy
        S20+/Note20+, Google Pixel 3a+) unterstützen eSIM. Sie installieren die Dominikanische
        Republik eSIM, indem Sie den QR-Code in den Mobilfunkeinstellungen scannen.
        Die Netzwerke von Claro / Altice Dominicana bieten hervorragende 5G/4G-Abdeckung
        in Dominikanische Republik.
    - q: Gibt es eine Geld‑zurück‑Garantie, falls die Dominikanische Republik eSIM
        nicht funktioniert?
    ...
    - q: Welche Vorteile bietet die Roami eSIM gegenüber lokalen Prepaid-SIM-Karten
      ...
      a: Im Gegensatz zu lokalen Prepaid‑SIMs sparen Sie sich den Gang zum Shop, die
        ...
        am Flughafen.
    - q: Kann ich die Dominikanische Republik eSIM nach der Installation auf ein anderes
        Gerät übertragen?
    ...
    - q: Was kostet die Dominikanische Republik eSIM und gibt es Rabattaktionen?
      a: Unser Dominikanische Republik eSIM Tarif startet bei nur $1.99/GB. Mit dem
    ...
    - q: Wie sicher ist die Dominikanische Republik eSIM im Vergleich zu einer physischen
        SIM-Karte?
    ...
    - q: Wie aktiviere ich die Dominikanische Republik eSIM und wann beginnt die Gültigkeit?
      a: Nach dem Kauf erhalten Sie sofort einen Aktivierungs‑QR‑Code per E‑Mail.
        Die Gültigkeit startet erst, wenn Ihr Telefon in Dominikanische Republik erstmals
        eine Verbindung zu einem der Partner-Netze (Claro / Altice Dominicana) herstellt.
        So zahlen Sie nur für die Tage, die Sie tatsächlich vor Ort sind.
    - q: Wie funktioniert das internationale Roaming mit der Dominikanische Republik
        eSIM in Nachbarländern?
      a: Die Dominikanische Republik eSIM ist primär für Dominikanische Republik optimiert.
        ...
        zuverlässig außerhalb von Dominikanische Republik.
    ...
    - q: Kann ich die Dominikanische Republik eSIM als Hotspot mit anderen Geräten
        teilen?
      a: Ja, alle Roami eSIM-Tarife für Dominikanische Republik erlauben unbegrenztes
  ...
  - id: faq-airport
    ...
    - q: Wie erhalte ich sofort nach der Landung ein zuverlässiges Netz?
      a: Installieren Sie die Dominikanische Republik eSIM vor Ihrem Flug. Sobald
        Sie an Flughäfen wie Flughafen Punta Cana (PUJ), Flughafen Santo Domingo (SDQ),
        Flughafen Santiago (STI) landen, schalten Sie einfach den Flugmodus aus und
    ...
    - q: Wie kontaktiere ich meinen Abholer oder nutze Uber/Grab?
      a: Nach der Aktivierung bei der Landung können Sie sofort Apps wie Uber, Cabify,
        TuyoTransport nutzen, um eine Fahrt zu buchen, oder WhatsApp verwenden, um
    ...
    - q: Wie nutze ich Google Maps/Apple Maps, um Transportmittel zu finden?
      a: Mit Ihren Dominikanische Republik eSIM-Daten können Sie direkt an der Gepäckausgabe
        in Flughafen Punta Cana (PUJ), Flughafen Santo Domingo (SDQ), Flughafen Santiago
        (STI) Echtzeit-Fahrpläne für Züge und Busse prüfen oder den Weg zum Taxistand
        finden.
    - q: Wie vermeide ich teure SIM-Karten am Flughafen?
      a: Indem Sie unsere Dominikanische Republik eSIM vorab online kaufen, umgehen
    ...
    - q: Wie empfange ich SMS von Hotel/Autovermietung ohne lokale Nummer?
      a: Unsere Dominikanische Republik eSIM ist ein reiner Datentarif. Um SMS zu
        empfangen, lassen Sie Ihre heimische SIM-Karte aktiviert (SMS-Empfang ist
        oft kostenlos im Roaming) und nutzen Sie die eSIM für den gesamten Datenverkehr.
    - q: Wie kontaktiere ich sofort meine Familie?
      a: Sobald Sie landen, können Sie iMessage, WhatsApp oder FaceTime über unsere
        schnellen Dominikanische Republik eSIM-Daten nutzen, um Ihren Lieben mitzuteilen,
  ...
  - id: faq-transport
    ...
    - q: Wie nutze ich Google Maps zur Routenplanung?
      a: Unsere stabile Dominikanische Republik eSIM-Verbindung stellt sicher, dass
        Google Maps überall in Dominikanische Republik Echtzeit-Verkehrsdaten und
        Fahrpläne laden kann.
    - q: Wie können mich Uber/Grab-Fahrer über die App kontaktieren?
      a: Apps wie Uber, Cabify, TuyoTransport nutzen VoIP. Da Sie aktive Dominikanische
        Republik eSIM-Daten haben, können Fahrer Sie direkt über die App anrufen oder
        benachrichtigen, ohne eine lokale Nummer.
    - q: Wie kaufe ich Zug- oder U-Bahn-Tickets online?
      a: Nutzen Sie Ihre Dominikanische Republik eSIM-Daten, um in lokalen Apps digitale
    ...
    - q: Wie nutze ich Google Maps für Echtzeit-Navigation im Mietwagen?
      a: Befestigen Sie Ihr Telefon und nutzen Sie Ihre Dominikanische Republik eSIM.
        Ein 5GB- oder 10GB-Tarif reicht für eine umfangreiche GPS-Navigation während
        eines Roadtrips in Dominikanische Republik.
    - q: Wie scanne und entsperre ich E-Scooter (Lime/Bird)?
      a: Das Entsperren von E-Scootern erfordert eine schnelle Internetverbindung.
        Unsere Dominikanische Republik eSIM bietet die dafür nötige zuverlässige Abdeckung.
    ...
    - q: Wie biete ich einen stabilen Hotspot für meine Familie?
      a: Aktivieren Sie einfach den 'Persönlichen Hotspot' in Ihren Einstellungen.
        Ihre Familie kann sich mit Ihrem Dominikanische Republik eSIM-Netzwerk im
        Zug oder Auto verbinden.
  - id: faq-hotels
    icon: hotel
    tab_title: Hotels
    ...
    - q: Wie mache ich einen Self-Check-in nach Buchung?
      a: Viele moderne Unterkünfte senden Smart-Lock-Codes per E-Mail. Ihre Dominikanische
        Republik eSIM stellt sicher, dass Sie diese Details direkt vor der Haustür
        abrufen können.
    - q: Wie kontaktiere ich meinen Airbnb-Gastgeber bei Ankunft?
      a: Nutzen Sie die Messaging-Funktion der Airbnb-App oder WhatsApp, um Ihre Ankunftszeit
        mit Ihrem Gastgeber über mobile Dominikanische Republik eSIM-Daten abzustimmen.
    - q: Wie nutze ich Google Maps, um zum Hotel zu navigieren?
      a: Egal ob Sie in Punta Cana Resort & Club, Hard Rock Hotel & Casino Punta Cana,
        RIU Republica übernachten, geben Sie die Adresse in Google Maps ein und nutzen
        Sie die Navigation Ihrer Dominikanische Republik eSIM.
    - q: Wie empfange ich SMS-Verifizierungscodes?
      a: Lassen Sie Ihre heimische SIM für SMS aktiv und nutzen Sie Ihre Dominikanische
        Republik eSIM-Daten, um Codes per E-Mail oder Authenticator-App zu empfangen.
    - q: Wie kontaktiere ich schnell den Kundenservice?
      a: Nutzen Sie VoIP-Apps wie Skype oder die Chat-Funktion der Buchungs-App über
        Ihre Hochgeschwindigkeits-Dominikanische Republik eSIM-Daten.
    - q: Wie bestelle ich Essen mit lokalen Liefer-Apps?
      a: Laden Sie PedidosYa, Lola Delivery, Alto Delivery herunter und nutzen Sie
        Ihre Dominikanische Republik eSIM-Daten, um eine warme Mahlzeit direkt in
        die Hotellobby zu bestellen.
    - q: Wie bleibe ich nach dem Checkout mit dem Hotel in Kontakt?
      a: Sobald Sie das Hotel-WLAN verlassen, übernimmt Ihre Dominikanische Republik
  ...
  - id: faq-attractions
    ...
    - q: Wie kaufe ich E-Tickets über GetYourGuide/Viator?
      a: Wenn Sie Los Haitises Nationalpark, Altos de Chavón, Saona-Insel spontan
        besuchen möchten, können Sie Ihre Dominikanische Republik eSIM-Daten nutzen,
        um Online-Tickets zu kaufen und den Barcode direkt vorzuzeigen.
    - q: Wie buche ich Erlebnisse bei Tripadvisor sofort?
      a: Mit dem zuverlässigen 4G/5G Ihrer Dominikanische Republik eSIM können Sie
    ...
    - q: Wie nutze ich Wikipedia/Google für Informationen während des Besuchs?
      a: Erweitern Sie Ihr kulturelles Erlebnis, indem Sie historische Fakten googeln
        oder Museumstafeln übersetzen, während Sie Dominikanische Republik erkunden.
    - q: Wie finde ich den Weg zur nächsten Sehenswürdigkeit?
      a: Geben Sie Ihr nächstes Ziel in Google Maps ein; die starke Abdeckung Ihrer
        Dominikanische Republik eSIM führt Sie über die schnellste Route.
    - q: Wie prüfe ich Echtzeit-Wartezeiten in Freizeitparks?
      a: Freizeitpark-Apps benötigen Internet für Live-Wartezeiten. Ihre Dominikanische
        Republik eSIM hält Sie im gesamten Park online.
    - q: Wie greife ich auf Ticketmaster für Show-Tickets zu?
      a: Sie können sicher Last-Minute-Theaterkarten über Ticketing-Apps mit Ihren
        Dominikanische Republik eSIM-Daten kaufen.
    - q: Wie teile ich Fotos/Videos sofort auf Instagram/TikTok?
      a: Unsere schnellen Dominikanische Republik eSIM-Upload-Geschwindigkeiten ermöglichen
  ...
  - id: faq-dining
    ...
    - q: Wie finde ich Restaurants mit Google Maps/Tripadvisor?
      a: Suchen Sie mit Ihrer Dominikanische Republik eSIM nach 'Restaurants in der
        Nähe', um Bewertungen, Öffnungszeiten und Menüfotos zu prüfen.
    - q: Wie reserviere ich Tische online?
      a: Sichern Sie sich eine Reservierung über Online-Plattformen mit Ihrer Dominikanische
        Republik eSIM, während Sie unterwegs sind.
    - q: Wie scanne ich QR-Codes für digitale Menüs?
      a: Viele Restaurants nutzen digitale Menüs. Ihre Dominikanische Republik eSIM
    ...
    - q: Wie nutze ich die Google Translate Kamera für Speisekarten?
      a: Öffnen Sie die App und richten Sie die Kamera auf das Menü. Die Live-Übersetzung
        benötigt eine Internetverbindung über Ihre Dominikanische Republik eSIM.
    - q: Wie nutze ich lokale Lieferdienste?
      a: Laden Sie lokale Apps wie PedidosYa, Lola Delivery, Alto Delivery herunter
        und bestellen Sie bequem über Ihre Dominikanische Republik eSIM-Mobildaten.
    - q: Wie bezahle ich mit Apple Pay/Google Pay?
      a: Kontaktlose Zahlungen oder lokale Methoden wie Kreditkarte, Bar (Dominikanischer
        Peso), Apple Pay erfordern einen kurzen Internet-Handshake, den Ihre Dominikanische
        Republik eSIM perfekt meistert.
    - q: Wie finde ich Geheimtipps von Food-Bloggern?
      a: Streamen Sie YouTube-Vlogs oder stöbern Sie in Yelp-Bewertungen mit Ihrer
        Dominikanische Republik eSIM, um kulinarische Highlights zu entdecken.
  - id: faq-social
    icon: smartphone
    ...
    - q: Wie nutze ich WhatsApp/Telegram stabil im Ausland?
      a: Ihre Accounts sind an Ihre Heimnummer gebunden. Mit unserer Dominikanische
        Republik eSIM als Internetquelle können Sie genau wie zu Hause chatten und
        telefonieren.
    - q: Wie lade ich Inhalte auf TikTok hoch, ohne öffentliches WLAN?
      a: Öffentliches WLAN ist oft langsam und unsicher. Unsere 4G/5G Dominikanische
        Republik eSIM bietet die Bandbreite für schnelle Uploads.
    - q: Wie mache ich Videoanrufe mit meiner Familie?
      a: Unsere Netzwerkpartnerschaften garantieren, dass Videoanrufe über die Dominikanische
        Republik eSIM klar und verzögerungsfrei sind, wo immer Sie sich im Land befinden.
    - q: Ist es sicher, sich in öffentlichen WLANs in soziale Accounts einzuloggen?
      a: Öffentliches WLAN ist anfällig für Hacker. Die Nutzung Ihrer persönlichen
        Dominikanische Republik eSIM-Daten ist verschlüsselt und wesentlich sicherer.
    - q: Wie teile ich das Netzwerk als Hotspot mit Reisebegleitern?
      a: Aktivieren Sie die Hotspot-Funktion. Ihre Freunde können sich verbinden und
        Ihr Dominikanische Republik eSIM-Datenvolumen für ihre sozialen Medien nutzen.
  - id: faq-crossborder
    icon: globe
    ...
    - q: Brauche ich für jedes Land eine neue SIM-Karte?
      a: Die Einzelland-Dominikanische Republik eSIM funktioniert nur dort. Für Reisen
    ...
    - q: Wie vermeide ich Roaminggebühren bei Zugfahrten über Grenzen?
      a: Deaktivieren Sie 'Daten-Roaming' auf Ihrer Heim-SIM. Stellen Sie sicher,
        dass die Dominikanische Republik eSIM als primäre Datenleitung eingestellt
        ist.
  ...
  - id: faq-emergency
    ...
    - q: Wie wähle ich lokale Notrufnummern?
      a: In Dominikanische Republik können Sie Notrufnummern wie 911 (Polizei/Feuerwehr/Rettungsdienst)
        direkt wählen, solange Ihr Telefon ein Mobilfunksignal empfängt.
    - q: Wie finde ich das nächste Krankenhaus?
      a: Ihre Dominikanische Republik eSIM-Daten ermöglichen eine sofortige Suche
        auf Google Maps nach 'Apotheke' oder 'Krankenhaus' mit der schnellsten Route.
    - q: Wie finde ich Botschaftsinformationen bei Passverlust?
      a: Nutzen Sie Ihre Dominikanische Republik eSIM, um schnell Adresse und Notfallkontakt
        Ihrer Botschaft zu finden.
    - q: Wie kontaktiere ich die Reiseversicherung bei einem Unfall?
      a: Nutzen Sie VoIP-Apps wie Skype über Ihre Dominikanische Republik eSIM-Daten,
    ...
    - q: Wie teile ich meinen Standort in Echtzeit?
      a: Nutzen Sie 'Live-Standort teilen' in WhatsApp oder Apples 'Wo ist?', um Ihre
        Koordinaten über Dominikanische Republik eSIM-Daten zu senden.
    - q: Wie lade ich Offline-Karten für abgelegene Gebiete?
      a: Nutzen Sie Ihre Stadt-Abdeckung der Dominikanische Republik eSIM, um Offline-Karten
  ...
  - id: faq-business
    ...
    - q: Wie garantiere ich stabile Zoom/Teams-Meetings?
      a: Unsere Dominikanische Republik eSIM verbindet sich mit Premium-Netzen und
    ...
    - q: Wie verbinde ich mich sicher mit dem Firmen-VPN?
      a: Unsere Daten beschränken keine VPN-Protokolle. Sie können Ihr Firmen-VPN
        sicher über das Dominikanische Republik eSIM-Netzwerk starten.
    - q: Wie nutze ich den Hotspot für Laptops in Cafés?
      a: Aktivieren Sie den Hotspot. Die Nutzung Ihrer Dominikanische Republik eSIM
    ...
    - q: Wie empfange ich 2FA-Codes für Firmen-E-Mails?
      a: Lassen Sie Ihre heimische SIM für SMS aktiv und nutzen Sie die Dominikanische
        Republik eSIM-Daten für E-Mail-basierte Codes.
    - q: Wie lade ich große Dateien bei Kundenbesuchen hoch?
      a: Mit 5G/4G-LTE-Geschwindigkeiten Ihrer Dominikanische Republik eSIM können
        Sie Präsentationen schnell in Cloud-Dienste hochladen.
    - q: Wie nutze ich Slack/Gmail nahtlos für die Zusammenarbeit?
      a: Ihre Dominikanische Republik eSIM bietet konstante Verbindung, sodass Sie
        Slack-Nachrichten und E-Mails sofort erhalten.
    - q: Wie aktualisiere ich Reisepläne für die Firma online?
      a: Greifen Sie über Ihre Dominikanische Republik eSIM von unterwegs auf Firmenportale
