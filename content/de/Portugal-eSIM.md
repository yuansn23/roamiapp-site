...
country_meta:
  ...
  scenario_keywords: Sightseeing in Lissabon, Porto-Weinprobe, Strandurlaub an der
    Algarve, Pilgerweg nach Fatima, Inselhopping auf Madeira
  operators: NOS, MEO, Vodafone Portugal
  competitors: Airalo, Holafly, Ubigi, GigSky, Orange Holiday
  main_cities: Lissabon, Porto, Faro, Funchal, Coimbra
...
seo:
  title: Portugal eSIM - Günstige mobile Daten ohne Roaming - Roami
  description: Sofortige eSIM für Portugal mit unbegrenzten Daten. Keine Roaming-Gebühren,
    QR-Code Aktivierung. Ideal für Reisen nach Lissabon, Porto. Jetzt kaufen!
  keywords: Portugal eSIM, günstige eSIM Portugal, mobiles Internet Portugal, eSIM
    ohne Roaming, Daten eSIM Portugal
  low_price: 1.99
  high_price: 39.9
order_summary:
...
hero:
  ...
  flag_alt: Portugal Flagge
  title: Portugal eSIM Datentarif
  subtitle: Top-Wahl für Reisen in Portugal | Günstige Portugal eSIM | 100% Geld-zurück-Garantie
features:
  ...
  service_details:
    ...
    - icon: map
      ...
      desc: Genießen Sie umfassende Netzabdeckung in ganz Portugal, einschließlich
        Städten wie Lissabon, Porto, Faro und Funchal. Unsere Portugal eSIM verbindet
        sich nahtlos mit den Netzen von NOS, MEO und Vodafone für stabilen Empfang.
    - icon: zap
...
reminders:
  ...
  - icon: ✈️
    html: Wir empfehlen, die eSIM erst nach Ankunft in Portugal zu aktivieren.
  - icon: ⏰
...
activation_steps:
  ...
  - num: '3'
    title: 'Schritt 3: In Portugal nutzen'
    desc: Aktivieren Sie nach der Landung in Portugal die eSIM in den Einstellungen.
      Wir empfehlen WLAN für die erste Aktivierung.
    is_list: false
faq_section:
  title: Portugal eSIM FAQ & Reiseführer
  desc: Alles, was Sie über die Nutzung Ihrer Portugal eSIM in verschiedenen Reiseszenarien
    wissen müssen.
  categories:
  - id: faq-general
    icon: help-circle
    ...
    questions:
    - q: Unterstützt mein Handy die Portugal eSIM? Wie installiere ich sie?
      a: Die meisten modernen Smartphones ab dem iPhone XS/XR, Samsung Galaxy S20+
        und Google Pixel 3+ unterstützen eSIM. Sie können Ihre Portugal eSIM einfach
    ...
    - q: Wie kaufe und aktiviere ich die Portugal eSIM? Ist sie sofort aktiv?
      a: Sie können sie direkt auf unserer Website kaufen. Sie ist nicht sofort nach
        dem Kauf aktiv; die Gültigkeitsdauer beginnt erst, wenn Sie in Portugal ankommen
    ...
    - q: Was ist ein Aktivierungs-QR-Code? Läuft er ab? Kann er wiederverwendet werden?
      a: Der QR-Code ist Ihr digitales SIM-Profil für die Portugal eSIM. Er muss in
        ...
        werden.
    - q: Kann ich eine Rückerstattung erhalten, wenn die Portugal eSIM nicht funktioniert
        oder ein schlechtes Signal hat?
      a: Ja, wir bieten eine Geld-zurück-Garantie. Wenn Sie anhaltende Netzwerkprobleme
        in Portugal haben, die unser Support-Team nicht lösen kann, haben Sie Anspruch
    ...
    - q: Gibt es Rabattcodes? Wie verwende ich den Promo-Code 'esim20'?
      a: Ja! Sie können den Promo-Code 'esim20' auf der Checkout-Seite eingeben, um
        sofort 20% Rabatt auf Ihre Portugal eSIM Bestellung zu erhalten.
    ...
    - q: Kann ich meine Portugal eSIM-Daten teilen (Hotspot)?
      a: Absolut. Alle unsere Portugal eSIM-Tarife unterstützen mobilen Hotspot und
        Tethering, sodass Sie Ihre Daten mit Ihrem Laptop, Tablet oder Mitreisenden
        teilen können.
    - q: Was sind die Vorteile Ihrer Portugal eSIM gegenüber lokalen SIM-Karten oder
        anderen Anbietern?
      a: Im Gegensatz zu physischen SIM-Karten müssen Sie nicht am Flughafen anstehen
        ...
        Portugal wie NOS, MEO, Vodafone Portugal zusammen, um Premium-Geschwindigkeiten
    ...
    - q: Wie schneidet Roami im Vergleich zu bekannten eSIM-Anbietern wie Flexiroam,
        Holafly, DENT, Airalo ab?
      a: Während großartige Unternehmen wie Flexiroam, Holafly, DENT, Airalo zuverlässige
        Dienste leisten, konzentrieren wir uns auf die kosteneffizienteste Portugal
  ...
  - id: faq-airport
    ...
    - q: Wie bekomme ich sofort nach dem Aussteigen eine Internetverbindung?
      a: Installieren Sie die Portugal eSIM vor Ihrem Flug. Sobald Sie an Flughäfen
        wie Flughafen Lissabon Humberto Delgado, Flughafen Porto, Flughafen Faro landen,
    ...
    - q: Wie nutze ich Google Maps zur Transportsuche am Flughafen?
      a: Mit Ihren Portugal eSIM-Daten können Sie direkt an der Gepäckausgabe in Flughafen
        Lissabon Humberto Delgado, Flughafen Porto, Flughafen Faro Echtzeit-Fahrpläne
  ...
  - id: faq-transport
    ...
    - q: Wie nutze ich Google Maps für die Routenplanung?
      a: Unsere stabile Portugal eSIM-Verbindung stellt sicher, dass Google Maps überall
        in Portugal Echtzeit-Verkehrsdaten und Fahrpläne laden kann, was die Navigation
        nahtlos macht.
    - q: Wie kontaktiere ich Uber/Grab-Fahrer über die App?
      a: Apps wie Uber, Bolt, Moovit nutzen VoIP. Da Sie aktive Portugal eSIM-Daten
    ...
    - q: Wie nutze ich Google Maps für Echtzeit-Navigation im Mietwagen?
      a: Befestigen Sie Ihr Handy und nutzen Sie Ihre Portugal eSIM. Ein 5GB oder
        10GB Tarif reicht völlig für eine umfangreiche GPS-Navigation während eines
        Roadtrips in Portugal.
  ...
  - id: faq-hotels
    ...
    - q: Wie mache ich einen Self-Check-in nach einer Online-Buchung?
      a: Many modern rentals require you to access an online portal or check your
        email for a smart lock code. Ihre Portugal eSIM stellt sicher, dass Sie diese
    ...
    - q: Wie nutze ich Google Maps, um zum Hotel zu navigieren?
      a: Egal ob Sie im Four Seasons Ritz Lissabon, Pestana Palace Lisboa, The Yeatman
        Porto oder einer Pension übernachten, geben Sie die Adresse in Google Maps
        ein und nutzen Sie die Navigation Ihrer Portugal eSIM.
    - q: Wie empfange ich Verifizierungscodes (SMS) im Hotel?
      a: Keep your home SIM active for receiving SMS, and use the hotel Wi-Fi or your
        Portugal eSIM data to trigger the verification code from your bank or app.
  ...
  - id: faq-attractions
    ...
    - q: Wie kaufe ich E-Tickets über GetYourGuide/Viator?
      a: Wenn Sie Torre de Belém, Hieronymitenkloster, Livraria Lello spontan besuchen
        möchten, können Sie Ihre Portugal eSIM-Daten nutzen, um Online-Tickets zu
  ...
  - id: faq-dining
    ...
    - q: Wie scanne ich QR-Codes für digitale Menüs?
      a: Viele Restaurants nutzen digitale Karten. Ihre Portugal eSIM stellt sicher,
    ...
    - q: Wie finde ich Geheimtipps von Food-Bloggern?
      a: Streamen Sie YouTube-Vlogs oder stöbern Sie in Yelp-Bewertungen mit Ihrer
        Portugal eSIM, um kulinarische Highlights der Stadt zu finden.
  - id: faq-social
    icon: smartphone
    tab_title: Social
    ...
    - q: Wie mache ich Videoanrufe mit meiner Familie?
      a: Unsere Netzpartnerschaften garantieren, dass Videoanrufe über die Portugal
  ...
  - id: faq-crossborder
    ...
    - q: Wie vermeide ich Roaming-Gebühren bei Bahnfahrten über Grenzen?
      a: Deaktivieren Sie 'Daten-Roaming' auf Ihrer Heim-SIM. Stellen Sie sicher,
        dass die Portugal eSIM als primäre Datenleitung festgelegt ist.
  ...
  - id: faq-emergency
    ...
    - q: Wie wähle ich lokale Notrufnummern?
      a: In Portugal können Sie Notrufnummern wie 112 (Allgemein), 112 (Polizei),
        112 (Feuerwehr) direkt wählen, solange Ihr Handy irgendein Mobilfunksignal
        empfängt, unabhängig von der SIM.
    - q: Wie finde ich das nächste Krankenhaus bei plötzlicher Krankheit?
      a: Ihre Portugal eSIM-Daten erlauben eine sofortige Suche auf Google Maps nach
        'Apotheke' oder 'Krankenhaus' mit der schnellsten Route.
    - q: Wie finde ich Botschaftsinformationen bei Passverlust?
      a: Nutzen Sie Ihre Portugal eSIM, um schnell Adresse, Notfallkontakt und Öffnungszeiten
        Ihrer Botschaft im Internet zu finden.
    - q: Wie kontaktiere ich die Reiseversicherung bei einem Unfall?
      a: Nutzen Sie VoIP-Apps wie Skype oder Viber über Ihre Portugal eSIM-Daten,
    ...
    - q: Wie teile ich meinen Standort in Echtzeit in unsicheren Gebieten?
      a: Nutzen Sie 'Live-Standort teilen' in WhatsApp oder 'Wo ist?' von Apple, um
        Ihre Koordinaten über Portugal eSIM-Daten zu senden.
  ...
  - id: faq-business
    ...
    - q: Wie empfange ich 2FA-Codes für Firmen-E-Mails?
      a: Lassen Sie Ihre Heim-SIM für SMS aktiv und nutzen Sie die Portugal eSIM-Daten
