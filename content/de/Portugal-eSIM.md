...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "Welche Internetgeschwindigkeit kann ich mit eSIM in Portugal erwarten?"
  ...
  - id: faq-general
    ...
    questions:
    - q: |
        Woran erkenne ich, ob mein Handy eSIM in Portugal unterstützt?
      a: |
    ...
    - q: |
      ...
      a: |
        Ja — der QR-Code kommt innerhalb von 5 Minuten per Email. Kaufen Sie am Gate, installieren Sie im Flugzeug über WLAN. Nach der Landung in Portugal Daten-Roaming aktivieren und in 1-2 Minuten online sein. Totalzeit von Kauf bis Online: unter 10 Minuten.
    - q: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. MEOs Netz in Portugal liefert stabile Verbindungen für Videoanrufe.
    - q: |
