...
activation_steps:
  ...
  - num: '4'
    ...
    is_list: false
faq_section:
  title: "eSIM in Australia -- Welche Geschwindigkeit ist realistisch? Ein Reisebericht"
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Australien eSIM FAQ
    questions:
    - q: |
        Gibt es große Unterschiede zwischen Telstra, Optus und Vodafone für eSIM in Australien?
      a: |
        Ja — Telstra ist am schnellsten in Städten (5G bis zu 1 Gbit/s). Optus deckt etwa 85% des Landes ab, auch ländliche Gebiete. Vodafone ist die günstigste Option mit niedrigeren Preisen pro GB. Australien nutzt 5G auf n78/n257-Bändern. Ländliche Geb Roami wählt automatisch das beste Netz für Sie aus.
    - q: |
        Woran erkenne ich, ob mein Handy eSIM in Australien unterstützt?
      a: |
    ...
    - q: |
        Ist eine eSIM für Australien günstiger als eine SIM-Karte am Flughafen?
      a: |
    ...
    - q: |
        Bekomme ich nach dem Kauf meiner Australien eSIM eine Bestätigung?
      a: |
    ...
    - q: |
        Funktioniert eSIM in Australien auch in ländlichen Gebieten?
      a: |
