...
faq_section:
  ...
  - id: faq-general
    icon: help-circle
    tab_title: Allgemein
    title: Litauen eSIM FAQ
    questions:
    - q: |
        Kann ich meine heimische SIM-Karte behalten, während ich eSIM in Litauen nutze?
      a: |
    ...
    - q: |
        Bekomme ich nach dem Kauf meiner Litauen eSIM eine Bestätigung?
      a: |
    ...
    - q: |
      ...
      a: |
        Ja — alle datenbasierten Apps funktionieren ohne Einschränkungen. Ein 5GB Tarif reicht für etwa 500 Stunden WhatsApp-Audio oder 10 Stunden FaceTime-Video. Ein 30-minütiges Zoom-Meeting verbraucht etwa 150-300MB. Telias Netz in Litauen liefert stabile Verbindungen für Videoanrufe.
    - q: |
